...
must contain seekdb-jemalloc-sys 0.2.2+5.3.1. After fetching,
CARGO_NET_OFFLINE=true can be used for offline configuration. CMake selects the
toolchain pinned by rust/rust-toolchain.toml, so rustup does not require a default
toolchain.
