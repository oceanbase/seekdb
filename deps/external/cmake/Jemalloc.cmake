...
foreach(_index RANGE 0 ${_last_package})
  ...
  if(_name STREQUAL "seekdb-jemalloc-sys")
    ...
    if(NOT _source MATCHES "^registry\\+")
      message(FATAL_ERROR "Expected registry seekdb-jemalloc-sys package")
    endif()
...
set(_jemalloc_cc "${CMAKE_C_COMPILER}")
if(CMAKE_C_COMPILER_LAUNCHER)
  list(JOIN CMAKE_C_COMPILER_LAUNCHER " " _jemalloc_c_launcher)
  set(_jemalloc_cc "${_jemalloc_c_launcher} ${CMAKE_C_COMPILER}")
endif()
set(_jemalloc_env "CC=${_jemalloc_cc}" "AR=${CMAKE_AR}" "CFLAGS=${_jemalloc_cflags}")
