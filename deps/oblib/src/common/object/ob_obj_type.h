...
enum ObObjType
{
  ...
  ObEnumInnerType   = 34,
  ObSetInnerType    = 35,
  ObJsonType          = 36, // Json Type
  ObGeometryType      = 37, // Geometry type
  ObUserDefinedSQLType = 38, // User defined type in SQL
  ObDecimalIntType     = 39, // decimal int type
...
static ObObjOType OBJ_TYPE_TO_O_TYPE[ObMaxType+1] = {
  ...
  ObOJsonType,               //ObJsonType = 36,
  ObOGeometryType,           //ObGeometryType = 37,
  ObOUDTSqlType,             //ObUserDefinedSQLType = 38,
  ObONumberType,             //ObDecimalIntType = 39,
...
inline bool ob_is_otimestamp_type(const ObObjType type) { return false; }
...
{
  return ob_is_varchar_or_char(type, cs_type);
}
