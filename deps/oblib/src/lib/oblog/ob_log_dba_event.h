...
/* request queue event */
DBA_ERROR_EVENT(OB_SERVER_REQUEST_QUEUE_FULL)
...
DEFINE_DBA_EVENT_LIST_H(server_start,
  ...
  OB_SERVER_WAIT_RUNTIME_READY_BEGIN,
  OB_SERVER_WAIT_RUNTIME_READY_SUCCESS,
...
DBA_ERROR_EVENT(OB_SERVER_WAIT_RUNTIME_READY_FAIL)
...
DEFINE_DBA_EVENT_LIST_H(bootstrap,
  ...
  OB_BOOTSTRAP_CREATE_RUNTIME_BEGIN,
  OB_BOOTSTRAP_CREATE_RUNTIME_SUCCESS,
...
DBA_ERROR_EVENT(OB_BOOTSTRAP_CREATE_RUNTIME_FAIL)
