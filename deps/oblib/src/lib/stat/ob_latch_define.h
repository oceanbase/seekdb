...
LATCH_DEF(DDL_SORT_PROVIDER_LOCK, 352, "ddl sort provider lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(DDL_TABLET_CONTEXT_LOCK, 347, "ddl tablet context lock", LATCH_FIFO, 2000, 0, true)
