#include "rpc/ob_reverse_keepalive_stub.h"
/*
...
#ifndef OCEANBASE_RPC_FRAME_OB_REQ_SESSION_HANDLER_
#define OCEANBASE_RPC_FRAME_OB_REQ_SESSION_HANDLER_
...
public:
  ...
  virtual int wait_for_next_request(int64_t session_id,
                                    ...
                                    const ObReverseKeepaliveArg& reverse_keepalive_arg);
...
private:
  DISALLOW_COPY_AND_ASSIGN(ObReqSessionHandler);
};
