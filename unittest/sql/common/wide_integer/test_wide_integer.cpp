...
#define check_val_len(v, expected_len)                                                             \
  ...
  void test_oracle_to_string()
  {
    ...
    int ret = wide::to_string(decint0, int_bytes0, scale0, buf, sizeof(buf), length, false);
    ASSERT_EQ(ret, 0);
    ASSERT_EQ(std::string(buf, length), "0.00000000099999999999999999999999999999999998");
    length = 0;
    ret = wide::to_string(decint1, int_bytes1, scale1, buf, sizeof(buf), length, false);
    ASSERT_EQ(ret, 0);
    ASSERT_EQ(std::string(buf, length), "0.000000000999999999999999999999999999999999998");
    length = 0;
    ret = wide::to_string(decint2, int_bytes2, scale2, buf, sizeof(buf), length, false);
    ASSERT_EQ(ret, 0);
    ASSERT_EQ(std::string(buf, length), "99999999999999999999999999999999999999998");
    length = 0;
    ret = wide::to_string(decint2, int_bytes2, scale3, buf, sizeof(buf), length, false);
    ASSERT_EQ(ret, 0);
    ASSERT_EQ(std::string(buf, length), "999999999999999999999999999999999999999.98");
    length = 0;
