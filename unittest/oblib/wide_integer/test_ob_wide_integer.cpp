...
std::string test_data_path(const char *name)
{
  ...
  if (nullptr != test_srcdir && nullptr != test_workspace) {
    return std::string(test_srcdir) + "/" + test_workspace
        + "/unittest/oblib/wide_integer/" + name;
  }
  return std::string("unittest/oblib/wide_integer/") + name;
}
...
#define check_trait(trait, expected)                                                               \
  ...
  {
    std::ifstream int128_result(test_data_path("wide_integer_int128_add.result"));
    ...
    std::ifstream int256_int128_result(test_data_path("wide_integer_int256_int128_add.result"));
  ...
  {
    // int128 * int64
    std::ifstream int128_int64_result(test_data_path("wide_integer_int128_int64_mul.result"));
    ...
    // int128 * int128
    std::ifstream int128_int128_result(test_data_path("wide_integer_int128_int128_mul.result"));
    ...
    // int256 * int128
    std::ifstream int256_int128_result(test_data_path("wide_integer_int256_int128_mul.result"));
    ASSERT_TRUE(int256_int128_result.is_open());
    while (!int256_int128_result.eof()) {
      std::string lhs_str, rhs_str, result_str, overflow;
  ...
  {
    // int128/int64
    std::ifstream int128_int64(test_data_path("wide_integer_int128_int64_div.result"));
    ...
    // int128/int128
    std::ifstream int128_int128(test_data_path("wide_integer_int128_int128_div.result"));
    ...
    // int256/int128
    std::ifstream int256_int128(test_data_path("wide_integer_int256_int128_div.result"));
  ...
  {
    std::ifstream cmp_cases(test_data_path("wide_integer_cmp.result"));
...
#define check_val_len(v, expected_len)                                                             \
  ...
  void op_from_string()
  {
    std::ifstream cases(test_data_path("wide_integer_from_string.result"));
  ...
  void op_from_number()
  {
    std::ifstream from_num_cases(test_data_path("wide_integer_from_number.result"));
  ...
  void op_to_number()
  {
    ...
    ObDecimalInt *decint = nullptr;
    std::string valstr;
    std::ifstream cases(test_data_path("wide_integer_to_number.result"));
  ...
  void test_const_value()
  {
    ...
    ASSERT_EQ(ret, 0);
    const std::string output_path = test_output_path("decimalint_const_val.out");
    ...
    ASSERT_TRUE(is_equal_content(output_path, test_data_path("nmb_const_value.result")));
  }
};

void test_small_decint_to_nmb()
{
  const int64_t constexpr test_cases = 256;
  MockAllocator tmp_alloc;
  number::ObNumber expect_nmb;
