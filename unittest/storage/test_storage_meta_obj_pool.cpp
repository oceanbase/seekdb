...
private:
  ObStorageMetaObjPool<ObTablet> obj_pool_;
...
{
public:
  TestConcurrentMetaObjPool(const int64_t thread_cnt, ObStorageMetaObjPool<ObTablet> &meta_obj_pool);
...
TestConcurrentMetaObjPool::TestConcurrentMetaObjPool(const int64_t thread_cnt,
                                                     ObStorageMetaObjPool<ObTablet> &meta_obj_pool)
...
{
  system("rm -f test_storage_meta_obj_pool.log*");
  OB_LOGGER.set_file_name("test_storage_meta_obj_pool.log", true);
