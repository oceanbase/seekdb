...
DAG_SCHEDULER_DAG_PRIO_DEF(DAG_PRIO_STORAGE_HIGH,      8, "PRIO_STORAGE_HIGH", PRIO_STORAGE_HIGH)
...
DAG_SCHEDULER_DAG_PRIO_DEF(DAG_PRIO_VECTOR_INDEX,   2, "PRIO_VECTOR_INDEX", DEFAULT_FUNCTION)
...
/*
 * NOTICE: if you add/delete a compaction dag type here, remember to alter function is_compaction_dag and get_diagnose_tablet_type in ob_dag_scheduler.h
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_TABLET_BACKFILL_TX, ObDagPrio::DAG_PRIO_STORAGE_HIGH, ObSysTaskType::BACKFILL_TX_TASK, "TABLET_BACKFILL_TX", "BACKFILL_TX",
    true, 2, {"ls_id", "tablet_id"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_FINISH_BACKFILL_TX, ObDagPrio::DAG_PRIO_STORAGE_HIGH, ObSysTaskType::BACKFILL_TX_TASK, "FINISH_BACKFILL_TX", "BACKFILL_TX",
    true, 1, {"ls_id"})

DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_STANDBY_RESTORE, ObDagPrio::DAG_PRIO_STORAGE_HIGH, ObSysTaskType::BACKFILL_TX_TASK, "STANDBY_RESTORE", "STANDBY",
    true, 1, {"tablet_id"})

DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_VECTOR_INDEX, ObDagPrio::DAG_PRIO_VECTOR_INDEX, ObSysTaskType::VECTOR_INDEX_TASK, "VECTOR_INDEX_DAG", "VECTOR_INDEX",
...
#ifndef SRC_DATA_PLANE_API_SCHEDULER_OB_DAG_SCHEDULER_CONFIG_H_
#define SRC_DATA_PLANE_API_SCHEDULER_OB_DAG_SCHEDULER_CONFIG_H_
...
#endif // SRC_DATA_PLANE_API_SCHEDULER_OB_DAG_SCHEDULER_CONFIG_H_
