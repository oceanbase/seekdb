...
#ifndef OCEANBASE_DATA_PLANE_API_ACCESS_OB_TABLE_PARAM_H_
#define OCEANBASE_DATA_PLANE_API_ACCESS_OB_TABLE_PARAM_H_
...
public:
  ...
  const storage::ObITableReadInfo &get_read_info() const;
...
#endif // OCEANBASE_DATA_PLANE_API_ACCESS_OB_TABLE_PARAM_H_
