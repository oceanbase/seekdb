...
#ifndef OCEANBASE_ROOTSERVER_FREEZE_OB_LOCAL_MAJOR_FREEZE_
#define OCEANBASE_ROOTSERVER_FREEZE_OB_LOCAL_MAJOR_FREEZE_
...
private:
  ...
  int check_runtime_status() const;
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ObLocalMajorFreeze);
};

} // end namespace rootserver
} // end namespace oceanbase

#endif // OCEANBASE_FREEZE_ROOTSERVER_OB_LOCAL_MAJOR_FREEZE_
