 ...
 */
#ifndef OCEANBASE_LOG_FETCHER_START_LOG_ID_LOCATOR_H_
#define OCEANBASE_LOG_FETCHER_START_LOG_ID_LOCATOR_H_
...
typedef common::ObMapQueueThread<ObLogFetcherConfig::max_start_lsn_locator_thread_num> LocateWorker;
