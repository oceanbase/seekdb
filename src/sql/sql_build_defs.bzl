...
load(
    ...
    _SQL_GIS_PLUGIN_ADAPTER_SOURCES = "SQL_GIS_PLUGIN_ADAPTER_SOURCES",
    _SQL_EXTENSION_RUNTIME_SOURCES = "SQL_EXTENSION_RUNTIME_SOURCES",
    _SQL_CORE_GIS_REPLACED_SOURCES = "SQL_CORE_GIS_REPLACED_SOURCES",
...
SQL_GIS_PLUGIN_ADAPTER_SOURCES = _SQL_GIS_PLUGIN_ADAPTER_SOURCES
SQL_EXTENSION_RUNTIME_SOURCES = _SQL_EXTENSION_RUNTIME_SOURCES
SQL_CORE_GIS_REPLACED_SOURCES = _SQL_CORE_GIS_REPLACED_SOURCES
