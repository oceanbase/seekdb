...
static const int64_t SAPTIAL_INDEX_DEFAULT_ROW_COUNT = 32; // the number of cellids generated by one wkb (set value)
...
public:
  ...
  UIntFixedArray table_rowkey_cids_; // main table primary key column_ids
