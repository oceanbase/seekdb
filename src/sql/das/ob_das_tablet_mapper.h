...
#ifndef DEV_SRC_SQL_DAS_OB_DAS_TABLET_MAPPER_H_
#define DEV_SRC_SQL_DAS_OB_DAS_TABLET_MAPPER_H_
...
public:
  ObDASTabletMapper()
    : table_schema_(nullptr),
      virtual_table_id_(common::OB_INVALID_ID),
      related_info_(),
...
private:
  int get_all_virtual_tablet_and_object_id(common::ObIArray<common::ObTabletID> &tablet_ids,
                                           common::ObIArray<common::ObObjectID> &object_ids);
...
#endif /* DEV_SRC_SQL_DAS_OB_DAS_TABLET_MAPPER_H_ */
