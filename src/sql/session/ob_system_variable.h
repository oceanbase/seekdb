...
public:
  ...
  {
    return (flag & share::ObSysVarFlag::NULLABLE)
...
public:
  ...
  inline bool is_readonly() const { return 0 != (flags_ & share::ObSysVarFlag::READONLY); }
  inline bool is_session_readonly() const { return 0 != (flags_ & share::ObSysVarFlag::SESSION_READONLY); }
  inline bool is_invisible() const { return 0 != (flags_ & share::ObSysVarFlag::INVISIBLE); }
  inline bool is_global_scope() const { return 0 != (flags_ & share::ObSysVarFlag::GLOBAL_SCOPE); }
