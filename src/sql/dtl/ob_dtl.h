...
public:
  ...
  int create_local_channel(
      uint64_t chid, ObDtlChannel *&chan, ObDtlFlowControl *dfc = nullptr);
  //
...
private:
  int new_channel(uint64_t chid, ObDtlChannel *&chan);
  int init_channel(uint64_t chid, ObDtlChannel *&chan,
