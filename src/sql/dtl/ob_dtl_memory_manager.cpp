...
using namespace oceanbase::runtime;
using namespace oceanbase::sql;
using namespace oceanbase::sql::dtl;


ObDtlMemoryManager::ObDtlMemoryManager()
{}

int ObDtlMemoryManager::init()
{
  int ret = OB_SUCCESS;
  char *buf = nullptr;
...
int ObDtlMemoryManager::get_channel_mem_manager(int64_t idx, ObDtlChannelMemManager *&mgr)
{
  int ret = OB_SUCCESS;
  mgr = nullptr;
...
void ObDtlMemoryManager::destroy()
{
  int ret = OB_SUCCESS;
  int64_t cnt = mem_mgrs_.count();
  if (0 < cnt) {
...
ObDtlLinkedBuffer *ObDtlMemoryManager::alloc(int64_t chid, int64_t size)
{
  int ret = OB_SUCCESS;
...
int ObDtlMemoryManager::free(ObDtlLinkedBuffer *buf)
{
  int ret = OB_SUCCESS;
...
int64_t ObDtlMemoryManager::avg_alloc_times()
{
  int64_t avg = 0;
  int64_t total = 0;
  if (0 < times_.count()) {
...
int64_t ObDtlMemoryManager::variance_alloc_times()
{
...
int ObDtlMemoryManager::auto_free_on_time()
{
  int ret = OB_SUCCESS;
    int tmp_ret = OB_SUCCESS;
...
int64_t ObDtlMemoryManager::get_used_memory_size()
{
  int64_t used = 0;
