...
ObDtlMemManager::ObDtlMemManager()
{}

int ObDtlMemManager::init()
{
  int ret = OB_SUCCESS;
  char *buf = nullptr;
...
int ObDtlMemManager::get_channel_mem_manager(int64_t idx, ObDtlChannelMemManager *&mgr)
{
  int ret = OB_SUCCESS;
  mgr = nullptr;
...
ObDtlLinkedBuffer *ObDtlMemManager::alloc(int64_t chid, int64_t size)
{
  int ret = OB_SUCCESS;
...
int ObDtlMemManager::free(ObDtlLinkedBuffer *buf)
{
  int ret = OB_SUCCESS;
...
int64_t ObDtlMemManager::avg_alloc_times()
{
  int64_t avg = 0;
  int64_t total = 0;
  if (0 < times_.count()) {
...
int64_t ObDtlMemManager::variance_alloc_times()
{
...
int ObDtlMemManager::auto_free_on_time()
{
  int ret = OB_SUCCESS;
    int tmp_ret = OB_SUCCESS;
...
int64_t ObDtlMemManager::get_used_memory_size()
{
  int64_t used = 0;
