...
#define DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(symbol, func) \
  ...
  DEFINE_DBMS_VECTOR_MYSQL_INTERFACE(DBMS_VECTOR_MYSQL_BATCH_KNN, ObDBMSVectorMySql::batch_knn)
