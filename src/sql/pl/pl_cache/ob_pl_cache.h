...
#include "query/plan_cache/ob_lib_cache_register.h"
...
public:
  ...
  /* System package/class changes may advance only the system schema version.
     Always check cached objects that depend on those packages or classes. */
