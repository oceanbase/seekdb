...
#ifndef OCEANBASE_PL_SYS_PACKAGE_OB_DBMS_VECTOR_MYSQL_H_
#define OCEANBASE_PL_SYS_PACKAGE_OB_DBMS_VECTOR_MYSQL_H_
...
private:
  static int get_estimate_memory_str(share::ObVectorIndexParam index_param,
...
#endif // OCEANBASE_PL_SYS_PACKAGE_OB_DBMS_VECTOR_MYSQL_H_
