...
public:
  ...
  // FTS PERF OPT 1: keep this analysis conservative. A score is considered
  // required unless every occurrence of MATCH is a truth-only predicate.
  static int check_match_score_required(const ObDMLStmt *stmt,
