  ...
  if (pattern.is_string_type()) {
    ...
    if (cs_type == CS_TYPE_INVALID || cs_type >= CS_TYPE_MAX) {
      ...
      if (col_len == 0) {
        ...
        is_precise = ObPreRangeGraph::check_like_range_precise(pattern_str,
...
bool ObPreRangeGraph::check_like_range_precise(const ObString &pattern_str,
...
bool ObPreRangeGraph::can_domain_be_extract_range(const ObDomainOpType &op_type, const ObRawExprResType &col_type,
...
common::ObDomainOpType ObPreRangeGraph::get_geo_relation(ObItemType type)
{
...
common::ObDomainOpType ObPreRangeGraph::get_domain_op_type(ObItemType type)
{
  common::ObDomainOpType rel_type = common::ObDomainOpType::T_INVALID;
  switch (type) {
