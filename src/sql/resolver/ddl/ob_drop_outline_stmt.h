...
public:
  ...
  obcall::ObDropOutlineArg &get_drop_outline_arg() { return drop_outline_arg_; }
  const obcall::ObDropOutlineArg &get_drop_outline_arg() const { return drop_outline_arg_; }
  virtual obcall::ObDDLArg &get_ddl_arg() { return drop_outline_arg_; }
  TO_STRING_KV(K_(drop_outline_arg));
private:
  obcall::ObDropOutlineArg drop_outline_arg_;
