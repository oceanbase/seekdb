...
public:
  ...
  virtual obcall::ObDDLArg &get_ddl_arg() { return purge_table_arg_; }
  TO_STRING_KV(K_(stmt_type),K_(purge_table_arg));
private:
  obcall::ObPurgeTableArg purge_table_arg_;
...
public:
  ...
  virtual obcall::ObDDLArg &get_ddl_arg() { return purge_index_arg_; }
  TO_STRING_KV(K_(stmt_type),K_(purge_index_arg));
private:
  obcall::ObPurgeIndexArg purge_index_arg_;
...
private:
  obcall::ObPurgeDatabaseArg purge_db_arg_;
...
private:
  obcall::ObPurgeRecycleBinArg purge_recyclebin_arg_;
