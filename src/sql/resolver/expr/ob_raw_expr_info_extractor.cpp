...
int ObRawExprInfoExtractor::visit(ObSysFunRawExpr &expr)
{
  ...
  if (OB_FAIL(clear_info(expr))) {
    ...
    if (T_FUN_SYS_AUTOINC_NEXTVAL == expr.get_expr_type()
        ...
        || T_FUN_SYS_PLUGIN_FUNCTION == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TABLE_FUNCTION == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TYPE_ENCODE == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_CAST == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TYPE_VALUE == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TYPE_COMPARE == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TYPE_BETWEEN == expr.get_expr_type()
        || T_FUN_SYS_PLUGIN_TYPE_IN == expr.get_expr_type()
