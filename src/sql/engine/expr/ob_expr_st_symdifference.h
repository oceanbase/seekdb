 ...
 */
#ifndef OCEANBASE_SQL_OB_EXPR_ST_SYMDIFFERENCE_H_
...
namespace sql
{
class ObExprSTSymDifference : public ObFuncExprOperator
{
public:
  explicit ObExprSTSymDifference(common::ObIAllocator &alloc);
  virtual ~ObExprSTSymDifference();
  virtual int calc_result_type2(ObExprResType &type, ObExprResType &type1, ObExprResType &type2,
      common::ObExprTypeCtx &type_ctx) const override;
  static int eval_st_symdifference(const ObExpr &expr, ObEvalCtx &ctx, ObDatum &res);
  virtual int cg_expr(
...
#endif  // OCEANBASE_SQL_OB_EXPR_ST_SYMDIFFERENCE_H_
