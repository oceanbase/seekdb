...
{
public:
  explicit ObExprLoadFile(common::ObIAllocator &allocator);
  virtual ~ObExprLoadFile() = default;

  int calc_result_type2(common::ObExprResType &type,
                        common::ObExprResType &location_type,
                        common::ObExprResType &file_type,
