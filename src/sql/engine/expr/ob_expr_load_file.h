...
private:
  static bool is_file_url(const common::ObString &url);
  static bool is_safe_relative_path(const common::ObString &path);
  static int build_full_path(const common::ObString &location_url,
