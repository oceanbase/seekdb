...
#ifndef OB_SQL_MEMORY_MANAGER_H
#define OB_SQL_MEMORY_MANAGER_H
...
class ObSqlMemoryTracker : public ObSqlMemoryCallback
{
public:
  ObSqlMemoryTracker() :
...
public:
  ...
  ObSqlMemoryTracker* get_sql_memory_callback() { return &sql_mem_callback_; }
...
OB_INLINE void ObSqlMemoryTracker::alloc(int64_t size)
{
  (ATOMIC_AAF(&total_alloc_size_, size));
}

OB_INLINE void ObSqlMemoryTracker::free(int64_t size)
{
