...
////////////////////////////////////////////////////////////////////////////////////
int ObSqlMemoryManager::ObSqlWorkAreaCalcInfo::init(
...
void ObSqlMemoryManager::ObSqlWorkAreaCalcInfo::destroy(ObIAllocator &allocator)
{
...
int ObSqlMemoryManager::ObSqlWorkAreaCalcInfo::calc_memory_target(
  int64_t idx,
...
int ObSqlMemoryManager::ObSqlWorkAreaCalcInfo::find_best_interval_index_by_mem_target(
...
int ObSqlMemoryManager::ObSqlWorkAreaCalcInfo::calculate_global_bound_size(
...
int ObSqlMemoryManager::server_module_new(ObSqlMemoryManager *&sql_mem_mgr)
{
  int ret = OB_SUCCESS;

  sql_mem_mgr = OB_NEW(ObSqlMemoryManager,
                        ObMemAttr("SqlMemMgr"));
...
int ObSqlMemoryManager::calc_work_area_size_by_profile(
...
int ObSqlMemoryManager::get_work_area_size(
  ObIAllocator *allocator,
  ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
...
int ObSqlMemoryManager::register_work_area_profile(ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
  if (!profile.is_registered()) {
...
int ObSqlMemoryManager::update_work_area_profile(
...
int ObSqlMemoryManager::fill_workarea_stat(
...
int ObSqlMemoryManager::try_fill_workarea_stat(
...
int ObSqlMemoryManager::new_and_fill_workarea_stat(
  ObSqlWorkAreaStat::WorkareaKey &workarea_key,
  ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
...
int ObSqlMemoryManager::collect_workarea_stat(ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
...
int ObSqlMemoryManager::fill_workarea_histogram(ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
...
int ObSqlMemoryManager::unregister_work_area_profile(ObSqlWorkAreaProfile &profile)
{
  int ret = OB_SUCCESS;
...
int ObSqlMemoryManager::find_interval_index(
...
int ObSqlMemoryManager::count_profile_into_work_area_intervals(
  ObSqlWorkAreaInterval *wa_intervals,
...
bool ObSqlMemoryManager::enable_auto_sql_memory_manager()
{
...
int ObSqlMemoryManager::try_push_profiles_work_area_size(int64_t global_bound_size)
{
  int ret = OB_SUCCESS;
  if (nullptr == profile_lists_) {
    ret = OB_ERR_UNEXPECTED;
...
int ObSqlMemoryManager::calculate_global_bound_size_by_interval_info(
  ObIAllocator &allocator,
  const int64_t wa_max_memory_size,
  const bool auto_calc)
{
...
int ObSqlMemoryManager::get_workarea_stat(ObIArray<ObSqlWorkAreaStat> &wa_stats)
{
  int ret = OB_SUCCESS;
  ObLatchRGuard guard(lock_, ObLatchIds::SQL_WA_STAT_MAP_LOCK);
...
int ObSqlMemoryManager::get_workarea_histogram(
...
int ObSqlMemoryManager::get_all_active_workarea(
...
int ObSqlMemoryManager::get_workarea_memory_info(
