...
#ifndef OCEANBASE_SQL_ENGINE_SORT_OB_PARTITION_SORT_STRATEGY_H_
#define OCEANBASE_SQL_ENGINE_SORT_OB_PARTITION_SORT_STRATEGY_H_
...
class ObPartitionSortStrategy : public ObISortStrategy
{
public:
  ObPartitionSortStrategy() : ctx_(nullptr), sort_impl_(nullptr), res_mgr_(nullptr)
  {
  }
...
#endif /* OCEANBASE_SQL_ENGINE_SORT_OB_PARTITION_SORT_STRATEGY_H_ */
