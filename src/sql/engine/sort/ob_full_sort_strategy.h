...
#ifndef OCEANBASE_SQL_ENGINE_SORT_OB_FULL_SORT_STRATEGY_H_
#define OCEANBASE_SQL_ENGINE_SORT_OB_FULL_SORT_STRATEGY_H_
...
class ObFullSortStrategy : public ObISortStrategy
{
public:
  ObFullSortStrategy() : sort_impl_(nullptr), res_mgr_(nullptr)
  {
  }
...
#endif /* OCEANBASE_SQL_ENGINE_SORT_OB_FULL_SORT_STRATEGY_H_ */
