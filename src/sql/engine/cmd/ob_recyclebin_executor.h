...
#ifndef OCEANBASE_SQL_ENGINE_CMD_OB_RECYCLEBIN_EXECUTOR_H_
#define OCEANBASE_SQL_ENGINE_CMD_OB_RECYCLEBIN_EXECUTOR_H_
...
#endif // OCEANBASE_SQL_ENGINE_CMD_OB_RECYCLEBIN_EXECUTOR_H_
