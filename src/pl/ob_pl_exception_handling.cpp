...
// DWARF exception-handling pointer encodings (LSB / DWARF spec). Previously pulled in
// transitively from LLVM's BinaryFormat/Dwarf.h via objit; defined locally now that LLVM
// is removed. Values match the LLVM/standard definitions exactly.
enum {
