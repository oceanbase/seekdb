...
#define OB_DEBUG_SYNC_POINT_DEF(ACT)                               \
    ...
    ACT(BEFORE_STANDBY_LOG_SYNC_FETCH,)\
    ACT(AFTER_STANDBY_PROMOTION_BOUNDARY_RESOLVED,)\
    ACT(AFTER_STANDBY_PROMOTION_INTENT_PERSISTED,)\
    ACT(AFTER_STANDBY_PRIMARY_ROLE_COMMITTED,)\
    ACT(BEFORE_FIX_RUNTIME_SCHEMA_VERSION,)\
    ...
    ACT(COLUMN_REDEFINITION_LOCAL_BUILD,)\
    ...
    ACT(DDL_STATS_BEFORE_SYNC,)\
    ACT(GATHER_STATS_BEFORE_ESTIMATE_BLOCK,)\
    ACT(GATHER_STATS_AFTER_BATCH_WRITE,)\
    ACT(FORK_TABLE_PREPARE,)\
    ACT(FORK_TABLE_OBTAIN_SNAPSHOT,)\
    ACT(FORK_TABLE_WAIT_FREEZE_END,)\
    ACT(FORK_TABLE_BUILD_DATA,)\
    ACT(FORK_TABLE_WAIT_DATA_COMPLEMENT,)\
    ACT(FORK_TABLE_SUCCESS,)\
    ACT(CREATE_INDEX_WAIT_TRANS_END,)\
    ACT(CREATE_INDEX_REPLICA_BUILD,)\
    ACT(CREATE_INDEX_LOCAL_BUILD,)\
    ...
    ACT(CS_FETCHER_AFTER_DML_REDO_LOG,)\
    ACT(CS_FETCHER_AFTER_MIN_DEP_END_LSN,)\
    ACT(CS_FETCHER_BEFORE_NO_ASYNC_DRAIN,)\
    ACT(CS_FETCHER_AFTER_NO_ASYNC_DRAIN,)\
    ACT(CS_REFRESH_AFTER_TARGET_CAPTURE,)\
    ACT(CS_REFRESH_AFTER_FENCE_PROCESSED,)\
