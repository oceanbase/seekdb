...
class ObBGThreadMonitor;
class ObBGThreadMonitorTimerTask : public common::ObTimerTask
{
public:
  ObBGThreadMonitorTimerTask(ObBGThreadMonitor &monitor) : monitor_(monitor)
  {}
  virtual ~ObBGThreadMonitorTimerTask() = default;

  void runTimerTask() override;

private:
  ObBGThreadMonitor &monitor_;
};
...
private:
  ...
  ObBGThreadMonitorTimerTask monitor_task_;

  friend ObBGThreadMonitorTimerTask;
private:
