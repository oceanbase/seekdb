...
DEF_STR_WITH_CHECKER(_publish_schema_mode, OB_CLUSTER_PARAMETER, "BEST_EFFORT",
...
DEF_STR_WITH_CHECKER(default_table_store_format, OB_CLUSTER_PARAMETER, "row",
...
DEF_CAP(_chunk_row_store_mem_limit, OB_CLUSTER_PARAMETER, "0M", "[0M,]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(kv_transport_compress_func, OB_CLUSTER_PARAMETER, "none",
                     common::ObConfigCompressFuncChecker,
...
DEF_CAP(kv_transport_compress_threshold, OB_CLUSTER_PARAMETER, "10K","[0B,]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(_sort_area_size, OB_CLUSTER_PARAMETER, "32M", "[2M,]",
        "size of maximum memory that could be used by SORT. Range: [2M,+∞)",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(_hash_area_size, OB_CLUSTER_PARAMETER, "32M", "[4M,]",
...
DEF_INT(recover_table_concurrency, OB_CLUSTER_PARAMETER, "0", "[0,16]",
...
DEF_INT(recover_table_dop, OB_CLUSTER_PARAMETER, "0", "[0,)",
...
DEF_STR_WITH_CHECKER(spill_compression_codec, OB_CLUSTER_PARAMETER, "NONE",
...
//// tenant config
DEF_TIME_WITH_CHECKER(max_stale_time_for_weak_consistency, OB_CLUSTER_PARAMETER, "5s",
                      ...
                      ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_monotonic_weak_read, OB_CLUSTER_PARAMETER, "false",
...
DEF_INT(_ob_max_thread_num, OB_CLUSTER_PARAMETER, "0", "[0,10000)",
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_DBL(cpu_quota_concurrency, OB_CLUSTER_PARAMETER, "4", "[1,20]",
...
DEF_INT(px_workers_per_cpu_quota, OB_CLUSTER_PARAMETER, "10", "[0,20]",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(undo_retention, OB_CLUSTER_PARAMETER, "1800", "[0, 4294967295]",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_mvcc_gc_using_min_txn_snapshot, OB_CLUSTER_PARAMETER, "True",
        "specifies enable mvcc gc using active txn snapshot",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_rowsets_enabled, OB_CLUSTER_PARAMETER, "True",
         "specifies whether vectorized sql execution engine is activated",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_rowsets_target_maxsize, OB_CLUSTER_PARAMETER, "524288", "[262144, 8388608]",
        "the size of the memory reserved for vectorized sql engine. Range: [262144, 8388608]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_rowsets_max_rows, OB_CLUSTER_PARAMETER, "256", "[0, 65535]",
        "the row number processed by vectorized sql engine within one batch. Range: [0, 65535]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(_ctx_memory_limit, OB_CLUSTER_PARAMETER, "",
        common::ObCtxMemoryLimitChecker,
        "specifies tenant ctx memory limit.",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_convert_real_to_decimal, OB_CLUSTER_PARAMETER, "False",
         "specifies whether convert column type float(M,D), double(M,D) to decimal(M,D) in DDL",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_decimal_int_type, OB_CLUSTER_PARAMETER, "True",
         "specifies wether use decimal_int type as backend for decimal values",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_ob_enable_dynamic_worker, OB_CLUSTER_PARAMETER, "True",
         "specifies whether worker count increases when all workers were in blocking.",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_optimizer_ads_time_limit, OB_CLUSTER_PARAMETER, "10", "[0, 300]",
        "the maximum optimizer dynamic sampling time limit. Range: [0, 300]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_hash_join_enabled, OB_CLUSTER_PARAMETER, "True",
         "enable/disable hash join",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_optimizer_sortmerge_join_enabled, OB_CLUSTER_PARAMETER, "True",
         "enable/disable merge join",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
//
DEF_BOOL(_nested_loop_join_enabled, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_mysql_compatible_dates, OB_CLUSTER_PARAMETER, "False",
  ...
  ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
//
DEF_BOOL(_enable_enum_set_subschema, OB_CLUSTER_PARAMETER, "True",
...
DEF_INT(_min_const_integer_precision, OB_CLUSTER_PARAMETER, "1", "[1, 20]",
        "the minimum precision of integer constant",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(_lob_rowsets_max_rows, OB_CLUSTER_PARAMETER, "65535", "[1, 65535]",
        "max batch size of physical plan with lob data",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(_use_hash_rollup, OB_CLUSTER_PARAMETER, "AUTO",
...
DEF_BOOL(_enable_constant_type_demotion, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(_non_standard_comparison_level, OB_CLUSTER_PARAMETER, "NONE",
...
DEF_INT(_memstore_limit_percentage, OB_CLUSTER_PARAMETER, "0", "[0, 100)",
        "used in calculating the value of MEMSTORE_LIMIT parameter: "
...
DEF_INT(data_disk_write_limit_percentage, OB_CLUSTER_PARAMETER, "0", "[0, 100)",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_tx_share_memory_limit_percentage, OB_CLUSTER_PARAMETER, "0", "[0, 100)",
        ...
        "Range: [0, 100)",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_tx_data_memory_limit_percentage, OB_CLUSTER_PARAMETER, "20", "(0, 100)",
        "used to control the upper limit percentage of memory resources that the TxData module can use. "
        "Range:(0, 100)",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_mds_memory_limit_percentage, OB_CLUSTER_PARAMETER, "10", "(0, 100)",
        "Used to control the upper limit percentage of memory resources that the Mds module can use. "
        "Range:(0, 100)",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(writing_throttling_maximum_duration, OB_CLUSTER_PARAMETER, "2h", "[1s, 3d]",
...
DEF_TIME(plan_cache_evict_interval, OB_CLUSTER_PARAMETER, "5s", "[0s,)",
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(default_progressive_merge_num, OB_CLUSTER_PARAMETER, "0", "[0,)",
         "default progressive_merge_num when tenant create table"
         "Range:[0,)",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(_parallel_min_message_pool, OB_CLUSTER_PARAMETER, "16M", "[16M, 8G]",
        "DTL message buffer pool reserve the mininum size after extend the size. Range: [16M,8G]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_DBL(_parallel_server_sleep_time, OB_CLUSTER_PARAMETER, "1", "[0, 2000]",
        "sleep time between get channel data in millisecond. Range: [0, 2000]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_DBL(_px_max_message_pool_pct, OB_CLUSTER_PARAMETER, "40", "[0,90]",
        "The maxinum percent of tenant memory that DTL message buffer pool can alloc memory. Range: [0,90]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_px_message_compression, OB_CLUSTER_PARAMETER, "True",
...
DEF_INT(_px_chunklist_count_ratio, OB_CLUSTER_PARAMETER, "1", "[1, 128]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_sqlexec_disable_hash_based_distagg_tiv, OB_CLUSTER_PARAMETER, "False",
         "disable hash based distinct aggregation in the second stage of three stage aggregation for gby queries"
         "Value:  True:turned on  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_force_hash_groupby_dump, OB_CLUSTER_PARAMETER, "False",
         "force hash groupby to dump"
         "Value:  True:turned on  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_force_hash_join_spill, OB_CLUSTER_PARAMETER, "False",
         "force hash join to dump after get all build hash table "
         "Value:  True:turned on  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_enable_hash_join_hasher, OB_CLUSTER_PARAMETER, "1", "[1, 7]",
         "which hash function to choose for hash join "
         "1: murmurhash, 2: crc, 4: xxhash",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_enable_hash_join_processor, OB_CLUSTER_PARAMETER, "7", "[1, 7]",
         "which path to process for hash join, default 7 to auto choose "
         "1: nest loop, 2: recursive, 4: in-memory",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_pushdown_storage_level, OB_CLUSTER_PARAMETER, "4", "[0, 4]",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_WORK_AREA_POLICY(workarea_size_policy, OB_CLUSTER_PARAMETER, "AUTO", "policy used to size SQL working areas (MANUAL/AUTO)",
              ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(temporary_file_max_disk_size, OB_CLUSTER_PARAMETER, "0M", "[0,)",
        "maximum disk usage of temporary file on a single node, 0 means no limit. "
        "Range: [0,+∞)",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_temporary_file_io_area_size, OB_CLUSTER_PARAMETER, "1", "[0, 50)",
         "memory buffer size of temporary file, as a percentage of total tenant memory. "
         "Range: [0, 50), percentage",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_storage_meta_memory_limit_percentage, OB_CLUSTER_PARAMETER, "20", "[0, 50)",
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_max_tablet_cnt_per_gb, OB_CLUSTER_PARAMETER, "20000", "[1000, 50000)",
         "The maximum number of tablets supported per 1GB of memory by tenant unit. Range: [1000, 50000)",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_filter_reordering, OB_CLUSTER_PARAMETER, "True",
...
DEF_STR(min_observer_version, OB_CLUSTER_PARAMETER, "5.0.0.0", "the min observer version",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_VERSION(compatible, OB_CLUSTER_PARAMETER, "5.0.0.0", "compatible version for persisted data",
            ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_ddl, OB_CLUSTER_PARAMETER, "True", "specifies whether DDL operation is turned on. "
         "Value:  True:turned on;  False: turned off",
         ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_parallel_table_creation, OB_CLUSTER_PARAMETER, "True", "specifies whether create table parallelly. "
...
DEF_MODE_WITH_PARSER(_parallel_ddl_control, OB_CLUSTER_PARAMETER, "",
...
DEF_INT(log_restore_concurrency, OB_CLUSTER_PARAMETER, "0", "[0, 100]",
...
DEF_INT(log_archive_concurrency, OB_CLUSTER_PARAMETER, "0", "[0, 100]",
...
DEF_INT(log_disk_utilization_limit_threshold, OB_CLUSTER_PARAMETER, "95",
        "[80, 100]",
...
DEF_TIME(log_disk_throttling_maximum_duration, OB_CLUSTER_PARAMETER, "2h", "[1s, 3d]",
...
DEF_TIME(ls_gc_delay_time, OB_CLUSTER_PARAMETER, "0s",
        "[0s,)",
...
DEF_TIME(standby_db_fetch_log_rpc_timeout, OB_CLUSTER_PARAMETER, "15s",
        "[2s,)",
...
DEF_TIME(archive_lag_target, OB_CLUSTER_PARAMETER, "120s",
        "[0ms,7200s]",
...
DEF_INT(_log_writer_parallelism, OB_CLUSTER_PARAMETER, "3",
       "[1,8]",
...
DEF_TIME(_ls_gc_wait_readonly_tx_time, OB_CLUSTER_PARAMETER, "24h",
        "[0s,)",
        ...
        ObParameterAttr(Section::LOGSERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR(standby_db_preferred_upstream_log_region, OB_CLUSTER_PARAMETER, "",
...
DEF_BOOL(_ob_enable_standby_db_parallel_log_transport, OB_CLUSTER_PARAMETER, "True",
...
DEF_STR(__balance_controller, OB_CLUSTER_PARAMETER, "",
        ...
        ObParameterAttr(Section::LOAD_BALANCE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(__min_full_resource_pool_memory, OB_CLUSTER_PARAMETER, "1073741824", "[1073741824,)",
...
DEF_STR_WITH_CHECKER(replica_parallel_migration_mode, OB_CLUSTER_PARAMETER, "auto",
...
DEF_TIME(_ob_trans_rpc_timeout, OB_CLUSTER_PARAMETER, "3s", "[0s, 3600s]",
         ...
         ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_early_lock_release, OB_CLUSTER_PARAMETER, "True",
         "enable early lock release",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_tx_result_retention, OB_CLUSTER_PARAMETER, "300", "[0, 36000]",
...
DEF_TIME(_ob_get_gts_ahead_interval, OB_CLUSTER_PARAMETER, "0s", "[0s, 1s]",
         ...
         ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_tx_debug_level, OB_CLUSTER_PARAMETER, "0", "[0, 10]",
        "the debug level of transaction module. Range: [0, 10] in integer.",
        ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_mock_stmt_flush_table, OB_CLUSTER_PARAMETER, "False",
...
DEF_TIME(_stream_rpc_max_wait_timeout, OB_CLUSTER_PARAMETER, "1200s", "[1s,)",
...
DEF_BOOL(_enable_pkt_nio, OB_CLUSTER_PARAMETER, "True",
         ...
         "Value:  True:turned on;  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(rpc_memory_limit_percentage, OB_CLUSTER_PARAMETER, "0", "[0,100]",
...
DEF_INT(_ss_major_compaction_prewarm_level, OB_CLUSTER_PARAMETER, "0", "[0, 2]",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_ss_replica_prewarm, OB_CLUSTER_PARAMETER, "True",
         "specifies whether enable replica prewarm in shared storage mode. "
         "Value: True:turned on;  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_ss_micro_cache_memory_percentage, OB_CLUSTER_PARAMETER, "20", "[1,50]",
...
DEF_TIME(_data_storage_io_timeout, OB_CLUSTER_PARAMETER, "10s", "[1s,600s]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_object_storage_io_timeout, OB_CLUSTER_PARAMETER, "20s", "[1s,1200s]",
...
DEF_INT(sync_io_thread_count, OB_CLUSTER_PARAMETER, "0",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_io_callback_thread_count, OB_CLUSTER_PARAMETER, "0", "[0,128]",
...
DEF_INT(_fast_commit_callback_count, OB_CLUSTER_PARAMETER, "10000", "[0,)"
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_trx_max_log_cb_limit, OB_CLUSTER_PARAMETER, "16", "[0,)",
...
DEF_INT(_ob_elr_fast_freeze_threshold, OB_CLUSTER_PARAMETER, "500000", "[10000,)",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_ob_enable_fast_freeze, OB_CLUSTER_PARAMETER, "True",
         "specifies whether the tenant's fast freeze is enabled"
         "Value: True:turned on;  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_adaptive_merge_schedule, OB_CLUSTER_PARAMETER, "False",
         "specifies whether the tenant's adaptive merge scheduling is enabled"
         "Value: True:turned on;  False: turned off",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_compaction_prewarm_percentage, OB_CLUSTER_PARAMETER, "0", "[0,100]",
...
DEF_INT(_max_ls_cnt_per_server, OB_CLUSTER_PARAMETER, "0", "[0, 1024]",
...
DEF_CAP(_io_read_batch_size, OB_CLUSTER_PARAMETER, "0K", "[0K,16M]", "Maximum batch size in one read io request. Range:[0K,16M]",
        ObParameterAttr(Section::SSTABLE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_io_read_redundant_limit_percentage, OB_CLUSTER_PARAMETER, "0", "[0, 99]",
...
ERRSIM_DEF_INT_LIST(errsim_ddl_sim_point_fixed_list, OB_CLUSTER_PARAMETER, "",
...
DEF_CAP(sql_work_area, OB_CLUSTER_PARAMETER, "1G", "[10M,)",
...
DEF_BOOL(ob_enable_batched_multi_statement, OB_CLUSTER_PARAMETER, "False",
...
DEF_BOOL(_enable_oracle_priv_check, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR(plsql_code_type, OB_CLUSTER_PARAMETER, "native",
        "specifies the compilation mode for PL/SQL library units",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(plsql_debug, OB_CLUSTER_PARAMETER, "False",
         "specifies whether or not PL/SQL library units will be compiled for debugging",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(plsql_v2_compatibility, OB_CLUSTER_PARAMETER, "False",
         "allows to control store routine compile action at DDL stage",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(sts_credential, OB_CLUSTER_PARAMETER, "",
...
DEF_STR_WITH_CHECKER(default_storage_cache_policy, OB_CLUSTER_PARAMETER, "AUTO",
...
DEF_BOOL_WITH_CHECKER(enable_manual_storage_cache_policy, OB_CLUSTER_PARAMETER, "True",
    common::ObConfigEnableManualSCPChecker,
    "enable user manual storage cache policy.",
    ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL_WITH_CHECKER(suspend_storage_cache_task, OB_CLUSTER_PARAMETER, "False",
    common::ObConfigSuspendStorageCacheTaskChecker,
    "Suspend background caching tasks.",
    ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

// for bloom filter
DEF_BOOL(_bloom_filter_enabled, OB_CLUSTER_PARAMETER, "True",
...
DEF_STR(ob_ssl_invited_common_names, OB_CLUSTER_PARAMETER, "NONE",
...
DEF_BOOL(_enable_add_fulltext_index_to_existing_table, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT_WITH_CHECKER(_ob_query_rate_limit, OB_CLUSTER_PARAMETER, "-1",
...
DEF_TIME(ob_ratelimit_stat_period, OB_CLUSTER_PARAMETER, "1s", "[100ms,]",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(open_cursors, OB_CLUSTER_PARAMETER, "50", "[0,65535]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_enhanced_cursor_validation, OB_CLUSTER_PARAMETER, "False",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_px_batch_rescan, OB_CLUSTER_PARAMETER, "True",
         "enable px batch rescan for nlj or subplan filter",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_spf_batch_rescan, OB_CLUSTER_PARAMETER, "False",
         "enable das batch rescan for subplan filter",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_das_keep_order, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_distributed_das_scan, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_enable_das_batch_rescan_flag, OB_CLUSTER_PARAMETER, "0",
        "enable das batch rescan for multiple scenarios.",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(_parallel_max_active_sessions, OB_CLUSTER_PARAMETER, "0", "[0,]",
...
DEF_BOOL(_enable_px_ordered_coord, OB_CLUSTER_PARAMETER, "false",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(connection_control_failed_connections_threshold, OB_CLUSTER_PARAMETER, "0", "[0,2147483647]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(connection_control_min_connection_delay, OB_CLUSTER_PARAMETER, "1000", "[1000,2147483647]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(connection_control_max_connection_delay, OB_CLUSTER_PARAMETER, "2147483647", "[1000,2147483647]",
        "The maximum delay in milliseconds for server response to failed connection attempts, "
        "if connection_control_failed_connections_threshold is greater than zero",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(ob_proxy_readonly_transaction_routing_policy, OB_CLUSTER_PARAMETER, "false",
         "Proxy route policy for readonly sql: whether regard begining read only stmts as in transaction",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(job_queue_processes, OB_CLUSTER_PARAMETER, "1000", "[0,16384]",
...
DEF_STR_WITH_CHECKER(_resource_limit_spec, OB_CLUSTER_PARAMETER, "auto", common::ObConfigResourceLimitSpecChecker,
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_resource_limit_max_session_num, OB_CLUSTER_PARAMETER, "0", "[0,1000000]",
...
DEF_STR_WITH_CHECKER(_px_bloom_filter_group_size, OB_CLUSTER_PARAMETER, "auto", common::ObConfigPxBFGroupSizeChecker,
         "specifies the px bloom filter each group size in sending to the other sqc"
         "Range: [1, +∞) or auto, the default value is auto",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(enable_sql_extension, OB_CLUSTER_PARAMETER, "False",
...
DEF_INT(_session_context_size, OB_CLUSTER_PARAMETER, "10000", "[0, 2147483647]",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::READONLY));
DEF_INT(_px_object_sampling, OB_CLUSTER_PARAMETER, "200", "[1, 100000]"
        "parallel query sampling for base objects (100000 = 100%)",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_follower_snapshot_read_retry_duration, OB_CLUSTER_PARAMETER, "0ms", "[0ms,]",
         "the waiting time after the first judgment failure of strong reading on follower"
         "Range: [0ms, +∞)",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(default_auto_increment_mode, OB_CLUSTER_PARAMETER, "order",
        common::ObAutoIncrementModeChecker, "specifies default auto-increment mode, default is 'order'",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
        "order, noorder");
DEF_STR(_trace_control_info, OB_CLUSTER_PARAMETER, "{\"type_t\":{\"level\":1,\"sample_pct\":\"0.10\",\"record_policy\":\"SAMPLE_AND_SLOW_QUERY\"}}",
        "persistent control information for full-link trace",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_print_sample_ppm, OB_CLUSTER_PARAMETER, "0", "[0, 1000000]",
        "In the full link diagnosis, control the frequency of printing traces to the log (unit is ppm, parts per million).",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(ob_query_switch_leader_retry_timeout, OB_CLUSTER_PARAMETER, "0ms", "[0ms,]",
         "max time spend on retry caused by leader swith or network disconnection"
         "Range: [0ms, +∞)",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(default_enable_extended_rowid, OB_CLUSTER_PARAMETER, "false",
...
DEF_BOOL(_ob_immediate_row_conflict_check, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_insertup_replace_gts_opt, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_var_assign_use_das, OB_CLUSTER_PARAMETER, "False",
         "enable use das if the sql statement has variable assignment",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
// query response time
DEF_BOOL(query_response_time_stats, OB_CLUSTER_PARAMETER, "True",
    "Enable or disable QUERY_RESPONSE_TIME statistics collecting"
    "The default value is True. Value: TRUE: turned on FALSE: turned off",
    ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(query_response_time_flush, OB_CLUSTER_PARAMETER, "False",
    ...
    ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(query_response_time_range_base, OB_CLUSTER_PARAMETER, "10", "[2,10000]",
    ...
    ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(arbitration_timeout, OB_CLUSTER_PARAMETER, "5s", "[3s,]",
...
ERRSIM_DEF_TIME(errsim_allow_force_archive_threshold, OB_CLUSTER_PARAMETER, "600s", "[1s,2h]",
                ...
                ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_display_non_session_cursor, OB_CLUSTER_PARAMETER, "True",
...
DEF_TIME(_transfer_start_trans_timeout, OB_CLUSTER_PARAMETER, "1s", "[1ms,600s]",
...
DEF_TIME(_transfer_process_lock_tx_timeout, OB_CLUSTER_PARAMETER, "100s", "[30s,)",
        "transaction timeout for locking and unlocking transfer task. "
        "Range: [30s, +∞)",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(_transfer_task_tablet_count_threshold, OB_CLUSTER_PARAMETER, "100", "(0,)",
        "Threshold for the count of tablets that can be processed by a transfer task. "
        "Range: (0, +∞)",
        ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_active_txn_transfer, OB_CLUSTER_PARAMETER, "True",
        "Specifies whether support transfer active tx",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_TIME(_transfer_task_retry_interval, OB_CLUSTER_PARAMETER, "1m", "[0s,)",
...
DEF_TIME(dump_data_dictionary_to_log_interval, OB_CLUSTER_PARAMETER, "24h", "(0s,]",
...
DEF_DBL(global_background_cpu_quota, OB_CLUSTER_PARAMETER, "-1", "[-1,)",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_user_defined_rewrite_rules, OB_CLUSTER_PARAMETER, "False",
...
DEF_STR_WITH_CHECKER(_display_mysql_version, OB_CLUSTER_PARAMETER, "5.7.25", common::ObMySQLVersionLengthChecker,
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_px_join_skew_handling, OB_CLUSTER_PARAMETER, "True",
        "enables skew handling for parallel joins. The  default value is True.",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_px_join_skew_minfreq, OB_CLUSTER_PARAMETER, "30", "[1,100]",
...
DEF_BOOL(_enable_protocol_diagnose, OB_CLUSTER_PARAMETER, "True",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_transaction_internal_routing, OB_CLUSTER_PARAMETER, "True",
         "enable SQLs of transaction routed to any servers in the cluster on demand",
         ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_wait_remote_lock, OB_CLUSTER_PARAMETER, "True",
...
DEF_INT(observer_id, OB_CLUSTER_PARAMETER, "0", "[1, 18446744073709551615]",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::READONLY));
DEF_INT(_pipelined_table_function_memory_limit, OB_CLUSTER_PARAMETER, "524288000", "[1024,18446744073709551615]",
        "pipeline table function result set memory size limit. default 524288000 (500M), Range: [1024,18446744073709551615]",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_balance_kill_transaction, OB_CLUSTER_PARAMETER, "False",
        "Specifies whether balance should actively kill transaction",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_balance_kill_transaction_threshold, OB_CLUSTER_PARAMETER, "100ms", "[1ms, 60s]",
         "the time given to the transaction to execute when do balance"
         "before it will be killed. Range: [1ms, 60s]",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_balance_wait_killing_transaction_end_threshold, OB_CLUSTER_PARAMETER, "100ms", "[10ms, 60s]",
         "the threshold for waiting time after killing transactions until they end."
         "Range: [10ms, 60s]",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_hgby_skew_detection, OB_CLUSTER_PARAMETER, "True",
         "specifies whether hgby skew detection is enabled",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_px_fast_reclaim, OB_CLUSTER_PARAMETER, "False",
...
DEF_CAP(_pdml_thread_cache_size, OB_CLUSTER_PARAMETER, "2M", "[1B,)",
        ...
        "Range:[1B, )",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_hgby_llc_ndv_adaptive, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_backtrace_function, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_dblink_reuse_connection, OB_CLUSTER_PARAMETER, "True",
         "specifies whether dblink reuse connection in a session",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_with_subquery, OB_CLUSTER_PARAMETER, "0", "[0,2]",
        "WITH subquery transformation,0: optimizer,1: materialize,2: inline",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_max_dblink_conn_per_observer, OB_CLUSTER_PARAMETER, "256", "[0,)",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_xsolapi_generate_with_clause, OB_CLUSTER_PARAMETER, "True",
        "OLAP API generates WITH clause",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_optimizer_group_by_placement, OB_CLUSTER_PARAMETER, "True",
        "enable group by placement transform rule",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_complex_cbqt_table_num, OB_CLUSTER_PARAMETER, "10", "[0,)",
        "cost-based transform will be disabled when table count in a single stmt exceeds threshold",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_wait_interval_after_parallel_ddl, OB_CLUSTER_PARAMETER, "30s", "[0s,)",
        "time interval for waiting other servers to refresh schema after parallel ddl is done",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(_rebuild_replica_log_lag_threshold, OB_CLUSTER_PARAMETER, "0M", "[0M,)",
        "size of clog files that a replica lag behind leader to trigger rebuild, 0 means never trigger rebuild on purpose. Range: [0, +∞)",
        ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_in_range_optimization, OB_CLUSTER_PARAMETER, "True",
        "Enable extract query range optimization for in predicate",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_force_subquery_unnest, OB_CLUSTER_PARAMETER, "FALSE",
...
DEF_BOOL(_force_explict_500_malloc, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(range_optimizer_max_mem_size, OB_CLUSTER_PARAMETER, "128M", "[0M,)",
...
DEF_BOOL(_force_malloc_for_absent_tenant, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
ERRSIM_DEF_TIME(errsim_transfer_backfill_error_time, OB_CLUSTER_PARAMETER, "0", "[0s,1h]",
        "the duration of the error happened to transfer backfill. "
        "Range: [0s, 1h] in duration",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_stall_threshold_for_dynamic_worker, OB_CLUSTER_PARAMETER, "3ms", "[0ms,)",
        "threshold of dynamic worker works",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_optimizer_better_inlist_costing, OB_CLUSTER_PARAMETER, "True",
        "enable improved costing of index access using in-list(s)",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_optimizer_skip_scan_enabled, OB_CLUSTER_PARAMETER, "False",
        "enable/disable index skip scan",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_ls_migration_wait_completing_timeout, OB_CLUSTER_PARAMETER, "30m", "[60s,)",
        "the wait timeout in ls complete migration phase",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

// column store section
DEF_BOOL(_enable_column_store, OB_CLUSTER_PARAMETER, "True",
        "enable the column store format in storage engine",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_skip_index, OB_CLUSTER_PARAMETER, "True",
        "enable the skip index in storage engine",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(_ob_ddl_temp_file_compress_func, OB_CLUSTER_PARAMETER, "AUTO",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
        "AUTO, ZSTD, LZ4, NONE");
DEF_BOOL(_enable_prefetch_limiting, OB_CLUSTER_PARAMETER, "False",
...
DEF_STR(_storage_leak_check_mod, OB_CLUSTER_PARAMETER, "", "set leak check mod in storage",
     ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_ha_tablet_info_batch_count, OB_CLUSTER_PARAMETER, "0", "[0,]",
        "the number of tablet replica info sent by on rpc for ha. Range: [0, +∞) in integer",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_ha_rpc_timeout, OB_CLUSTER_PARAMETER, "0", "[0,120s]",
...
DEF_BOOL(_enable_diagnostic_info_cache, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_ob_sqlstat_enable, OB_CLUSTER_PARAMETER, "True", "enable/disable sql stat",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
...
DEF_BOOL_WITH_CHECKER(enable_auto_split, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP_WITH_CHECKER(auto_split_tablet_size, OB_CLUSTER_PARAMETER, "2GB", common::ObConfigAutoSplitTabletSizeChecker,
        "[128M,)",
...
DEF_STR_WITH_CHECKER(global_index_auto_split_policy, OB_CLUSTER_PARAMETER, "DISTRIBUTED",
#else
DEF_STR_WITH_CHECKER(global_index_auto_split_policy, OB_CLUSTER_PARAMETER, "ALL",
#endif
         ...
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
         "DISTRIBUTED, ALL, OFF");
DEF_INT(_inlist_rewrite_threshold, OB_CLUSTER_PARAMETER, "1000", "[1, 2147483647]"
        "specifies transform how much const params in IN list to values table",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_enable_di_experimental_feature_flags, OB_CLUSTER_PARAMETER, "3", "[0, +∞)"
         "enable diagnostic info experimental feature",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

// for set errsim module types, format like transfer;migration
ERRSIM_DEF_STR_LIST(errsim_module_types, OB_CLUSTER_PARAMETER, "",
             "set module list for errsim error",
             ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
ERRSIM_DEF_DBL(errsim_module_error_percentage, OB_CLUSTER_PARAMETER, "0", "[0,100]",
        "the percentage of the error happened to errsim module. "
        "Range: [0, 100] in percentage",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE))

ERRSIM_DEF_BOOL(block_transfer_out_replay, OB_CLUSTER_PARAMETER, "False",
         "errsim to block transfer out clog replay",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

ERRSIM_DEF_BOOL(allow_transfer_backfill, OB_CLUSTER_PARAMETER, "True",
          "errsim to allow transfer backfill",
          ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

// ttl
DEF_STR_WITH_CHECKER(kv_ttl_duty_duration, OB_CLUSTER_PARAMETER, "", common::ObTTLDutyDurationChecker,
    "ttl background task working time duration"
    "begin_time or end_time in Range, e.g., [23:00:00, 24:00:00]",
    ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(vector_index_optimize_duty_time, OB_CLUSTER_PARAMETER, "[00:00:00, 24:00:00]", common::ObVecIndexOptDutyTimeChecker,
    "A runtime range bounded by start time and end time for vector index background task, e.g., [23:00:00, 24:00:00]",
    ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(kv_ttl_history_recycle_interval, OB_CLUSTER_PARAMETER, "7d", "[1d, 180d]",
    "the time to recycle ttl history. Range: [1d, 180d]",
    ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_kv_ttl, OB_CLUSTER_PARAMETER, "False",
    "specifies whether ttl task is enbled",
    ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(ttl_thread_score, OB_CLUSTER_PARAMETER, "0", "[0,100]",
...
DEF_TIME(shared_log_retention, OB_CLUSTER_PARAMETER, "1d", "[0s,7d]",
...
DEF_TIME(_standby_max_replay_gap_time, OB_CLUSTER_PARAMETER, "900s", "[10s,)",
...
DEF_INT(kv_hbase_client_scanner_timeout_period, OB_CLUSTER_PARAMETER, "60000", "(0,)",
...
DEF_BOOL(_enable_kv_hbase_admin_ddl, OB_CLUSTER_PARAMETER, "False",
    "Whether to allow the execution of the DDL function provided by the OBKV-HBase Admin interface. The default value is false.",
    ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_enable_optimizer_qualify_filter, OB_CLUSTER_PARAMETER, "True",
        "Enable extracting qualify filters for window function",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_range_extraction_for_not_in, OB_CLUSTER_PARAMETER, "True",
...
DEF_STR_WITH_CHECKER(_iut_stat_collection_type, OB_CLUSTER_PARAMETER, "SAMPLED",
    common::ObConfigIndexStatsModeChecker,
    "specify index table usage stat collection type, values: SAMPLED, ALL",
    ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
    "SAMPLED, ALL");

DEF_INT(optimizer_index_cost_adj, OB_CLUSTER_PARAMETER, "0", "[0,100]",
...
DEF_BOOL(_preserve_order_for_pagination, OB_CLUSTER_PARAMETER, "False",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_preserve_order_for_groupby, OB_CLUSTER_PARAMETER, "False",
        "Control whether the query results are sorted according to the GROUP BY expression",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(max_partition_num, OB_CLUSTER_PARAMETER, "8192", "[8192, 65536]",
...
DEF_TIME(_faststack_min_interval, OB_CLUSTER_PARAMETER, "30m", "[1s,)",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(choose_migration_source_policy, OB_CLUSTER_PARAMETER, "region",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
        "idc, region");
DEF_INT(_query_record_size_limit, OB_CLUSTER_PARAMETER, "65536", "[0, 67108864] in integer",
        "set sql_audit and plan stat query sql size. Range: [0,67108864] in integer in integer.",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_choose_migration_source_policy, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_global_enable_rich_vector_format, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_allow_skip_replay_redo_after_detete_tablet, OB_CLUSTER_PARAMETER, "FALSE",
...
DEF_BOOL(_enable_memleak_light_backtrace, OB_CLUSTER_PARAMETER, "True",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_dbms_lob_partial_update, OB_CLUSTER_PARAMETER, "False",
...
DEF_TIME(_ss_new_leader_overwrite_delay, OB_CLUSTER_PARAMETER, "60s", "[1s,)",
         "the delay time for new leader to write ss obj, Range: [1s, )"
         "Range: [1s, )",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_TIME(_ss_deleted_tablet_gc_time, OB_CLUSTER_PARAMETER, "5d", "[0,365d]",
         "the GC time for deleted tablet in shared dir,"
         "Range: [0,365d]",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_TIME(_ss_old_ver_retention_time, OB_CLUSTER_PARAMETER, "5d", "[0,365d]",
         "the retention time of old compaction version data in shared dir,"
         "Range: [0,365d]",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_enable_ss_migration_prewarm, OB_CLUSTER_PARAMETER, "True",
         "Control whether open migration prewarm",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_TIME(_ss_local_cache_expiration_time, OB_CLUSTER_PARAMETER, "0s", "[0s,)",
...
DEF_BOOL(_enable_kv_feature, OB_CLUSTER_PARAMETER, "True",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_CAP(lob_enable_block_cache_threshold, OB_CLUSTER_PARAMETER, "256K", "[0B, 512M]",
...
DEF_BOOL(_enable_compatible_monotonic, OB_CLUSTER_PARAMETER, "True",
        ...
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_lock_priority, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::TRANS, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(default_load_mode, OB_CLUSTER_PARAMETER, "DISABLED",
...
DEF_BOOL(direct_load_allow_fallback, OB_CLUSTER_PARAMETER, "True",
...
ERRSIM_DEF_TIME(errsim_delay_gc_interval, OB_CLUSTER_PARAMETER, "30m", "[0,)",
        "delay gc interval in errsim mode"
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
// regexp engine
DEF_STR_WITH_CHECKER(_regex_engine, OB_CLUSTER_PARAMETER, "ICU",
...
DEF_BOOL(_preset_runtime_bloom_filter_size, OB_CLUSTER_PARAMETER, "False",
         ...
         "Value:  True:turned on  False: turned off",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_ddl_worker_isolation, OB_CLUSTER_PARAMETER, "False",
         "a switch controling ddl thread isolation",
         ObParameterAttr(Section::ROOT_SERVICE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_enable_check_trigger_const_variables_assign, OB_CLUSTER_PARAMETER, "True",
...
// obkv group commit
DEF_INT(kv_group_commit_batch_size, OB_CLUSTER_PARAMETER, "10", "(0,)",
        ...
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(kv_group_commit_rw_mode, OB_CLUSTER_PARAMETER, "ALL",
...
DEF_INT(_enable_kv_group_commit_ops, OB_CLUSTER_PARAMETER, "10000", "[0,)",
...
DEF_INT(ob_vector_memory_limit_percentage, OB_CLUSTER_PARAMETER, "0",
        "[0,100)",
...
DEF_INT(_max_partition_count_to_collect_statistic, OB_CLUSTER_PARAMETER, "5", "[0,)",
        "force odps external table to using block granule iterator when count of partition is under this config",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(ob_encoding_granularity, OB_CLUSTER_PARAMETER, "65536", "[8192, 1048576]",
        "Maximum rows for encoding in one micro block. Range:[8192,1048576]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_partition_wise_plan_enabled, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_adaptive_auto_dop, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(query_memory_limit_percentage, OB_CLUSTER_PARAMETER, "50", "[0,100]",
        "the percentage of tenant memory that can be used by a single SQL. The default value is 50. Range: [0,100]",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_INT(package_state_sync_max_size, OB_CLUSTER_PARAMETER, "8192", "[0, 16777216]",
...
DEF_CAP(_parquet_row_group_prebuffer_size, OB_CLUSTER_PARAMETER, "0M", "[0M,)",
        ...
        ObParameterAttr(Section::SSTABLE, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR_WITH_CHECKER(px_node_policy, OB_CLUSTER_PARAMETER, "DATA",
                     ...
                     ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE),
                     "data, zone, cluster");
DEF_INT(_max_px_workers_per_cpu, OB_CLUSTER_PARAMETER, "1", "[1,30]",
        "The upper limit of PX workers that each CPU can carry. Range: [1,30]",
        ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_pc_adaptive_min_exec_time_threshold, OB_CLUSTER_PARAMETER, "1s", "[0,)",
        "minimum execution time threshold for enabling adaptive plan cache. Range: [0, +∞]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_pc_adaptive_effectiveness_ratio_threshold, OB_CLUSTER_PARAMETER, "5", "[0,)",
        "minimum effectiveness ratio threshold for enabling adaptive plan cache. Range:[0, +∞]",
        ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(enable_adaptive_plan_cache, OB_CLUSTER_PARAMETER, "False",
         "enable/disable adaptive plan cache",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_force_enable_plan_tracing, OB_CLUSTER_PARAMETER, "True",
         "controls whether plan tracking is enabled when plan cache is disabled",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR(default_table_organization, OB_CLUSTER_PARAMETER, "INDEX",
...
DEF_BOOL(_enable_topn_runtime_filter, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_pl_recompile_job, OB_CLUSTER_PARAMETER, "False",
         "Enable pl recompile task.",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_enable_px_task_rebalance, OB_CLUSTER_PARAMETER, "False",
         "Enable or disable px task rebalance.",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_TIME(_px_task_rebalance_trigger_time, OB_CLUSTER_PARAMETER, "10ms", "[1us, 1h]",
...
DEF_BOOL(_ob_enable_truncate_partition_preserve_global_index, OB_CLUSTER_PARAMETER, "False",
         ...
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_STR(default_table_merge_engine, OB_CLUSTER_PARAMETER, "PARTIAL_UPDATE",
         "Specify the default merge_engine when creating table: partial_update, delete_insert.",
         ObParameterAttr(Section::TENANT, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));

DEF_BOOL(_enable_delete_insert_scan, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_px_worker_share_plan_enabled, OB_CLUSTER_PARAMETER, "True",
...
DEF_BOOL(_enable_drop_column_instant, OB_CLUSTER_PARAMETER, "True", "Whether to enable the capability for fast column deletion."
...
DEF_BOOL(_obkv_enable_distributed_execution, OB_CLUSTER_PARAMETER, "False",
...
DEF_INT_WITH_CHECKER(_hnsw_max_scan_vectors, OB_CLUSTER_PARAMETER, "20000",
                    ...
                    ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_BOOL(_enable_sql_ccl_rule, OB_CLUSTER_PARAMETER, "True",
         "Enable or disable sql ccl rule.",
         ObParameterAttr(Section::OBSERVER, Source::DEFAULT, EditLevel::DYNAMIC_EFFECTIVE));
DEF_INT(_orc_filter_pushdown_level, OB_CLUSTER_PARAMETER, "4", "[0, 4]",
...
DEF_INT(_parquet_filter_pushdown_level, OB_CLUSTER_PARAMETER, "4", "[0, 4]",
