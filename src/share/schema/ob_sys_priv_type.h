...
/* catalog */
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_CREATE_CATALOG, "CREATE CATALOG")
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_USE_ANY_CATALOG, "USE ANY CATALOG")

/* ccl rule */
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_CREATE_ANY_CCL_RULE, "CREATE ANY CCL RULE")
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_DROP_ANY_CCL_RULE, "DROP ANY CCL RULE")
/* location */
OB_SYS_PRIV_TYPE_DEF(PRIV_ID_CREATE_LOCATION, "CREATE LOCATION")
