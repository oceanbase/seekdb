...
#ifndef OCEANBASE_SHARE_OB_MEMORY_DUMP_BACKGROUND_SOURCE_H_
#define OCEANBASE_SHARE_OB_MEMORY_DUMP_BACKGROUND_SOURCE_H_
...
class ObMemoryDumpBackgroundSource : public ObIBackgroundTaskSource
{
public:
  ObMemoryDumpBackgroundSource();
  virtual ~ObMemoryDumpBackgroundSource();
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ObMemoryDumpBackgroundSource);
};

} // namespace share
} // namespace oceanbase

#endif // OCEANBASE_SHARE_OB_MEMORY_DUMP_BACKGROUND_SOURCE_H_
