...
static struct VarsInit{
  VarsInit(){
    ...
    [&] (){
      ...
      ObSysVars[229].info_ = "specifies runtime filter wait time before output rows, 0 means adaptive wait according to data size" ;
    ...
    [&] (){
      ObSysVars[232].default_value_ = "1.0.0.0" ;
    ...
    [&] (){
      ObSysVars[240].default_value_ = "8192" ;
    ...
    [&] (){
      ...
      ObSysVars[245].info_ = "Specifies whether InnoDB index statistics are persisted to disk." ;
      ObSysVars[245].name_ = "innodb_stats_persistent" ;
      ...
      ObSysVars[245].id_ = SYS_VAR_INNODB_STATS_PERSISTENT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_PERSISTENT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_PERSISTENT] = 245 ;
      ObSysVars[245].base_value_ = "1" ;
    ObSysVars[245].alias_ = "OB_SV_INNODB_STATS_PERSISTENT" ;
    }();

    [&] (){
      ObSysVars[246].default_value_ = "d:t:i:o,/tmp/mysqld.trace" ;
      ObSysVars[246].info_ = "This variable indicates the current debugging settings" ;
      ObSysVars[246].name_ = "debug" ;
      ObSysVars[246].data_type_ = ObVarcharType ;
      ObSysVars[246].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[246].id_ = SYS_VAR_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEBUG] = 246 ;
      ObSysVars[246].base_value_ = "d:t:i:o,/tmp/mysqld.trace" ;
    ObSysVars[246].alias_ = "OB_SV_DEBUG" ;
    }();

    [&] (){
      ObSysVars[247].default_value_ = "0" ;
      ObSysVars[247].info_ = "Sets a debug flag for InnoDB change buffering. " ;
      ObSysVars[247].name_ = "innodb_change_buffering_debug" ;
      ObSysVars[247].data_type_ = ObIntType ;
      ObSysVars[247].min_val_ = "0" ;
      ObSysVars[247].max_val_ = "2" ;
      ObSysVars[247].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[247].id_ = SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHANGE_BUFFERING_DEBUG] = 247 ;
      ObSysVars[247].base_value_ = "0" ;
    ObSysVars[247].alias_ = "OB_SV_INNODB_CHANGE_BUFFERING_DEBUG" ;
    }();

    [&] (){
      ObSysVars[248].default_value_ = "0" ;
      ObSysVars[248].info_ = "Compresses all tables using a specified compression algorithm without having to define a COMPRESSION attribute for each table." ;
      ObSysVars[248].name_ = "innodb_compress_debug" ;
      ObSysVars[248].data_type_ = ObIntType ;
      ObSysVars[248].enum_names_ = "[u'NONE', u'ZLIB', u'LZ4', u'LZ4HC']" ;
      ObSysVars[248].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[248].id_ = SYS_VAR_INNODB_COMPRESS_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMPRESS_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMPRESS_DEBUG] = 248 ;
      ObSysVars[248].base_value_ = "0" ;
    ObSysVars[248].alias_ = "OB_SV_INNODB_COMPRESS_DEBUG" ;
    }();

    [&] (){
      ObSysVars[249].default_value_ = "1" ;
      ObSysVars[249].info_ = "Disables resizing of the InnoDB buffer pool" ;
      ObSysVars[249].name_ = "innodb_disable_resize_buffer_pool_debug" ;
      ObSysVars[249].data_type_ = ObIntType ;
      ObSysVars[249].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[249].id_ = SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG] = 249 ;
      ObSysVars[249].base_value_ = "1" ;
    ObSysVars[249].alias_ = "OB_SV_INNODB_DISABLE_RESIZE_BUFFER_POOL_DEBUG" ;
    }();

    [&] (){
      ObSysVars[250].default_value_ = "0" ;
      ObSysVars[250].info_ = "set to 1 (the default by MySQL), foreign key constraints are checked. If set to 0, foreign key constraints are ignored" ;
      ObSysVars[250].name_ = "innodb_fil_make_page_dirty_debug" ;
      ...
      ObSysVars[250].id_ = SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG] = 250 ;
      ObSysVars[250].base_value_ = "0" ;
    ObSysVars[250].alias_ = "OB_SV_INNODB_FIL_MAKE_PAGE_DIRTY_DEBUG" ;
    }();

    [&] (){
      ObSysVars[251].default_value_ = "0" ;
      ObSysVars[251].info_ = "Limits the number of records per B-tree page" ;
      ObSysVars[251].name_ = "innodb_limit_optimistic_insert_debug" ;
      ...
      ObSysVars[251].id_ = SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG] = 251 ;
      ObSysVars[251].base_value_ = "0" ;
    ObSysVars[251].alias_ = "OB_SV_INNODB_LIMIT_OPTIMISTIC_INSERT_DEBUG" ;
    }();

    [&] (){
      ObSysVars[252].default_value_ = "50" ;
      ObSysVars[252].info_ = "Defines a page-full percentage value for index pages that overrides the current MERGE_THRESHOLD setting for all indexes that are currently in the dictionary cache" ;
      ObSysVars[252].name_ = "innodb_merge_threshold_set_all_debug" ;
      ObSysVars[252].data_type_ = ObIntType ;
      ObSysVars[252].min_val_ = "1" ;
      ObSysVars[252].max_val_ = "50" ;
      ObSysVars[252].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[252].id_ = SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG] = 252 ;
      ObSysVars[252].base_value_ = "50" ;
    ObSysVars[252].alias_ = "OB_SV_INNODB_MERGE_THRESHOLD_SET_ALL_DEBUG" ;
    }();

    [&] (){
      ObSysVars[253].default_value_ = "0" ;
      ObSysVars[253].info_ = "Saves a page number. Setting the innodb_fil_make_page_dirty_debug option dirties the page defined by innodb_saved_page_number_debug" ;
      ObSysVars[253].name_ = "innodb_saved_page_number_debug" ;
      ...
      ObSysVars[253].id_ = SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SAVED_PAGE_NUMBER_DEBUG] = 253 ;
      ObSysVars[253].base_value_ = "0" ;
    ObSysVars[253].alias_ = "OB_SV_INNODB_SAVED_PAGE_NUMBER_DEBUG" ;
    }();

    [&] (){
      ObSysVars[254].default_value_ = "0" ;
      ObSysVars[254].info_ = "Pauses purging of delete-marked records while allowing the purge view to be updated" ;
      ObSysVars[254].name_ = "innodb_trx_purge_view_update_only_debug" ;
      ObSysVars[254].data_type_ = ObIntType ;
      ObSysVars[254].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[254].id_ = SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG] = 254 ;
      ObSysVars[254].base_value_ = "0" ;
    ObSysVars[254].alias_ = "OB_SV_INNODB_TRX_PURGE_VIEW_UPDATE_ONLY_DEBUG" ;
    }();

    [&] (){
      ObSysVars[255].default_value_ = "0" ;
      ObSysVars[255].info_ = "Sets a debug flag that limits TRX_RSEG_N_SLOTS to a given value for the trx_rsegf_undo_find_free function that looks for free slots for undo log segments" ;
      ObSysVars[255].name_ = "innodb_trx_rseg_n_slots_debug" ;
      ObSysVars[255].data_type_ = ObIntType ;
      ObSysVars[255].min_val_ = "0" ;
      ObSysVars[255].max_val_ = "1024" ;
      ObSysVars[255].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[255].id_ = SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TRX_RSEG_N_SLOTS_DEBUG] = 255 ;
      ObSysVars[255].base_value_ = "0" ;
    ObSysVars[255].alias_ = "OB_SV_INNODB_TRX_RSEG_N_SLOTS_DEBUG" ;
    }();

    [&] (){
      ObSysVars[256].default_value_ = "256" ;
      ObSysVars[256].info_ = "Sets a soft upper limit for the number of cached stored routines per connection" ;
      ObSysVars[256].name_ = "stored_program_cache" ;
      ObSysVars[256].data_type_ = ObIntType ;
      ObSysVars[256].min_val_ = "16" ;
      ObSysVars[256].max_val_ = "524288" ;
      ObSysVars[256].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[256].id_ = SYS_VAR_STORED_PROGRAM_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_STORED_PROGRAM_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_STORED_PROGRAM_CACHE] = 256 ;
      ObSysVars[256].base_value_ = "256" ;
    ObSysVars[256].alias_ = "OB_SV_STORED_PROGRAM_CACHE" ;
    }();

    [&] (){
      ObSysVars[257].default_value_ = "0" ;
      ObSysVars[257].info_ = "specifies the compatible mode when the behaviors of MySQL 5.7 and MySQL 8.0 are different" ;
      ObSysVars[257].name_ = "ob_compatibility_control" ;
      ObSysVars[257].data_type_ = ObIntType ;
      ObSysVars[257].enum_names_ = "[u'MYSQL5.7', u'MYSQL8.0']" ;
      ObSysVars[257].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
      ObSysVars[257].id_ = SYS_VAR_OB_COMPATIBILITY_CONTROL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_CONTROL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_CONTROL] = 257 ;
      ObSysVars[257].base_value_ = "0" ;
    ObSysVars[257].alias_ = "OB_SV_COMPATIBILITY_CONTROL" ;
    }();

    [&] (){
      ObSysVars[258].default_value_ = "17180000512" ;
      ObSysVars[258].info_ = "specifies the compatible verision when the behaviors of different release version are different" ;
      ObSysVars[258].name_ = "ob_compatibility_version" ;
      ObSysVars[258].data_type_ = ObUInt64Type ;
      ObSysVars[258].to_show_str_func_ = "ObSysVarToStrFuncs::to_str_version" ;
      ObSysVars[258].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::INFLUENCE_PL ;
      ObSysVars[258].base_class_ = "ObVersionSysVar" ;
      ObSysVars[258].to_select_obj_func_ = "ObSysVarToObjFuncs::to_obj_version" ;
      ObSysVars[258].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_compat_version" ;
      ObSysVars[258].id_ = SYS_VAR_OB_COMPATIBILITY_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_COMPATIBILITY_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_COMPATIBILITY_VERSION] = 258 ;
      ObSysVars[258].get_meta_type_func_ = "ObSysVarGetMetaTypeFuncs::get_meta_type_varchar" ;
      ObSysVars[258].base_value_ = "17180000512" ;
    ObSysVars[258].alias_ = "OB_SV_COMPATIBILITY_VERSION" ;
    }();

    [&] (){
      ObSysVars[259].default_value_ = "17180000512" ;
      ObSysVars[259].info_ = "specifies the security verision when the behaviors of different release version are different" ;
      ObSysVars[259].name_ = "ob_security_version" ;
      ...
      ObSysVars[259].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_and_convert_security_version" ;
      ObSysVars[259].id_ = SYS_VAR_OB_SECURITY_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SECURITY_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_SECURITY_VERSION] = 259 ;
      ObSysVars[259].get_meta_type_func_ = "ObSysVarGetMetaTypeFuncs::get_meta_type_varchar" ;
      ObSysVars[259].base_value_ = "17180000512" ;
    ObSysVars[259].alias_ = "OB_SV_SECURITY_VERSION" ;
    }();

    [&] (){
      ObSysVars[260].default_value_ = "1" ;
      ObSysVars[260].info_ = "Specifies the correlation model when the optimizer estimates cardinality" ;
      ObSysVars[260].name_ = "cardinality_estimation_model" ;
      ObSysVars[260].data_type_ = ObIntType ;
      ObSysVars[260].enum_names_ = "[u'INDEPENDENT', u'PARTIAL', u'FULL']" ;
      ObSysVars[260].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN ;
      ObSysVars[260].id_ = SYS_VAR_CARDINALITY_ESTIMATION_MODEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CARDINALITY_ESTIMATION_MODEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CARDINALITY_ESTIMATION_MODEL] = 260 ;
      ObSysVars[260].base_value_ = "1" ;
    ObSysVars[260].alias_ = "OB_SV_CARDINALITY_ESTIMATION_MODEL" ;
    }();

    [&] (){
      ObSysVars[261].default_value_ = "0" ;
      ObSysVars[261].info_ = "Whether to enable the materialized view rewriting" ;
      ObSysVars[261].name_ = "query_rewrite_enabled" ;
      ObSysVars[261].data_type_ = ObIntType ;
      ObSysVars[261].enum_names_ = "[u'FALSE', u'TRUE', u'FORCE']" ;
      ...
      ObSysVars[261].id_ = SYS_VAR_QUERY_REWRITE_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_QUERY_REWRITE_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_QUERY_REWRITE_ENABLED] = 261 ;
      ObSysVars[261].base_value_ = "0" ;
    ObSysVars[261].alias_ = "OB_SV_QUERY_REWRITE_ENABLED" ;
    }();

    [&] (){
      ObSysVars[262].default_value_ = "0" ;
      ObSysVars[262].info_ = "Control the data integrity of materialized view rewriting" ;
      ObSysVars[262].name_ = "query_rewrite_integrity" ;
      ObSysVars[262].data_type_ = ObIntType ;
      ObSysVars[262].enum_names_ = "[u'ENFORCED', u'STALE_TOLERATED']" ;
      ObSysVars[262].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN ;
      ObSysVars[262].id_ = SYS_VAR_QUERY_REWRITE_INTEGRITY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_QUERY_REWRITE_INTEGRITY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_QUERY_REWRITE_INTEGRITY] = 262 ;
      ObSysVars[262].base_value_ = "0" ;
    ObSysVars[262].alias_ = "OB_SV_QUERY_REWRITE_INTEGRITY" ;
    }();

    [&] (){
      ObSysVars[263].default_value_ = "0" ;
      ObSysVars[263].info_ = "If ON, the server flushes (synchronizes) all changes to disk after each SQL statement" ;
      ObSysVars[263].name_ = "flush" ;
      ...
      ObSysVars[263].id_ = SYS_VAR_FLUSH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FLUSH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_FLUSH] = 263 ;
      ObSysVars[263].base_value_ = "0" ;
    ObSysVars[263].alias_ = "OB_SV_FLUSH" ;
    }();

    [&] (){
      ObSysVars[264].default_value_ = "0" ;
      ObSysVars[264].info_ = "if this is set to a nonzero value, all tables are closed every flush_time seconds to free up resources and synchronize unflushed data to disk" ;
      ObSysVars[264].name_ = "flush_time" ;
      ObSysVars[264].data_type_ = ObIntType ;
      ObSysVars[264].min_val_ = "0" ;
      ObSysVars[264].max_val_ = "31536000" ;
      ObSysVars[264].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[264].id_ = SYS_VAR_FLUSH_TIME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FLUSH_TIME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_FLUSH_TIME] = 264 ;
      ObSysVars[264].base_value_ = "0" ;
    ObSysVars[264].alias_ = "OB_SV_FLUSH_TIME" ;
    }();

    [&] (){
      ObSysVars[265].default_value_ = "1" ;
      ObSysVars[265].info_ = "specifies whether to dynamically adjust the rate of flushing dirty pages in the InnoDB buffer pool based on the workload" ;
      ObSysVars[265].name_ = "innodb_adaptive_flushing" ;
      ...
      ObSysVars[265].id_ = SYS_VAR_INNODB_ADAPTIVE_FLUSHING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ADAPTIVE_FLUSHING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ADAPTIVE_FLUSHING] = 265 ;
      ObSysVars[265].base_value_ = "1" ;
    ObSysVars[265].alias_ = "OB_SV_INNODB_ADAPTIVE_FLUSHING" ;
    }();

    [&] (){
      ObSysVars[266].default_value_ = "10" ;
      ObSysVars[266].info_ = "Defines the low water mark representing percentage of redo log capacity at which adaptive flushing is enabled" ;
      ObSysVars[266].name_ = "innodb_adaptive_flushing_lwm" ;
      ObSysVars[266].data_type_ = ObIntType ;
      ObSysVars[266].min_val_ = "0" ;
      ObSysVars[266].max_val_ = "70" ;
      ObSysVars[266].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[266].id_ = SYS_VAR_INNODB_ADAPTIVE_FLUSHING_LWM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ADAPTIVE_FLUSHING_LWM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ADAPTIVE_FLUSHING_LWM] = 266 ;
      ObSysVars[266].base_value_ = "10" ;
    ObSysVars[266].alias_ = "OB_SV_INNODB_ADAPTIVE_FLUSHING_LWM" ;
    }();

    [&] (){
      ObSysVars[267].default_value_ = "1" ;
      ObSysVars[267].info_ = "Whether the InnoDB adaptive hash index is enabled or disabled. It may be desirable, depending on your workload, to dynamically enable or disable adaptive hash indexing to improve query performance" ;
      ObSysVars[267].name_ = "innodb_adaptive_hash_index" ;
      ...
      ObSysVars[267].id_ = SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX] = 267 ;
      ObSysVars[267].base_value_ = "1" ;
    ObSysVars[267].alias_ = "OB_SV_INNODB_ADAPTIVE_HASH_INDEX" ;
    }();

    [&] (){
      ObSysVars[268].default_value_ = "8" ;
      ObSysVars[268].info_ = "Partitions the adaptive hash index search system. Each index is bound to a specific partition, with each partition protected by a separate latch." ;
      ObSysVars[268].name_ = "innodb_adaptive_hash_index_parts" ;
      ObSysVars[268].data_type_ = ObIntType ;
      ObSysVars[268].min_val_ = "1" ;
      ObSysVars[268].max_val_ = "512" ;
      ObSysVars[268].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[268].id_ = SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX_PARTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX_PARTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ADAPTIVE_HASH_INDEX_PARTS] = 268 ;
      ObSysVars[268].base_value_ = "8" ;
    ObSysVars[268].alias_ = "OB_SV_INNODB_ADAPTIVE_HASH_INDEX_PARTS" ;
    }();

    [&] (){
      ObSysVars[269].default_value_ = "150000" ;
      ObSysVars[269].info_ = "Permits InnoDB to automatically adjust the value of innodb_thread_sleep_delay up or down according to the current workload" ;
      ObSysVars[269].name_ = "innodb_adaptive_max_sleep_delay" ;
      ObSysVars[269].data_type_ = ObIntType ;
      ObSysVars[269].min_val_ = "0" ;
      ObSysVars[269].max_val_ = "1000000" ;
      ObSysVars[269].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[269].id_ = SYS_VAR_INNODB_ADAPTIVE_MAX_SLEEP_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ADAPTIVE_MAX_SLEEP_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ADAPTIVE_MAX_SLEEP_DELAY] = 269 ;
      ObSysVars[269].base_value_ = "150000" ;
    ObSysVars[269].alias_ = "OB_SV_INNODB_ADAPTIVE_MAX_SLEEP_DELAY" ;
    }();

    [&] (){
      ObSysVars[270].default_value_ = "64" ;
      ObSysVars[270].info_ = "The increment size (in megabytes) for extending the size of an auto-extending InnoDB system tablespace file when it becomes full" ;
      ObSysVars[270].name_ = "innodb_autoextend_increment" ;
      ...
      ObSysVars[270].id_ = SYS_VAR_INNODB_AUTOEXTEND_INCREMENT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_AUTOEXTEND_INCREMENT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_AUTOEXTEND_INCREMENT] = 270 ;
      ObSysVars[270].base_value_ = "64" ;
    ObSysVars[270].alias_ = "OB_SV_INNODB_AUTOEXTEND_INCREMENT" ;
    }();

    [&] (){
      ObSysVars[271].default_value_ = "0" ;
      ObSysVars[271].info_ = "Enabling the innodb_background_drop_list_empty debug option helps avoid test case failures by delaying table creation until the background drop list is empty" ;
      ObSysVars[271].name_ = "innodb_background_drop_list_empty" ;
      ...
      ObSysVars[271].id_ = SYS_VAR_INNODB_BACKGROUND_DROP_LIST_EMPTY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BACKGROUND_DROP_LIST_EMPTY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BACKGROUND_DROP_LIST_EMPTY] = 271 ;
      ObSysVars[271].base_value_ = "0" ;
    ObSysVars[271].alias_ = "OB_SV_INNODB_BACKGROUND_DROP_LIST_EMPTY" ;
    }();

    [&] (){
      ObSysVars[272].default_value_ = "1" ;
      ObSysVars[272].info_ = "Specifies whether to record the pages cached in the InnoDB buffer pool when the MySQL server is shut down, to shorten the warmup process at the next restart" ;
      ObSysVars[272].name_ = "innodb_buffer_pool_dump_at_shutdown" ;
      ...
      ObSysVars[272].id_ = SYS_VAR_INNODB_BUFFER_POOL_DUMP_AT_SHUTDOWN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_DUMP_AT_SHUTDOWN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_DUMP_AT_SHUTDOWN] = 272 ;
      ObSysVars[272].base_value_ = "1" ;
    ObSysVars[272].alias_ = "OB_SV_INNODB_BUFFER_POOL_DUMP_AT_SHUTDOWN" ;
    }();

    [&] (){
      ObSysVars[273].default_value_ = "0" ;
      ObSysVars[273].info_ = "Immediately makes a record of pages cached in the InnoDB buffer pool" ;
      ObSysVars[273].name_ = "innodb_buffer_pool_dump_now" ;
      ...
      ObSysVars[273].id_ = SYS_VAR_INNODB_BUFFER_POOL_DUMP_NOW ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_DUMP_NOW)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_DUMP_NOW] = 273 ;
      ObSysVars[273].base_value_ = "0" ;
    ObSysVars[273].alias_ = "OB_SV_INNODB_BUFFER_POOL_DUMP_NOW" ;
    }();

    [&] (){
      ObSysVars[274].default_value_ = "25" ;
      ObSysVars[274].info_ = "Specifies the percentage of the most recently used pages for each buffer pool to read out and dump" ;
      ObSysVars[274].name_ = "innodb_buffer_pool_dump_pct" ;
      ObSysVars[274].data_type_ = ObIntType ;
      ObSysVars[274].min_val_ = "1" ;
      ObSysVars[274].max_val_ = "100" ;
      ObSysVars[274].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[274].id_ = SYS_VAR_INNODB_BUFFER_POOL_DUMP_PCT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_DUMP_PCT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_DUMP_PCT] = 274 ;
      ObSysVars[274].base_value_ = "25" ;
    ObSysVars[274].alias_ = "OB_SV_INNODB_BUFFER_POOL_DUMP_PCT" ;
    }();

    [&] (){
      ObSysVars[275].default_value_ = "ib_buffer_pool" ;
      ObSysVars[275].info_ = "Specifies the name of the file that holds the list of tablespace IDs and page IDs produced by innodb_buffer_pool_dump_at_shutdown or innodb_buffer_pool_dump_now" ;
      ObSysVars[275].name_ = "innodb_buffer_pool_filename" ;
      ObSysVars[275].data_type_ = ObVarcharType ;
      ObSysVars[275].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[275].id_ = SYS_VAR_INNODB_BUFFER_POOL_FILENAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_FILENAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_FILENAME] = 275 ;
      ObSysVars[275].base_value_ = "" ;
    ObSysVars[275].alias_ = "OB_SV_INNODB_BUFFER_POOL_FILENAME" ;
    }();

    [&] (){
      ObSysVars[276].default_value_ = "0" ;
      ObSysVars[276].info_ = "Interrupts the process of restoring InnoDB buffer pool contents triggered by innodb_buffer_pool_load_at_startup or innodb_buffer_pool_load_now" ;
      ObSysVars[276].name_ = "innodb_buffer_pool_load_abort" ;
      ...
      ObSysVars[276].id_ = SYS_VAR_INNODB_BUFFER_POOL_LOAD_ABORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_LOAD_ABORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_LOAD_ABORT] = 276 ;
      ObSysVars[276].base_value_ = "0" ;
    ObSysVars[276].alias_ = "OB_SV_INNODB_BUFFER_POOL_LOAD_ABORT" ;
    }();

    [&] (){
      ObSysVars[277].default_value_ = "0" ;
      ObSysVars[277].info_ = "Immediately warms up the InnoDB buffer pool by loading data pages without waiting for a server restart" ;
      ObSysVars[277].name_ = "innodb_buffer_pool_load_now" ;
      ObSysVars[277].data_type_ = ObIntType ;
      ObSysVars[277].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[277].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[277].id_ = SYS_VAR_INNODB_BUFFER_POOL_LOAD_NOW ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_LOAD_NOW)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_LOAD_NOW] = 277 ;
      ObSysVars[277].base_value_ = "0" ;
    ObSysVars[277].alias_ = "OB_SV_INNODB_BUFFER_POOL_LOAD_NOW" ;
    }();

    [&] (){
      ObSysVars[278].default_value_ = "134217728" ;
      ObSysVars[278].info_ = "The size in bytes of the buffer pool, the memory area where InnoDB caches table and index data" ;
      ObSysVars[278].name_ = "innodb_buffer_pool_size" ;
      ObSysVars[278].data_type_ = ObUInt64Type ;
      ObSysVars[278].min_val_ = "5242880" ;
      ObSysVars[278].max_val_ = "18446744073709551615" ;
      ObSysVars[278].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[278].id_ = SYS_VAR_INNODB_BUFFER_POOL_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_SIZE] = 278 ;
      ObSysVars[278].base_value_ = "134217728" ;
    ObSysVars[278].alias_ = "OB_SV_INNODB_BUFFER_POOL_SIZE" ;
    }();

    [&] (){
      ObSysVars[279].default_value_ = "25" ;
      ObSysVars[279].info_ = "Maximum size for the InnoDB change buffer, as a percentage of the total size of the buffer pool." ;
      ObSysVars[279].name_ = "innodb_change_buffer_max_size" ;
      ObSysVars[279].data_type_ = ObIntType ;
      ObSysVars[279].min_val_ = "0" ;
      ObSysVars[279].max_val_ = "50" ;
      ObSysVars[279].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[279].id_ = SYS_VAR_INNODB_CHANGE_BUFFER_MAX_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHANGE_BUFFER_MAX_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHANGE_BUFFER_MAX_SIZE] = 279 ;
      ObSysVars[279].base_value_ = "25" ;
    ObSysVars[279].alias_ = "OB_SV_INNODB_CHANGE_BUFFER_MAX_SIZE" ;
    }();

    [&] (){
      ObSysVars[280].default_value_ = "5" ;
      ObSysVars[280].info_ = "Whether InnoDB performs change buffering, an optimization that delays write operations to secondary indexes so that the I/O operations can be performed sequentially" ;
      ObSysVars[280].name_ = "innodb_change_buffering" ;
      ObSysVars[280].data_type_ = ObIntType ;
      ObSysVars[280].enum_names_ = "[u'none', u'inserts', u'deletes', u'changes', u'purges', u'all']" ;
      ObSysVars[280].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[280].id_ = SYS_VAR_INNODB_CHANGE_BUFFERING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHANGE_BUFFERING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHANGE_BUFFERING] = 280 ;
      ObSysVars[280].base_value_ = "5" ;
    ObSysVars[280].alias_ = "OB_SV_INNODB_CHANGE_BUFFERING" ;
    }();

    [&] (){
      ObSysVars[281].default_value_ = "0" ;
      ObSysVars[281].info_ = "Specifies how to generate and verify the checksum stored in the disk blocks of InnoDB tablespaces" ;
      ObSysVars[281].name_ = "innodb_checksum_algorithm" ;
      ObSysVars[281].data_type_ = ObIntType ;
      ObSysVars[281].enum_names_ = "[u'crc32', u'strict_crc32', u'innodb', u'strict_innodb', u'none', u'strict_none']" ;
      ObSysVars[281].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[281].id_ = SYS_VAR_INNODB_CHECKSUM_ALGORITHM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHECKSUM_ALGORITHM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHECKSUM_ALGORITHM] = 281 ;
      ObSysVars[281].base_value_ = "0" ;
    ObSysVars[281].alias_ = "OB_SV_INNODB_CHECKSUM_ALGORITHM" ;
    }();

    [&] (){
      ObSysVars[282].default_value_ = "0" ;
      ObSysVars[282].info_ = "Enables per-index compression-related statistics in the Information Schema INNODB_CMP_PER_INDEX table" ;
      ObSysVars[282].name_ = "innodb_cmp_per_index_enabled" ;
      ...
      ObSysVars[282].id_ = SYS_VAR_INNODB_CMP_PER_INDEX_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CMP_PER_INDEX_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CMP_PER_INDEX_ENABLED] = 282 ;
      ObSysVars[282].base_value_ = "0" ;
    ObSysVars[282].alias_ = "OB_SV_INNODB_CMP_PER_INDEX_ENABLED" ;
    }();

    [&] (){
      ObSysVars[283].default_value_ = "0" ;
      ObSysVars[283].info_ = "The number of threads that can commit at the same time. A value of 0 (the default) permits any number of transactions to commit simultaneously" ;
      ObSysVars[283].name_ = "innodb_commit_concurrency" ;
      ...
      ObSysVars[283].id_ = SYS_VAR_INNODB_COMMIT_CONCURRENCY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMMIT_CONCURRENCY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMMIT_CONCURRENCY] = 283 ;
      ObSysVars[283].base_value_ = "0" ;
    ObSysVars[283].alias_ = "OB_SV_INNODB_COMMIT_CONCURRENCY" ;
    }();

    [&] (){
      ObSysVars[284].default_value_ = "5" ;
      ObSysVars[284].info_ = "Defines the compression failure rate threshold for a table, as a percentage, at which point MySQL begins adding padding within compressed pages to avoid expensive compression failures" ;
      ObSysVars[284].name_ = "innodb_compression_failure_threshold_pct" ;
      ObSysVars[284].data_type_ = ObIntType ;
      ObSysVars[284].min_val_ = "0" ;
      ObSysVars[284].max_val_ = "100" ;
      ObSysVars[284].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[284].id_ = SYS_VAR_INNODB_COMPRESSION_FAILURE_THRESHOLD_PCT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMPRESSION_FAILURE_THRESHOLD_PCT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMPRESSION_FAILURE_THRESHOLD_PCT] = 284 ;
      ObSysVars[284].base_value_ = "5" ;
    ObSysVars[284].alias_ = "OB_SV_INNODB_COMPRESSION_FAILURE_THRESHOLD_PCT" ;
    }();

    [&] (){
      ObSysVars[285].default_value_ = "6" ;
      ObSysVars[285].info_ = "Specifies the level of zlib compression to use for InnoDB compressed tables and indexes" ;
      ObSysVars[285].name_ = "innodb_compression_level" ;
      ObSysVars[285].data_type_ = ObIntType ;
      ObSysVars[285].min_val_ = "0" ;
      ObSysVars[285].max_val_ = "9" ;
      ObSysVars[285].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[285].id_ = SYS_VAR_INNODB_COMPRESSION_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMPRESSION_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMPRESSION_LEVEL] = 285 ;
      ObSysVars[285].base_value_ = "6" ;
    ObSysVars[285].alias_ = "OB_SV_INNODB_COMPRESSION_LEVEL" ;
    }();

    [&] (){
      ObSysVars[286].default_value_ = "50" ;
      ObSysVars[286].info_ = "Specifies the maximum percentage that can be reserved as free space within each compressed page, allowing room to reorganize the data and modification log within the page when a compressed table or index is updated and the data might be recompressed" ;
      ObSysVars[286].name_ = "innodb_compression_pad_pct_max" ;
      ObSysVars[286].data_type_ = ObIntType ;
      ObSysVars[286].min_val_ = "0" ;
      ObSysVars[286].max_val_ = "75" ;
      ObSysVars[286].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[286].id_ = SYS_VAR_INNODB_COMPRESSION_PAD_PCT_MAX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_COMPRESSION_PAD_PCT_MAX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_COMPRESSION_PAD_PCT_MAX] = 286 ;
      ObSysVars[286].base_value_ = "50" ;
    ObSysVars[286].alias_ = "OB_SV_INNODB_COMPRESSION_PAD_PCT_MAX" ;
    }();

    [&] (){
      ObSysVars[287].default_value_ = "5000" ;
      ObSysVars[287].info_ = "Determines the number of threads that can enter InnoDB concurrently" ;
      ObSysVars[287].name_ = "innodb_concurrency_tickets" ;
      ObSysVars[287].data_type_ = ObIntType ;
      ObSysVars[287].min_val_ = "1" ;
      ObSysVars[287].max_val_ = "4294967295" ;
      ObSysVars[287].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[287].id_ = SYS_VAR_INNODB_CONCURRENCY_TICKETS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CONCURRENCY_TICKETS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CONCURRENCY_TICKETS] = 287 ;
      ObSysVars[287].base_value_ = "5000" ;
    ObSysVars[287].alias_ = "OB_SV_INNODB_CONCURRENCY_TICKETS" ;
    }();

    [&] (){
      ObSysVars[288].default_value_ = "2" ;
      ObSysVars[288].info_ = "The innodb_default_row_format option defines the default row format for InnoDB tables and user-created temporary tables" ;
      ObSysVars[288].name_ = "innodb_default_row_format" ;
      ObSysVars[288].data_type_ = ObIntType ;
      ObSysVars[288].enum_names_ = "[u'REDUNDANT', u'COMPACT', u'DYNAMIC']" ;
      ObSysVars[288].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[288].id_ = SYS_VAR_INNODB_DEFAULT_ROW_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DEFAULT_ROW_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DEFAULT_ROW_FORMAT] = 288 ;
      ObSysVars[288].base_value_ = "2" ;
    ObSysVars[288].alias_ = "OB_SV_INNODB_DEFAULT_ROW_FORMAT" ;
    }();

    [&] (){
      ObSysVars[289].default_value_ = "0" ;
      ObSysVars[289].info_ = "Disables the operating system file system cache for merge-sort temporary files. The effect is to open such files with the equivalent of O_DIRECT" ;
      ObSysVars[289].name_ = "innodb_disable_sort_file_cache" ;
      ...
      ObSysVars[289].id_ = SYS_VAR_INNODB_DISABLE_SORT_FILE_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DISABLE_SORT_FILE_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DISABLE_SORT_FILE_CACHE] = 289 ;
      ObSysVars[289].base_value_ = "0" ;
    ObSysVars[289].alias_ = "OB_SV_INNODB_DISABLE_SORT_FILE_CACHE" ;
    }();

    [&] (){
      ObSysVars[290].default_value_ = "1" ;
      ObSysVars[290].info_ = "Enables an InnoDB file format for file-per-table tablespaces" ;
      ObSysVars[290].name_ = "innodb_file_format" ;
      ...
      ObSysVars[290].id_ = SYS_VAR_INNODB_FILE_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FILE_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FILE_FORMAT] = 290 ;
      ObSysVars[290].base_value_ = "1" ;
    ObSysVars[290].alias_ = "OB_SV_INNODB_FILE_FORMAT" ;
    }();

    [&] (){
      ObSysVars[291].default_value_ = "1" ;
      ObSysVars[291].info_ = "At server startup, InnoDB sets the value of this variable to the file format tag in the system tablespace (for example, Antelope or Barracuda)" ;
      ObSysVars[291].name_ = "innodb_file_format_max" ;
      ObSysVars[291].data_type_ = ObIntType ;
      ObSysVars[291].enum_names_ = "[u'Antelope', u'Barracuda']" ;
      ObSysVars[291].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[291].id_ = SYS_VAR_INNODB_FILE_FORMAT_MAX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FILE_FORMAT_MAX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FILE_FORMAT_MAX] = 291 ;
      ObSysVars[291].base_value_ = "1" ;
    ObSysVars[291].alias_ = "OB_SV_INNODB_FILE_FORMAT_MAX" ;
    }();

    [&] (){
      ObSysVars[292].default_value_ = "1" ;
      ObSysVars[292].info_ = "When innodb_file_per_table is enabled, tables are created in file-per-table tablespaces by default" ;
      ObSysVars[292].name_ = "innodb_file_per_table" ;
      ObSysVars[292].data_type_ = ObIntType ;
      ObSysVars[292].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[292].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[292].id_ = SYS_VAR_INNODB_FILE_PER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FILE_PER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FILE_PER_TABLE] = 292 ;
      ObSysVars[292].base_value_ = "1" ;
    ObSysVars[292].alias_ = "OB_SV_INNODB_FILE_PER_TABLE" ;
    }();

    [&] (){
      ObSysVars[293].default_value_ = "100" ;
      ObSysVars[293].info_ = "InnoDB performs a bulk load when creating or rebuilding indexes" ;
      ObSysVars[293].name_ = "innodb_fill_factor" ;
      ObSysVars[293].data_type_ = ObIntType ;
      ObSysVars[293].min_val_ = "10" ;
      ObSysVars[293].max_val_ = "100" ;
      ObSysVars[293].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[293].id_ = SYS_VAR_INNODB_FILL_FACTOR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FILL_FACTOR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FILL_FACTOR] = 293 ;
      ObSysVars[293].base_value_ = "100" ;
    ObSysVars[293].alias_ = "OB_SV_INNODB_FILL_FACTOR" ;
    }();

    [&] (){
      ObSysVars[294].default_value_ = "1" ;
      ObSysVars[294].info_ = "Specifies whether flushing a page from the InnoDB buffer pool also flushes other dirty pages in the same extent" ;
      ObSysVars[294].name_ = "innodb_flush_neighbors" ;
      ObSysVars[294].data_type_ = ObIntType ;
      ObSysVars[294].enum_names_ = "[u'0', u'1', u'2']" ;
      ObSysVars[294].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[294].id_ = SYS_VAR_INNODB_FLUSH_NEIGHBORS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSH_NEIGHBORS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSH_NEIGHBORS] = 294 ;
      ObSysVars[294].base_value_ = "1" ;
    ObSysVars[294].alias_ = "OB_SV_INNODB_FLUSH_NEIGHBORS" ;
    }();

    [&] (){
      ObSysVars[295].default_value_ = "1" ;
      ObSysVars[295].info_ = "The innodb_flush_sync variable, which is enabled by default, causes the innodb_io_capacity setting to be ignored during bursts of I/O activity that occur at checkpoints" ;
      ObSysVars[295].name_ = "innodb_flush_sync" ;
      ObSysVars[295].data_type_ = ObIntType ;
      ObSysVars[295].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[295].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[295].id_ = SYS_VAR_INNODB_FLUSH_SYNC ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSH_SYNC)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSH_SYNC] = 295 ;
      ObSysVars[295].base_value_ = "1" ;
    ObSysVars[295].alias_ = "OB_SV_INNODB_FLUSH_SYNC" ;
    }();

    [&] (){
      ObSysVars[296].default_value_ = "30" ;
      ObSysVars[296].info_ = "Number of iterations for which InnoDB keeps the previously calculated snapshot of the flushing state, controlling how quickly adaptive flushing responds to changing workloads" ;
      ObSysVars[296].name_ = "innodb_flushing_avg_loops" ;
      ObSysVars[296].data_type_ = ObIntType ;
      ObSysVars[296].min_val_ = "1" ;
      ObSysVars[296].max_val_ = "1000" ;
      ObSysVars[296].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[296].id_ = SYS_VAR_INNODB_FLUSHING_AVG_LOOPS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSHING_AVG_LOOPS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSHING_AVG_LOOPS] = 296 ;
      ObSysVars[296].base_value_ = "30" ;
    ObSysVars[296].alias_ = "OB_SV_INNODB_FLUSHING_AVG_LOOPS" ;
    }();

    [&] (){
      ObSysVars[297].default_value_ = "1024" ;
      ObSysVars[297].info_ = "A parameter that influences the algorithms and heuristics for the flush operation for the InnoDB buffer pool. Primarily of interest to performance experts tuning I/O-intensive workloads" ;
      ObSysVars[297].name_ = "innodb_lru_scan_depth" ;
      ObSysVars[297].data_type_ = ObUInt64Type ;
      ObSysVars[297].min_val_ = "100" ;
      ObSysVars[297].max_val_ = "18446744073709551615" ;
      ObSysVars[297].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[297].id_ = SYS_VAR_INNODB_LRU_SCAN_DEPTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LRU_SCAN_DEPTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LRU_SCAN_DEPTH] = 297 ;
      ObSysVars[297].base_value_ = "1024" ;
    ObSysVars[297].alias_ = "OB_SV_INNODB_LRU_SCAN_DEPTH" ;
    }();

    [&] (){
      ObSysVars[298].default_value_ = "75" ;
      ObSysVars[298].info_ = "InnoDB tries to flush data from the buffer pool so that the percentage of dirty pages does not exceed this value" ;
      ObSysVars[298].name_ = "innodb_max_dirty_pages_pct" ;
      ...
      ObSysVars[298].id_ = SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT] = 298 ;
      ObSysVars[298].base_value_ = "75" ;
    ObSysVars[298].alias_ = "OB_SV_INNODB_MAX_DIRTY_PAGES_PCT" ;
    }();

    [&] (){
      ObSysVars[299].default_value_ = "0" ;
      ObSysVars[299].info_ = "Defines a low water mark representing the percentage of dirty pages at which preflushing is enabled to control the dirty page ratio" ;
      ObSysVars[299].name_ = "innodb_max_dirty_pages_pct_lwm" ;
      ObSysVars[299].data_type_ = ObNumberType ;
      ObSysVars[299].min_val_ = "0" ;
      ObSysVars[299].max_val_ = "99.999" ;
      ObSysVars[299].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[299].id_ = SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT_LWM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT_LWM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MAX_DIRTY_PAGES_PCT_LWM] = 299 ;
      ObSysVars[299].base_value_ = "0" ;
    ObSysVars[299].alias_ = "OB_SV_INNODB_MAX_DIRTY_PAGES_PCT_LWM" ;
    }();

    [&] (){
      ObSysVars[300].default_value_ = "0" ;
      ObSysVars[300].info_ = "Defines the desired maximum purge lag. If this value is exceeded, a delay is imposed on INSERT, UPDATE, and DELETE operations to allow time for purge to catch up" ;
      ObSysVars[300].name_ = "innodb_max_purge_lag" ;
      ...
      ObSysVars[300].id_ = SYS_VAR_INNODB_MAX_PURGE_LAG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MAX_PURGE_LAG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MAX_PURGE_LAG] = 300 ;
      ObSysVars[300].base_value_ = "0" ;
    ObSysVars[300].alias_ = "OB_SV_INNODB_MAX_PURGE_LAG" ;
    }();

    [&] (){
      ObSysVars[301].default_value_ = "0" ;
      ObSysVars[301].info_ = "Specifies the maximum delay in microseconds for the delay imposed when the innodb_max_purge_lag threshold is exceeded" ;
      ObSysVars[301].name_ = "innodb_max_purge_lag_delay" ;
      ObSysVars[301].data_type_ = ObIntType ;
      ObSysVars[301].min_val_ = "0" ;
      ObSysVars[301].max_val_ = "10000000" ;
      ObSysVars[301].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[301].id_ = SYS_VAR_INNODB_MAX_PURGE_LAG_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MAX_PURGE_LAG_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MAX_PURGE_LAG_DELAY] = 301 ;
      ObSysVars[301].base_value_ = "0" ;
    ObSysVars[301].alias_ = "OB_SV_INNODB_MAX_PURGE_LAG_DELAY" ;
    }();

    [&] (){
      ObSysVars[302].default_value_ = "1" ;
      ObSysVars[302].info_ = "This is required on Unix for support of the DATA DIRECTORY and INDEX DIRECTORY table options" ;
      ObSysVars[302].name_ = "have_symlink" ;
      ...
      ObSysVars[302].id_ = SYS_VAR_HAVE_SYMLINK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_SYMLINK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_SYMLINK] = 302 ;
      ObSysVars[302].base_value_ = "1" ;
    ObSysVars[302].alias_ = "OB_SV_HAVE_SYMLINK" ;
    }();

    [&] (){
      ObSysVars[303].default_value_ = "0" ;
      ObSysVars[303].info_ = "In earlier versions of MySQL, enabling this variable caused the server to behave as if the built-in InnoDB were not present, which enabled the InnoDB Plugin to be used instead" ;
      ObSysVars[303].name_ = "ignore_builtin_innodb" ;
      ObSysVars[303].data_type_ = ObIntType ;
      ObSysVars[303].enum_names_ = "[u'NO', u'YES']" ;
      ObSysVars[303].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[303].id_ = SYS_VAR_IGNORE_BUILTIN_INNODB ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_IGNORE_BUILTIN_INNODB)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_IGNORE_BUILTIN_INNODB] = 303 ;
      ObSysVars[303].base_value_ = "0" ;
    ObSysVars[303].alias_ = "OB_SV_IGNORE_BUILTIN_INNODB" ;
    }();

    [&] (){
      ObSysVars[304].default_value_ = "134217728" ;
      ObSysVars[304].info_ = "defines the chunk size for InnoDB buffer pool resizing operations" ;
      ObSysVars[304].name_ = "innodb_buffer_pool_chunk_size" ;
      ObSysVars[304].data_type_ = ObIntType ;
      ObSysVars[304].min_val_ = "1048576" ;
      ObSysVars[304].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[304].id_ = SYS_VAR_INNODB_BUFFER_POOL_CHUNK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_CHUNK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_CHUNK_SIZE] = 304 ;
      ObSysVars[304].base_value_ = "134217728" ;
    ObSysVars[304].alias_ = "OB_SV_INNODB_BUFFER_POOL_CHUNK_SIZE" ;
    }();

    [&] (){
      ObSysVars[305].default_value_ = "8" ;
      ObSysVars[305].info_ = "defines the chunk size for InnoDB buffer pool resizing operations" ;
      ObSysVars[305].name_ = "innodb_buffer_pool_instances" ;
      ObSysVars[305].data_type_ = ObIntType ;
      ObSysVars[305].min_val_ = "1" ;
      ObSysVars[305].max_val_ = "64" ;
      ObSysVars[305].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[305].id_ = SYS_VAR_INNODB_BUFFER_POOL_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_INSTANCES] = 305 ;
      ObSysVars[305].base_value_ = "8" ;
    ObSysVars[305].alias_ = "OB_SV_INNODB_BUFFER_POOL_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[306].default_value_ = "1" ;
      ObSysVars[306].info_ = "Specifies that, on MySQL server startup, the InnoDB buffer pool is automatically warmed up by loading the same pages it held at an earlier time" ;
      ObSysVars[306].name_ = "innodb_buffer_pool_load_at_startup" ;
      ...
      ObSysVars[306].id_ = SYS_VAR_INNODB_BUFFER_POOL_LOAD_AT_STARTUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_BUFFER_POOL_LOAD_AT_STARTUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_BUFFER_POOL_LOAD_AT_STARTUP] = 306 ;
      ObSysVars[306].base_value_ = "1" ;
    ObSysVars[306].alias_ = "OB_SV_INNODB_BUFFER_POOL_LOAD_AT_STARTUP" ;
    }();

    [&] (){
      ObSysVars[307].default_value_ = "1" ;
      ObSysVars[307].info_ = "InnoDB can use checksum validation on all tablespace pages read from disk to ensure extra fault tolerance against hardware faults or corrupted data files" ;
      ObSysVars[307].name_ = "innodb_checksums" ;
      ...
      ObSysVars[307].id_ = SYS_VAR_INNODB_CHECKSUMS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_CHECKSUMS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_CHECKSUMS] = 307 ;
      ObSysVars[307].base_value_ = "1" ;
    ObSysVars[307].alias_ = "OB_SV_INNODB_CHECKSUMS" ;
    }();

    [&] (){
      ObSysVars[308].default_value_ = "1" ;
      ObSysVars[308].info_ = "When enabled (the default), InnoDB stores all data twice, first to the doublewrite buffer, then to the actual data files" ;
      ObSysVars[308].name_ = "innodb_doublewrite" ;
      ...
      ObSysVars[308].id_ = SYS_VAR_INNODB_DOUBLEWRITE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DOUBLEWRITE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DOUBLEWRITE] = 308 ;
      ObSysVars[308].base_value_ = "1" ;
    ObSysVars[308].alias_ = "OB_SV_INNODB_DOUBLEWRITE" ;
    }();

    [&] (){
      ObSysVars[309].default_value_ = "1" ;
      ObSysVars[309].info_ = "This variable can be set to 1 or 0 at server startup to enable or disable whether InnoDB checks the file format tag in the system tablespace (for example, Antelope or Barracuda)" ;
      ObSysVars[309].name_ = "innodb_file_format_check" ;
      ...
      ObSysVars[309].id_ = SYS_VAR_INNODB_FILE_FORMAT_CHECK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FILE_FORMAT_CHECK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FILE_FORMAT_CHECK] = 309 ;
      ObSysVars[309].base_value_ = "1" ;
    ObSysVars[309].alias_ = "OB_SV_INNODB_FILE_FORMAT_CHECK" ;
    }();

    [&] (){
      ObSysVars[310].default_value_ = "0" ;
      ObSysVars[310].info_ = "Defines the method used to flush data to InnoDB data files and log files, which can affect I/O throughput" ;
      ObSysVars[310].name_ = "innodb_flush_method" ;
      ObSysVars[310].data_type_ = ObIntType ;
      ObSysVars[310].enum_names_ = "[u'null', u'fsync', u'O_DSYNC', u'littlesync', u'nosync', u'O_DIRECT', u'O_DIRECT_NO_FSYNC']" ;
      ObSysVars[310].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[310].id_ = SYS_VAR_INNODB_FLUSH_METHOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSH_METHOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSH_METHOD] = 310 ;
      ObSysVars[310].base_value_ = "0" ;
    ObSysVars[310].alias_ = "OB_SV_INNODB_FLUSH_METHOD" ;
    }();

    [&] (){
      ObSysVars[311].default_value_ = "0" ;
      ObSysVars[311].info_ = "Permits InnoDB to load tables at startup that are marked as corrupted" ;
      ObSysVars[311].name_ = "innodb_force_load_corrupted" ;
      ...
      ObSysVars[311].id_ = SYS_VAR_INNODB_FORCE_LOAD_CORRUPTED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FORCE_LOAD_CORRUPTED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FORCE_LOAD_CORRUPTED] = 311 ;
      ObSysVars[311].base_value_ = "0" ;
    ObSysVars[311].alias_ = "OB_SV_INNODB_FORCE_LOAD_CORRUPTED" ;
    }();

    [&] (){
      ObSysVars[312].default_value_ = "2" ;
      ObSysVars[312].info_ = "Specifies the page size for InnoDB tablespaces. Values can be specified in bytes or kilobytes" ;
      ObSysVars[312].name_ = "innodb_page_size" ;
      ObSysVars[312].data_type_ = ObIntType ;
      ObSysVars[312].enum_names_ = "[u'4096', u'8192', u'16384', u'32768', u'65536']" ;
      ObSysVars[312].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[312].id_ = SYS_VAR_INNODB_PAGE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PAGE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PAGE_SIZE] = 312 ;
      ObSysVars[312].base_value_ = "2" ;
    ObSysVars[312].alias_ = "OB_SV_INNODB_PAGE_SIZE" ;
    }();

    [&] (){
      ObSysVars[313].default_value_ = "0" ;
      ObSysVars[313].info_ = "The InnoDB version number" ;
      ObSysVars[313].name_ = "innodb_version" ;
      ObSysVars[313].data_type_ = ObIntType ;
      ObSysVars[313].enum_names_ = "[u'5.7.38']" ;
      ObSysVars[313].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[313].id_ = SYS_VAR_INNODB_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_VERSION] = 313 ;
      ObSysVars[313].base_value_ = "0" ;
    ObSysVars[313].alias_ = "OB_SV_INNODB_VERSION" ;
    }();

    [&] (){
      ObSysVars[314].default_value_ = "18446744073709551615" ;
      ObSysVars[314].info_ = "The maximum amount of memory to use for memory mapping compressed MyISAM files" ;
      ObSysVars[314].name_ = "myisam_mmap_size" ;
      ObSysVars[314].data_type_ = ObUInt64Type ;
      ObSysVars[314].min_val_ = "7" ;
      ...
      ObSysVars[314].id_ = SYS_VAR_MYISAM_MMAP_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_MMAP_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_MMAP_SIZE] = 314 ;
      ObSysVars[314].base_value_ = "18446744073709551615" ;
    ObSysVars[314].alias_ = "OB_SV_MYISAM_MMAP_SIZE" ;
    }();

    [&] (){
      ObSysVars[315].default_value_ = "16" ;
      ObSysVars[315].info_ = "The maximum amount of memory to use for memory mapping compressed MyISAM files" ;
      ObSysVars[315].name_ = "table_open_cache_instances" ;
      ObSysVars[315].data_type_ = ObIntType ;
      ObSysVars[315].min_val_ = "1" ;
      ObSysVars[315].max_val_ = "64" ;
      ObSysVars[315].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[315].id_ = SYS_VAR_TABLE_OPEN_CACHE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TABLE_OPEN_CACHE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TABLE_OPEN_CACHE_INSTANCES] = 315 ;
      ObSysVars[315].base_value_ = "16" ;
    ObSysVars[315].alias_ = "OB_SV_TABLE_OPEN_CACHE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[316].default_value_ = "" ;
      ObSysVars[316].info_ = "When used with global scope, this variable contains a representation of the set of all transactions executed on the server and GTIDs that have been set by a SET gtid_purged statement, merely simulates MySQL 5.7" ;
      ObSysVars[316].name_ = "gtid_executed" ;
      ...
      ObSysVars[316].id_ = SYS_VAR_GTID_EXECUTED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_EXECUTED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_EXECUTED] = 316 ;
      ObSysVars[316].base_value_ = "" ;
    ObSysVars[316].alias_ = "OB_SV_GTID_EXECUTED" ;
    }();

    [&] (){
      ObSysVars[317].default_value_ = "" ;
      ObSysVars[317].info_ = "When used with global scope, gtid_owned holds a list of all the GTIDs that are currently in use on the server, with the IDs of the threads that own them. When used with session scope, gtid_owned holds a single GTID that is currently in use by and owned by this session, merely simulates MySQL 5.7" ;
      ObSysVars[317].name_ = "gtid_owned" ;
      ObSysVars[317].data_type_ = ObVarcharType ;
      ObSysVars[317].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[317].id_ = SYS_VAR_GTID_OWNED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_OWNED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_OWNED] = 317 ;
      ObSysVars[317].base_value_ = "" ;
    ObSysVars[317].alias_ = "OB_SV_GTID_OWNED" ;
    }();

    [&] (){
      ObSysVars[318].default_value_ = "0" ;
      ObSysVars[318].info_ = "InnoDB rolls back only the last statement on a transaction timeout by default. If --innodb-rollback-on-timeout is specified, a transaction timeout causes InnoDB to abort and roll back the entire transaction, merely simulates MySQL 5.7" ;
      ObSysVars[318].name_ = "innodb_rollback_on_timeout" ;
      ...
      ObSysVars[318].id_ = SYS_VAR_INNODB_ROLLBACK_ON_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ROLLBACK_ON_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ROLLBACK_ON_TIMEOUT] = 318 ;
      ObSysVars[318].base_value_ = "0" ;
    ObSysVars[318].alias_ = "OB_SV_INNODB_ROLLBACK_ON_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[319].default_value_ = "0" ;
      ObSysVars[319].info_ = "completion_type affects transactions that begin with START TRANSACTION or BEGIN and end with COMMIT or ROLLBACK. It does not apply for XA COMMIT, XA ROLLBACK, or when autocommit=1, merely simulates MySQL 5.7" ;
      ObSysVars[319].name_ = "completion_type" ;
      ObSysVars[319].data_type_ = ObIntType ;
      ObSysVars[319].enum_names_ = "[u'NO_CHAIN', u'CHAIN', u'RELEASE']" ;
      ObSysVars[319].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[319].id_ = SYS_VAR_COMPLETION_TYPE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_COMPLETION_TYPE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_COMPLETION_TYPE] = 319 ;
      ObSysVars[319].base_value_ = "0" ;
    ObSysVars[319].alias_ = "OB_SV_COMPLETION_TYPE" ;
    }();

    [&] (){
      ObSysVars[320].default_value_ = "0" ;
      ObSysVars[320].info_ = "Depending on the value of this variable, the server enforces GTID consistency by allowing execution of only statements that can be safely logged using a GTID. You must set this variable to ON before enabling GTID based replication, merely simulates MySQL 5.7" ;
      ObSysVars[320].name_ = "enforce_gtid_consistency" ;
      ObSysVars[320].data_type_ = ObIntType ;
      ObSysVars[320].enum_names_ = "[u'OFF', u'ON', u'WARN']" ;
      ObSysVars[320].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[320].id_ = SYS_VAR_ENFORCE_GTID_CONSISTENCY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_ENFORCE_GTID_CONSISTENCY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_ENFORCE_GTID_CONSISTENCY] = 320 ;
      ObSysVars[320].base_value_ = "0" ;
    ObSysVars[320].alias_ = "OB_SV_ENFORCE_GTID_CONSISTENCY" ;
    }();

    [&] (){
      ObSysVars[321].default_value_ = "1000" ;
      ObSysVars[321].info_ = "Compress the mysql.gtid_executed table each time this many transactions have been processed, merely simulates MySQL 5.7" ;
      ObSysVars[321].name_ = "gtid_executed_compression_period" ;
      ObSysVars[321].data_type_ = ObIntType ;
      ObSysVars[321].min_val_ = "0" ;
      ObSysVars[321].max_val_ = "4294967295" ;
      ObSysVars[321].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[321].id_ = SYS_VAR_GTID_EXECUTED_COMPRESSION_PERIOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_EXECUTED_COMPRESSION_PERIOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_EXECUTED_COMPRESSION_PERIOD] = 321 ;
      ObSysVars[321].base_value_ = "1000" ;
    ObSysVars[321].alias_ = "OB_SV_GTID_EXECUTED_COMPRESSION_PERIOD" ;
    }();

    [&] (){
      ObSysVars[322].default_value_ = "0" ;
      ObSysVars[322].info_ = "Controls whether GTID based logging is enabled and what type of transactions the logs can contain, merely simulates MySQL 5.7" ;
      ObSysVars[322].name_ = "gtid_mode" ;
      ObSysVars[322].data_type_ = ObIntType ;
      ObSysVars[322].enum_names_ = "[u'OFF', u'OFF_PERMISSIVE', u'ON_PERMISSIVE', u'ON']" ;
      ObSysVars[322].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[322].id_ = SYS_VAR_GTID_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_MODE] = 322 ;
      ObSysVars[322].base_value_ = "0" ;
    ObSysVars[322].alias_ = "OB_SV_GTID_MODE" ;
    }();

    [&] (){
      ObSysVars[323].default_value_ = "0" ;
      ObSysVars[323].info_ = "This variable is used to specify whether and how the next GTID is obtained, merely simulates MySQL 5.7" ;
      ObSysVars[323].name_ = "gtid_next" ;
      ObSysVars[323].data_type_ = ObIntType ;
      ObSysVars[323].enum_names_ = "[u'AUTOMATIC', u'ANONYMOUS']" ;
      ObSysVars[323].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[323].id_ = SYS_VAR_GTID_NEXT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_NEXT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_NEXT] = 323 ;
      ObSysVars[323].base_value_ = "0" ;
    ObSysVars[323].alias_ = "OB_SV_GTID_NEXT" ;
    }();

    [&] (){
      ObSysVars[324].default_value_ = "" ;
      ObSysVars[324].info_ = "The global value of the gtid_purged system variable is a GTID set consisting of the GTIDs of all the transactions that have been committed on the server, but do not exist in any binary log file on the server. gtid_purged is a subset of gtid_executed, merely simulates MySQL 5.7" ;
      ObSysVars[324].name_ = "gtid_purged" ;
      ObSysVars[324].data_type_ = ObVarcharType ;
      ObSysVars[324].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[324].id_ = SYS_VAR_GTID_PURGED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GTID_PURGED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GTID_PURGED] = 324 ;
      ObSysVars[324].base_value_ = "" ;
    ObSysVars[324].alias_ = "OB_SV_GTID_PURGED" ;
    }();

    [&] (){
      ObSysVars[325].default_value_ = "5" ;
      ObSysVars[325].info_ = "How often to auto-commit idle connections that use the InnoDB memcached interface, in seconds, merely simulates MySQL 5.7" ;
      ObSysVars[325].name_ = "innodb_api_bk_commit_interval" ;
      ObSysVars[325].data_type_ = ObIntType ;
      ObSysVars[325].min_val_ = "1" ;
      ObSysVars[325].max_val_ = "1073741824" ;
      ObSysVars[325].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[325].id_ = SYS_VAR_INNODB_API_BK_COMMIT_INTERVAL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_BK_COMMIT_INTERVAL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_BK_COMMIT_INTERVAL] = 325 ;
      ObSysVars[325].base_value_ = "5" ;
    ObSysVars[325].alias_ = "OB_SV_INNODB_API_BK_COMMIT_INTERVAL" ;
    }();

    [&] (){
      ObSysVars[326].default_value_ = "0" ;
      ObSysVars[326].info_ = "Controls the transaction isolation level on queries processed by the memcached interface, merely simulates MySQL 5.7" ;
      ObSysVars[326].name_ = "innodb_api_trx_level" ;
      ObSysVars[326].data_type_ = ObIntType ;
      ObSysVars[326].min_val_ = "0" ;
      ObSysVars[326].max_val_ = "3" ;
      ObSysVars[326].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[326].id_ = SYS_VAR_INNODB_API_TRX_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_TRX_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_TRX_LEVEL] = 326 ;
      ObSysVars[326].base_value_ = "0" ;
    ObSysVars[326].alias_ = "OB_SV_INNODB_API_TRX_LEVEL" ;
    }();

    [&] (){
      ObSysVars[327].default_value_ = "1" ;
      ObSysVars[327].info_ = "Enables InnoDB support for two-phase commit in XA transactions, causing an extra disk flush for transaction preparation, merely simulates MySQL 5.7" ;
      ObSysVars[327].name_ = "innodb_support_xa" ;
      ...
      ObSysVars[327].id_ = SYS_VAR_INNODB_SUPPORT_XA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SUPPORT_XA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SUPPORT_XA] = 327 ;
      ObSysVars[327].base_value_ = "1" ;
    ObSysVars[327].alias_ = "OB_SV_INNODB_SUPPORT_XA" ;
    }();

    [&] (){
      ObSysVars[328].default_value_ = "0" ;
      ObSysVars[328].info_ = "Controls whether the server returns GTIDs to the client, enabling the client to use them to track the server state, merely simulates MySQL 5.7" ;
      ObSysVars[328].name_ = "session_track_gtids" ;
      ObSysVars[328].data_type_ = ObIntType ;
      ObSysVars[328].enum_names_ = "[u'OFF', u'OWN_GTID', u'ALL_GTIDS']" ;
      ObSysVars[328].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[328].id_ = SYS_VAR_SESSION_TRACK_GTIDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SESSION_TRACK_GTIDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SESSION_TRACK_GTIDS] = 328 ;
      ObSysVars[328].base_value_ = "0" ;
    ObSysVars[328].alias_ = "OB_SV_SESSION_TRACK_GTIDS" ;
    }();

    [&] (){
      ObSysVars[329].default_value_ = "0" ;
      ObSysVars[329].info_ = "Controls whether the server tracks the state and characteristics of transactions within the current session and notifies the client to make this information available, merely simulates MySQL 5.7" ;
      ObSysVars[329].name_ = "session_track_transaction_info" ;
      ObSysVars[329].data_type_ = ObIntType ;
      ObSysVars[329].enum_names_ = "[u'OFF', u'STATE', u'CHARACTERISTICS']" ;
      ObSysVars[329].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[329].id_ = SYS_VAR_SESSION_TRACK_TRANSACTION_INFO ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SESSION_TRACK_TRANSACTION_INFO)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SESSION_TRACK_TRANSACTION_INFO] = 329 ;
      ObSysVars[329].base_value_ = "0" ;
    ObSysVars[329].alias_ = "OB_SV_SESSION_TRACK_TRANSACTION_INFO" ;
    }();

    [&] (){
      ObSysVars[330].default_value_ = "8192" ;
      ObSysVars[330].info_ = "The amount in bytes by which to increase a per-transaction memory pool which needs memory, merely simulates MySQL 5.7" ;
      ObSysVars[330].name_ = "transaction_alloc_block_size" ;
      ...
      ObSysVars[330].id_ = SYS_VAR_TRANSACTION_ALLOC_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TRANSACTION_ALLOC_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TRANSACTION_ALLOC_BLOCK_SIZE] = 330 ;
      ObSysVars[330].base_value_ = "8192" ;
    ObSysVars[330].alias_ = "OB_SV_TRANSACTION_ALLOC_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[331].default_value_ = "0" ;
      ObSysVars[331].info_ = "When set to 1 or ON, this variable enables batching of statements within the same transaction. To use this variable, autocommit must first be disabled by setting it to 0 or OFF; otherwise, setting transaction_allow_batching has no effect, merely simulates MySQL 5.7" ;
      ObSysVars[331].name_ = "transaction_allow_batching" ;
      ObSysVars[331].data_type_ = ObIntType ;
      ObSysVars[331].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[331].id_ = SYS_VAR_TRANSACTION_ALLOW_BATCHING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TRANSACTION_ALLOW_BATCHING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TRANSACTION_ALLOW_BATCHING] = 331 ;
      ObSysVars[331].base_value_ = "0" ;
    ObSysVars[331].alias_ = "OB_SV_TRANSACTION_ALLOW_BATCHING" ;
    }();

    [&] (){
      ObSysVars[332].default_value_ = "4096" ;
      ObSysVars[332].info_ = "There is a per-transaction memory pool from which various transaction-related allocations take memory. The initial size of the pool in bytes is transaction_prealloc_size, merely simulates MySQL 5.7" ;
      ObSysVars[332].name_ = "transaction_prealloc_size" ;
      ...
      ObSysVars[332].id_ = SYS_VAR_TRANSACTION_PREALLOC_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TRANSACTION_PREALLOC_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TRANSACTION_PREALLOC_SIZE] = 332 ;
      ObSysVars[332].base_value_ = "4096" ;
    ObSysVars[332].alias_ = "OB_SV_TRANSACTION_PREALLOC_SIZE" ;
    }();

    [&] (){
      ObSysVars[333].default_value_ = "0" ;
      ObSysVars[333].info_ = "Defines the algorithm used to generate a hash identifying the writes associated with a transaction, merely simulates MySQL 5.7" ;
      ObSysVars[333].name_ = "transaction_write_set_extraction" ;
      ObSysVars[333].data_type_ = ObIntType ;
      ObSysVars[333].enum_names_ = "[u'OFF', u'MURMUR32', u'XXHASH64']" ;
      ObSysVars[333].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[333].id_ = SYS_VAR_TRANSACTION_WRITE_SET_EXTRACTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TRANSACTION_WRITE_SET_EXTRACTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TRANSACTION_WRITE_SET_EXTRACTION] = 333 ;
      ObSysVars[333].base_value_ = "0" ;
    ObSysVars[333].alias_ = "OB_SV_TRANSACTION_WRITE_SET_EXTRACTION" ;
    }();

    [&] (){
      ObSysVars[334].default_value_ = "86400" ;
      ObSysVars[334].info_ = "The number of seconds after which the server will fetch data from storage engine and replace the data in cache." ;
      ObSysVars[334].name_ = "information_schema_stats_expiry" ;
      ObSysVars[334].data_type_ = ObUInt64Type ;
      ObSysVars[334].min_val_ = "0" ;
      ObSysVars[334].max_val_ = "31536000" ;
      ObSysVars[334].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[334].id_ = SYS_VAR_INFORMATION_SCHEMA_STATS_EXPIRY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INFORMATION_SCHEMA_STATS_EXPIRY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INFORMATION_SCHEMA_STATS_EXPIRY] = 334 ;
      ObSysVars[334].base_value_ = "86400" ;
    ObSysVars[334].alias_ = "OB_SV_INFORMATION_SCHEMA_STATS_EXPIRY" ;
    }();

    [&] (){
      ObSysVars[335].default_value_ = "9223372036854775807" ;
      ObSysVars[335].info_ = "used by JDBC setMaxRows() interface to specify limitation of row number in ResultSet" ;
      ObSysVars[335].name_ = "_oracle_sql_select_limit" ;
      ObSysVars[335].data_type_ = ObIntType ;
      ObSysVars[335].min_val_ = "0" ;
      ObSysVars[335].max_val_ = "9223372036854775807" ;
      ObSysVars[335].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::ORACLE_ONLY ;
      ObSysVars[335].id_ = SYS_VAR__ORACLE_SQL_SELECT_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__ORACLE_SQL_SELECT_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__ORACLE_SQL_SELECT_LIMIT] = 335 ;
      ObSysVars[335].base_value_ = "9223372036854775807" ;
    ObSysVars[335].alias_ = "OB_SV__ORACLE_SQL_SELECT_LIMIT" ;
    }();

    [&] (){
      ObSysVars[336].default_value_ = "0" ;
      ObSysVars[336].info_ = "Allows the server to join the group even if it has local transactions that are not present in the group" ;
      ObSysVars[336].name_ = "group_replication_allow_local_disjoint_gtids_join" ;
      ObSysVars[336].data_type_ = ObIntType ;
      ObSysVars[336].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[336].id_ = SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_DISJOINT_GTIDS_JOIN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_DISJOINT_GTIDS_JOIN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_DISJOINT_GTIDS_JOIN] = 336 ;
      ObSysVars[336].base_value_ = "0" ;
    ObSysVars[336].alias_ = "OB_SV_GROUP_REPLICATION_ALLOW_LOCAL_DISJOINT_GTIDS_JOIN" ;
    }();

    [&] (){
      ObSysVars[337].default_value_ = "0" ;
      ObSysVars[337].info_ = "Allows the current server to join the group even if it has a lower major version than the group" ;
      ObSysVars[337].name_ = "group_replication_allow_local_lower_version_join" ;
      ObSysVars[337].data_type_ = ObIntType ;
      ObSysVars[337].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[337].id_ = SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_LOWER_VERSION_JOIN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_LOWER_VERSION_JOIN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_ALLOW_LOCAL_LOWER_VERSION_JOIN] = 337 ;
      ObSysVars[337].base_value_ = "0" ;
    ObSysVars[337].alias_ = "OB_SV_GROUP_REPLICATION_ALLOW_LOCAL_LOWER_VERSION_JOIN" ;
    }();

    [&] (){
      ObSysVars[338].default_value_ = "7" ;
      ObSysVars[338].info_ = "Determines the interval between successive column values for transactions that execute on this server instance" ;
      ObSysVars[338].name_ = "group_replication_auto_increment_increment" ;
      ObSysVars[338].data_type_ = ObIntType ;
      ObSysVars[338].min_val_ = "1" ;
      ObSysVars[338].max_val_ = "65535" ;
      ObSysVars[338].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[338].id_ = SYS_VAR_GROUP_REPLICATION_AUTO_INCREMENT_INCREMENT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_AUTO_INCREMENT_INCREMENT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_AUTO_INCREMENT_INCREMENT] = 338 ;
      ObSysVars[338].base_value_ = "7" ;
    ObSysVars[338].alias_ = "OB_SV_GROUP_REPLICATION_AUTO_INCREMENT_INCREMENT" ;
    }();

    [&] (){
      ObSysVars[339].default_value_ = "0" ;
      ObSysVars[339].info_ = "Configure this server to bootstrap the group" ;
      ObSysVars[339].name_ = "group_replication_bootstrap_group" ;
      ObSysVars[339].data_type_ = ObIntType ;
      ObSysVars[339].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[339].id_ = SYS_VAR_GROUP_REPLICATION_BOOTSTRAP_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_BOOTSTRAP_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_BOOTSTRAP_GROUP] = 339 ;
      ObSysVars[339].base_value_ = "0" ;
    ObSysVars[339].alias_ = "OB_SV_GROUP_REPLICATION_BOOTSTRAP_GROUP" ;
    }();

    [&] (){
      ObSysVars[340].default_value_ = "31536000" ;
      ObSysVars[340].info_ = "Timeout, in seconds, that Group Replication waits for each of the components when shutting down" ;
      ObSysVars[340].name_ = "group_replication_components_stop_timeout" ;
      ObSysVars[340].data_type_ = ObIntType ;
      ObSysVars[340].min_val_ = "2" ;
      ObSysVars[340].max_val_ = "31536000" ;
      ObSysVars[340].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[340].id_ = SYS_VAR_GROUP_REPLICATION_COMPONENTS_STOP_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_COMPONENTS_STOP_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_COMPONENTS_STOP_TIMEOUT] = 340 ;
      ObSysVars[340].base_value_ = "31536000" ;
    ObSysVars[340].alias_ = "OB_SV_GROUP_REPLICATION_COMPONENTS_STOP_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[341].default_value_ = "1000000" ;
      ObSysVars[341].info_ = "The threshold value in bytes above which compression is applied to messages sent between group members" ;
      ObSysVars[341].name_ = "group_replication_compression_threshold" ;
      ObSysVars[341].data_type_ = ObIntType ;
      ObSysVars[341].min_val_ = "0" ;
      ObSysVars[341].max_val_ = "4294967295" ;
      ObSysVars[341].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[341].id_ = SYS_VAR_GROUP_REPLICATION_COMPRESSION_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_COMPRESSION_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_COMPRESSION_THRESHOLD] = 341 ;
      ObSysVars[341].base_value_ = "1000000" ;
    ObSysVars[341].alias_ = "OB_SV_GROUP_REPLICATION_COMPRESSION_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[342].default_value_ = "0" ;
      ObSysVars[342].info_ = "Enable or disable strict consistency checks for multi-primary update everywhere" ;
      ObSysVars[342].name_ = "group_replication_enforce_update_everywhere_checks" ;
      ObSysVars[342].data_type_ = ObIntType ;
      ObSysVars[342].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[342].id_ = SYS_VAR_GROUP_REPLICATION_ENFORCE_UPDATE_EVERYWHERE_CHECKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_ENFORCE_UPDATE_EVERYWHERE_CHECKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_ENFORCE_UPDATE_EVERYWHERE_CHECKS] = 342 ;
      ObSysVars[342].base_value_ = "0" ;
    ObSysVars[342].alias_ = "OB_SV_GROUP_REPLICATION_ENFORCE_UPDATE_EVERYWHERE_CHECKS" ;
    }();

    [&] (){
      ObSysVars[343].default_value_ = "1" ;
      ObSysVars[343].info_ = "Configures how Group Replication behaves when a server instance leaves the group unintentionally, for example after encountering an applier error, or in the case of a loss of majority, or when another member of the group expels it due to a suspicion timing out" ;
      ObSysVars[343].name_ = "group_replication_exit_state_action" ;
      ObSysVars[343].data_type_ = ObIntType ;
      ObSysVars[343].enum_names_ = "[u'ABORT_SERVER', u'READ_ONLY']" ;
      ObSysVars[343].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[343].id_ = SYS_VAR_GROUP_REPLICATION_EXIT_STATE_ACTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_EXIT_STATE_ACTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_EXIT_STATE_ACTION] = 343 ;
      ObSysVars[343].base_value_ = "1" ;
    ObSysVars[343].alias_ = "OB_SV_GROUP_REPLICATION_EXIT_STATE_ACTION" ;
    }();

    [&] (){
      ObSysVars[344].default_value_ = "25000" ;
      ObSysVars[344].info_ = "Specifies the number of waiting transactions in the applier queue that trigger flow control. This variable can be changed without resetting Group Replication" ;
      ObSysVars[344].name_ = "group_replication_flow_control_applier_threshold" ;
      ...
      ObSysVars[344].id_ = SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_APPLIER_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_APPLIER_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_APPLIER_THRESHOLD] = 344 ;
      ObSysVars[344].base_value_ = "25000" ;
    ObSysVars[344].alias_ = "OB_SV_GROUP_REPLICATION_FLOW_CONTROL_APPLIER_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[345].default_value_ = "25000" ;
      ObSysVars[345].info_ = "Specifies the number of waiting transactions in the certifier queue that trigger flow control. This variable can be changed without resetting Group Replication" ;
      ObSysVars[345].name_ = "group_replication_flow_control_certifier_threshold" ;
      ...
      ObSysVars[345].id_ = SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_CERTIFIER_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_CERTIFIER_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_CERTIFIER_THRESHOLD] = 345 ;
      ObSysVars[345].base_value_ = "25000" ;
    ObSysVars[345].alias_ = "OB_SV_GROUP_REPLICATION_FLOW_CONTROL_CERTIFIER_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[346].default_value_ = "1" ;
      ObSysVars[346].info_ = "Specifies the mode used for flow control. This variable can be changed without resetting Group Replication" ;
      ObSysVars[346].name_ = "group_replication_flow_control_mode" ;
      ObSysVars[346].data_type_ = ObIntType ;
      ObSysVars[346].enum_names_ = "[u'DISABLED', u'QUOTA']" ;
      ObSysVars[346].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[346].id_ = SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_FLOW_CONTROL_MODE] = 346 ;
      ObSysVars[346].base_value_ = "1" ;
    ObSysVars[346].alias_ = "OB_SV_GROUP_REPLICATION_FLOW_CONTROL_MODE" ;
    }();

    [&] (){
      ObSysVars[347].default_value_ = "" ;
      ObSysVars[347].info_ = "A list of peer addresses as a comma separated list such as host1:port1,host2:port2" ;
      ObSysVars[347].name_ = "group_replication_force_members" ;
      ObSysVars[347].data_type_ = ObVarcharType ;
      ObSysVars[347].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[347].id_ = SYS_VAR_GROUP_REPLICATION_FORCE_MEMBERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_FORCE_MEMBERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_FORCE_MEMBERS] = 347 ;
      ObSysVars[347].base_value_ = "" ;
    ObSysVars[347].alias_ = "OB_SV_GROUP_REPLICATION_FORCE_MEMBERS" ;
    }();

    [&] (){
      ObSysVars[348].default_value_ = "" ;
      ObSysVars[348].info_ = "The name of the group which this server instance belongs to. Must be a valid UUID. This UUID is used internally when setting GTIDs for Group Replication events in the binary log" ;
      ObSysVars[348].name_ = "group_replication_group_name" ;
      ObSysVars[348].data_type_ = ObVarcharType ;
      ObSysVars[348].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[348].id_ = SYS_VAR_GROUP_REPLICATION_GROUP_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_GROUP_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_GROUP_NAME] = 348 ;
      ObSysVars[348].base_value_ = "" ;
    ObSysVars[348].alias_ = "OB_SV_GROUP_REPLICATION_GROUP_NAME" ;
    }();

    [&] (){
      ObSysVars[349].default_value_ = "" ;
      ObSysVars[349].info_ = "The number of consecutive GTIDs that are reserved for each member. Each member consumes its blocks and reserves more when needed" ;
      ObSysVars[349].name_ = "group_replication_gtid_assignment_block_size" ;
      ObSysVars[349].data_type_ = ObVarcharType ;
      ObSysVars[349].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[349].id_ = SYS_VAR_GROUP_REPLICATION_GTID_ASSIGNMENT_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_GTID_ASSIGNMENT_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_GTID_ASSIGNMENT_BLOCK_SIZE] = 349 ;
      ObSysVars[349].base_value_ = "" ;
    ObSysVars[349].alias_ = "OB_SV_GROUP_REPLICATION_GTID_ASSIGNMENT_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[350].default_value_ = "AUTOMATIC" ;
      ObSysVars[350].info_ = "Specifies the allowlist of hosts that are permitted to connect to the group" ;
      ObSysVars[350].name_ = "group_replication_ip_whitelist" ;
      ObSysVars[350].data_type_ = ObVarcharType ;
      ObSysVars[350].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[350].id_ = SYS_VAR_GROUP_REPLICATION_IP_WHITELIST ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_IP_WHITELIST)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_IP_WHITELIST] = 350 ;
      ObSysVars[350].base_value_ = "AUTOMATIC" ;
    ObSysVars[350].alias_ = "OB_SV_GROUP_REPLICATION_IP_WHITELIST" ;
    }();

    [&] (){
      ObSysVars[351].default_value_ = "" ;
      ObSysVars[351].info_ = "The network address which the member provides for connections from other members, specified as a host:port formatted string" ;
      ObSysVars[351].name_ = "group_replication_local_address" ;
      ObSysVars[351].data_type_ = ObVarcharType ;
      ObSysVars[351].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[351].id_ = SYS_VAR_GROUP_REPLICATION_LOCAL_ADDRESS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_LOCAL_ADDRESS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_LOCAL_ADDRESS] = 351 ;
      ObSysVars[351].base_value_ = "" ;
    ObSysVars[351].alias_ = "OB_SV_GROUP_REPLICATION_LOCAL_ADDRESS" ;
    }();

    [&] (){
      ObSysVars[352].default_value_ = "50" ;
      ObSysVars[352].info_ = "A percentage weight that can be assigned to members to influence the chance of the member being elected as primary in the event of failover, for example when the existing primary leaves a single-primary group" ;
      ObSysVars[352].name_ = "group_replication_member_weight" ;
      ObSysVars[352].data_type_ = ObIntType ;
      ObSysVars[352].min_val_ = "0" ;
      ObSysVars[352].max_val_ = "100" ;
      ObSysVars[352].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[352].id_ = SYS_VAR_GROUP_REPLICATION_MEMBER_WEIGHT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_MEMBER_WEIGHT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_MEMBER_WEIGHT] = 352 ;
      ObSysVars[352].base_value_ = "50" ;
    ObSysVars[352].alias_ = "OB_SV_GROUP_REPLICATION_MEMBER_WEIGHT" ;
    }();

    [&] (){
      ObSysVars[353].default_value_ = "0" ;
      ObSysVars[353].info_ = "The number of times the group communication thread waits for the communication engine mutex to be released before the thread waits for more incoming network messages" ;
      ObSysVars[353].name_ = "group_replication_poll_spin_loops" ;
      ...
      ObSysVars[353].id_ = SYS_VAR_GROUP_REPLICATION_POLL_SPIN_LOOPS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_POLL_SPIN_LOOPS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_POLL_SPIN_LOOPS] = 353 ;
      ObSysVars[353].base_value_ = "0" ;
    ObSysVars[353].alias_ = "OB_SV_GROUP_REPLICATION_POLL_SPIN_LOOPS" ;
    }();

    [&] (){
      ObSysVars[354].default_value_ = "1" ;
      ObSysVars[354].info_ = "Recovery policies when handling cached transactions after state transfer" ;
      ObSysVars[354].name_ = "group_replication_recovery_complete_at" ;
      ObSysVars[354].data_type_ = ObIntType ;
      ObSysVars[354].enum_names_ = "[u'TRANSACTIONS_CERTIFIED', u'TRANSACTIONS_APPLIED']" ;
      ObSysVars[354].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[354].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_COMPLETE_AT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_COMPLETE_AT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_COMPLETE_AT] = 354 ;
      ObSysVars[354].base_value_ = "1" ;
    ObSysVars[354].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_COMPLETE_AT" ;
    }();

    [&] (){
      ObSysVars[355].default_value_ = "60" ;
      ObSysVars[355].info_ = "The sleep time, in seconds, between reconnection attempts when no donor was found in the group" ;
      ObSysVars[355].name_ = "group_replication_recovery_reconnect_interval" ;
      ...
      ObSysVars[355].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_RECONNECT_INTERVAL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_RECONNECT_INTERVAL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_RECONNECT_INTERVAL] = 355 ;
      ObSysVars[355].base_value_ = "60" ;
    ObSysVars[355].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_RECONNECT_INTERVAL" ;
    }();

    [&] (){
      ObSysVars[356].default_value_ = "10" ;
      ObSysVars[356].info_ = "The number of times that the member that is joining tries to connect to the available donors before giving up" ;
      ObSysVars[356].name_ = "group_replication_recovery_retry_count" ;
      ObSysVars[356].data_type_ = ObIntType ;
      ObSysVars[356].min_val_ = "0" ;
      ObSysVars[356].max_val_ = "31536000" ;
      ObSysVars[356].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[356].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_RETRY_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_RETRY_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_RETRY_COUNT] = 356 ;
      ObSysVars[356].base_value_ = "10" ;
    ObSysVars[356].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_RETRY_COUNT" ;
    }();

    [&] (){
      ObSysVars[357].default_value_ = "" ;
      ObSysVars[357].info_ = "The path to a file that contains a list of trusted SSL certificate authorities" ;
      ObSysVars[357].name_ = "group_replication_recovery_ssl_ca" ;
      ObSysVars[357].data_type_ = ObVarcharType ;
      ObSysVars[357].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[357].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CA] = 357 ;
      ObSysVars[357].base_value_ = "" ;
    ObSysVars[357].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CA" ;
    }();

    [&] (){
      ObSysVars[358].default_value_ = "" ;
      ObSysVars[358].info_ = "The path to a directory that contains trusted SSL certificate authority certificates" ;
      ObSysVars[358].name_ = "group_replication_recovery_ssl_capath" ;
      ObSysVars[358].data_type_ = ObVarcharType ;
      ObSysVars[358].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[358].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CAPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CAPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CAPATH] = 358 ;
      ObSysVars[358].base_value_ = "" ;
    ObSysVars[358].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CAPATH" ;
    }();

    [&] (){
      ObSysVars[359].default_value_ = "" ;
      ObSysVars[359].info_ = "The name of the SSL certificate file to use for establishing a secure connection" ;
      ObSysVars[359].name_ = "group_replication_recovery_ssl_cert" ;
      ObSysVars[359].data_type_ = ObVarcharType ;
      ObSysVars[359].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[359].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CERT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CERT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CERT] = 359 ;
      ObSysVars[359].base_value_ = "" ;
    ObSysVars[359].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CERT" ;
    }();

    [&] (){
      ObSysVars[360].default_value_ = "" ;
      ObSysVars[360].info_ = "The list of permissible ciphers for SSL encryption" ;
      ObSysVars[360].name_ = "group_replication_recovery_ssl_cipher" ;
      ObSysVars[360].data_type_ = ObVarcharType ;
      ObSysVars[360].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[360].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CIPHER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CIPHER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CIPHER] = 360 ;
      ObSysVars[360].base_value_ = "" ;
    ObSysVars[360].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CIPHER" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[361].name_ = "group_replication_recovery_ssl_crl" ;
      ObSysVars[361].data_type_ = ObVarcharType ;
      ObSysVars[361].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[361].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRL] = 361 ;
      ObSysVars[361].base_value_ = "" ;
    ObSysVars[361].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CRL" ;
    }();

    [&] (){
      ObSysVars[362].default_value_ = "" ;
      ObSysVars[362].info_ = "The path to a directory that contains files containing certificate revocation lists" ;
      ObSysVars[362].name_ = "group_replication_recovery_ssl_crlpath" ;
      ObSysVars[362].data_type_ = ObVarcharType ;
      ObSysVars[362].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[362].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRLPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRLPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_CRLPATH] = 362 ;
      ObSysVars[362].base_value_ = "" ;
    ObSysVars[362].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_CRLPATH" ;
    }();

    [&] (){
      ObSysVars[363].default_value_ = "" ;
      ObSysVars[363].info_ = "The name of the SSL key file to use for establishing a secure connection" ;
      ObSysVars[363].name_ = "group_replication_recovery_ssl_key" ;
      ObSysVars[363].data_type_ = ObVarcharType ;
      ObSysVars[363].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[363].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_KEY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_KEY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_KEY] = 363 ;
      ObSysVars[363].base_value_ = "" ;
    ObSysVars[363].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_KEY" ;
    }();

    [&] (){
      ObSysVars[364].default_value_ = "0" ;
      ObSysVars[364].info_ = "Make the recovery process check the server's Common Name value in the donor sent certificate" ;
      ObSysVars[364].name_ = "group_replication_recovery_ssl_verify_server_cert" ;
      ObSysVars[364].data_type_ = ObIntType ;
      ObSysVars[364].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[364].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_VERIFY_SERVER_CERT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_VERIFY_SERVER_CERT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_SSL_VERIFY_SERVER_CERT] = 364 ;
      ObSysVars[364].base_value_ = "0" ;
    ObSysVars[364].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_SSL_VERIFY_SERVER_CERT" ;
    }();

    [&] (){
      ObSysVars[365].default_value_ = "0" ;
      ObSysVars[365].info_ = "Whether Group Replication recovery connection should use SSL or not" ;
      ObSysVars[365].name_ = "group_replication_recovery_use_ssl" ;
      ObSysVars[365].data_type_ = ObIntType ;
      ObSysVars[365].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[365].id_ = SYS_VAR_GROUP_REPLICATION_RECOVERY_USE_SSL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_RECOVERY_USE_SSL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_RECOVERY_USE_SSL] = 365 ;
      ObSysVars[365].base_value_ = "0" ;
    ObSysVars[365].alias_ = "OB_SV_GROUP_REPLICATION_RECOVERY_USE_SSL" ;
    }();

    [&] (){
      ObSysVars[366].default_value_ = "0" ;
      ObSysVars[366].info_ = "Instructs the group to pick a single server automatically to be the one that handles read/write workload. This server is the primary and all others are secondaries" ;
      ObSysVars[366].name_ = "group_replication_single_primary_mode" ;
      ObSysVars[366].data_type_ = ObIntType ;
      ObSysVars[366].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[366].id_ = SYS_VAR_GROUP_REPLICATION_SINGLE_PRIMARY_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_SINGLE_PRIMARY_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_SINGLE_PRIMARY_MODE] = 366 ;
      ObSysVars[366].base_value_ = "0" ;
    ObSysVars[366].alias_ = "OB_SV_GROUP_REPLICATION_SINGLE_PRIMARY_MODE" ;
    }();

    [&] (){
      ObSysVars[367].default_value_ = "0" ;
      ObSysVars[367].info_ = "Specifies the security state of the connection between Group Replication members" ;
      ObSysVars[367].name_ = "group_replication_ssl_mode" ;
      ObSysVars[367].data_type_ = ObIntType ;
      ObSysVars[367].enum_names_ = "[u'DISABLED', u'REQUIRED', u'VERIFY_CA', u'VERIFY_IDENTITY']" ;
      ObSysVars[367].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[367].id_ = SYS_VAR_GROUP_REPLICATION_SSL_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_SSL_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_SSL_MODE] = 367 ;
      ObSysVars[367].base_value_ = "0" ;
    ObSysVars[367].alias_ = "OB_SV_GROUP_REPLICATION_SSL_MODE" ;
    }();

    [&] (){
      ObSysVars[368].default_value_ = "0" ;
      ObSysVars[368].info_ = "Whether the server should start Group Replication or not during server start" ;
      ObSysVars[368].name_ = "group_replication_start_on_boot" ;
      ObSysVars[368].data_type_ = ObIntType ;
      ObSysVars[368].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[368].id_ = SYS_VAR_GROUP_REPLICATION_START_ON_BOOT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_START_ON_BOOT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_START_ON_BOOT] = 368 ;
      ObSysVars[368].base_value_ = "0" ;
    ObSysVars[368].alias_ = "OB_SV_GROUP_REPLICATION_START_ON_BOOT" ;
    }();

    [&] (){
      ObSysVars[369].default_value_ = "0" ;
      ObSysVars[369].info_ = "Configures the maximum transaction size in bytes which the replication group accepts" ;
      ObSysVars[369].name_ = "group_replication_transaction_size_limit" ;
      ObSysVars[369].data_type_ = ObIntType ;
      ObSysVars[369].min_val_ = "0" ;
      ObSysVars[369].max_val_ = "2147483647" ;
      ObSysVars[369].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[369].id_ = SYS_VAR_GROUP_REPLICATION_TRANSACTION_SIZE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_TRANSACTION_SIZE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_TRANSACTION_SIZE_LIMIT] = 369 ;
      ObSysVars[369].base_value_ = "0" ;
    ObSysVars[369].alias_ = "OB_SV_GROUP_REPLICATION_TRANSACTION_SIZE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[370].default_value_ = "0" ;
      ObSysVars[370].info_ = "Configures how long members that suffer a network partition and cannot connect to the majority wait before leaving the group" ;
      ObSysVars[370].name_ = "group_replication_unreachable_majority_timeout" ;
      ...
      ObSysVars[370].id_ = SYS_VAR_GROUP_REPLICATION_UNREACHABLE_MAJORITY_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_UNREACHABLE_MAJORITY_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_UNREACHABLE_MAJORITY_TIMEOUT] = 370 ;
      ObSysVars[370].base_value_ = "0" ;
    ObSysVars[370].alias_ = "OB_SV_GROUP_REPLICATION_UNREACHABLE_MAJORITY_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[371].default_value_ = "0" ;
      ObSysVars[371].info_ = "The replication thread delay in milliseconds on a replica server if innodb_thread_concurrency is reached" ;
      ObSysVars[371].name_ = "innodb_replication_delay" ;
      ObSysVars[371].data_type_ = ObIntType ;
      ObSysVars[371].min_val_ = "0" ;
      ObSysVars[371].max_val_ = "4294967295" ;
      ObSysVars[371].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[371].id_ = SYS_VAR_INNODB_REPLICATION_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_REPLICATION_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_REPLICATION_DELAY] = 371 ;
      ObSysVars[371].base_value_ = "0" ;
    ObSysVars[371].alias_ = "OB_SV_INNODB_REPLICATION_DELAY" ;
    }();

    [&] (){
      ObSysVars[372].default_value_ = "FILE" ;
      ObSysVars[372].info_ = "The setting of this variable determines whether the replica records metadata about the source, consisting of status and connection information, to an InnoDB table in the mysql system database, or as a file in the data directory" ;
      ObSysVars[372].name_ = "master_info_repository" ;
      ObSysVars[372].data_type_ = ObVarcharType ;
      ObSysVars[372].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[372].id_ = SYS_VAR_MASTER_INFO_REPOSITORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MASTER_INFO_REPOSITORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MASTER_INFO_REPOSITORY] = 372 ;
      ObSysVars[372].base_value_ = "FILE" ;
    ObSysVars[372].alias_ = "OB_SV_MASTER_INFO_REPOSITORY" ;
    }();

    [&] (){
      ObSysVars[373].default_value_ = "0" ;
      ObSysVars[373].info_ = "Enabling this variable causes the source to verify events read from the binary log by examining checksums, and to stop with an error in the event of a mismatch" ;
      ObSysVars[373].name_ = "master_verify_checksum" ;
      ObSysVars[373].data_type_ = ObIntType ;
      ObSysVars[373].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[373].id_ = SYS_VAR_MASTER_VERIFY_CHECKSUM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MASTER_VERIFY_CHECKSUM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MASTER_VERIFY_CHECKSUM] = 373 ;
      ObSysVars[373].base_value_ = "0" ;
    ObSysVars[373].alias_ = "OB_SV_MASTER_VERIFY_CHECKSUM" ;
    }();

    [&] (){
      ObSysVars[374].default_value_ = "0" ;
      ObSysVars[374].info_ = "Assists with the correct handling of transactions that originated on older or newer servers than the server currently processing them" ;
      ObSysVars[374].name_ = "pseudo_slave_mode" ;
      ObSysVars[374].data_type_ = ObIntType ;
      ObSysVars[374].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[374].id_ = SYS_VAR_PSEUDO_SLAVE_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PSEUDO_SLAVE_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PSEUDO_SLAVE_MODE] = 374 ;
      ObSysVars[374].base_value_ = "0" ;
    ObSysVars[374].alias_ = "OB_SV_PSEUDO_SLAVE_MODE" ;
    }();

    [&] (){
      ObSysVars[375].default_value_ = "2147483647" ;
      ObSysVars[375].info_ = "This variable is for internal server use" ;
      ObSysVars[375].name_ = "pseudo_thread_id" ;
      ObSysVars[375].data_type_ = ObIntType ;
      ObSysVars[375].min_val_ = "0" ;
      ObSysVars[375].max_val_ = "2147483647" ;
      ObSysVars[375].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[375].id_ = SYS_VAR_PSEUDO_THREAD_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PSEUDO_THREAD_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PSEUDO_THREAD_ID] = 375 ;
      ObSysVars[375].base_value_ = "2147483647" ;
    ObSysVars[375].alias_ = "OB_SV_PSEUDO_THREAD_ID" ;
    }();

    [&] (){
      ObSysVars[376].default_value_ = "0" ;
      ObSysVars[376].info_ = "For internal use by mysqlbinlog" ;
      ObSysVars[376].name_ = "rbr_exec_mode" ;
      ObSysVars[376].data_type_ = ObIntType ;
      ObSysVars[376].enum_names_ = "[u'STRICT', u'IDEMPOTENT']" ;
      ObSysVars[376].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[376].id_ = SYS_VAR_RBR_EXEC_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RBR_EXEC_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RBR_EXEC_MODE] = 376 ;
      ObSysVars[376].base_value_ = "0" ;
    ObSysVars[376].alias_ = "OB_SV_RBR_EXEC_MODE" ;
    }();

    [&] (){
      ObSysVars[377].default_value_ = "0" ;
      ObSysVars[377].info_ = "Use shared locks, and avoid unnecessary lock acquisitions, to improve performance for semisynchronous replication" ;
      ObSysVars[377].name_ = "replication_optimize_for_static_plugin_config" ;
      ObSysVars[377].data_type_ = ObIntType ;
      ObSysVars[377].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[377].id_ = SYS_VAR_REPLICATION_OPTIMIZE_FOR_STATIC_PLUGIN_CONFIG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPLICATION_OPTIMIZE_FOR_STATIC_PLUGIN_CONFIG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPLICATION_OPTIMIZE_FOR_STATIC_PLUGIN_CONFIG] = 377 ;
      ObSysVars[377].base_value_ = "0" ;
    ObSysVars[377].alias_ = "OB_SV_REPLICATION_OPTIMIZE_FOR_STATIC_PLUGIN_CONFIG" ;
    }();

    [&] (){
      ObSysVars[378].default_value_ = "0" ;
      ObSysVars[378].info_ = "Limit callbacks to improve performance for semisynchronous replication" ;
      ObSysVars[378].name_ = "replication_sender_observe_commit_only" ;
      ObSysVars[378].data_type_ = ObIntType ;
      ObSysVars[378].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[378].id_ = SYS_VAR_REPLICATION_SENDER_OBSERVE_COMMIT_ONLY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPLICATION_SENDER_OBSERVE_COMMIT_ONLY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPLICATION_SENDER_OBSERVE_COMMIT_ONLY] = 378 ;
      ObSysVars[378].base_value_ = "0" ;
    ObSysVars[378].alias_ = "OB_SV_REPLICATION_SENDER_OBSERVE_COMMIT_ONLY" ;
    }();

    [&] (){
      ObSysVars[379].default_value_ = "0" ;
      ObSysVars[379].info_ = "Controls whether semisynchronous replication is enabled on the source" ;
      ObSysVars[379].name_ = "rpl_semi_sync_master_enabled" ;
      ObSysVars[379].data_type_ = ObIntType ;
      ObSysVars[379].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[379].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_ENABLED] = 379 ;
      ObSysVars[379].base_value_ = "0" ;
    ObSysVars[379].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_ENABLED" ;
    }();

    [&] (){
      ObSysVars[380].default_value_ = "10000" ;
      ObSysVars[380].info_ = "A value in milliseconds that controls how long the source waits on a commit for acknowledgment from a replica before timing out and reverting to asynchronous replication" ;
      ObSysVars[380].name_ = "rpl_semi_sync_master_timeout" ;
      ...
      ObSysVars[380].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_TIMEOUT] = 380 ;
      ObSysVars[380].base_value_ = "10000" ;
    ObSysVars[380].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[381].default_value_ = "32" ;
      ObSysVars[381].info_ = "The semisynchronous replication debug trace level on the source" ;
      ObSysVars[381].name_ = "rpl_semi_sync_master_trace_level" ;
      ObSysVars[381].data_type_ = ObIntType ;
      ObSysVars[381].min_val_ = "0" ;
      ObSysVars[381].max_val_ = "4294967295" ;
      ObSysVars[381].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[381].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_TRACE_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_TRACE_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_TRACE_LEVEL] = 381 ;
      ObSysVars[381].base_value_ = "32" ;
    ObSysVars[381].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_TRACE_LEVEL" ;
    }();

    [&] (){
      ObSysVars[382].default_value_ = "1" ;
      ObSysVars[382].info_ = "The number of replica acknowledgments the source must receive per transaction before proceeding" ;
      ObSysVars[382].name_ = "rpl_semi_sync_master_wait_for_slave_count" ;
      ObSysVars[382].data_type_ = ObIntType ;
      ObSysVars[382].min_val_ = "1" ;
      ObSysVars[382].max_val_ = "65535" ;
      ObSysVars[382].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[382].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_FOR_SLAVE_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_FOR_SLAVE_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_FOR_SLAVE_COUNT] = 382 ;
      ObSysVars[382].base_value_ = "1" ;
    ObSysVars[382].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_WAIT_FOR_SLAVE_COUNT" ;
    }();

    [&] (){
      ObSysVars[383].default_value_ = "0" ;
      ObSysVars[383].info_ = "Controls whether the source waits for the timeout period configured by rpl_semi_sync_master_timeout to expire, even if the replica count drops to less than the number of replicas configured by rpl_semi_sync_master_wait_for_slave_count during the timeout period" ;
      ObSysVars[383].name_ = "rpl_semi_sync_master_wait_no_slave" ;
      ObSysVars[383].data_type_ = ObIntType ;
      ObSysVars[383].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[383].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_NO_SLAVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_NO_SLAVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_NO_SLAVE] = 383 ;
      ObSysVars[383].base_value_ = "0" ;
    ObSysVars[383].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_WAIT_NO_SLAVE" ;
    }();

    [&] (){
      ObSysVars[384].default_value_ = "0" ;
      ObSysVars[384].info_ = "This variable controls the point at which a semisynchronous source waits for replica acknowledgment of transaction receipt before returning a status to the client that committed the transaction" ;
      ObSysVars[384].name_ = "rpl_semi_sync_master_wait_point" ;
      ObSysVars[384].data_type_ = ObIntType ;
      ObSysVars[384].enum_names_ = "[u'AFTER_SYNC', u'AFTER_COMMIT']" ;
      ObSysVars[384].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[384].id_ = SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_POINT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_POINT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_MASTER_WAIT_POINT] = 384 ;
      ObSysVars[384].base_value_ = "0" ;
    ObSysVars[384].alias_ = "OB_SV_RPL_SEMI_SYNC_MASTER_WAIT_POINT" ;
    }();

    [&] (){
      ObSysVars[385].default_value_ = "0" ;
      ObSysVars[385].info_ = "Controls whether semisynchronous replication is enabled on the replica" ;
      ObSysVars[385].name_ = "rpl_semi_sync_slave_enabled" ;
      ObSysVars[385].data_type_ = ObIntType ;
      ObSysVars[385].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[385].id_ = SYS_VAR_RPL_SEMI_SYNC_SLAVE_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_SLAVE_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_SLAVE_ENABLED] = 385 ;
      ObSysVars[385].base_value_ = "0" ;
    ObSysVars[385].alias_ = "OB_SV_RPL_SEMI_SYNC_SLAVE_ENABLED" ;
    }();

    [&] (){
      ObSysVars[386].default_value_ = "32" ;
      ObSysVars[386].info_ = "The semisynchronous replication debug trace level on the replica" ;
      ObSysVars[386].name_ = "rpl_semi_sync_slave_trace_level" ;
      ObSysVars[386].data_type_ = ObIntType ;
      ObSysVars[386].min_val_ = "0" ;
      ObSysVars[386].max_val_ = "4294967295" ;
      ObSysVars[386].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[386].id_ = SYS_VAR_RPL_SEMI_SYNC_SLAVE_TRACE_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_SEMI_SYNC_SLAVE_TRACE_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_SEMI_SYNC_SLAVE_TRACE_LEVEL] = 386 ;
      ObSysVars[386].base_value_ = "32" ;
    ObSysVars[386].alias_ = "OB_SV_RPL_SEMI_SYNC_SLAVE_TRACE_LEVEL" ;
    }();

    [&] (){
      ObSysVars[387].default_value_ = "31536000" ;
      ObSysVars[387].info_ = "You can control the length of time (in seconds) that STOP SLAVE waits before timing out by setting this variab" ;
      ObSysVars[387].name_ = "rpl_stop_slave_timeout" ;
      ObSysVars[387].data_type_ = ObIntType ;
      ObSysVars[387].min_val_ = "2" ;
      ObSysVars[387].max_val_ = "31536000" ;
      ObSysVars[387].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[387].id_ = SYS_VAR_RPL_STOP_SLAVE_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RPL_STOP_SLAVE_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RPL_STOP_SLAVE_TIMEOUT] = 387 ;
      ObSysVars[387].base_value_ = "31536000" ;
    ObSysVars[387].alias_ = "OB_SV_RPL_STOP_SLAVE_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[388].default_value_ = "0" ;
      ObSysVars[388].info_ = "Whether or not batched updates are enabled on NDB Cluster replicas" ;
      ObSysVars[388].name_ = "slave_allow_batching" ;
      ObSysVars[388].data_type_ = ObIntType ;
      ObSysVars[388].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[388].id_ = SYS_VAR_SLAVE_ALLOW_BATCHING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_ALLOW_BATCHING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_ALLOW_BATCHING] = 388 ;
      ObSysVars[388].base_value_ = "0" ;
    ObSysVars[388].alias_ = "OB_SV_SLAVE_ALLOW_BATCHING" ;
    }();

    [&] (){
      ObSysVars[389].default_value_ = "512" ;
      ObSysVars[389].info_ = "Sets the maximum number of transactions that can be processed by a multithreaded replica before a checkpoint operation is called to update its status as shown by SHOW SLAVE STATUS" ;
      ObSysVars[389].name_ = "slave_checkpoint_group" ;
      ObSysVars[389].data_type_ = ObIntType ;
      ObSysVars[389].min_val_ = "32" ;
      ObSysVars[389].max_val_ = "524280" ;
      ObSysVars[389].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[389].id_ = SYS_VAR_SLAVE_CHECKPOINT_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_CHECKPOINT_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_CHECKPOINT_GROUP] = 389 ;
      ObSysVars[389].base_value_ = "512" ;
    ObSysVars[389].alias_ = "OB_SV_SLAVE_CHECKPOINT_GROUP" ;
    }();

    [&] (){
      ObSysVars[390].default_value_ = "300" ;
      ObSysVars[390].info_ = "Sets the maximum time (in milliseconds) that is allowed to pass before a checkpoint operation is called to update the status of a multithreaded replica as shown by SHOW SLAVE STATUS" ;
      ObSysVars[390].name_ = "slave_checkpoint_period" ;
      ObSysVars[390].data_type_ = ObIntType ;
      ObSysVars[390].min_val_ = "1" ;
      ObSysVars[390].max_val_ = "4294967295" ;
      ObSysVars[390].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[390].id_ = SYS_VAR_SLAVE_CHECKPOINT_PERIOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_CHECKPOINT_PERIOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_CHECKPOINT_PERIOD] = 390 ;
      ObSysVars[390].base_value_ = "300" ;
    ObSysVars[390].alias_ = "OB_SV_SLAVE_CHECKPOINT_PERIOD" ;
    }();

    [&] (){
      ObSysVars[391].default_value_ = "0" ;
      ObSysVars[391].info_ = "Whether to use compression of the source/replica protocol if both source and replica support it" ;
      ObSysVars[391].name_ = "slave_compressed_protocol" ;
      ObSysVars[391].data_type_ = ObIntType ;
      ObSysVars[391].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[391].id_ = SYS_VAR_SLAVE_COMPRESSED_PROTOCOL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_COMPRESSED_PROTOCOL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_COMPRESSED_PROTOCOL] = 391 ;
      ObSysVars[391].base_value_ = "0" ;
    ObSysVars[391].alias_ = "OB_SV_SLAVE_COMPRESSED_PROTOCOL" ;
    }();

    [&] (){
      ObSysVars[392].default_value_ = "0" ;
      ObSysVars[392].info_ = "Controls how a replication thread resolves conflicts and errors during replication" ;
      ObSysVars[392].name_ = "slave_exec_mode" ;
      ObSysVars[392].data_type_ = ObIntType ;
      ObSysVars[392].enum_names_ = "[u'STRICT', u'IDEMPOTENT']" ;
      ObSysVars[392].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[392].id_ = SYS_VAR_SLAVE_EXEC_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_EXEC_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_EXEC_MODE] = 392 ;
      ObSysVars[392].base_value_ = "0" ;
    ObSysVars[392].alias_ = "OB_SV_SLAVE_EXEC_MODE" ;
    }();

    [&] (){
      ObSysVars[393].default_value_ = "1073741824" ;
      ObSysVars[393].info_ = "This variable sets the maximum packet size for the replication SQL and I/O threads, so that large updates using row-based replication do not cause replication to fail because an update exceeded max_allowed_packet" ;
      ObSysVars[393].name_ = "slave_max_allowed_packet" ;
      ObSysVars[393].data_type_ = ObIntType ;
      ObSysVars[393].min_val_ = "1024" ;
      ObSysVars[393].max_val_ = "1073741824" ;
      ObSysVars[393].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[393].id_ = SYS_VAR_SLAVE_MAX_ALLOWED_PACKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_MAX_ALLOWED_PACKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_MAX_ALLOWED_PACKET] = 393 ;
      ObSysVars[393].base_value_ = "1073741824" ;
    ObSysVars[393].alias_ = "OB_SV_SLAVE_MAX_ALLOWED_PACKET" ;
    }();

    [&] (){
      ObSysVars[394].default_value_ = "60" ;
      ObSysVars[394].info_ = "The number of seconds to wait for more data or a heartbeat signal from the source before the replica considers the connection broken, aborts the read, and tries to reconnect" ;
      ObSysVars[394].name_ = "slave_net_timeout" ;
      ObSysVars[394].data_type_ = ObIntType ;
      ObSysVars[394].min_val_ = "1" ;
      ObSysVars[394].max_val_ = "31536000" ;
      ObSysVars[394].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[394].id_ = SYS_VAR_SLAVE_NET_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_NET_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_NET_TIMEOUT] = 394 ;
      ObSysVars[394].base_value_ = "60" ;
    ObSysVars[394].alias_ = "OB_SV_SLAVE_NET_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[395].default_value_ = "0" ;
      ObSysVars[395].info_ = "When using a multithreaded replica (slave_parallel_workers is greater than 0), this variable specifies the policy used to decide which transactions are allowed to execute in parallel on the replica" ;
      ObSysVars[395].name_ = "slave_parallel_type" ;
      ObSysVars[395].data_type_ = ObIntType ;
      ObSysVars[395].enum_names_ = "[u'DATABASE', u'LOGICAL_CLOCK']" ;
      ObSysVars[395].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[395].id_ = SYS_VAR_SLAVE_PARALLEL_TYPE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_PARALLEL_TYPE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_PARALLEL_TYPE] = 395 ;
      ObSysVars[395].base_value_ = "0" ;
    ObSysVars[395].alias_ = "OB_SV_SLAVE_PARALLEL_TYPE" ;
    }();

    [&] (){
      ObSysVars[396].default_value_ = "0" ;
      ObSysVars[396].info_ = "Sets the number of applier threads for executing replication transactions in parallel" ;
      ObSysVars[396].name_ = "slave_parallel_workers" ;
      ObSysVars[396].data_type_ = ObIntType ;
      ObSysVars[396].min_val_ = "0" ;
      ObSysVars[396].max_val_ = "1024" ;
      ObSysVars[396].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[396].id_ = SYS_VAR_SLAVE_PARALLEL_WORKERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_PARALLEL_WORKERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_PARALLEL_WORKERS] = 396 ;
      ObSysVars[396].base_value_ = "0" ;
    ObSysVars[396].alias_ = "OB_SV_SLAVE_PARALLEL_WORKERS" ;
    }();

    [&] (){
      ObSysVars[397].default_value_ = "16777216" ;
      ObSysVars[397].info_ = "For multithreaded replicas, this variable sets the maximum amount of memory (in bytes) available to worker queues holding events not yet applied" ;
      ObSysVars[397].name_ = "slave_pending_jobs_size_max" ;
      ObSysVars[397].data_type_ = ObUInt64Type ;
      ObSysVars[397].min_val_ = "1024" ;
      ObSysVars[397].max_val_ = "18446744073709551615" ;
      ObSysVars[397].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[397].id_ = SYS_VAR_SLAVE_PENDING_JOBS_SIZE_MAX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_PENDING_JOBS_SIZE_MAX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_PENDING_JOBS_SIZE_MAX] = 397 ;
      ObSysVars[397].base_value_ = "16777216" ;
    ObSysVars[397].alias_ = "OB_SV_SLAVE_PENDING_JOBS_SIZE_MAX" ;
    }();

    [&] (){
      ObSysVars[398].default_value_ = "0" ;
      ObSysVars[398].info_ = "For multithreaded replicas, the setting 1 for this variable ensures that transactions are externalized on the replica in the same order as they appear in the replica's relay log, and prevents gaps in the sequence of transactions that have been executed from the relay lo" ;
      ObSysVars[398].name_ = "slave_preserve_commit_order" ;
      ObSysVars[398].data_type_ = ObIntType ;
      ObSysVars[398].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[398].id_ = SYS_VAR_SLAVE_PRESERVE_COMMIT_ORDER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_PRESERVE_COMMIT_ORDER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_PRESERVE_COMMIT_ORDER] = 398 ;
      ObSysVars[398].base_value_ = "0" ;
    ObSysVars[398].alias_ = "OB_SV_SLAVE_PRESERVE_COMMIT_ORDER" ;
    }();

    [&] (){
      ObSysVars[399].default_value_ = "0" ;
      ObSysVars[399].info_ = "Cause the replication SQL thread to verify data using the checksums read from the relay log" ;
      ObSysVars[399].name_ = "slave_sql_verify_checksum" ;
      ObSysVars[399].data_type_ = ObIntType ;
      ObSysVars[399].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[399].id_ = SYS_VAR_SLAVE_SQL_VERIFY_CHECKSUM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_SQL_VERIFY_CHECKSUM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_SQL_VERIFY_CHECKSUM] = 399 ;
      ObSysVars[399].base_value_ = "0" ;
    ObSysVars[399].alias_ = "OB_SV_SLAVE_SQL_VERIFY_CHECKSUM" ;
    }();

    [&] (){
      ObSysVars[400].default_value_ = "10" ;
      ObSysVars[400].info_ = "Deadlock or because the transaction's execution time exceeded InnoDB's innodb_lock_wait_timeout or NDB's TransactionDeadlockDetectionTimeout or TransactionInactiveTimeout, it automatically retries slave_transaction_retries times before stopping with an error. Transactions with a non-temporary error are not retried" ;
      ObSysVars[400].name_ = "slave_transaction_retries" ;
      ObSysVars[400].data_type_ = ObUInt64Type ;
      ObSysVars[400].min_val_ = "0" ;
      ObSysVars[400].max_val_ = "18446744073709551615" ;
      ObSysVars[400].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[400].id_ = SYS_VAR_SLAVE_TRANSACTION_RETRIES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_TRANSACTION_RETRIES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_TRANSACTION_RETRIES] = 400 ;
      ObSysVars[400].base_value_ = "10" ;
    ObSysVars[400].alias_ = "OB_SV_SLAVE_TRANSACTION_RETRIES" ;
    }();

    [&] (){
      ObSysVars[401].default_value_ = "0" ;
      ObSysVars[401].info_ = "The number of events from the source that a replica should ski" ;
      ObSysVars[401].name_ = "sql_slave_skip_counter" ;
      ...
      ObSysVars[401].id_ = SYS_VAR_SQL_SLAVE_SKIP_COUNTER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_SLAVE_SKIP_COUNTER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SQL_SLAVE_SKIP_COUNTER] = 401 ;
      ObSysVars[401].base_value_ = "0" ;
    ObSysVars[401].alias_ = "OB_SV_SQL_SLAVE_SKIP_COUNTER" ;
    }();

    [&] (){
      ObSysVars[402].default_value_ = "0" ;
      ObSysVars[402].info_ = "The crash recovery mode, typically only changed in serious troubleshooting situations. Possible values are from 0 to 6" ;
      ObSysVars[402].name_ = "innodb_force_recovery" ;
      ObSysVars[402].data_type_ = ObIntType ;
      ObSysVars[402].min_val_ = "0" ;
      ObSysVars[402].max_val_ = "6" ;
      ObSysVars[402].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[402].id_ = SYS_VAR_INNODB_FORCE_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FORCE_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FORCE_RECOVERY] = 402 ;
      ObSysVars[402].base_value_ = "0" ;
    ObSysVars[402].alias_ = "OB_SV_INNODB_FORCE_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[403].default_value_ = "0" ;
      ObSysVars[403].info_ = "Tells the replica server not to start the replication threads when the server starts" ;
      ObSysVars[403].name_ = "skip_slave_start" ;
      ObSysVars[403].data_type_ = ObIntType ;
      ObSysVars[403].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[403].id_ = SYS_VAR_SKIP_SLAVE_START ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_SLAVE_START)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_SLAVE_START] = 403 ;
      ObSysVars[403].base_value_ = "0" ;
    ObSysVars[403].alias_ = "OB_SV_SKIP_SLAVE_START" ;
    }();

    [&] (){
      ObSysVars[404].default_value_ = "" ;
      ObSysVars[404].info_ = "The name of the directory where the replica creates temporary files" ;
      ObSysVars[404].name_ = "slave_load_tmpdir" ;
      ObSysVars[404].data_type_ = ObVarcharType ;
      ObSysVars[404].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[404].id_ = SYS_VAR_SLAVE_LOAD_TMPDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_LOAD_TMPDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_LOAD_TMPDIR] = 404 ;
      ObSysVars[404].base_value_ = "" ;
    ObSysVars[404].alias_ = "OB_SV_SLAVE_LOAD_TMPDIR" ;
    }();

    [&] (){
      ObSysVars[405].default_value_ = "OFF" ;
      ObSysVars[405].info_ = "This variable causes the replication SQL thread to continue replication when a statement returns any of the errors listed in the variable value" ;
      ObSysVars[405].name_ = "slave_skip_errors" ;
      ObSysVars[405].data_type_ = ObVarcharType ;
      ObSysVars[405].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[405].id_ = SYS_VAR_SLAVE_SKIP_ERRORS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_SKIP_ERRORS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_SKIP_ERRORS] = 405 ;
      ObSysVars[405].base_value_ = "OFF" ;
    ObSysVars[405].alias_ = "OB_SV_SLAVE_SKIP_ERRORS" ;
    }();

    [&] (){
      ObSysVars[406].default_value_ = "0" ;
      ObSysVars[406].info_ = "Enables sync debug checking for the InnoDB storage engine" ;
      ObSysVars[406].name_ = "innodb_sync_debug" ;
      ObSysVars[406].data_type_ = ObIntType ;
      ObSysVars[406].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[406].id_ = SYS_VAR_INNODB_SYNC_DEBUG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SYNC_DEBUG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SYNC_DEBUG] = 406 ;
      ObSysVars[406].base_value_ = "0" ;
    ObSysVars[406].alias_ = "OB_SV_INNODB_SYNC_DEBUG" ;
    }();

    [&] (){
      ObSysVars[407].default_value_ = "45" ;
      ObSysVars[407].info_ = "control default collation for utf8mb4" ;
      ObSysVars[407].name_ = "default_collation_for_utf8mb4" ;
      ObSysVars[407].data_type_ = ObIntType ;
      ObSysVars[407].to_show_str_func_ = "ObSysVarToStrFuncs::to_str_collation" ;
      ObSysVars[407].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[407].base_class_ = "ObCharsetSysVar" ;
      ObSysVars[407].to_select_obj_func_ = "ObSysVarToObjFuncs::to_obj_collation" ;
      ObSysVars[407].on_check_and_convert_func_ = "ObSysVarOnCheckFuncs::check_default_value_for_utf8mb4" ;
      ObSysVars[407].id_ = SYS_VAR_DEFAULT_COLLATION_FOR_UTF8MB4 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_COLLATION_FOR_UTF8MB4)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_COLLATION_FOR_UTF8MB4] = 407 ;
      ObSysVars[407].get_meta_type_func_ = "ObSysVarGetMetaTypeFuncs::get_meta_type_varchar" ;
      ObSysVars[407].base_value_ = "45" ;
    ObSysVars[407].alias_ = "OB_SV_DEFAULT_COLLATION_FOR_UTF8MB4" ;
    }();

    [&] (){
      ObSysVars[408].default_value_ = "0" ;
      ObSysVars[408].info_ = "control wether to enable old charset aggregation rule" ;
      ObSysVars[408].name_ = "_enable_old_charset_aggregation" ;
      ObSysVars[408].data_type_ = ObIntType ;
      ObSysVars[408].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PL ;
      ObSysVars[408].id_ = SYS_VAR__ENABLE_OLD_CHARSET_AGGREGATION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__ENABLE_OLD_CHARSET_AGGREGATION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__ENABLE_OLD_CHARSET_AGGREGATION] = 408 ;
      ObSysVars[408].base_value_ = "0" ;
    ObSysVars[408].alias_ = "OB_SV__ENABLE_OLD_CHARSET_AGGREGATION" ;
    }();

    [&] (){
      ObSysVars[409].default_value_ = "0" ;
      ObSysVars[409].info_ = "To set whether the SQL for the current session is logged into the SQL plan monitor." ;
      ObSysVars[409].name_ = "enable_sql_plan_monitor" ;
      ObSysVars[409].data_type_ = ObIntType ;
      ObSysVars[409].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN ;
      ObSysVars[409].id_ = SYS_VAR_ENABLE_SQL_PLAN_MONITOR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_ENABLE_SQL_PLAN_MONITOR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_ENABLE_SQL_PLAN_MONITOR] = 409 ;
      ObSysVars[409].base_value_ = "0" ;
    ObSysVars[409].alias_ = "OB_SV_ENABLE_SQL_PLAN_MONITOR" ;
    }();

    [&] (){
      ObSysVars[410].default_value_ = "0" ;
      ObSysVars[410].info_ = "The value to be used by the following INSERT or ALTER TABLE statement when inserting an AUTO_INCREMENT value. Merely simulates MySQL 5.7." ;
      ObSysVars[410].name_ = "insert_id" ;
      ObSysVars[410].data_type_ = ObIntType ;
      ObSysVars[410].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[410].id_ = SYS_VAR_INSERT_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INSERT_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INSERT_ID] = 410 ;
      ObSysVars[410].base_value_ = "0" ;
    ObSysVars[410].alias_ = "OB_SV_INSERT_ID" ;
    }();

    [&] (){
      ObSysVars[411].default_value_ = "262144" ;
      ObSysVars[411].info_ = "The minimum size of the buffer that is used for plain index scans, range index scans, and joins that do not use indexes and thus perform full table scans. Merely simulates MySQL 5.7." ;
      ObSysVars[411].name_ = "join_buffer_size" ;
      ...
      ObSysVars[411].id_ = SYS_VAR_JOIN_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_JOIN_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_JOIN_BUFFER_SIZE] = 411 ;
      ObSysVars[411].base_value_ = "262144" ;
    ObSysVars[411].alias_ = "OB_SV_JOIN_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[412].default_value_ = "18446744073709547520" ;
      ObSysVars[412].info_ = "Do not permit statements that probably need to examine more than max_join_size rows (for single-table statements) or row combinations (for multiple-table statements) or that are likely to do more than max_join_size disk seeks. Merely simulates MySQL 5.7." ;
      ObSysVars[412].name_ = "max_join_size" ;
      ObSysVars[412].data_type_ = ObUInt64Type ;
      ObSysVars[412].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[412].id_ = SYS_VAR_MAX_JOIN_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_JOIN_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_JOIN_SIZE] = 412 ;
      ObSysVars[412].base_value_ = "18446744073709547520" ;
    ObSysVars[412].alias_ = "OB_SV_MAX_JOIN_SIZE" ;
    }();

    [&] (){
      ObSysVars[413].default_value_ = "1024" ;
      ObSysVars[413].info_ = "The cutoff on the size of index values that determines which filesort algorithm to use. Merely simulates MySQL 5.7." ;
      ObSysVars[413].name_ = "max_length_for_sort_data" ;
      ...
      ObSysVars[413].id_ = SYS_VAR_MAX_LENGTH_FOR_SORT_DATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_LENGTH_FOR_SORT_DATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_LENGTH_FOR_SORT_DATA] = 413 ;
      ObSysVars[413].base_value_ = "1024" ;
    ObSysVars[413].alias_ = "OB_SV_MAX_LENGTH_FOR_SORT_DATA" ;
    }();

    [&] (){
      ObSysVars[414].default_value_ = "16382" ;
      ObSysVars[414].info_ = "This variable limits the total number of prepared statements in the server. Merely simulates MySQL 5.7." ;
      ObSysVars[414].name_ = "max_prepared_stmt_count" ;
      ObSysVars[414].data_type_ = ObIntType ;
      ObSysVars[414].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[414].id_ = SYS_VAR_MAX_PREPARED_STMT_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_PREPARED_STMT_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_PREPARED_STMT_COUNT] = 414 ;
      ObSysVars[414].base_value_ = "16382" ;
    ObSysVars[414].alias_ = "OB_SV_MAX_PREPARED_STMT_COUNT" ;
    }();

    [&] (){
      ObSysVars[415].default_value_ = "1024" ;
      ObSysVars[415].info_ = "The number of bytes to use when sorting data values. Merely simulates MySQL 5.7." ;
      ObSysVars[415].name_ = "max_sort_length" ;
      ...
      ObSysVars[415].id_ = SYS_VAR_MAX_SORT_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_SORT_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_SORT_LENGTH] = 415 ;
      ObSysVars[415].base_value_ = "1024" ;
    ObSysVars[415].alias_ = "OB_SV_MAX_SORT_LENGTH" ;
    }();

    [&] (){
      ObSysVars[416].default_value_ = "0" ;
      ObSysVars[416].info_ = "Queries that examine fewer than this number of rows are not logged to the slow query log. Merely simulates MySQL 5.7." ;
      ObSysVars[416].name_ = "min_examined_row_limit" ;
      ...
      ObSysVars[416].id_ = SYS_VAR_MIN_EXAMINED_ROW_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MIN_EXAMINED_ROW_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MIN_EXAMINED_ROW_LIMIT] = 416 ;
      ObSysVars[416].base_value_ = "0" ;
    ObSysVars[416].alias_ = "OB_SV_MIN_EXAMINED_ROW_LIMIT" ;
    }();

    [&] (){
      ObSysVars[417].default_value_ = "256" ;
      ObSysVars[417].info_ = "This variable has no effect. Merely simulates MySQL 5.7." ;
      ObSysVars[417].name_ = "multi_range_count" ;
      ...
      ObSysVars[417].id_ = SYS_VAR_MULTI_RANGE_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MULTI_RANGE_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MULTI_RANGE_COUNT] = 417 ;
      ObSysVars[417].base_value_ = "256" ;
    ObSysVars[417].alias_ = "OB_SV_MULTI_RANGE_COUNT" ;
    }();

    [&] (){
      ObSysVars[418].default_value_ = "30" ;
      ObSysVars[418].info_ = "The number of seconds X Plugin waits for the first packet to be received from newly connected clients. Merely simulates MySQL 5.7." ;
      ObSysVars[418].name_ = "mysqlx_connect_timeout" ;
      ObSysVars[418].data_type_ = ObIntType ;
      ObSysVars[418].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[418].id_ = SYS_VAR_MYSQLX_CONNECT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_CONNECT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_CONNECT_TIMEOUT] = 418 ;
      ObSysVars[418].base_value_ = "30" ;
    ObSysVars[418].alias_ = "OB_SV_MYSQLX_CONNECT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[419].default_value_ = "60" ;
      ObSysVars[419].info_ = "The number of seconds after which idle worker threads are terminated. Merely simulates MySQL 5.7." ;
      ObSysVars[419].name_ = "mysqlx_idle_worker_thread_timeout" ;
      ObSysVars[419].data_type_ = ObIntType ;
      ObSysVars[419].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[419].id_ = SYS_VAR_MYSQLX_IDLE_WORKER_THREAD_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_IDLE_WORKER_THREAD_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_IDLE_WORKER_THREAD_TIMEOUT] = 419 ;
      ObSysVars[419].base_value_ = "60" ;
    ObSysVars[419].alias_ = "OB_SV_MYSQLX_IDLE_WORKER_THREAD_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[420].default_value_ = "67108864" ;
      ObSysVars[420].info_ = "The maximum size of network packets that can be received by X Plugin. Merely simulates MySQL 5.7." ;
      ObSysVars[420].name_ = "mysqlx_max_allowed_packet" ;
      ObSysVars[420].data_type_ = ObIntType ;
      ObSysVars[420].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[420].id_ = SYS_VAR_MYSQLX_MAX_ALLOWED_PACKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_MAX_ALLOWED_PACKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_MAX_ALLOWED_PACKET] = 420 ;
      ObSysVars[420].base_value_ = "67108864" ;
    ObSysVars[420].alias_ = "OB_SV_MYSQLX_MAX_ALLOWED_PACKET" ;
    }();

    [&] (){
      ObSysVars[421].default_value_ = "100" ;
      ObSysVars[421].info_ = "The maximum number of concurrent client connections X Plugin can accept. Merely simulates MySQL 5.7." ;
      ObSysVars[421].name_ = "mysqlx_max_connections" ;
      ObSysVars[421].data_type_ = ObIntType ;
      ObSysVars[421].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[421].id_ = SYS_VAR_MYSQLX_MAX_CONNECTIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_MAX_CONNECTIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_MAX_CONNECTIONS] = 421 ;
      ObSysVars[421].base_value_ = "100" ;
    ObSysVars[421].alias_ = "OB_SV_MYSQLX_MAX_CONNECTIONS" ;
    }();

    [&] (){
      ObSysVars[422].default_value_ = "2" ;
      ObSysVars[422].info_ = "The minimum number of worker threads used by X Plugin for handling client requests. Merely simulates MySQL 5.7." ;
      ObSysVars[422].name_ = "mysqlx_min_worker_threads" ;
      ObSysVars[422].data_type_ = ObIntType ;
      ObSysVars[422].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[422].id_ = SYS_VAR_MYSQLX_MIN_WORKER_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_MIN_WORKER_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_MIN_WORKER_THREADS] = 422 ;
      ObSysVars[422].base_value_ = "2" ;
    ObSysVars[422].alias_ = "OB_SV_MYSQLX_MIN_WORKER_THREADS" ;
    }();

    [&] (){
      ObSysVars[423].default_value_ = "0" ;
      ObSysVars[423].info_ = "The variable determines which SHOW PROCESSLIST implementation to use. Merely simulates MySQL 5.7." ;
      ObSysVars[423].name_ = "performance_schema_show_processlist" ;
      ObSysVars[423].data_type_ = ObIntType ;
      ObSysVars[423].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[423].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SHOW_PROCESSLIST ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SHOW_PROCESSLIST)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SHOW_PROCESSLIST] = 423 ;
      ObSysVars[423].base_value_ = "0" ;
    ObSysVars[423].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SHOW_PROCESSLIST" ;
    }();

    [&] (){
      ObSysVars[424].default_value_ = "8192" ;
      ObSysVars[424].info_ = "The allocation size in bytes of memory blocks that are allocated for objects created during statement parsing and execution. Merely simulates MySQL 5.7." ;
      ObSysVars[424].name_ = "query_alloc_block_size" ;
      ...
      ObSysVars[424].id_ = SYS_VAR_QUERY_ALLOC_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_QUERY_ALLOC_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_QUERY_ALLOC_BLOCK_SIZE] = 424 ;
      ObSysVars[424].base_value_ = "8192" ;
    ObSysVars[424].alias_ = "OB_SV_QUERY_ALLOC_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[425].default_value_ = "8192" ;
      ObSysVars[425].info_ = "The size in bytes of the persistent buffer used for statement parsing and execution. Merely simulates MySQL 5.7." ;
      ObSysVars[425].name_ = "query_prealloc_size" ;
      ...
      ObSysVars[425].id_ = SYS_VAR_QUERY_PREALLOC_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_QUERY_PREALLOC_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_QUERY_PREALLOC_SIZE] = 425 ;
      ObSysVars[425].base_value_ = "8192" ;
    ObSysVars[425].alias_ = "OB_SV_QUERY_PREALLOC_SIZE" ;
    }();

    [&] (){
      ObSysVars[426].default_value_ = "0" ;
      ObSysVars[426].info_ = "Whether the slow query log is enabled. Merely simulates MySQL 5.7." ;
      ObSysVars[426].name_ = "slow_query_log" ;
      ObSysVars[426].data_type_ = ObIntType ;
      ObSysVars[426].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[426].id_ = SYS_VAR_SLOW_QUERY_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLOW_QUERY_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLOW_QUERY_LOG] = 426 ;
      ObSysVars[426].base_value_ = "0" ;
    ObSysVars[426].alias_ = "OB_SV_SLOW_QUERY_LOG" ;
    }();

    [&] (){
      ObSysVars[427].default_value_ = "/usr/local/mysql/data/obrd-slow.log" ;
      ObSysVars[427].info_ = "The name of the slow query log file. Merely simulates MySQL 5.7." ;
      ObSysVars[427].name_ = "slow_query_log_file" ;
      ObSysVars[427].data_type_ = ObVarcharType ;
      ObSysVars[427].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[427].id_ = SYS_VAR_SLOW_QUERY_LOG_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLOW_QUERY_LOG_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLOW_QUERY_LOG_FILE] = 427 ;
      ObSysVars[427].base_value_ = "/usr/local/mysql/data/obrd-slow.log" ;
    ObSysVars[427].alias_ = "OB_SV_SLOW_QUERY_LOG_FILE" ;
    }();

    [&] (){
      ObSysVars[428].default_value_ = "262144" ;
      ObSysVars[428].info_ = "Each session that must perform a sort allocates a buffer of this size. Merely simulates MySQL 5.7." ;
      ObSysVars[428].name_ = "sort_buffer_size" ;
      ...
      ObSysVars[428].id_ = SYS_VAR_SORT_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SORT_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SORT_BUFFER_SIZE] = 428 ;
      ObSysVars[428].base_value_ = "262144" ;
    ObSysVars[428].alias_ = "OB_SV_SORT_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[429].default_value_ = "0" ;
      ObSysVars[429].info_ = "If enabled, sql_buffer_result forces results from SELECT statements to be put into temporary tables. Merely simulates MySQL 5.7." ;
      ObSysVars[429].name_ = "sql_buffer_result" ;
      ...
      ObSysVars[429].id_ = SYS_VAR_SQL_BUFFER_RESULT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_BUFFER_RESULT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SQL_BUFFER_RESULT] = 429 ;
      ObSysVars[429].base_value_ = "0" ;
    ObSysVars[429].alias_ = "OB_SV_SQL_BUFFER_RESULT" ;
    }();

    [&] (){
      ObSysVars[430].default_value_ = "32768" ;
      ObSysVars[430].info_ = "binlog_cache_size sets the size for the transaction cache only. Merely simulates MySQL 5.7." ;
      ObSysVars[430].name_ = "binlog_cache_size" ;
      ObSysVars[430].data_type_ = ObIntType ;
      ObSysVars[430].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[430].id_ = SYS_VAR_BINLOG_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_CACHE_SIZE] = 430 ;
      ObSysVars[430].base_value_ = "32768" ;
    ObSysVars[430].alias_ = "OB_SV_BINLOG_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[431].default_value_ = "0" ;
      ObSysVars[431].info_ = "Enabling binlog_direct_non_transactional_updates causes updates to nontransactional tables to be written directly to the binary log, rather than to the transaction cache. Merely simulates MySQL 5.7." ;
      ObSysVars[431].name_ = "binlog_direct_non_transactional_updates" ;
      ...
      ObSysVars[431].id_ = SYS_VAR_BINLOG_DIRECT_NON_TRANSACTIONAL_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_DIRECT_NON_TRANSACTIONAL_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_DIRECT_NON_TRANSACTIONAL_UPDATES] = 431 ;
      ObSysVars[431].base_value_ = "0" ;
    ObSysVars[431].alias_ = "OB_SV_BINLOG_DIRECT_NON_TRANSACTIONAL_UPDATES" ;
    }();

    [&] (){
      ObSysVars[432].default_value_ = "1" ;
      ObSysVars[432].info_ = "Controls what happens when the server encounters an error. Merely simulates MySQL 5.7." ;
      ObSysVars[432].name_ = "binlog_error_action" ;
      ObSysVars[432].data_type_ = ObIntType ;
      ObSysVars[432].enum_names_ = "[u'IGNORE_ERROR', u'ABORT_SERVER']" ;
      ObSysVars[432].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[432].id_ = SYS_VAR_BINLOG_ERROR_ACTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_ERROR_ACTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_ERROR_ACTION] = 432 ;
      ObSysVars[432].base_value_ = "1" ;
    ObSysVars[432].alias_ = "OB_SV_BINLOG_ERROR_ACTION" ;
    }();

    [&] (){
      ObSysVars[433].default_value_ = "0" ;
      ObSysVars[433].info_ = "Controls how many microseconds the binary log commit waits before synchronizing the binary log file to disk. Merely simulates MySQL 5.7." ;
      ObSysVars[433].name_ = "binlog_group_commit_sync_delay" ;
      ObSysVars[433].data_type_ = ObIntType ;
      ObSysVars[433].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[433].id_ = SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_DELAY] = 433 ;
      ObSysVars[433].base_value_ = "0" ;
    ObSysVars[433].alias_ = "OB_SV_BINLOG_GROUP_COMMIT_SYNC_DELAY" ;
    }();

    [&] (){
      ObSysVars[434].default_value_ = "0" ;
      ObSysVars[434].info_ = "The maximum number of transactions to wait for before aborting the current delay as specified by binlog_group_commit_sync_delay. Merely simulates MySQL 5.7." ;
      ObSysVars[434].name_ = "binlog_group_commit_sync_no_delay_count" ;
      ObSysVars[434].data_type_ = ObIntType ;
      ObSysVars[434].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[434].id_ = SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_NO_DELAY_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_NO_DELAY_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_GROUP_COMMIT_SYNC_NO_DELAY_COUNT] = 434 ;
      ObSysVars[434].base_value_ = "0" ;
    ObSysVars[434].alias_ = "OB_SV_BINLOG_GROUP_COMMIT_SYNC_NO_DELAY_COUNT" ;
    }();

    [&] (){
      ObSysVars[435].default_value_ = "0" ;
      ObSysVars[435].info_ = "This variable no longer has any effect. Merely simulates MySQL 5.7." ;
      ObSysVars[435].name_ = "binlog_max_flush_queue_time" ;
      ObSysVars[435].data_type_ = ObIntType ;
      ObSysVars[435].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[435].id_ = SYS_VAR_BINLOG_MAX_FLUSH_QUEUE_TIME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_MAX_FLUSH_QUEUE_TIME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_MAX_FLUSH_QUEUE_TIME] = 435 ;
      ObSysVars[435].base_value_ = "0" ;
    ObSysVars[435].alias_ = "OB_SV_BINLOG_MAX_FLUSH_QUEUE_TIME" ;
    }();

    [&] (){
      ObSysVars[436].default_value_ = "1" ;
      ObSysVars[436].info_ = "When this variable is enabled on a replication source server, transaction commit instructions issued to storage engines are serialized on a single thread. Merely simulates MySQL 5.7." ;
      ObSysVars[436].name_ = "binlog_order_commits" ;
      ObSysVars[436].data_type_ = ObIntType ;
      ObSysVars[436].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[436].id_ = SYS_VAR_BINLOG_ORDER_COMMITS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_ORDER_COMMITS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_ORDER_COMMITS] = 436 ;
      ObSysVars[436].base_value_ = "1" ;
    ObSysVars[436].alias_ = "OB_SV_BINLOG_ORDER_COMMITS" ;
    }();

    [&] (){
      ObSysVars[437].default_value_ = "32768" ;
      ObSysVars[437].info_ = "This variable determines the size of the cache for the binary log to hold nontransactional statements issued during a transaction. Merely simulates MySQL 5.7." ;
      ObSysVars[437].name_ = "binlog_stmt_cache_size" ;
      ObSysVars[437].data_type_ = ObIntType ;
      ObSysVars[437].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[437].id_ = SYS_VAR_BINLOG_STMT_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_STMT_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_STMT_CACHE_SIZE] = 437 ;
      ObSysVars[437].base_value_ = "32768" ;
    ObSysVars[437].alias_ = "OB_SV_BINLOG_STMT_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[438].default_value_ = "25000" ;
      ObSysVars[438].info_ = "Sets an upper limit on the number of row hashes which are kept in memory and used for looking up the transaction that last modified a given row. Merely simulates MySQL 5.7." ;
      ObSysVars[438].name_ = "binlog_transaction_dependency_history_size" ;
      ObSysVars[438].data_type_ = ObIntType ;
      ObSysVars[438].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[438].id_ = SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_HISTORY_SIZE] = 438 ;
      ObSysVars[438].base_value_ = "25000" ;
    ObSysVars[438].alias_ = "OB_SV_BINLOG_TRANSACTION_DEPENDENCY_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[439].default_value_ = "0" ;
      ObSysVars[439].info_ = "The source of dependency information that the source uses to determine which transactions can be executed in parallel by the replica's multithreaded applier. Merely simulates MySQL 5.7." ;
      ObSysVars[439].name_ = "binlog_transaction_dependency_tracking" ;
      ObSysVars[439].data_type_ = ObIntType ;
      ObSysVars[439].enum_names_ = "[u'COMMIT_ORDER', u'WRITESET', u'WRITESET_SESSION']" ;
      ObSysVars[439].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[439].id_ = SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_TRACKING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_TRACKING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_TRANSACTION_DEPENDENCY_TRACKING] = 439 ;
      ObSysVars[439].base_value_ = "0" ;
    ObSysVars[439].alias_ = "OB_SV_BINLOG_TRANSACTION_DEPENDENCY_TRACKING" ;
    }();

    [&] (){
      ObSysVars[440].default_value_ = "0" ;
      ObSysVars[440].info_ = "The number of days for automatic binary log file removal. Merely simulates MySQL 5.7." ;
      ObSysVars[440].name_ = "expire_logs_days" ;
      ObSysVars[440].data_type_ = ObIntType ;
      ObSysVars[440].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[440].id_ = SYS_VAR_EXPIRE_LOGS_DAYS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EXPIRE_LOGS_DAYS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EXPIRE_LOGS_DAYS] = 440 ;
      ObSysVars[440].base_value_ = "0" ;
    ObSysVars[440].alias_ = "OB_SV_EXPIRE_LOGS_DAYS" ;
    }();

    [&] (){
      ObSysVars[441].default_value_ = "1" ;
      ObSysVars[441].info_ = "Write and flush the logs every N seconds. Merely simulates MySQL 5.7." ;
      ObSysVars[441].name_ = "innodb_flush_log_at_timeout" ;
      ObSysVars[441].data_type_ = ObIntType ;
      ObSysVars[441].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[441].id_ = SYS_VAR_INNODB_FLUSH_LOG_AT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSH_LOG_AT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSH_LOG_AT_TIMEOUT] = 441 ;
      ObSysVars[441].base_value_ = "1" ;
    ObSysVars[441].alias_ = "OB_SV_INNODB_FLUSH_LOG_AT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[442].default_value_ = "1" ;
      ObSysVars[442].info_ = "Controls the balance between strict ACID compliance for commit operations and higher performance. Merely simulates MySQL 5.7." ;
      ObSysVars[442].name_ = "innodb_flush_log_at_trx_commit" ;
      ObSysVars[442].data_type_ = ObIntType ;
      ObSysVars[442].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[442].id_ = SYS_VAR_INNODB_FLUSH_LOG_AT_TRX_COMMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FLUSH_LOG_AT_TRX_COMMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FLUSH_LOG_AT_TRX_COMMIT] = 442 ;
      ObSysVars[442].base_value_ = "1" ;
    ObSysVars[442].alias_ = "OB_SV_INNODB_FLUSH_LOG_AT_TRX_COMMIT" ;
    }();

    [&] (){
      ObSysVars[443].default_value_ = "0" ;
      ObSysVars[443].info_ = "Enable this debug option to force InnoDB to write a checkpoint. Merely simulates MySQL 5.7." ;
      ObSysVars[443].name_ = "innodb_log_checkpoint_now" ;
      ObSysVars[443].data_type_ = ObIntType ;
      ObSysVars[443].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[443].id_ = SYS_VAR_INNODB_LOG_CHECKPOINT_NOW ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_CHECKPOINT_NOW)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_CHECKPOINT_NOW] = 443 ;
      ObSysVars[443].base_value_ = "0" ;
    ObSysVars[443].alias_ = "OB_SV_INNODB_LOG_CHECKPOINT_NOW" ;
    }();

    [&] (){
      ObSysVars[444].default_value_ = "1" ;
      ObSysVars[444].info_ = "Enables or disables checksums for redo log pages. Merely simulates MySQL 5.7." ;
      ObSysVars[444].name_ = "innodb_log_checksums" ;
      ObSysVars[444].data_type_ = ObIntType ;
      ObSysVars[444].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[444].id_ = SYS_VAR_INNODB_LOG_CHECKSUMS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_CHECKSUMS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_CHECKSUMS] = 444 ;
      ObSysVars[444].base_value_ = "1" ;
    ObSysVars[444].alias_ = "OB_SV_INNODB_LOG_CHECKSUMS" ;
    }();

    [&] (){
      ObSysVars[445].default_value_ = "1" ;
      ObSysVars[445].info_ = "Specifies whether images of re-compressed pages are written to the redo log. Merely simulates MySQL 5.7." ;
      ObSysVars[445].name_ = "innodb_log_compressed_pages" ;
      ObSysVars[445].data_type_ = ObIntType ;
      ObSysVars[445].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[445].id_ = SYS_VAR_INNODB_LOG_COMPRESSED_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_COMPRESSED_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_COMPRESSED_PAGES] = 445 ;
      ObSysVars[445].base_value_ = "1" ;
    ObSysVars[445].alias_ = "OB_SV_INNODB_LOG_COMPRESSED_PAGES" ;
    }();

    [&] (){
      ObSysVars[446].default_value_ = "8192" ;
      ObSysVars[446].info_ = "Defines the write-ahead block size for the redo log, in bytes. Merely simulates MySQL 5.7." ;
      ObSysVars[446].name_ = "innodb_log_write_ahead_size" ;
      ObSysVars[446].data_type_ = ObIntType ;
      ObSysVars[446].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[446].id_ = SYS_VAR_INNODB_LOG_WRITE_AHEAD_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_WRITE_AHEAD_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_WRITE_AHEAD_SIZE] = 446 ;
      ObSysVars[446].base_value_ = "8192" ;
    ObSysVars[446].alias_ = "OB_SV_INNODB_LOG_WRITE_AHEAD_SIZE" ;
    }();

    [&] (){
      ObSysVars[447].default_value_ = "1073741824" ;
      ObSysVars[447].info_ = "Defines a threshold size for undo tablespaces. Merely simulates MySQL 5.7." ;
      ObSysVars[447].name_ = "innodb_max_undo_log_size" ;
      ObSysVars[447].data_type_ = ObIntType ;
      ObSysVars[447].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[447].id_ = SYS_VAR_INNODB_MAX_UNDO_LOG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_MAX_UNDO_LOG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_MAX_UNDO_LOG_SIZE] = 447 ;
      ObSysVars[447].base_value_ = "1073741824" ;
    ObSysVars[447].alias_ = "OB_SV_INNODB_MAX_UNDO_LOG_SIZE" ;
    }();

    [&] (){
      ObSysVars[448].default_value_ = "134217728" ;
      ObSysVars[448].info_ = "Specifies an upper limit in bytes on the size of the temporary log files used during online DDL operations for InnoDB tables. Merely simulates MySQL 5.7." ;
      ObSysVars[448].name_ = "innodb_online_alter_log_max_size" ;
      ObSysVars[448].data_type_ = ObIntType ;
      ObSysVars[448].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[448].id_ = SYS_VAR_INNODB_ONLINE_ALTER_LOG_MAX_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_ONLINE_ALTER_LOG_MAX_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_ONLINE_ALTER_LOG_MAX_SIZE] = 448 ;
      ObSysVars[448].base_value_ = "134217728" ;
    ObSysVars[448].alias_ = "OB_SV_INNODB_ONLINE_ALTER_LOG_MAX_SIZE" ;
    }();

    [&] (){
      ObSysVars[449].default_value_ = "0" ;
      ObSysVars[449].info_ = "When enabled, undo tablespaces that exceed the threshold value defined by innodb_max_undo_log_size are marked for truncation. Merely simulates MySQL 5.7." ;
      ObSysVars[449].name_ = "innodb_undo_log_truncate" ;
      ObSysVars[449].data_type_ = ObIntType ;
      ObSysVars[449].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[449].id_ = SYS_VAR_INNODB_UNDO_LOG_TRUNCATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_LOG_TRUNCATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_LOG_TRUNCATE] = 449 ;
      ObSysVars[449].base_value_ = "0" ;
    ObSysVars[449].alias_ = "OB_SV_INNODB_UNDO_LOG_TRUNCATE" ;
    }();

    [&] (){
      ObSysVars[450].default_value_ = "128" ;
      ObSysVars[450].info_ = "Defines the number of rollback segments used by InnoDB. Merely simulates MySQL 5.7." ;
      ObSysVars[450].name_ = "innodb_undo_logs" ;
      ObSysVars[450].data_type_ = ObIntType ;
      ObSysVars[450].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[450].id_ = SYS_VAR_INNODB_UNDO_LOGS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_LOGS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_LOGS] = 450 ;
      ObSysVars[450].base_value_ = "128" ;
    ObSysVars[450].alias_ = "OB_SV_INNODB_UNDO_LOGS" ;
    }();

    [&] (){
      ObSysVars[451].default_value_ = "0" ;
      ObSysVars[451].info_ = "It controls whether stored function creators can be trusted not to create stored functions that causes unsafe events to be written to the binary log. Merely simulates MySQL 5.7." ;
      ObSysVars[451].name_ = "log_bin_trust_function_creators" ;
      ObSysVars[451].data_type_ = ObIntType ;
      ObSysVars[451].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[451].id_ = SYS_VAR_LOG_BIN_TRUST_FUNCTION_CREATORS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_TRUST_FUNCTION_CREATORS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_TRUST_FUNCTION_CREATORS] = 451 ;
      ObSysVars[451].base_value_ = "0" ;
    ObSysVars[451].alias_ = "OB_SV_LOG_BIN_TRUST_FUNCTION_CREATORS" ;
    }();

    [&] (){
      ObSysVars[452].default_value_ = "0" ;
      ObSysVars[452].info_ = "Whether Version 2 binary logging is in use. Merely simulates MySQL 5.7." ;
      ObSysVars[452].name_ = "log_bin_use_v1_row_events" ;
      ObSysVars[452].data_type_ = ObIntType ;
      ObSysVars[452].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[452].id_ = SYS_VAR_LOG_BIN_USE_V1_ROW_EVENTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_USE_V1_ROW_EVENTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_USE_V1_ROW_EVENTS] = 452 ;
      ObSysVars[452].base_value_ = "0" ;
    ObSysVars[452].alias_ = "OB_SV_LOG_BIN_USE_V1_ROW_EVENTS" ;
    }();

    [&] (){
      ObSysVars[453].default_value_ = "0" ;
      ObSysVars[453].info_ = "This variable affects binary logging of user-management statements. Merely simulates MySQL 5.7." ;
      ObSysVars[453].name_ = "log_builtin_as_identified_by_password" ;
      ObSysVars[453].data_type_ = ObIntType ;
      ObSysVars[453].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[453].id_ = SYS_VAR_LOG_BUILTIN_AS_IDENTIFIED_BY_PASSWORD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BUILTIN_AS_IDENTIFIED_BY_PASSWORD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BUILTIN_AS_IDENTIFIED_BY_PASSWORD] = 453 ;
      ObSysVars[453].base_value_ = "0" ;
    ObSysVars[453].alias_ = "OB_SV_LOG_BUILTIN_AS_IDENTIFIED_BY_PASSWORD" ;
    }();

    [&] (){
      ObSysVars[454].default_value_ = "18446744073709500416" ;
      ObSysVars[454].info_ = "If a transaction requires more than this many bytes, the server generates a Multi-statement transaction required more than 'max_binlog_cache_size' bytes of storage error. Merely simulates MySQL 5.7." ;
      ObSysVars[454].name_ = "max_binlog_cache_size" ;
      ObSysVars[454].data_type_ = ObUInt64Type ;
      ObSysVars[454].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[454].id_ = SYS_VAR_MAX_BINLOG_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_BINLOG_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_BINLOG_CACHE_SIZE] = 454 ;
      ObSysVars[454].base_value_ = "18446744073709500416" ;
    ObSysVars[454].alias_ = "OB_SV_MAX_BINLOG_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[455].default_value_ = "1073741824" ;
      ObSysVars[455].info_ = "If a write to the binary log causes the current log file size to exceed the value of this variable, the server rotates the binary logs. Merely simulates MySQL 5.7." ;
      ObSysVars[455].name_ = "max_binlog_size" ;
      ObSysVars[455].data_type_ = ObIntType ;
      ObSysVars[455].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[455].id_ = SYS_VAR_MAX_BINLOG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_BINLOG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_BINLOG_SIZE] = 455 ;
      ObSysVars[455].base_value_ = "1073741824" ;
    ObSysVars[455].alias_ = "OB_SV_MAX_BINLOG_SIZE" ;
    }();

    [&] (){
      ObSysVars[456].default_value_ = "18446744073709500416" ;
      ObSysVars[456].info_ = "If nontransactional statements within a transaction require more than this many bytes of memory, the server generates an error. Merely simulates MySQL 5.7." ;
      ObSysVars[456].name_ = "max_binlog_stmt_cache_size" ;
      ObSysVars[456].data_type_ = ObUInt64Type ;
      ObSysVars[456].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[456].id_ = SYS_VAR_MAX_BINLOG_STMT_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_BINLOG_STMT_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_BINLOG_STMT_CACHE_SIZE] = 456 ;
      ObSysVars[456].base_value_ = "18446744073709500416" ;
    ObSysVars[456].alias_ = "OB_SV_MAX_BINLOG_STMT_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[457].default_value_ = "0" ;
      ObSysVars[457].info_ = "The size at which the server rotates relay log files automatically. Merely simulates MySQL 5.7." ;
      ObSysVars[457].name_ = "max_relay_log_size" ;
      ObSysVars[457].data_type_ = ObIntType ;
      ObSysVars[457].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[457].id_ = SYS_VAR_MAX_RELAY_LOG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_RELAY_LOG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_RELAY_LOG_SIZE] = 457 ;
      ObSysVars[457].base_value_ = "0" ;
    ObSysVars[457].alias_ = "OB_SV_MAX_RELAY_LOG_SIZE" ;
    }();

    [&] (){
      ObSysVars[458].default_value_ = "FILE" ;
      ObSysVars[458].info_ = "The setting of this variable determines whether the replica server stores its applier metadata repository as an InnoDB table in the mysql system database, or as a file in the data directory. Merely simulates MySQL 5.7." ;
      ObSysVars[458].name_ = "relay_log_info_repository" ;
      ObSysVars[458].data_type_ = ObVarcharType ;
      ObSysVars[458].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[458].id_ = SYS_VAR_RELAY_LOG_INFO_REPOSITORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INFO_REPOSITORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INFO_REPOSITORY] = 458 ;
      ObSysVars[458].base_value_ = "FILE" ;
    ObSysVars[458].alias_ = "OB_SV_RELAY_LOG_INFO_REPOSITORY" ;
    }();

    [&] (){
      ObSysVars[459].default_value_ = "1" ;
      ObSysVars[459].info_ = "Disables or enables automatic purging of relay log files as soon as they are not needed any more. Merely simulates MySQL 5.7." ;
      ObSysVars[459].name_ = "relay_log_purge" ;
      ObSysVars[459].data_type_ = ObIntType ;
      ObSysVars[459].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[459].id_ = SYS_VAR_RELAY_LOG_PURGE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_PURGE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_PURGE] = 459 ;
      ObSysVars[459].base_value_ = "1" ;
    ObSysVars[459].alias_ = "OB_SV_RELAY_LOG_PURGE" ;
    }();

    [&] (){
      ObSysVars[460].default_value_ = "1" ;
      ObSysVars[460].info_ = "Controls how often the MySQL server synchronizes the binary log to disk. Merely simulates MySQL 5.7." ;
      ObSysVars[460].name_ = "sync_binlog" ;
      ObSysVars[460].data_type_ = ObIntType ;
      ObSysVars[460].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[460].id_ = SYS_VAR_SYNC_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SYNC_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SYNC_BINLOG] = 460 ;
      ObSysVars[460].base_value_ = "1" ;
    ObSysVars[460].alias_ = "OB_SV_SYNC_BINLOG" ;
    }();

    [&] (){
      ObSysVars[461].default_value_ = "10000" ;
      ObSysVars[461].info_ = "If the value of this variable is greater than 0, the MySQL server synchronizes its relay log to disk after every sync_relay_log events are written to the relay log. Merely simulates MySQL 5.7." ;
      ObSysVars[461].name_ = "sync_relay_log" ;
      ObSysVars[461].data_type_ = ObIntType ;
      ObSysVars[461].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[461].id_ = SYS_VAR_SYNC_RELAY_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SYNC_RELAY_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SYNC_RELAY_LOG] = 461 ;
      ObSysVars[461].base_value_ = "10000" ;
    ObSysVars[461].alias_ = "OB_SV_SYNC_RELAY_LOG" ;
    }();

    [&] (){
      ObSysVars[462].default_value_ = "10000" ;
      ObSysVars[462].info_ = "Setting this variable takes effect for all replication channels immediately, including running channels. Merely simulates MySQL 5.7." ;
      ObSysVars[462].name_ = "sync_relay_log_info" ;
      ObSysVars[462].data_type_ = ObIntType ;
      ObSysVars[462].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[462].id_ = SYS_VAR_SYNC_RELAY_LOG_INFO ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SYNC_RELAY_LOG_INFO)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SYNC_RELAY_LOG_INFO] = 462 ;
      ObSysVars[462].base_value_ = "10000" ;
    ObSysVars[462].alias_ = "OB_SV_SYNC_RELAY_LOG_INFO" ;
    }();

    [&] (){
      ObSysVars[463].default_value_ = "1" ;
      ObSysVars[463].info_ = "This option is used to disable deadlock detection. Merely simulates MySQL 5.7." ;
      ObSysVars[463].name_ = "innodb_deadlock_detect" ;
      ObSysVars[463].data_type_ = ObIntType ;
      ObSysVars[463].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[463].id_ = SYS_VAR_INNODB_DEADLOCK_DETECT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DEADLOCK_DETECT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DEADLOCK_DETECT] = 463 ;
      ObSysVars[463].base_value_ = "1" ;
    ObSysVars[463].alias_ = "OB_SV_INNODB_DEADLOCK_DETECT" ;
    }();

    [&] (){
      ObSysVars[464].default_value_ = "50" ;
      ObSysVars[464].info_ = "The length of time in seconds an InnoDB transaction waits for a row lock before giving up. Merely simulates MySQL 5.7." ;
      ObSysVars[464].name_ = "innodb_lock_wait_timeout" ;
      ...
      ObSysVars[464].id_ = SYS_VAR_INNODB_LOCK_WAIT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOCK_WAIT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOCK_WAIT_TIMEOUT] = 464 ;
      ObSysVars[464].base_value_ = "50" ;
    ObSysVars[464].alias_ = "OB_SV_INNODB_LOCK_WAIT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[465].default_value_ = "0" ;
      ObSysVars[465].info_ = "When this option is enabled, information about all deadlocks in InnoDB user transactions is recorded in the mysqld error log. Merely simulates MySQL 5.7." ;
      ObSysVars[465].name_ = "innodb_print_all_deadlocks" ;
      ObSysVars[465].data_type_ = ObIntType ;
      ObSysVars[465].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[465].id_ = SYS_VAR_INNODB_PRINT_ALL_DEADLOCKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PRINT_ALL_DEADLOCKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PRINT_ALL_DEADLOCKS] = 465 ;
      ObSysVars[465].base_value_ = "0" ;
    ObSysVars[465].alias_ = "OB_SV_INNODB_PRINT_ALL_DEADLOCKS" ;
    }();

    [&] (){
      ObSysVars[466].default_value_ = "1" ;
      ObSysVars[466].info_ = "The default value is 1, which means that LOCK TABLES causes InnoDB to lock a table internally if autocommit = 0. Merely simulates MySQL 5.7." ;
      ObSysVars[466].name_ = "innodb_table_locks" ;
      ...
      ObSysVars[466].id_ = SYS_VAR_INNODB_TABLE_LOCKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TABLE_LOCKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TABLE_LOCKS] = 466 ;
      ObSysVars[466].base_value_ = "1" ;
    ObSysVars[466].alias_ = "OB_SV_INNODB_TABLE_LOCKS" ;
    }();

    [&] (){
      ObSysVars[467].default_value_ = "18446744073709500416" ;
      ObSysVars[467].info_ = "if max_write_lock_count is set to some low value (say, 10), read lock requests may be preferred over pending write lock requests if the read lock requests have already been passed over in favor of 10 write lock requests. Merely simulates MySQL 5.7." ;
      ObSysVars[467].name_ = "max_write_lock_count" ;
      ObSysVars[467].data_type_ = ObUInt64Type ;
      ObSysVars[467].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[467].id_ = SYS_VAR_MAX_WRITE_LOCK_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_WRITE_LOCK_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_WRITE_LOCK_COUNT] = 467 ;
      ObSysVars[467].base_value_ = "18446744073709500416" ;
    ObSysVars[467].alias_ = "OB_SV_MAX_WRITE_LOCK_COUNT" ;
    }();

    [&] (){
      ObSysVars[468].default_value_ = "" ;
      ObSysVars[468].info_ = "enabled roles for current session" ;
      ObSysVars[468].name_ = "_ob_enable_role_ids" ;
      ObSysVars[468].data_type_ = ObVarcharType ;
      ObSysVars[468].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE ;
      ObSysVars[468].id_ = SYS_VAR__OB_ENABLE_ROLE_IDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OB_ENABLE_ROLE_IDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__OB_ENABLE_ROLE_IDS] = 468 ;
      ObSysVars[468].base_value_ = "" ;
    ObSysVars[468].alias_ = "OB_SV__OB_ENABLE_ROLE_IDS" ;
    }();

    [&] (){
      ObSysVars[469].default_value_ = "0" ;
      ObSysVars[469].info_ = "Starts InnoDB in read-only mode. For distributing database applications or data sets on read-only media. Can also be used in data warehouses to share the same data directory between multiple instances, merely simulates MySQL 5.7" ;
      ObSysVars[469].name_ = "innodb_read_only" ;
      ...
      ObSysVars[469].id_ = SYS_VAR_INNODB_READ_ONLY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_READ_ONLY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_READ_ONLY] = 469 ;
      ObSysVars[469].base_value_ = "0" ;
    ObSysVars[469].alias_ = "OB_SV_INNODB_READ_ONLY" ;
    }();

    [&] (){
      ObSysVars[470].default_value_ = "0" ;
      ObSysVars[470].info_ = "Use this option to disable row locks when InnoDB memcached performs DML operations. By default, innodb_api_disable_rowlock is disabled, which means that memcached requests row locks for get and set operations, merely simulates MySQL 5.7" ;
      ObSysVars[470].name_ = "innodb_api_disable_rowlock" ;
      ...
      ObSysVars[470].id_ = SYS_VAR_INNODB_API_DISABLE_ROWLOCK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_DISABLE_ROWLOCK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_DISABLE_ROWLOCK] = 470 ;
      ObSysVars[470].base_value_ = "0" ;
    ObSysVars[470].alias_ = "OB_SV_INNODB_API_DISABLE_ROWLOCK" ;
    }();

    [&] (){
      ObSysVars[471].default_value_ = "1" ;
      ObSysVars[471].info_ = "The lock mode to use for generating auto-increment values. Permissible values are 0, 1, or 2, for traditional, consecutive, or interleaved, respectively. The default setting is 1 (consecutive), merely simulates MySQL 5.7" ;
      ObSysVars[471].name_ = "innodb_autoinc_lock_mode" ;
      ObSysVars[471].data_type_ = ObIntType ;
      ObSysVars[471].min_val_ = "0" ;
      ObSysVars[471].max_val_ = "2" ;
      ObSysVars[471].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[471].id_ = SYS_VAR_INNODB_AUTOINC_LOCK_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_AUTOINC_LOCK_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_AUTOINC_LOCK_MODE] = 471 ;
      ObSysVars[471].base_value_ = "1" ;
    ObSysVars[471].alias_ = "OB_SV_INNODB_AUTOINC_LOCK_MODE" ;
    }();

    [&] (){
      ObSysVars[472].default_value_ = "1" ;
      ObSysVars[472].info_ = "This is OFF if mysqld uses external locking (system locking), ON if external locking is disabled, merely simulates MySQL 5.7" ;
      ObSysVars[472].name_ = "skip_external_locking" ;
      ...
      ObSysVars[472].id_ = SYS_VAR_SKIP_EXTERNAL_LOCKING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_EXTERNAL_LOCKING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_EXTERNAL_LOCKING] = 472 ;
      ObSysVars[472].base_value_ = "1" ;
    ObSysVars[472].alias_ = "OB_SV_SKIP_EXTERNAL_LOCKING" ;
    }();

    [&] (){
      ObSysVars[473].default_value_ = "0" ;
      ObSysVars[473].info_ = "If the read_only system variable is enabled, the server permits no client updates except from users who have the SUPER privilege. If the super_read_only system variable is also enabled, the server prohibits client updates even from users who have SUPER, merely simulates MySQL 5.7" ;
      ObSysVars[473].name_ = "super_read_only" ;
      ...
      ObSysVars[473].id_ = SYS_VAR_SUPER_READ_ONLY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SUPER_READ_ONLY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SUPER_READ_ONLY] = 473 ;
      ObSysVars[473].base_value_ = "0" ;
    ObSysVars[473].alias_ = "OB_SV_SUPER_READ_ONLY" ;
    }();

    [&] (){
      ObSysVars[474].default_value_ = "0" ;
      ObSysVars[474].info_ = "Whether the MySQL Event Scheduler is enabled." ;
      ObSysVars[474].name_ = "event_scheduler" ;
      ObSysVars[474].data_type_ = ObIntType ;
      ObSysVars[474].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[474].id_ = SYS_VAR_EVENT_SCHEDULER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EVENT_SCHEDULER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EVENT_SCHEDULER] = 474 ;
      ObSysVars[474].base_value_ = "0" ;
    ObSysVars[474].alias_ = "OB_SV_EVENT_SCHEDULER" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[476].name_ = "low_priority_updates" ;
      ...
      ObSysVars[476].id_ = SYS_VAR_LOW_PRIORITY_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOW_PRIORITY_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOW_PRIORITY_UPDATES] = 476 ;
      ObSysVars[476].base_value_ = "0" ;
    ObSysVars[476].alias_ = "OB_SV_LOW_PRIORITY_UPDATES" ;
    }();

    [&] (){
      ObSysVars[477].default_value_ = "64" ;
      ObSysVars[477].info_ = "mock for mysql5.7" ;
      ObSysVars[477].name_ = "max_error_count" ;
      ObSysVars[477].data_type_ = ObIntType ;
      ObSysVars[477].min_val_ = "0" ;
      ObSysVars[477].max_val_ = "65535" ;
      ObSysVars[477].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[477].id_ = SYS_VAR_MAX_ERROR_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_ERROR_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_ERROR_COUNT] = 477 ;
      ObSysVars[477].base_value_ = "64" ;
    ObSysVars[477].alias_ = "OB_SV_MAX_ERROR_COUNT" ;
    }();

    [&] (){
      ObSysVars[478].default_value_ = "0" ;
      ObSysVars[478].info_ = "mock for mysql5.7" ;
      ObSysVars[478].name_ = "max_insert_delayed_threads" ;
      ObSysVars[478].data_type_ = ObIntType ;
      ObSysVars[478].min_val_ = "20" ;
      ObSysVars[478].max_val_ = "16384" ;
      ObSysVars[478].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[478].id_ = SYS_VAR_MAX_INSERT_DELAYED_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_INSERT_DELAYED_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_INSERT_DELAYED_THREADS] = 478 ;
      ObSysVars[478].base_value_ = "0" ;
    ObSysVars[478].alias_ = "OB_SV_MAX_INSERT_DELAYED_THREADS" ;
    }();

    [&] (){
      ObSysVars[479].default_value_ = "built-in" ;
      ObSysVars[479].info_ = "mock for mysql5.7" ;
      ObSysVars[479].name_ = "ft_stopword_file" ;
      ObSysVars[479].data_type_ = ObVarcharType ;
      ObSysVars[479].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[479].id_ = SYS_VAR_FT_STOPWORD_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FT_STOPWORD_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_FT_STOPWORD_FILE] = 479 ;
      ObSysVars[479].base_value_ = "built-in" ;
    ObSysVars[479].alias_ = "OB_SV_FT_STOPWORD_FILE" ;
    }();

    [&] (){
      ObSysVars[480].default_value_ = "8000000" ;
      ObSysVars[480].info_ = "mock for mysql5.7" ;
      ObSysVars[480].name_ = "innodb_ft_cache_size" ;
      ObSysVars[480].data_type_ = ObIntType ;
      ObSysVars[480].min_val_ = "1600000" ;
      ObSysVars[480].max_val_ = "80000000" ;
      ObSysVars[480].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[480].id_ = SYS_VAR_INNODB_FT_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_CACHE_SIZE] = 480 ;
      ObSysVars[480].base_value_ = "8000000" ;
    ObSysVars[480].alias_ = "OB_SV_INNODB_FT_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[481].default_value_ = "2" ;
      ObSysVars[481].info_ = "mock for mysql5.7" ;
      ObSysVars[481].name_ = "innodb_ft_sort_pll_degree" ;
      ObSysVars[481].data_type_ = ObIntType ;
      ObSysVars[481].min_val_ = "1" ;
      ObSysVars[481].max_val_ = "16" ;
      ObSysVars[481].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[481].id_ = SYS_VAR_INNODB_FT_SORT_PLL_DEGREE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_SORT_PLL_DEGREE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_SORT_PLL_DEGREE] = 481 ;
      ObSysVars[481].base_value_ = "2" ;
    ObSysVars[481].alias_ = "OB_SV_INNODB_FT_SORT_PLL_DEGREE" ;
    }();

    [&] (){
      ObSysVars[482].default_value_ = "640000000" ;
      ObSysVars[482].info_ = "mock for mysql5.7" ;
      ObSysVars[482].name_ = "innodb_ft_total_cache_size" ;
      ObSysVars[482].data_type_ = ObIntType ;
      ObSysVars[482].min_val_ = "32000000" ;
      ObSysVars[482].max_val_ = "1600000000" ;
      ObSysVars[482].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[482].id_ = SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE] = 482 ;
      ObSysVars[482].base_value_ = "640000000" ;
    ObSysVars[482].alias_ = "OB_SV_INNODB_FT_TOTAL_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[483].default_value_ = "" ;
      ObSysVars[483].info_ = "mock for mysql5.7" ;
      ObSysVars[483].name_ = "mecab_rc_file" ;
      ObSysVars[483].data_type_ = ObVarcharType ;
      ObSysVars[483].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[483].id_ = SYS_VAR_MECAB_RC_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MECAB_RC_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MECAB_RC_FILE] = 483 ;
      ObSysVars[483].base_value_ = "" ;
    ObSysVars[483].alias_ = "OB_SV_MECAB_RC_FILE" ;
    }();

    [&] (){
      ObSysVars[484].default_value_ = "1024" ;
      ObSysVars[484].info_ = "mock for mysql5.7" ;
      ObSysVars[484].name_ = "metadata_locks_cache_size" ;
      ObSysVars[484].data_type_ = ObIntType ;
      ObSysVars[484].min_val_ = "1" ;
      ObSysVars[484].max_val_ = "1048576" ;
      ObSysVars[484].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[484].id_ = SYS_VAR_METADATA_LOCKS_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_METADATA_LOCKS_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_METADATA_LOCKS_CACHE_SIZE] = 484 ;
      ObSysVars[484].base_value_ = "1024" ;
    ObSysVars[484].alias_ = "OB_SV_METADATA_LOCKS_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[485].default_value_ = "8" ;
      ObSysVars[485].info_ = "mock for mysql5.7" ;
      ObSysVars[485].name_ = "metadata_locks_hash_instances" ;
      ObSysVars[485].data_type_ = ObIntType ;
      ObSysVars[485].min_val_ = "1" ;
      ObSysVars[485].max_val_ = "1024" ;
      ObSysVars[485].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[485].id_ = SYS_VAR_METADATA_LOCKS_HASH_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_METADATA_LOCKS_HASH_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_METADATA_LOCKS_HASH_INSTANCES] = 485 ;
      ObSysVars[485].base_value_ = "8" ;
    ObSysVars[485].alias_ = "OB_SV_METADATA_LOCKS_HASH_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[486].default_value_ = "ibtmp1:12M:autoextend" ;
      ObSysVars[486].info_ = "mock for mysql5.7" ;
      ObSysVars[486].name_ = "innodb_temp_data_file_path" ;
      ObSysVars[486].data_type_ = ObVarcharType ;
      ObSysVars[486].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[486].id_ = SYS_VAR_INNODB_TEMP_DATA_FILE_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TEMP_DATA_FILE_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TEMP_DATA_FILE_PATH] = 486 ;
      ObSysVars[486].base_value_ = "ibtmp1:12M:autoextend" ;
    ObSysVars[486].alias_ = "OB_SV_INNODB_TEMP_DATA_FILE_PATH" ;
    }();

    [&] (){
      ObSysVars[487].default_value_ = "ibdata1:12M:autoextend" ;
      ObSysVars[487].info_ = "mock for mysql5.7" ;
      ObSysVars[487].name_ = "innodb_data_file_path" ;
      ObSysVars[487].data_type_ = ObVarcharType ;
      ObSysVars[487].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[487].id_ = SYS_VAR_INNODB_DATA_FILE_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DATA_FILE_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DATA_FILE_PATH] = 487 ;
      ObSysVars[487].base_value_ = "ibdata1:12M:autoextend" ;
    ObSysVars[487].alias_ = "OB_SV_INNODB_DATA_FILE_PATH" ;
    }();

    [&] (){
      ObSysVars[488].default_value_ = "" ;
      ObSysVars[488].info_ = "mock for mysql5.7" ;
      ObSysVars[488].name_ = "innodb_data_home_dir" ;
      ObSysVars[488].data_type_ = ObVarcharType ;
      ObSysVars[488].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[488].id_ = SYS_VAR_INNODB_DATA_HOME_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DATA_HOME_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DATA_HOME_DIR] = 488 ;
      ObSysVars[488].base_value_ = "" ;
    ObSysVars[488].alias_ = "OB_SV_INNODB_DATA_HOME_DIR" ;
    }();

    [&] (){
      ObSysVars[489].default_value_ = "0" ;
      ObSysVars[489].info_ = "mock for mysql5.7" ;
      ObSysVars[489].name_ = "avoid_temporal_upgrade" ;
      ObSysVars[489].data_type_ = ObIntType ;
      ObSysVars[489].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[489].id_ = SYS_VAR_AVOID_TEMPORAL_UPGRADE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AVOID_TEMPORAL_UPGRADE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_AVOID_TEMPORAL_UPGRADE] = 489 ;
      ObSysVars[489].base_value_ = "0" ;
    ObSysVars[489].alias_ = "OB_SV_AVOID_TEMPORAL_UPGRADE" ;
    }();

    [&] (){
      ObSysVars[490].default_value_ = "0" ;
      ObSysVars[490].info_ = "mock for mysql5.7" ;
      ObSysVars[490].name_ = "default_tmp_storage_engine" ;
      ObSysVars[490].data_type_ = ObIntType ;
      ObSysVars[490].enum_names_ = "[u'InnoDB']" ;
      ObSysVars[490].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[490].id_ = SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE] = 490 ;
      ObSysVars[490].base_value_ = "0" ;
    ObSysVars[490].alias_ = "OB_SV_DEFAULT_TMP_STORAGE_ENGINE" ;
    }();

    [&] (){
      ObSysVars[491].default_value_ = "0" ;
      ObSysVars[491].info_ = "mock for mysql5.7" ;
      ObSysVars[491].name_ = "innodb_ft_enable_diag_print" ;
      ObSysVars[491].data_type_ = ObIntType ;
      ObSysVars[491].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[491].id_ = SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT] = 491 ;
      ObSysVars[491].base_value_ = "0" ;
    ObSysVars[491].alias_ = "OB_SV_INNODB_FT_ENABLE_DIAG_PRINT" ;
    }();

    [&] (){
      ObSysVars[492].default_value_ = "2000" ;
      ObSysVars[492].info_ = "mock for mysql5.7" ;
      ObSysVars[492].name_ = "innodb_ft_num_word_optimize" ;
      ObSysVars[492].data_type_ = ObIntType ;
      ObSysVars[492].min_val_ = "1000" ;
      ObSysVars[492].max_val_ = "10000" ;
      ObSysVars[492].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[492].id_ = SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE] = 492 ;
      ObSysVars[492].base_value_ = "2000" ;
    ObSysVars[492].alias_ = "OB_SV_INNODB_FT_NUM_WORD_OPTIMIZE" ;
    }();

    [&] (){
      ObSysVars[493].default_value_ = "2000000000" ;
      ObSysVars[493].info_ = "mock for mysql5.7" ;
      ObSysVars[493].name_ = "innodb_ft_result_cache_limit" ;
      ObSysVars[493].data_type_ = ObUInt64Type ;
      ObSysVars[493].min_val_ = "1000000" ;
      ObSysVars[493].max_val_ = "4294967295" ;
      ObSysVars[493].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[493].id_ = SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT] = 493 ;
      ObSysVars[493].base_value_ = "2000000000" ;
    ObSysVars[493].alias_ = "OB_SV_INNODB_FT_RESULT_CACHE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[494].default_value_ = "" ;
      ObSysVars[494].info_ = "mock for mysql5.7" ;
      ObSysVars[494].name_ = "innodb_ft_server_stopword_table" ;
      ObSysVars[494].data_type_ = ObVarcharType ;
      ObSysVars[494].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[494].id_ = SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE] = 494 ;
      ObSysVars[494].base_value_ = "" ;
    ObSysVars[494].alias_ = "OB_SV_INNODB_FT_SERVER_STOPWORD_TABLE" ;
    }();

    [&] (){
      ObSysVars[495].default_value_ = "0" ;
      ObSysVars[495].info_ = "mock for mysql5.7" ;
      ObSysVars[495].name_ = "innodb_optimize_fulltext_only" ;
      ObSysVars[495].data_type_ = ObIntType ;
      ObSysVars[495].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[495].id_ = SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY] = 495 ;
      ObSysVars[495].base_value_ = "0" ;
    ObSysVars[495].alias_ = "OB_SV_INNODB_OPTIMIZE_FULLTEXT_ONLY" ;
    }();

    [&] (){
      ObSysVars[496].default_value_ = "32" ;
      ObSysVars[496].info_ = "mock for mysql5.7" ;
      ObSysVars[496].name_ = "max_tmp_tables" ;
      ObSysVars[496].data_type_ = ObIntType ;
      ObSysVars[496].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[496].id_ = SYS_VAR_MAX_TMP_TABLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_TMP_TABLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_TMP_TABLES] = 496 ;
      ObSysVars[496].base_value_ = "32" ;
    ObSysVars[496].alias_ = "OB_SV_MAX_TMP_TABLES" ;
    }();

    [&] (){
      ObSysVars[497].default_value_ = "" ;
      ObSysVars[497].info_ = "mock for mysql5.7" ;
      ObSysVars[497].name_ = "innodb_tmpdir" ;
      ObSysVars[497].data_type_ = ObVarcharType ;
      ObSysVars[497].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[497].id_ = SYS_VAR_INNODB_TMPDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TMPDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TMPDIR] = 497 ;
      ObSysVars[497].base_value_ = "" ;
    ObSysVars[497].alias_ = "OB_SV_INNODB_TMPDIR" ;
    }();

    [&] (){
      ObSysVars[498].default_value_ = "" ;
      ObSysVars[498].info_ = "A list of group members to which a joining member can connect to obtain details of all the current group members" ;
      ObSysVars[498].name_ = "group_replication_group_seeds" ;
      ObSysVars[498].data_type_ = ObVarcharType ;
      ObSysVars[498].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[498].id_ = SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS] = 498 ;
      ObSysVars[498].base_value_ = "" ;
    ObSysVars[498].alias_ = "OB_SV_GROUP_REPLICATION_GROUP_SEEDS" ;
    }();

    [&] (){
      ObSysVars[499].default_value_ = "0" ;
      ObSysVars[499].info_ = "When preparing batches of rows for row-based logging and replication, this variable controls how the rows are searched for matches" ;
      ObSysVars[499].name_ = "slave_rows_search_algorithms" ;
      ObSysVars[499].data_type_ = ObIntType ;
      ObSysVars[499].enum_names_ = "[u'TABLE_SCAN,INDEX_SCAN', u'INDEX_SCAN,HASH_SCAN', u'TABLE_SCAN,HASH_SCAN', u'TABLE_SCAN,INDEX_SCAN,HASH_SCAN']" ;
      ObSysVars[499].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[499].id_ = SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS] = 499 ;
      ObSysVars[499].base_value_ = "0" ;
    ObSysVars[499].alias_ = "OB_SV_SLAVE_ROWS_SEARCH_ALGORITHMS" ;
    }();

    [&] (){
      ObSysVars[500].default_value_ = "0" ;
      ObSysVars[500].info_ = "Controls the type conversion mode in effect on the replica when using row-based replication" ;
      ObSysVars[500].name_ = "slave_type_conversions" ;
      ObSysVars[500].data_type_ = ObIntType ;
      ObSysVars[500].enum_names_ = "[u'ALL_LOSSY', u'ALL_NON_LOSSY', u'ALL_SIGNED', u'ALL_UNSIGNED']" ;
      ObSysVars[500].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[500].id_ = SYS_VAR_SLAVE_TYPE_CONVERSIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_TYPE_CONVERSIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_TYPE_CONVERSIONS] = 500 ;
      ObSysVars[500].base_value_ = "0" ;
    ObSysVars[500].alias_ = "OB_SV_SLAVE_TYPE_CONVERSIONS" ;
    }();

    [&] (){
      ObSysVars[501].default_value_ = "64" ;
      ObSysVars[501].info_ = "The number of neighbor nodes considered during any HNSW vector index search on the session" ;
      ObSysVars[501].name_ = "ob_hnsw_ef_search" ;
      ObSysVars[501].data_type_ = ObUInt64Type ;
      ObSysVars[501].min_val_ = "1" ;
      ObSysVars[501].max_val_ = "160000" ;
      ObSysVars[501].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[501].id_ = SYS_VAR_OB_HNSW_EF_SEARCH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_HNSW_EF_SEARCH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_HNSW_EF_SEARCH] = 501 ;
      ObSysVars[501].base_value_ = "40" ;
    ObSysVars[501].alias_ = "OB_SV_HNSW_EF_SEARCH" ;
    }();

    [&] (){
      ObSysVars[502].default_value_ = "0" ;
      ObSysVars[502].info_ = "mock for mysql5.7" ;
      ObSysVars[502].name_ = "ndb_allow_copying_alter_table" ;
      ...
      ObSysVars[502].id_ = SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE] = 502 ;
      ObSysVars[502].base_value_ = "0" ;
    ObSysVars[502].alias_ = "OB_SV_NDB_ALLOW_COPYING_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[503].default_value_ = "1" ;
      ObSysVars[503].info_ = "mock for mysql5.7" ;
      ObSysVars[503].name_ = "ndb_autoincrement_prefetch_sz" ;
      ...
      ObSysVars[503].id_ = SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ] = 503 ;
      ObSysVars[503].base_value_ = "1" ;
    ObSysVars[503].alias_ = "OB_SV_NDB_AUTOINCREMENT_PREFETCH_SZ" ;
    }();

    [&] (){
      ObSysVars[504].default_value_ = "65536" ;
      ObSysVars[504].info_ = "mock for mysql5.7" ;
      ObSysVars[504].name_ = "ndb_blob_read_batch_bytes" ;
      ...
      ObSysVars[504].id_ = SYS_VAR_NDB_BLOB_READ_BATCH_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_BLOB_READ_BATCH_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_BLOB_READ_BATCH_BYTES] = 504 ;
      ObSysVars[504].base_value_ = "65536" ;
    ObSysVars[504].alias_ = "OB_SV_NDB_BLOB_READ_BATCH_BYTES" ;
    }();

    [&] (){
      ObSysVars[505].default_value_ = "65536" ;
      ObSysVars[505].info_ = "mock for mysql5.7" ;
      ObSysVars[505].name_ = "ndb_blob_write_batch_bytes" ;
    ...
    [&] (){
      ...
      ObSysVars[516].id_ = SYS_VAR_NDB_FULLY_REPLICATED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_FULLY_REPLICATED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_FULLY_REPLICATED] = 516 ;
      ObSysVars[516].base_value_ = "0" ;
    ObSysVars[516].alias_ = "OB_SV_NDB_FULLY_REPLICATED" ;
    }();

    [&] (){
      ObSysVars[517].default_value_ = "0" ;
      ObSysVars[517].info_ = "mock for mysql5.7" ;
      ObSysVars[517].name_ = "ndb_index_stat_enable" ;
      ...
      ObSysVars[517].id_ = SYS_VAR_NDB_INDEX_STAT_ENABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_INDEX_STAT_ENABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_INDEX_STAT_ENABLE] = 517 ;
      ObSysVars[517].base_value_ = "0" ;
    ObSysVars[517].alias_ = "OB_SV_NDB_INDEX_STAT_ENABLE" ;
    }();

    [&] (){
      ObSysVars[518].default_value_ = "loop_checkon=1000ms,loop_idle=1000ms,loop_busy=100ms, update_batch=1,read_batch=4,idle_batch=32,check_batch=32, check_delay=1m,delete_batch=8,clean_delay=0,error_batch=4, error_delay=1m,evict_batch=8,evict_delay=1m,cache_limit=32M, cache_lowpct=90" ;
      ObSysVars[518].info_ = "mock for mysql5.7" ;
      ObSysVars[518].name_ = "ndb_index_stat_option" ;
      ...
      ObSysVars[518].id_ = SYS_VAR_NDB_INDEX_STAT_OPTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_INDEX_STAT_OPTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_INDEX_STAT_OPTION] = 518 ;
      ObSysVars[518].base_value_ = "loop_checkon=1000ms,loop_idle=1000ms,loop_busy=100ms, update_batch=1,read_batch=4,idle_batch=32,check_batch=32, check_delay=1m,delete_batch=8,clean_delay=0,error_batch=4, error_delay=1m,evict_batch=8,evict_delay=1m,cache_limit=32M, cache_lowpct=90" ;
    ObSysVars[518].alias_ = "OB_SV_NDB_INDEX_STAT_OPTION" ;
    }();

    [&] (){
      ObSysVars[519].default_value_ = "0" ;
      ObSysVars[519].info_ = "mock for mysql5.7" ;
      ObSysVars[519].name_ = "ndb_join_pushdown" ;
    ...
    [&] (){
      ...
      ObSysVars[538].id_ = SYS_VAR_NDB_USE_EXACT_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_EXACT_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_EXACT_COUNT] = 538 ;
      ObSysVars[538].base_value_ = "0" ;
    ObSysVars[538].alias_ = "OB_SV_NDB_USE_EXACT_COUNT" ;
    }();

    [&] (){
      ObSysVars[539].default_value_ = "0" ;
      ObSysVars[539].info_ = "mock for mysql5.7" ;
      ObSysVars[539].name_ = "ndb_use_transactions" ;
      ...
      ObSysVars[539].id_ = SYS_VAR_NDB_USE_TRANSACTIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_TRANSACTIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_TRANSACTIONS] = 539 ;
      ObSysVars[539].base_value_ = "0" ;
    ObSysVars[539].alias_ = "OB_SV_NDB_USE_TRANSACTIONS" ;
    }();

    [&] (){
      ObSysVars[540].default_value_ = "0" ;
      ObSysVars[540].info_ = "mock for mysql5.7" ;
      ObSysVars[540].name_ = "ndbinfo_max_bytes" ;
      ...
      ObSysVars[540].id_ = SYS_VAR_NDBINFO_MAX_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_MAX_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_MAX_BYTES] = 540 ;
      ObSysVars[540].base_value_ = "0" ;
    ObSysVars[540].alias_ = "OB_SV_NDBINFO_MAX_BYTES" ;
    }();

    [&] (){
      ObSysVars[541].default_value_ = "10" ;
      ObSysVars[541].info_ = "mock for mysql5.7" ;
      ObSysVars[541].name_ = "ndbinfo_max_rows" ;
    ...
    [&] (){
      ...
      ObSysVars[546].id_ = SYS_VAR_MYISAM_REPAIR_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_REPAIR_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_REPAIR_THREADS] = 546 ;
      ObSysVars[546].base_value_ = "1" ;
    ObSysVars[546].alias_ = "OB_SV_MYISAM_REPAIR_THREADS" ;
    }();

    [&] (){
      ObSysVars[547].default_value_ = "8388608" ;
      ObSysVars[547].info_ = "mock for mysql5.7" ;
      ObSysVars[547].name_ = "myisam_sort_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[550].id_ = SYS_VAR_PRELOAD_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PRELOAD_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PRELOAD_BUFFER_SIZE] = 550 ;
      ObSysVars[550].base_value_ = "32768" ;
    ObSysVars[550].alias_ = "OB_SV_PRELOAD_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[551].default_value_ = "131072" ;
      ObSysVars[551].info_ = "mock for mysql5.7" ;
      ObSysVars[551].name_ = "read_buffer_size" ;
      ...
      ObSysVars[551].id_ = SYS_VAR_READ_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_READ_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_READ_BUFFER_SIZE] = 551 ;
      ObSysVars[551].base_value_ = "131072" ;
    ObSysVars[551].alias_ = "OB_SV_READ_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[552].default_value_ = "262144" ;
      ObSysVars[552].info_ = "mock for mysql5.7" ;
      ObSysVars[552].name_ = "read_rnd_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[572].id_ = SYS_VAR_KEEP_FILES_ON_CREATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEEP_FILES_ON_CREATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEEP_FILES_ON_CREATE] = 572 ;
      ObSysVars[572].base_value_ = "0" ;
    ObSysVars[572].alias_ = "OB_SV_KEEP_FILES_ON_CREATE" ;
    }();

    [&] (){
      ObSysVars[573].default_value_ = "16777216" ;
      ObSysVars[573].info_ = "mock for mysql5.7" ;
      ObSysVars[573].name_ = "max_heap_table_size" ;
      ...
      ObSysVars[573].id_ = SYS_VAR_MAX_HEAP_TABLE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_HEAP_TABLE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_HEAP_TABLE_SIZE] = 573 ;
      ObSysVars[573].base_value_ = "16777216" ;
    ObSysVars[573].alias_ = "OB_SV_MAX_HEAP_TABLE_SIZE" ;
    }();

    [&] (){
      ObSysVars[574].default_value_ = "8388608" ;
      ObSysVars[574].info_ = "mock for mysql5.7" ;
      ObSysVars[574].name_ = "bulk_insert_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[605].id_ = SYS_VAR_HAVE_STATEMENT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_STATEMENT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_STATEMENT_TIMEOUT] = 605 ;
      ObSysVars[605].base_value_ = "1" ;
    ObSysVars[605].alias_ = "OB_SV_HAVE_STATEMENT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[606].default_value_ = "*" ;
      ObSysVars[606].info_ = "mock for mysql5.7" ;
      ObSysVars[606].name_ = "mysqlx_bind_address" ;
      ObSysVars[606].data_type_ = ObVarcharType ;
      ObSysVars[606].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[606].id_ = SYS_VAR_MYSQLX_BIND_ADDRESS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_BIND_ADDRESS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_BIND_ADDRESS] = 606 ;
      ObSysVars[606].base_value_ = "*" ;
    ObSysVars[606].alias_ = "OB_SV_MYSQLX_BIND_ADDRESS" ;
    }();

    [&] (){
      ObSysVars[607].default_value_ = "33060" ;
      ObSysVars[607].info_ = "mock for mysql5.7" ;
      ObSysVars[607].name_ = "mysqlx_port" ;
      ...
      ObSysVars[607].id_ = SYS_VAR_MYSQLX_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT] = 607 ;
      ObSysVars[607].base_value_ = "33060" ;
    ObSysVars[607].alias_ = "OB_SV_MYSQLX_PORT" ;
    }();

    [&] (){
      ObSysVars[608].default_value_ = "0" ;
      ObSysVars[608].info_ = "mock for mysql5.7" ;
      ObSysVars[608].name_ = "mysqlx_port_open_timeout" ;
      ...
      ObSysVars[608].id_ = SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT] = 608 ;
      ObSysVars[608].base_value_ = "0" ;
    ObSysVars[608].alias_ = "OB_SV_MYSQLX_PORT_OPEN_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[609].default_value_ = "/tmp/mysqlx.sock" ;
      ObSysVars[609].info_ = "mock for mysql5.7" ;
      ObSysVars[609].name_ = "mysqlx_socket" ;
      ...
      ObSysVars[609].id_ = SYS_VAR_MYSQLX_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SOCKET] = 609 ;
      ObSysVars[609].base_value_ = "/tmp/mysqlx.sock" ;
    ObSysVars[609].alias_ = "OB_SV_MYSQLX_SOCKET" ;
    }();

    [&] (){
      ObSysVars[610].default_value_ = "" ;
      ObSysVars[610].info_ = "mock for mysql5.7" ;
      ObSysVars[610].name_ = "mysqlx_ssl_ca" ;
    ...
    [&] (){
      ...
      ObSysVars[611].id_ = SYS_VAR_MYSQLX_SSL_CAPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CAPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CAPATH] = 611 ;
      ObSysVars[611].base_value_ = "" ;
    ObSysVars[611].alias_ = "OB_SV_MYSQLX_SSL_CAPATH" ;
    }();

    [&] (){
      ObSysVars[612].default_value_ = "" ;
      ObSysVars[612].info_ = "mock for mysql5.7" ;
      ObSysVars[612].name_ = "mysqlx_ssl_cert" ;
      ...
      ObSysVars[612].id_ = SYS_VAR_MYSQLX_SSL_CERT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CERT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CERT] = 612 ;
      ObSysVars[612].base_value_ = "" ;
    ObSysVars[612].alias_ = "OB_SV_MYSQLX_SSL_CERT" ;
    }();

    [&] (){
      ObSysVars[613].default_value_ = "" ;
      ObSysVars[613].info_ = "mock for mysql5.7" ;
      ObSysVars[613].name_ = "mysqlx_ssl_cipher" ;
      ...
      ObSysVars[613].id_ = SYS_VAR_MYSQLX_SSL_CIPHER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CIPHER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CIPHER] = 613 ;
      ObSysVars[613].base_value_ = "" ;
    ObSysVars[613].alias_ = "OB_SV_MYSQLX_SSL_CIPHER" ;
    }();

    [&] (){
      ObSysVars[614].default_value_ = "" ;
      ObSysVars[614].info_ = "mock for mysql5.7" ;
      ObSysVars[614].name_ = "mysqlx_ssl_crl" ;
      ...
      ObSysVars[614].id_ = SYS_VAR_MYSQLX_SSL_CRL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRL] = 614 ;
      ObSysVars[614].base_value_ = "" ;
    ObSysVars[614].alias_ = "OB_SV_MYSQLX_SSL_CRL" ;
    }();

    [&] (){
      ObSysVars[615].default_value_ = "" ;
      ObSysVars[615].info_ = "mock for mysql5.7" ;
      ObSysVars[615].name_ = "mysqlx_ssl_crlpath" ;
      ...
      ObSysVars[615].id_ = SYS_VAR_MYSQLX_SSL_CRLPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRLPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRLPATH] = 615 ;
      ObSysVars[615].base_value_ = "" ;
    ObSysVars[615].alias_ = "OB_SV_MYSQLX_SSL_CRLPATH" ;
    }();

    [&] (){
      ObSysVars[616].default_value_ = "" ;
      ObSysVars[616].info_ = "mock for mysql5.7" ;
      ObSysVars[616].name_ = "mysqlx_ssl_key" ;
    ...
    [&] (){
      ...
      ObSysVars[618].id_ = SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE] = 618 ;
      ObSysVars[618].base_value_ = "-1" ;
    ObSysVars[618].alias_ = "OB_SV_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[619].default_value_ = "10000" ;
      ObSysVars[619].info_ = "mock for mysql5.7" ;
      ObSysVars[619].name_ = "performance_schema_digests_size" ;
      ...
      ObSysVars[619].id_ = SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE] = 619 ;
      ObSysVars[619].base_value_ = "10000" ;
    ObSysVars[619].alias_ = "OB_SV_PERFORMANCE_SCHEMA_DIGESTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[620].default_value_ = "10000" ;
      ObSysVars[620].info_ = "mock for mysql5.7" ;
      ObSysVars[620].name_ = "performance_schema_events_stages_history_long_size" ;
      ...
      ObSysVars[620].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE] = 620 ;
      ObSysVars[620].base_value_ = "10000" ;
    ObSysVars[620].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[621].default_value_ = "10" ;
      ObSysVars[621].info_ = "mock for mysql5.7" ;
      ObSysVars[621].name_ = "performance_schema_events_stages_history_size" ;
      ...
      ObSysVars[621].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE] = 621 ;
      ObSysVars[621].base_value_ = "10" ;
    ObSysVars[621].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[622].default_value_ = "10000" ;
      ObSysVars[622].info_ = "mock for mysql5.7" ;
      ObSysVars[622].name_ = "performance_schema_events_statements_history_long_size" ;
      ...
      ObSysVars[622].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE] = 622 ;
      ObSysVars[622].base_value_ = "10000" ;
    ObSysVars[622].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[623].default_value_ = "10" ;
      ObSysVars[623].info_ = "mock for mysql5.7" ;
      ObSysVars[623].name_ = "performance_schema_events_statements_history_size" ;
      ...
      ObSysVars[623].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE] = 623 ;
      ObSysVars[623].base_value_ = "10" ;
    ObSysVars[623].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[624].default_value_ = "10000" ;
      ObSysVars[624].info_ = "mock for mysql5.7" ;
      ObSysVars[624].name_ = "performance_schema_events_transactions_history_long_size" ;
      ...
      ObSysVars[624].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE] = 624 ;
      ObSysVars[624].base_value_ = "10000" ;
    ObSysVars[624].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[625].default_value_ = "10" ;
      ObSysVars[625].info_ = "mock for mysql5.7" ;
      ObSysVars[625].name_ = "performance_schema_events_transactions_history_size" ;
      ...
      ObSysVars[625].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE] = 625 ;
      ObSysVars[625].base_value_ = "10" ;
    ObSysVars[625].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[626].default_value_ = "10000" ;
      ObSysVars[626].info_ = "mock for mysql5.7" ;
      ObSysVars[626].name_ = "performance_schema_events_waits_history_long_size" ;
      ...
      ObSysVars[626].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE] = 626 ;
      ObSysVars[626].base_value_ = "10000" ;
    ObSysVars[626].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[627].default_value_ = "10" ;
      ObSysVars[627].info_ = "mock for mysql5.7" ;
      ObSysVars[627].name_ = "performance_schema_events_waits_history_size" ;
      ...
      ObSysVars[627].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE] = 627 ;
      ObSysVars[627].base_value_ = "10" ;
    ObSysVars[627].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[628].default_value_ = "-1" ;
      ObSysVars[628].info_ = "mock for mysql5.7" ;
      ObSysVars[628].name_ = "performance_schema_hosts_size" ;
      ...
      ObSysVars[628].id_ = SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE] = 628 ;
      ObSysVars[628].base_value_ = "-1" ;
    ObSysVars[628].alias_ = "OB_SV_PERFORMANCE_SCHEMA_HOSTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[629].default_value_ = "80" ;
      ObSysVars[629].info_ = "mock for mysql5.7" ;
      ObSysVars[629].name_ = "performance_schema_max_cond_classes" ;
      ...
      ObSysVars[629].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES] = 629 ;
      ObSysVars[629].base_value_ = "80" ;
    ObSysVars[629].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_CLASSES" ;
    }();

    [&] (){
      ObSysVars[630].default_value_ = "-1" ;
      ObSysVars[630].info_ = "mock for mysql5.7" ;
      ObSysVars[630].name_ = "performance_schema_max_cond_instances" ;
      ...
      ObSysVars[630].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES] = 630 ;
      ObSysVars[630].base_value_ = "-1" ;
    ObSysVars[630].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[631].default_value_ = "1024" ;
      ObSysVars[631].info_ = "mock for mysql5.7" ;
      ObSysVars[631].name_ = "performance_schema_max_digest_length" ;
      ...
      ObSysVars[631].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH] = 631 ;
      ObSysVars[631].base_value_ = "1024" ;
    ObSysVars[631].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH" ;
    }();

    [&] (){
      ObSysVars[632].default_value_ = "80" ;
      ObSysVars[632].info_ = "mock for mysql5.7" ;
      ObSysVars[632].name_ = "performance_schema_max_file_classes" ;
      ...
      ObSysVars[632].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES] = 632 ;
      ObSysVars[632].base_value_ = "80" ;
    ObSysVars[632].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[633].default_value_ = "32768" ;
      ObSysVars[633].info_ = "mock for mysql5.7" ;
      ObSysVars[633].name_ = "performance_schema_max_file_handles" ;
      ...
      ObSysVars[633].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES] = 633 ;
      ObSysVars[633].base_value_ = "32768" ;
    ObSysVars[633].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[634].default_value_ = "-1" ;
      ObSysVars[634].info_ = "mock for mysql5.7" ;
      ObSysVars[634].name_ = "performance_schema_max_file_instances" ;
      ...
      ObSysVars[634].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES] = 634 ;
      ObSysVars[634].base_value_ = "-1" ;
    ObSysVars[634].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[635].default_value_ = "-1" ;
      ObSysVars[635].info_ = "mock for mysql5.7" ;
      ObSysVars[635].name_ = "performance_schema_max_index_stat" ;
      ...
      ObSysVars[635].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT] = 635 ;
      ObSysVars[635].base_value_ = "-1" ;
    ObSysVars[635].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_INDEX_STAT" ;
    }();

    [&] (){
      ObSysVars[636].default_value_ = "320" ;
      ObSysVars[636].info_ = "mock for mysql5.7" ;
      ObSysVars[636].name_ = "performance_schema_max_memory_classes" ;
      ...
      ObSysVars[636].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES] = 636 ;
      ObSysVars[636].base_value_ = "320" ;
    ObSysVars[636].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES" ;
    }();

    [&] (){
      ObSysVars[637].default_value_ = "-1" ;
      ObSysVars[637].info_ = "mock for mysql5.7" ;
      ObSysVars[637].name_ = "performance_schema_max_metadata_locks" ;
      ...
      ObSysVars[637].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS] = 637 ;
      ObSysVars[637].base_value_ = "-1" ;
    ObSysVars[637].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS" ;
    }();

    [&] (){
      ObSysVars[638].default_value_ = "210" ;
      ObSysVars[638].info_ = "mock for mysql5.7" ;
      ObSysVars[638].name_ = "performance_schema_max_mutex_classes" ;
      ...
      ObSysVars[638].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES] = 638 ;
      ObSysVars[638].base_value_ = "210" ;
    ObSysVars[638].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES" ;
    }();

    [&] (){
      ObSysVars[639].default_value_ = "-1" ;
      ObSysVars[639].info_ = "mock for mysql5.7" ;
      ObSysVars[639].name_ = "performance_schema_max_mutex_instances" ;
      ...
      ObSysVars[639].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES] = 639 ;
      ObSysVars[639].base_value_ = "-1" ;
    ObSysVars[639].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[640].default_value_ = "-1" ;
      ObSysVars[640].info_ = "mock for mysql5.7" ;
      ObSysVars[640].name_ = "performance_schema_max_prepared_statements_instances" ;
      ...
      ObSysVars[640].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES] = 640 ;
      ObSysVars[640].base_value_ = "-1" ;
    ObSysVars[640].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[641].default_value_ = "-1" ;
      ObSysVars[641].info_ = "mock for mysql5.7" ;
      ObSysVars[641].name_ = "performance_schema_max_program_instances" ;
      ...
      ObSysVars[641].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES] = 641 ;
      ObSysVars[641].base_value_ = "-1" ;
    ObSysVars[641].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[642].default_value_ = "50" ;
      ObSysVars[642].info_ = "mock for mysql5.7" ;
      ObSysVars[642].name_ = "performance_schema_max_rwlock_classes" ;
      ...
      ObSysVars[642].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES] = 642 ;
      ObSysVars[642].base_value_ = "50" ;
    ObSysVars[642].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES" ;
    }();

    [&] (){
      ObSysVars[643].default_value_ = "-1" ;
      ObSysVars[643].info_ = "mock for mysql5.7" ;
      ObSysVars[643].name_ = "performance_schema_max_rwlock_instances" ;
      ...
      ObSysVars[643].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES] = 643 ;
      ObSysVars[643].base_value_ = "-1" ;
    ObSysVars[643].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[644].default_value_ = "10" ;
      ObSysVars[644].info_ = "mock for mysql5.7" ;
      ObSysVars[644].name_ = "performance_schema_max_socket_classes" ;
      ...
      ObSysVars[644].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES] = 644 ;
      ObSysVars[644].base_value_ = "10" ;
    ObSysVars[644].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES" ;
    }();

    [&] (){
      ObSysVars[645].default_value_ = "-1" ;
      ObSysVars[645].info_ = "mock for mysql5.7" ;
      ObSysVars[645].name_ = "performance_schema_max_socket_instances" ;
      ...
      ObSysVars[645].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES] = 645 ;
      ObSysVars[645].base_value_ = "-1" ;
    ObSysVars[645].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[646].default_value_ = "1024" ;
      ObSysVars[646].info_ = "mock for mysql5.7" ;
      ObSysVars[646].name_ = "performance_schema_max_sql_text_length" ;
      ...
      ObSysVars[646].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH] = 646 ;
      ObSysVars[646].base_value_ = "1024" ;
    ObSysVars[646].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH" ;
    }();

    [&] (){
      ObSysVars[647].default_value_ = "150" ;
      ObSysVars[647].info_ = "mock for mysql5.7" ;
      ObSysVars[647].name_ = "performance_schema_max_stage_classes" ;
      ...
      ObSysVars[647].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES] = 647 ;
      ObSysVars[647].base_value_ = "150" ;
    ObSysVars[647].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[648].default_value_ = "193" ;
      ObSysVars[648].info_ = "mock for mysql5.7" ;
      ObSysVars[648].name_ = "performance_schema_max_statement_classes" ;
      ...
      ObSysVars[648].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES] = 648 ;
      ObSysVars[648].base_value_ = "193" ;
    ObSysVars[648].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES" ;
    }();

    [&] (){
      ObSysVars[649].default_value_ = "10" ;
      ObSysVars[649].info_ = "mock for mysql5.7" ;
      ObSysVars[649].name_ = "performance_schema_max_statement_stack" ;
      ...
      ObSysVars[649].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK] = 649 ;
      ObSysVars[649].base_value_ = "10" ;
    ObSysVars[649].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK" ;
    }();

    [&] (){
      ObSysVars[650].default_value_ = "-1" ;
      ObSysVars[650].info_ = "mock for mysql5.7" ;
      ObSysVars[650].name_ = "performance_schema_max_table_handles" ;
      ...
      ObSysVars[650].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES] = 650 ;
      ObSysVars[650].base_value_ = "-1" ;
    ObSysVars[650].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[651].default_value_ = "-1" ;
      ObSysVars[651].info_ = "mock for mysql5.7" ;
      ObSysVars[651].name_ = "performance_schema_max_table_instances" ;
      ...
      ObSysVars[651].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES] = 651 ;
      ObSysVars[651].base_value_ = "-1" ;
    ObSysVars[651].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[652].default_value_ = "-1" ;
      ObSysVars[652].info_ = "mock for mysql5.7" ;
      ObSysVars[652].name_ = "performance_schema_max_table_lock_stat" ;
      ...
      ObSysVars[652].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT] = 652 ;
      ObSysVars[652].base_value_ = "-1" ;
    ObSysVars[652].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT" ;
    }();

    [&] (){
      ObSysVars[653].default_value_ = "50" ;
      ObSysVars[653].info_ = "mock for mysql5.7" ;
      ObSysVars[653].name_ = "performance_schema_max_thread_classes" ;
      ...
      ObSysVars[653].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES] = 653 ;
      ObSysVars[653].base_value_ = "50" ;
    ObSysVars[653].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES" ;
    }();

    [&] (){
      ObSysVars[654].default_value_ = "-1" ;
      ObSysVars[654].info_ = "mock for mysql5.7" ;
      ObSysVars[654].name_ = "performance_schema_max_thread_instances" ;
      ...
      ObSysVars[654].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES] = 654 ;
      ObSysVars[654].base_value_ = "-1" ;
    ObSysVars[654].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[655].default_value_ = "512" ;
      ObSysVars[655].info_ = "mock for mysql5.7" ;
      ObSysVars[655].name_ = "performance_schema_session_connect_attrs_size" ;
      ...
      ObSysVars[655].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE] = 655 ;
      ObSysVars[655].base_value_ = "512" ;
    ObSysVars[655].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE" ;
    }();

    [&] (){
      ObSysVars[656].default_value_ = "-1" ;
      ObSysVars[656].info_ = "mock for mysql5.7" ;
      ObSysVars[656].name_ = "performance_schema_setup_actors_size" ;
      ...
      ObSysVars[656].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE] = 656 ;
      ObSysVars[656].base_value_ = "-1" ;
    ObSysVars[656].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE" ;
    }();

    [&] (){
      ObSysVars[657].default_value_ = "-1" ;
      ObSysVars[657].info_ = "mock for mysql5.7" ;
      ObSysVars[657].name_ = "performance_schema_setup_objects_size" ;
      ...
      ObSysVars[657].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE] = 657 ;
      ObSysVars[657].base_value_ = "-1" ;
    ObSysVars[657].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[658].default_value_ = "-1" ;
      ObSysVars[658].info_ = "mock for mysql5.7" ;
      ObSysVars[658].name_ = "performance_schema_users_size" ;
      ...
      ObSysVars[658].id_ = SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE] = 658 ;
      ObSysVars[658].base_value_ = "-1" ;
    ObSysVars[658].alias_ = "OB_SV_PERFORMANCE_SCHEMA_USERS_SIZE" ;
    }();

    [&] (){
      ObSysVars[659].default_value_ = "0" ;
      ObSysVars[659].info_ = "mock for mysql5.7" ;
      ObSysVars[659].name_ = "version_tokens_session_number" ;
      ...
      ObSysVars[659].id_ = SYS_VAR_VERSION_TOKENS_SESSION_NUMBER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VERSION_TOKENS_SESSION_NUMBER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VERSION_TOKENS_SESSION_NUMBER] = 659 ;
      ObSysVars[659].base_value_ = "0" ;
    ObSysVars[659].alias_ = "OB_SV_VERSION_TOKENS_SESSION_NUMBER" ;
    }();

    [&] (){
      ObSysVars[660].default_value_ = "80" ;
      ObSysVars[660].info_ = "mock for mysql5.7" ;
      ObSysVars[660].name_ = "back_log" ;
      ...
      ObSysVars[660].id_ = SYS_VAR_BACK_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BACK_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BACK_LOG] = 660 ;
      ObSysVars[660].base_value_ = "80" ;
    ObSysVars[660].alias_ = "OB_SV_BACK_LOG" ;
    }();

    [&] (){
      ObSysVars[661].default_value_ = "/usr/local/mysql/" ;
      ObSysVars[661].info_ = "mock for mysql5.7" ;
      ObSysVars[661].name_ = "basedir" ;
      ...
      ObSysVars[661].id_ = SYS_VAR_BASEDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BASEDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BASEDIR] = 661 ;
      ObSysVars[661].base_value_ = "/usr/local/mysql/" ;
    ObSysVars[661].alias_ = "OB_SV_BASEDIR" ;
    }();

    [&] (){
      ObSysVars[662].default_value_ = "*" ;
      ObSysVars[662].info_ = "mock for mysql5.7" ;
      ObSysVars[662].name_ = "bind_address" ;
    ...
    [&] (){
      ...
      ObSysVars[667].id_ = SYS_VAR_INNODB_NUMA_INTERLEAVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_NUMA_INTERLEAVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_NUMA_INTERLEAVE] = 667 ;
      ObSysVars[667].base_value_ = "0" ;
    ObSysVars[667].alias_ = "OB_SV_INNODB_NUMA_INTERLEAVE" ;
    }();

    [&] (){
      ObSysVars[668].default_value_ = "2000" ;
      ObSysVars[668].info_ = "mock for mysql5.7" ;
      ObSysVars[668].name_ = "innodb_open_files" ;
      ...
      ObSysVars[668].id_ = SYS_VAR_INNODB_OPEN_FILES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_OPEN_FILES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_OPEN_FILES] = 668 ;
      ObSysVars[668].base_value_ = "2000" ;
    ObSysVars[668].alias_ = "OB_SV_INNODB_OPEN_FILES" ;
    }();

    [&] (){
      ObSysVars[669].default_value_ = "1" ;
      ObSysVars[669].info_ = "mock for mysql5.7" ;
      ObSysVars[669].name_ = "innodb_page_cleaners" ;
      ...
      ObSysVars[669].id_ = SYS_VAR_INNODB_PAGE_CLEANERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PAGE_CLEANERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PAGE_CLEANERS] = 669 ;
      ObSysVars[669].base_value_ = "1" ;
    ObSysVars[669].alias_ = "OB_SV_INNODB_PAGE_CLEANERS" ;
    }();

    [&] (){
      ObSysVars[670].default_value_ = "4" ;
      ObSysVars[670].info_ = "mock for mysql5.7" ;
      ObSysVars[670].name_ = "innodb_purge_threads" ;
      ...
      ObSysVars[670].id_ = SYS_VAR_INNODB_PURGE_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PURGE_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PURGE_THREADS] = 670 ;
      ObSysVars[670].base_value_ = "4" ;
    ObSysVars[670].alias_ = "OB_SV_INNODB_PURGE_THREADS" ;
    }();

    [&] (){
      ObSysVars[671].default_value_ = "4" ;
      ObSysVars[671].info_ = "mock for mysql5.7" ;
      ObSysVars[671].name_ = "innodb_read_io_threads" ;
      ...
      ObSysVars[671].id_ = SYS_VAR_INNODB_READ_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_READ_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_READ_IO_THREADS] = 671 ;
      ObSysVars[671].base_value_ = "4" ;
    ObSysVars[671].alias_ = "OB_SV_INNODB_READ_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[672].default_value_ = "1" ;
      ObSysVars[672].info_ = "mock for mysql5.7" ;
      ObSysVars[672].name_ = "innodb_sync_array_size" ;
      ...
      ObSysVars[672].id_ = SYS_VAR_INNODB_SYNC_ARRAY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SYNC_ARRAY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SYNC_ARRAY_SIZE] = 672 ;
      ObSysVars[672].base_value_ = "1" ;
    ObSysVars[672].alias_ = "OB_SV_INNODB_SYNC_ARRAY_SIZE" ;
    }();

    [&] (){
      ObSysVars[673].default_value_ = "1" ;
      ObSysVars[673].info_ = "mock for mysql5.7" ;
      ObSysVars[673].name_ = "innodb_use_native_aio" ;
      ...
      ObSysVars[673].id_ = SYS_VAR_INNODB_USE_NATIVE_AIO ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_USE_NATIVE_AIO)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_USE_NATIVE_AIO] = 673 ;
      ObSysVars[673].base_value_ = "1" ;
    ObSysVars[673].alias_ = "OB_SV_INNODB_USE_NATIVE_AIO" ;
    }();

    [&] (){
      ObSysVars[674].default_value_ = "4" ;
      ObSysVars[674].info_ = "mock for mysql5.7" ;
      ObSysVars[674].name_ = "innodb_write_io_threads" ;
      ...
      ObSysVars[674].id_ = SYS_VAR_INNODB_WRITE_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_WRITE_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_WRITE_IO_THREADS] = 674 ;
      ObSysVars[674].base_value_ = "4" ;
    ObSysVars[674].alias_ = "OB_SV_INNODB_WRITE_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[675].default_value_ = "1" ;
      ObSysVars[675].info_ = "mock for mysql5.7" ;
      ObSysVars[675].name_ = "large_files_support" ;
      ...
      ObSysVars[675].id_ = SYS_VAR_LARGE_FILES_SUPPORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LARGE_FILES_SUPPORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LARGE_FILES_SUPPORT] = 675 ;
      ObSysVars[675].base_value_ = "1" ;
    ObSysVars[675].alias_ = "OB_SV_LARGE_FILES_SUPPORT" ;
    }();

    [&] (){
      ObSysVars[676].default_value_ = "0" ;
      ObSysVars[676].info_ = "mock for mysql5.7" ;
      ObSysVars[676].name_ = "large_pages" ;
    ...
    [&] (){
      ...
      ObSysVars[678].id_ = SYS_VAR_LOCKED_IN_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOCKED_IN_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOCKED_IN_MEMORY] = 678 ;
      ObSysVars[678].base_value_ = "0" ;
    ObSysVars[678].alias_ = "OB_SV_LOCKED_IN_MEMORY" ;
    }();

    [&] (){
      ObSysVars[679].default_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
      ObSysVars[679].info_ = "mock for mysql5.7" ;
      ObSysVars[679].name_ = "log_error" ;
      ...
      ObSysVars[679].id_ = SYS_VAR_LOG_ERROR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_ERROR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_ERROR] = 679 ;
      ObSysVars[679].base_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
    ObSysVars[679].alias_ = "OB_SV_LOG_ERROR" ;
    }();

    [&] (){
      ObSysVars[680].default_value_ = "0" ;
      ObSysVars[680].info_ = "mock for mysql5.7" ;
      ObSysVars[680].name_ = "named_pipe" ;
      ...
      ObSysVars[680].id_ = SYS_VAR_NAMED_PIPE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NAMED_PIPE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NAMED_PIPE] = 680 ;
      ObSysVars[680].base_value_ = "0" ;
    ObSysVars[680].alias_ = "OB_SV_NAMED_PIPE" ;
    }();

    [&] (){
      ObSysVars[681].default_value_ = "empty string" ;
      ObSysVars[681].info_ = "mock for mysql5.7" ;
      ObSysVars[681].name_ = "named_pipe_full_access_group" ;
      ...
      ObSysVars[681].id_ = SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP] = 681 ;
      ObSysVars[681].base_value_ = "empty string" ;
    ObSysVars[681].alias_ = "OB_SV_NAMED_PIPE_FULL_ACCESS_GROUP" ;
    }();

    [&] (){
      ObSysVars[682].default_value_ = "655360" ;
      ObSysVars[682].info_ = "mock for mysql5.7" ;
      ObSysVars[682].name_ = "open_files_limit" ;
      ...
      ObSysVars[682].id_ = SYS_VAR_OPEN_FILES_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPEN_FILES_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPEN_FILES_LIMIT] = 682 ;
      ObSysVars[682].base_value_ = "655360" ;
    ObSysVars[682].alias_ = "OB_SV_OPEN_FILES_LIMIT" ;
    }();

    [&] (){
      ObSysVars[683].default_value_ = "null" ;
      ObSysVars[683].info_ = "mock for mysql5.7" ;
      ObSysVars[683].name_ = "report_host" ;
    ...
    [&] (){
      ...
      ObSysVars[686].id_ = SYS_VAR_REPORT_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPORT_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPORT_USER] = 686 ;
      ObSysVars[686].base_value_ = "null" ;
    ObSysVars[686].alias_ = "OB_SV_REPORT_USER" ;
    }();

    [&] (){
      ObSysVars[687].default_value_ = "32" ;
      ObSysVars[687].info_ = "mock for mysql5.7" ;
      ObSysVars[687].name_ = "server_id_bits" ;
      ...
      ObSysVars[687].id_ = SYS_VAR_SERVER_ID_BITS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SERVER_ID_BITS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SERVER_ID_BITS] = 687 ;
      ObSysVars[687].base_value_ = "32" ;
    ObSysVars[687].alias_ = "OB_SV_SERVER_ID_BITS" ;
    }();

    [&] (){
      ObSysVars[688].default_value_ = "0" ;
      ObSysVars[688].info_ = "mock for mysql5.7" ;
      ObSysVars[688].name_ = "shared_memory" ;
      ...
      ObSysVars[688].id_ = SYS_VAR_SHARED_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY] = 688 ;
      ObSysVars[688].base_value_ = "0" ;
    ObSysVars[688].alias_ = "OB_SV_SHARED_MEMORY" ;
    }();

    [&] (){
      ObSysVars[689].default_value_ = "MYSQL" ;
      ObSysVars[689].info_ = "mock for mysql5.7" ;
      ObSysVars[689].name_ = "shared_memory_base_name" ;
      ...
      ObSysVars[689].id_ = SYS_VAR_SHARED_MEMORY_BASE_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY_BASE_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY_BASE_NAME] = 689 ;
      ObSysVars[689].base_value_ = "MYSQL" ;
    ObSysVars[689].alias_ = "OB_SV_SHARED_MEMORY_BASE_NAME" ;
    }();

    [&] (){
      ObSysVars[690].default_value_ = "0" ;
      ObSysVars[690].info_ = "mock for mysql5.7" ;
      ObSysVars[690].name_ = "skip_name_resolve" ;
      ...
      ObSysVars[690].id_ = SYS_VAR_SKIP_NAME_RESOLVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_NAME_RESOLVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_NAME_RESOLVE] = 690 ;
      ObSysVars[690].base_value_ = "0" ;
    ObSysVars[690].alias_ = "OB_SV_SKIP_NAME_RESOLVE" ;
    }();

    [&] (){
      ObSysVars[691].default_value_ = "0" ;
      ObSysVars[691].info_ = "mock for mysql5.7" ;
      ObSysVars[691].name_ = "skip_networking" ;
    ...
    [&] (){
      ...
      ObSysVars[693].id_ = SYS_VAR_THREAD_POOL_ALGORITHM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_ALGORITHM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_ALGORITHM] = 693 ;
      ObSysVars[693].base_value_ = "0" ;
    ObSysVars[693].alias_ = "OB_SV_THREAD_POOL_ALGORITHM" ;
    }();

    [&] (){
      ObSysVars[694].default_value_ = "16" ;
      ObSysVars[694].info_ = "mock for mysql5.7" ;
      ObSysVars[694].name_ = "thread_pool_size" ;
      ...
      ObSysVars[694].id_ = SYS_VAR_THREAD_POOL_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_SIZE] = 694 ;
      ObSysVars[694].base_value_ = "16" ;
    ObSysVars[694].alias_ = "OB_SV_THREAD_POOL_SIZE" ;
    }();

    [&] (){
      ObSysVars[695].default_value_ = "262144" ;
      ObSysVars[695].info_ = "mock for mysql5.7" ;
      ObSysVars[695].name_ = "thread_stack" ;
      ...
      ObSysVars[695].id_ = SYS_VAR_THREAD_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_STACK] = 695 ;
      ObSysVars[695].base_value_ = "262144" ;
    ObSysVars[695].alias_ = "OB_SV_THREAD_STACK" ;
    }();

    [&] (){
      ObSysVars[696].default_value_ = "1" ;
      ObSysVars[696].info_ = "mock for mysql5.7" ;
      ObSysVars[696].name_ = "binlog_gtid_simple_recovery" ;
      ...
      ObSysVars[696].id_ = SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY] = 696 ;
      ObSysVars[696].base_value_ = "1" ;
    ObSysVars[696].alias_ = "OB_SV_BINLOG_GTID_SIMPLE_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[697].default_value_ = "0" ;
      ObSysVars[697].info_ = "mock for mysql5.7" ;
      ObSysVars[697].name_ = "innodb_api_enable_binlog" ;
      ...
      ObSysVars[697].id_ = SYS_VAR_INNODB_API_ENABLE_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_ENABLE_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_ENABLE_BINLOG] = 697 ;
      ObSysVars[697].base_value_ = "0" ;
    ObSysVars[697].alias_ = "OB_SV_INNODB_API_ENABLE_BINLOG" ;
    }();

    [&] (){
      ObSysVars[698].default_value_ = "0" ;
      ObSysVars[698].info_ = "mock for mysql5.7" ;
      ObSysVars[698].name_ = "innodb_locks_unsafe_for_binlog" ;
      ...
      ObSysVars[698].id_ = SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG] = 698 ;
      ObSysVars[698].base_value_ = "0" ;
    ObSysVars[698].alias_ = "OB_SV_INNODB_LOCKS_UNSAFE_FOR_BINLOG" ;
    }();

    [&] (){
      ObSysVars[699].default_value_ = "16777216" ;
      ObSysVars[699].info_ = "mock for mysql5.7" ;
      ObSysVars[699].name_ = "innodb_log_buffer_size" ;
      ...
      ObSysVars[699].id_ = SYS_VAR_INNODB_LOG_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_BUFFER_SIZE] = 699 ;
      ObSysVars[699].base_value_ = "16777216" ;
    ObSysVars[699].alias_ = "OB_SV_INNODB_LOG_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[700].default_value_ = "2" ;
      ObSysVars[700].info_ = "mock for mysql5.7" ;
      ObSysVars[700].name_ = "innodb_log_files_in_group" ;
      ...
      ObSysVars[700].id_ = SYS_VAR_INNODB_LOG_FILES_IN_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILES_IN_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILES_IN_GROUP] = 700 ;
      ObSysVars[700].base_value_ = "2" ;
    ObSysVars[700].alias_ = "OB_SV_INNODB_LOG_FILES_IN_GROUP" ;
    }();

    [&] (){
      ObSysVars[701].default_value_ = "50331648" ;
      ObSysVars[701].info_ = "mock for mysql5.7" ;
      ObSysVars[701].name_ = "innodb_log_file_size" ;
      ...
      ObSysVars[701].id_ = SYS_VAR_INNODB_LOG_FILE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILE_SIZE] = 701 ;
      ObSysVars[701].base_value_ = "50331648" ;
    ObSysVars[701].alias_ = "OB_SV_INNODB_LOG_FILE_SIZE" ;
    }();

    [&] (){
      ObSysVars[702].default_value_ = "./" ;
      ObSysVars[702].info_ = "mock for mysql5.7" ;
      ObSysVars[702].name_ = "innodb_log_group_home_dir" ;
      ...
      ObSysVars[702].id_ = SYS_VAR_INNODB_LOG_GROUP_HOME_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_GROUP_HOME_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_GROUP_HOME_DIR] = 702 ;
      ObSysVars[702].base_value_ = "./" ;
    ObSysVars[702].alias_ = "OB_SV_INNODB_LOG_GROUP_HOME_DIR" ;
    }();

    [&] (){
      ObSysVars[703].default_value_ = "./" ;
      ObSysVars[703].info_ = "mock for mysql5.7" ;
      ObSysVars[703].name_ = "innodb_undo_directory" ;
      ...
      ObSysVars[703].id_ = SYS_VAR_INNODB_UNDO_DIRECTORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_DIRECTORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_DIRECTORY] = 703 ;
      ObSysVars[703].base_value_ = "./" ;
    ObSysVars[703].alias_ = "OB_SV_INNODB_UNDO_DIRECTORY" ;
    }();

    [&] (){
      ObSysVars[704].default_value_ = "0" ;
      ObSysVars[704].info_ = "mock for mysql5.7" ;
      ObSysVars[704].name_ = "innodb_undo_tablespaces" ;
      ...
      ObSysVars[704].id_ = SYS_VAR_INNODB_UNDO_TABLESPACES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_TABLESPACES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_TABLESPACES] = 704 ;
      ObSysVars[704].base_value_ = "0" ;
    ObSysVars[704].alias_ = "OB_SV_INNODB_UNDO_TABLESPACES" ;
    }();

    [&] (){
      ObSysVars[705].default_value_ = "null" ;
      ObSysVars[705].info_ = "mock for mysql5.7" ;
      ObSysVars[705].name_ = "log_bin_basename" ;
    ...
    [&] (){
      ...
      ObSysVars[706].id_ = SYS_VAR_LOG_BIN_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_INDEX] = 706 ;
      ObSysVars[706].base_value_ = "null" ;
    ObSysVars[706].alias_ = "OB_SV_LOG_BIN_INDEX" ;
    }();

    [&] (){
      ObSysVars[707].default_value_ = "0" ;
      ObSysVars[707].info_ = "mock for mysql5.7" ;
      ObSysVars[707].name_ = "log_slave_updates" ;
      ObSysVars[707].data_type_ = ObIntType ;
      ObSysVars[707].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[707].id_ = SYS_VAR_LOG_SLAVE_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_SLAVE_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_SLAVE_UPDATES] = 707 ;
      ObSysVars[707].base_value_ = "0" ;
    ObSysVars[707].alias_ = "OB_SV_LOG_SLAVE_UPDATES" ;
    }();

    [&] (){
      ObSysVars[708].default_value_ = "null" ;
      ObSysVars[708].info_ = "mock for mysql5.7" ;
      ObSysVars[708].name_ = "relay_log" ;
      ...
      ObSysVars[708].id_ = SYS_VAR_RELAY_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG] = 708 ;
      ObSysVars[708].base_value_ = "null" ;
    ObSysVars[708].alias_ = "OB_SV_RELAY_LOG" ;
    }();

    [&] (){
      ObSysVars[709].default_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
      ObSysVars[709].info_ = "mock for mysql5.7" ;
      ObSysVars[709].name_ = "relay_log_basename" ;
      ...
      ObSysVars[709].id_ = SYS_VAR_RELAY_LOG_BASENAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_BASENAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_BASENAME] = 709 ;
      ObSysVars[709].base_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
    ObSysVars[709].alias_ = "OB_SV_RELAY_LOG_BASENAME" ;
    }();

    [&] (){
      ObSysVars[710].default_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
      ObSysVars[710].info_ = "mock for mysql5.7" ;
      ObSysVars[710].name_ = "relay_log_index" ;
      ...
      ObSysVars[710].id_ = SYS_VAR_RELAY_LOG_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INDEX] = 710 ;
      ObSysVars[710].base_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
    ObSysVars[710].alias_ = "OB_SV_RELAY_LOG_INDEX" ;
    }();

    [&] (){
      ObSysVars[711].default_value_ = "relay-log.info" ;
      ObSysVars[711].info_ = "mock for mysql5.7" ;
      ObSysVars[711].name_ = "relay_log_info_file" ;
      ...
      ObSysVars[711].id_ = SYS_VAR_RELAY_LOG_INFO_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INFO_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INFO_FILE] = 711 ;
      ObSysVars[711].base_value_ = "relay-log.info" ;
    ObSysVars[711].alias_ = "OB_SV_RELAY_LOG_INFO_FILE" ;
    }();

    [&] (){
      ObSysVars[712].default_value_ = "0" ;
      ObSysVars[712].info_ = "mock for mysql5.7" ;
      ObSysVars[712].name_ = "relay_log_recovery" ;
      ...
      ObSysVars[712].id_ = SYS_VAR_RELAY_LOG_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_RECOVERY] = 712 ;
      ObSysVars[712].base_value_ = "0" ;
    ObSysVars[712].alias_ = "OB_SV_RELAY_LOG_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[713].default_value_ = "0" ;
      ObSysVars[713].info_ = "mock for mysql5.7" ;
      ObSysVars[713].name_ = "relay_log_space_limit" ;
      ...
      ObSysVars[713].id_ = SYS_VAR_RELAY_LOG_SPACE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_SPACE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_SPACE_LIMIT] = 713 ;
      ObSysVars[713].base_value_ = "0" ;
    ObSysVars[713].alias_ = "OB_SV_RELAY_LOG_SPACE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[714].default_value_ = "0" ;
      ObSysVars[714].info_ = "This variable specifies how to use delayed key writes. It applies only to MyISAM tables. Delayed key writing causes key buffers not to be flushed between writes, merely simulates MySQL 5.7" ;
      ObSysVars[714].name_ = "delay_key_write" ;
      ObSysVars[714].data_type_ = ObIntType ;
      ObSysVars[714].enum_names_ = "[u'ON', u'OFF', u'ALL']" ;
      ObSysVars[714].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[714].id_ = SYS_VAR_DELAY_KEY_WRITE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAY_KEY_WRITE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAY_KEY_WRITE] = 714 ;
      ObSysVars[714].base_value_ = "0" ;
    ObSysVars[714].alias_ = "OB_SV_DELAY_KEY_WRITE" ;
    }();

    [&] (){
      ObSysVars[715].default_value_ = "0" ;
      ObSysVars[715].info_ = "When this option is enabled, index key prefixes longer than 767 bytes (up to 3072 bytes) are allowed for InnoDB tables that use DYNAMIC or COMPRESSED row format, merely simulates MySQL 5.7" ;
      ObSysVars[715].name_ = "innodb_large_prefix" ;
      ObSysVars[715].data_type_ = ObIntType ;
      ObSysVars[715].enum_names_ = "[u'ON', u'OFF']" ;
      ObSysVars[715].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[715].id_ = SYS_VAR_INNODB_LARGE_PREFIX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LARGE_PREFIX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LARGE_PREFIX] = 715 ;
      ObSysVars[715].base_value_ = "0" ;
    ObSysVars[715].alias_ = "OB_SV_INNODB_LARGE_PREFIX" ;
    }();

    [&] (){
      ObSysVars[716].default_value_ = "8388608" ;
      ObSysVars[716].info_ = "The size of the buffer used for index blocks, merely simulates MySQL 5.7" ;
      ObSysVars[716].name_ = "key_buffer_size" ;
      ObSysVars[716].data_type_ = ObIntType ;
      ObSysVars[716].min_val_ = "0" ;
      ObSysVars[716].max_val_ = "4294967295" ;
      ObSysVars[716].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[716].id_ = SYS_VAR_KEY_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_BUFFER_SIZE] = 716 ;
      ObSysVars[716].base_value_ = "8388608" ;
    ObSysVars[716].alias_ = "OB_SV_KEY_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[717].default_value_ = "300" ;
      ObSysVars[717].info_ = "This value controls the demotion of buffers from the hot sublist of a key cache to the warm sublist. Lower values cause demotion to happen more quickly, merely simulates MySQL 5.7" ;
      ObSysVars[717].name_ = "key_cache_age_threshold" ;
      ObSysVars[717].data_type_ = ObUInt64Type ;
      ObSysVars[717].min_val_ = "100" ;
      ObSysVars[717].max_val_ = "18446744073709551516" ;
      ObSysVars[717].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[717].id_ = SYS_VAR_KEY_CACHE_AGE_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_AGE_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_AGE_THRESHOLD] = 717 ;
      ObSysVars[717].base_value_ = "300" ;
    ObSysVars[717].alias_ = "OB_SV_KEY_CACHE_AGE_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[718].default_value_ = "100" ;
      ObSysVars[718].info_ = "The division point between the hot and warm sublists of the key cache buffer list, merely simulates MySQL 5.7" ;
      ObSysVars[718].name_ = "key_cache_division_limit" ;
      ...
      ObSysVars[718].id_ = SYS_VAR_KEY_CACHE_DIVISION_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_DIVISION_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_DIVISION_LIMIT] = 718 ;
      ObSysVars[718].base_value_ = "100" ;
    ObSysVars[718].alias_ = "OB_SV_KEY_CACHE_DIVISION_LIMIT" ;
    }();

    [&] (){
      ObSysVars[719].default_value_ = "18446744073709551615" ;
      ObSysVars[719].info_ = "Limit the assumed maximum number of seeks when looking up rows based on a key, merely simulates MySQL 5.7" ;
      ObSysVars[719].name_ = "max_seeks_for_key" ;
      ObSysVars[719].data_type_ = ObUInt64Type ;
      ObSysVars[719].min_val_ = "1" ;
      ObSysVars[719].max_val_ = "18446744073709551615" ;
      ObSysVars[719].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[719].id_ = SYS_VAR_MAX_SEEKS_FOR_KEY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_SEEKS_FOR_KEY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_SEEKS_FOR_KEY] = 719 ;
      ObSysVars[719].base_value_ = "18446744073709551615" ;
    ObSysVars[719].alias_ = "OB_SV_MAX_SEEKS_FOR_KEY" ;
    }();

    [&] (){
      ObSysVars[720].default_value_ = "0" ;
      ObSysVars[720].info_ = "When this variable is enabled, the server does not use the optimized method of processing an ALTER TABLE operation, merely simulates MySQL 5.7" ;
      ObSysVars[720].name_ = "old_alter_table" ;
      ObSysVars[720].data_type_ = ObIntType ;
      ObSysVars[720].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[720].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[720].id_ = SYS_VAR_OLD_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD_ALTER_TABLE] = 720 ;
      ObSysVars[720].base_value_ = "0" ;
    ObSysVars[720].alias_ = "OB_SV_OLD_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[721].default_value_ = "-1" ;
      ObSysVars[721].info_ = "The number of table definitions that can be stored in the table definition cache, merely simulates MySQL 5.7" ;
      ObSysVars[721].name_ = "table_definition_cache" ;
      ObSysVars[721].data_type_ = ObIntType ;
      ObSysVars[721].min_val_ = "400" ;
      ObSysVars[721].max_val_ = "524288" ;
      ObSysVars[721].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[721].id_ = SYS_VAR_TABLE_DEFINITION_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TABLE_DEFINITION_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TABLE_DEFINITION_CACHE] = 721 ;
      ObSysVars[721].base_value_ = "-1" ;
    ObSysVars[721].alias_ = "OB_SV_TABLE_DEFINITION_CACHE" ;
    }();

    [&] (){
      ObSysVars[722].default_value_ = "1048576" ;
      ObSysVars[722].info_ = "The sort buffer size for online DDL operations that create or rebuild secondary indexes, merely simulates MySQL 5.7" ;
      ObSysVars[722].name_ = "innodb_sort_buffer_size" ;
      ObSysVars[722].data_type_ = ObIntType ;
      ObSysVars[722].min_val_ = "65536" ;
      ObSysVars[722].max_val_ = "67108864" ;
      ObSysVars[722].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[722].id_ = SYS_VAR_INNODB_SORT_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SORT_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SORT_BUFFER_SIZE] = 722 ;
      ObSysVars[722].base_value_ = "1048576" ;
    ObSysVars[722].alias_ = "OB_SV_INNODB_SORT_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[723].default_value_ = "1024" ;
      ObSysVars[723].info_ = "The size in bytes of blocks in the key cache, merely simulates MySQL 5.7" ;
      ObSysVars[723].name_ = "key_cache_block_size" ;
      ObSysVars[723].data_type_ = ObIntType ;
      ObSysVars[723].min_val_ = "512" ;
      ObSysVars[723].max_val_ = "16384" ;
      ObSysVars[723].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[723].id_ = SYS_VAR_KEY_CACHE_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_BLOCK_SIZE] = 723 ;
      ObSysVars[723].base_value_ = "1024" ;
    ObSysVars[723].alias_ = "OB_SV_KEY_CACHE_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[724].default_value_ = "0" ;
      ObSysVars[724].info_ = "Indicate features that observer supports, readonly after modified by first observer" ;
      ObSysVars[724].name_ = "__ob_client_capability_flag" ;
      ObSysVars[724].data_type_ = ObUInt64Type ;
      ObSysVars[724].min_val_ = "0" ;
      ObSysVars[724].max_val_ = "18446744073709551615" ;
      ObSysVars[724].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
      ObSysVars[724].id_ = SYS_VAR___OB_CLIENT_CAPABILITY_FLAG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR___OB_CLIENT_CAPABILITY_FLAG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR___OB_CLIENT_CAPABILITY_FLAG] = 724 ;
      ObSysVars[724].base_value_ = "0" ;
    ObSysVars[724].alias_ = "OB_SV___OB_CLIENT_CAPABILITY_FLAG" ;
    }();

    [&] (){
      ObSysVars[725].default_value_ = "1" ;
      ObSysVars[725].info_ = "wether use parameter anonymous_block" ;
      ObSysVars[725].name_ = "ob_enable_parameter_anonymous_block" ;
      ObSysVars[725].data_type_ = ObIntType ;
      ObSysVars[725].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[725].id_ = SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK] = 725 ;
      ObSysVars[725].base_value_ = "1" ;
    ObSysVars[725].alias_ = "OB_SV_ENABLE_PARAMETER_ANONYMOUS_BLOCK" ;
    }();

    [&] (){
      ObSysVars[726].default_value_ = "" ;
      ObSysVars[726].info_ = "The directory where character sets are installed" ;
      ObSysVars[726].name_ = "character_sets_dir" ;
      ...
      ObSysVars[726].id_ = SYS_VAR_CHARACTER_SETS_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CHARACTER_SETS_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CHARACTER_SETS_DIR] = 726 ;
      ObSysVars[726].base_value_ = "" ;
    ObSysVars[726].alias_ = "OB_SV_CHARACTER_SETS_DIR" ;
    }();

    [&] (){
      ObSysVars[727].default_value_ = "%Y-%m-%d" ;
      ObSysVars[727].info_ = "" ;
      ObSysVars[727].name_ = "date_format" ;
      ...
      ObSysVars[727].id_ = SYS_VAR_DATE_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DATE_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DATE_FORMAT] = 727 ;
      ObSysVars[727].base_value_ = "%Y-%m-%d" ;
    ObSysVars[727].alias_ = "OB_SV_DATE_FORMAT" ;
    }();

    [&] (){
      ObSysVars[728].default_value_ = "%Y-%m-%d %H:%i:%s" ;
      ObSysVars[728].info_ = "" ;
      ObSysVars[728].name_ = "datetime_format" ;
      ...
      ObSysVars[728].id_ = SYS_VAR_DATETIME_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DATETIME_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DATETIME_FORMAT] = 728 ;
      ObSysVars[728].base_value_ = "%Y-%m-%d %H:%i:%s" ;
    ObSysVars[728].alias_ = "OB_SV_DATETIME_FORMAT" ;
    }();

    [&] (){
      ObSysVars[729].default_value_ = "1" ;
      ObSysVars[729].info_ = "This variable controls how the server handles clients with expired passwords" ;
      ObSysVars[729].name_ = "disconnect_on_expired_password" ;
      ...
      ObSysVars[729].id_ = SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD] = 729 ;
      ObSysVars[729].base_value_ = "1" ;
    ObSysVars[729].alias_ = "OB_SV_DISCONNECT_ON_EXPIRED_PASSWORD" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[730].name_ = "external_user" ;
      ObSysVars[730].data_type_ = ObVarcharType ;
      ObSysVars[730].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::NULLABLE | ObSysVarFlag::READONLY ;
      ObSysVars[730].id_ = SYS_VAR_EXTERNAL_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EXTERNAL_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EXTERNAL_USER] = 730 ;
      ObSysVars[730].base_value_ = "" ;
    ObSysVars[730].alias_ = "OB_SV_EXTERNAL_USER" ;
    }();

    [&] (){
      ObSysVars[731].default_value_ = "YES" ;
      ObSysVars[731].info_ = "The external user name used during the authentication process, as set by the plugin used to authenticate the client" ;
      ObSysVars[731].name_ = "have_crypt" ;
      ...
      ObSysVars[731].id_ = SYS_VAR_HAVE_CRYPT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_CRYPT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_CRYPT] = 731 ;
      ObSysVars[731].base_value_ = "YES" ;
    ObSysVars[731].alias_ = "OB_SV_HAVE_CRYPT" ;
    }();

    [&] (){
      ObSysVars[732].default_value_ = "YES" ;
      ObSysVars[732].info_ = "YES if mysqld supports dynamic loading of plugins, NO if not. If the value is NO, you cannot use options such as --plugin-load to load plugins at server startup, or the INSTALL PLUGIN statement to load plugins at runtime" ;
      ObSysVars[732].name_ = "have_dynamic_loading" ;
      ...
      ObSysVars[732].id_ = SYS_VAR_HAVE_DYNAMIC_LOADING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_DYNAMIC_LOADING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_DYNAMIC_LOADING] = 732 ;
      ObSysVars[732].base_value_ = "YES" ;
    ObSysVars[732].alias_ = "OB_SV_HAVE_DYNAMIC_LOADING" ;
    }();

    [&] (){
      ObSysVars[733].default_value_ = "" ;
      ObSysVars[733].info_ = "The location of the configuration file for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[733].name_ = "keyring_aws_conf_file" ;
      ...
      ObSysVars[733].id_ = SYS_VAR_KEYRING_AWS_CONF_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_CONF_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_CONF_FILE] = 733 ;
      ObSysVars[733].base_value_ = "" ;
    ObSysVars[733].alias_ = "OB_SV_KEYRING_AWS_CONF_FILE" ;
    }();

    [&] (){
      ObSysVars[734].default_value_ = "" ;
      ObSysVars[734].info_ = "The location of the storage file for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[734].name_ = "keyring_aws_data_file" ;
    ...
    [&] (){
      ...
      ObSysVars[735].id_ = SYS_VAR_LANGUAGE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LANGUAGE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LANGUAGE] = 735 ;
      ObSysVars[735].base_value_ = "" ;
    ObSysVars[735].alias_ = "OB_SV_LANGUAGE" ;
    }();

    [&] (){
      ObSysVars[736].default_value_ = "" ;
      ObSysVars[736].info_ = "The language to use for error messages" ;
      ObSysVars[736].name_ = "lc_messages_dir" ;
      ...
      ObSysVars[736].id_ = SYS_VAR_LC_MESSAGES_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LC_MESSAGES_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LC_MESSAGES_DIR] = 736 ;
      ObSysVars[736].base_value_ = "" ;
    ObSysVars[736].alias_ = "OB_SV_LC_MESSAGES_DIR" ;
    }();

    [&] (){
      ObSysVars[737].default_value_ = "0" ;
      ObSysVars[737].info_ = "This variable describes the case sensitivity of file names on the file system where the data directory is located" ;
      ObSysVars[737].name_ = "lower_case_file_system" ;
      ...
      ObSysVars[737].id_ = SYS_VAR_LOWER_CASE_FILE_SYSTEM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOWER_CASE_FILE_SYSTEM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOWER_CASE_FILE_SYSTEM] = 737 ;
      ObSysVars[737].base_value_ = "0" ;
    ObSysVars[737].alias_ = "OB_SV_LOWER_CASE_FILE_SYSTEM" ;
    }();

    [&] (){
      ObSysVars[738].default_value_ = "1024" ;
      ObSysVars[738].info_ = "The maximum number of bytes of memory reserved per session for computation of normalized statement digests" ;
      ObSysVars[738].name_ = "max_digest_length" ;
      ...
      ObSysVars[738].id_ = SYS_VAR_MAX_DIGEST_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_DIGEST_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_DIGEST_LENGTH] = 738 ;
      ObSysVars[738].base_value_ = "1024" ;
    ObSysVars[738].alias_ = "OB_SV_MAX_DIGEST_LENGTH" ;
    }();

    [&] (){
      ObSysVars[739].default_value_ = "ndbinfo" ;
      ObSysVars[739].info_ = "Shows the name used for the NDB information database" ;
      ObSysVars[739].name_ = "ndbinfo_database" ;
      ...
      ObSysVars[739].id_ = SYS_VAR_NDBINFO_DATABASE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_DATABASE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_DATABASE] = 739 ;
      ObSysVars[739].base_value_ = "ndbinfo" ;
    ObSysVars[739].alias_ = "OB_SV_NDBINFO_DATABASE" ;
    }();

    [&] (){
      ObSysVars[740].default_value_ = "ndb$" ;
      ObSysVars[740].info_ = "The prefix used in naming the ndbinfo database's base tables (normally hidden, unless exposed by setting ndbinfo_show_hidden" ;
      ObSysVars[740].name_ = "ndbinfo_table_prefix" ;
      ...
      ObSysVars[740].id_ = SYS_VAR_NDBINFO_TABLE_PREFIX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_TABLE_PREFIX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_TABLE_PREFIX] = 740 ;
      ObSysVars[740].base_value_ = "ndb$" ;
    ObSysVars[740].alias_ = "OB_SV_NDBINFO_TABLE_PREFIX" ;
    }();

    [&] (){
      ObSysVars[741].default_value_ = "" ;
      ObSysVars[741].info_ = "Shows the version of the ndbinfo engine in use" ;
      ObSysVars[741].name_ = "ndbinfo_version" ;
      ...
      ObSysVars[741].id_ = SYS_VAR_NDBINFO_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_VERSION] = 741 ;
      ObSysVars[741].base_value_ = "" ;
    ObSysVars[741].alias_ = "OB_SV_NDBINFO_VERSION" ;
    }();

    [&] (){
      ObSysVars[742].default_value_ = "32768" ;
      ObSysVars[742].info_ = "This sets the size in bytes that is used for NDB transaction batches" ;
      ObSysVars[742].name_ = "ndb_batch_size" ;
      ObSysVars[742].data_type_ = ObIntType ;
      ObSysVars[742].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[742].id_ = SYS_VAR_NDB_BATCH_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_BATCH_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_BATCH_SIZE] = 742 ;
      ObSysVars[742].base_value_ = "32768" ;
    ObSysVars[742].alias_ = "OB_SV_NDB_BATCH_SIZE" ;
    }();

    [&] (){
      ObSysVars[743].default_value_ = "1" ;
      ObSysVars[743].info_ = "a mysqld process can use multiple connections to the cluster, effectively mimicking several SQL nodes" ;
      ObSysVars[743].name_ = "ndb_cluster_connection_pool" ;
      ObSysVars[743].data_type_ = ObIntType ;
      ObSysVars[743].min_val_ = "1" ;
      ObSysVars[743].max_val_ = "63" ;
      ObSysVars[743].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[743].id_ = SYS_VAR_NDB_CLUSTER_CONNECTION_POOL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_CLUSTER_CONNECTION_POOL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_CLUSTER_CONNECTION_POOL] = 743 ;
      ObSysVars[743].base_value_ = "1" ;
    ObSysVars[743].alias_ = "OB_SV_NDB_CLUSTER_CONNECTION_POOL" ;
    }();

    [&] (){
      ObSysVars[744].default_value_ = "" ;
      ObSysVars[744].info_ = "Specifies a comma-separated list of node IDs for connections to the cluster used by an SQL node" ;
      ObSysVars[744].name_ = "ndb_cluster_connection_pool_nodeids" ;
      ObSysVars[744].data_type_ = ObVarcharType ;
      ObSysVars[744].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[744].id_ = SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS] = 744 ;
      ObSysVars[744].base_value_ = "" ;
    ObSysVars[744].alias_ = "OB_SV_NDB_CLUSTER_CONNECTION_POOL_NODEIDS" ;
    }();

    [&] (){
      ObSysVars[745].default_value_ = "0" ;
      ObSysVars[745].info_ = "Causes a replica mysqld to log any updates received from its immediate source to the mysql.ndb_apply_status table in its own binary log using its own server ID rather than the server ID of the source" ;
      ObSysVars[745].name_ = "ndb_log_apply_status" ;
      ...
      ObSysVars[745].id_ = SYS_VAR_NDB_LOG_APPLY_STATUS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_APPLY_STATUS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_APPLY_STATUS] = 745 ;
      ObSysVars[745].base_value_ = "0" ;
    ObSysVars[745].alias_ = "OB_SV_NDB_LOG_APPLY_STATUS" ;
    }();

    [&] (){
      ObSysVars[746].default_value_ = "1" ;
      ObSysVars[746].info_ = "Causes updates to NDB tables to be written to the binary log. Setting this variable has no effect if binary logging is not already enabled for the server using log_bin" ;
      ObSysVars[746].name_ = "ndb_log_bin" ;
      ObSysVars[746].data_type_ = ObIntType ;
      ObSysVars[746].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[746].id_ = SYS_VAR_NDB_LOG_BIN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_BIN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_BIN] = 746 ;
      ObSysVars[746].base_value_ = "1" ;
    ObSysVars[746].alias_ = "OB_SV_NDB_LOG_BIN" ;
    }();

    [&] (){
      ObSysVars[747].default_value_ = "0" ;
      ObSysVars[747].info_ = "When this option is specified, and complete logging of all found row events is not possible, the mysqld process is terminated" ;
      ObSysVars[747].name_ = "ndb_log_fail_terminate" ;
      ...
      ObSysVars[747].id_ = SYS_VAR_NDB_LOG_FAIL_TERMINATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_FAIL_TERMINATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_FAIL_TERMINATE] = 747 ;
      ObSysVars[747].base_value_ = "0" ;
    ObSysVars[747].alias_ = "OB_SV_NDB_LOG_FAIL_TERMINATE" ;
    }();

    [&] (){
      ObSysVars[748].default_value_ = "0" ;
      ObSysVars[748].info_ = "Shows whether the originating server ID and epoch are logged in the ndb_binlog_index table" ;
      ObSysVars[748].name_ = "ndb_log_orig" ;
      ...
      ObSysVars[748].id_ = SYS_VAR_NDB_LOG_ORIG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_ORIG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_ORIG] = 748 ;
      ObSysVars[748].base_value_ = "0" ;
    ObSysVars[748].alias_ = "OB_SV_NDB_LOG_ORIG" ;
    }();

    [&] (){
      ObSysVars[749].default_value_ = "0" ;
      ObSysVars[749].info_ = "shows whether a replica mysqld writes NDB transaction IDs in the binary log" ;
      ObSysVars[749].name_ = "ndb_log_transaction_id" ;
      ...
      ObSysVars[749].id_ = SYS_VAR_NDB_LOG_TRANSACTION_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_TRANSACTION_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_TRANSACTION_ID] = 749 ;
      ObSysVars[749].base_value_ = "0" ;
    ObSysVars[749].alias_ = "OB_SV_NDB_LOG_TRANSACTION_ID" ;
    }();

    [&] (){
      ObSysVars[750].default_value_ = "3" ;
      ObSysVars[750].info_ = "" ;
      ObSysVars[750].name_ = "ndb_optimized_node_selection" ;
      ...
      ObSysVars[750].id_ = SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION] = 750 ;
      ObSysVars[750].base_value_ = "3" ;
    ObSysVars[750].alias_ = "OB_SV_NDB_OPTIMIZED_NODE_SELECTION" ;
    }();

    [&] (){
      ObSysVars[751].default_value_ = "" ;
      ObSysVars[751].info_ = "If this MySQL Server is connected to an NDB cluster, this read-only variable shows the cluster system name. Otherwise, the value is an empty string" ;
      ObSysVars[751].name_ = "Ndb_system_name" ;
      ...
      ObSysVars[751].id_ = SYS_VAR_NDB_SYSTEM_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_SYSTEM_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_SYSTEM_NAME] = 751 ;
      ObSysVars[751].base_value_ = "" ;
    ObSysVars[751].alias_ = "OB_SV_NDB_SYSTEM_NAME" ;
    }();

    [&] (){
      ObSysVars[752].default_value_ = "0" ;
      ObSysVars[752].info_ = "Forces NDB to use copying of tables in the event of problems with online ALTER TABLE operations" ;
      ObSysVars[752].name_ = "ndb_use_copying_alter_table" ;
      ObSysVars[752].data_type_ = ObIntType ;
      ObSysVars[752].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[752].id_ = SYS_VAR_NDB_USE_COPYING_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_COPYING_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_COPYING_ALTER_TABLE] = 752 ;
      ObSysVars[752].base_value_ = "0" ;
    ObSysVars[752].alias_ = "OB_SV_NDB_USE_COPYING_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[753].default_value_ = "" ;
      ObSysVars[753].info_ = "NDB engine version in ndb-x.y.z format" ;
      ObSysVars[753].name_ = "ndb_version_string" ;
      ...
      ObSysVars[753].id_ = SYS_VAR_NDB_VERSION_STRING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_VERSION_STRING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_VERSION_STRING] = 753 ;
      ObSysVars[753].base_value_ = "" ;
    ObSysVars[753].alias_ = "OB_SV_NDB_VERSION_STRING" ;
    }();

    [&] (){
      ObSysVars[754].default_value_ = "30" ;
      ObSysVars[754].info_ = "This option sets the period of time that the MySQL server waits for connections to NDB Cluster management and data nodes to be established before accepting MySQL client connections." ;
      ObSysVars[754].name_ = "ndb_wait_connected" ;
      ...
      ObSysVars[754].id_ = SYS_VAR_NDB_WAIT_CONNECTED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_WAIT_CONNECTED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_WAIT_CONNECTED] = 754 ;
      ObSysVars[754].base_value_ = "30" ;
    ObSysVars[754].alias_ = "OB_SV_NDB_WAIT_CONNECTED" ;
    }();

    [&] (){
      ObSysVars[755].default_value_ = "30" ;
      ObSysVars[755].info_ = "This variable shows the period of time that the MySQL server waits for the NDB storage engine to complete setup before timing out and treating NDB as unavailable. The time is specified in seconds." ;
      ObSysVars[755].name_ = "ndb_wait_setup" ;
      ObSysVars[755].data_type_ = ObIntType ;
      ObSysVars[755].min_val_ = "0" ;
      ObSysVars[755].max_val_ = "31536000" ;
      ObSysVars[755].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[755].id_ = SYS_VAR_NDB_WAIT_SETUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_WAIT_SETUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_WAIT_SETUP] = 755 ;
      ObSysVars[755].base_value_ = "30" ;
    ObSysVars[755].alias_ = "OB_SV_NDB_WAIT_SETUP" ;
    }();

    [&] (){
      ObSysVars[756].default_value_ = "" ;
      ObSysVars[756].info_ = "If the current client is a proxy for another user, this variable is the proxy user account name" ;
      ObSysVars[756].name_ = "proxy_user" ;
      ObSysVars[756].data_type_ = ObVarcharType ;
      ObSysVars[756].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[756].id_ = SYS_VAR_PROXY_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PROXY_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PROXY_USER] = 756 ;
      ObSysVars[756].base_value_ = "" ;
    ObSysVars[756].alias_ = "OB_SV_PROXY_USER" ;
    }();

    [&] (){
      ObSysVars[757].default_value_ = "1" ;
      ObSysVars[757].info_ = "It controls whether the server autogenerates RSA private/public key-pair files in the data directory" ;
      ObSysVars[757].name_ = "sha256_password_auto_generate_rsa_keys" ;
      ...
      ObSysVars[757].id_ = SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS] = 757 ;
      ObSysVars[757].base_value_ = "1" ;
    ObSysVars[757].alias_ = "OB_SV_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS" ;
    }();

    [&] (){
      ObSysVars[758].default_value_ = "private_key.pem" ;
      ObSysVars[758].info_ = "Its value is the path name of the RSA private key file for the sha256_password authentication plugin" ;
      ObSysVars[758].name_ = "sha256_password_private_key_path" ;
      ...
      ObSysVars[758].id_ = SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH] = 758 ;
      ObSysVars[758].base_value_ = "private_key.pem" ;
    ObSysVars[758].alias_ = "OB_SV_SHA256_PASSWORD_PRIVATE_KEY_PATH" ;
    }();

    [&] (){
      ObSysVars[759].default_value_ = "public_key.pem" ;
      ObSysVars[759].info_ = "Its value is the path name of the RSA public key file for the sha256_password authentication plugin" ;
      ObSysVars[759].name_ = "sha256_password_public_key_path" ;
      ...
      ObSysVars[759].id_ = SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH] = 759 ;
      ObSysVars[759].base_value_ = "public_key.pem" ;
    ObSysVars[759].alias_ = "OB_SV_SHA256_PASSWORD_PUBLIC_KEY_PATH" ;
    }();

    [&] (){
      ObSysVars[760].default_value_ = "0" ;
      ObSysVars[760].info_ = " If the variable value is ON, the SHOW DATABASES statement is permitted only to users who have the SHOW DATABASES privilege, and the statement displays all database names" ;
      ObSysVars[760].name_ = "skip_show_database" ;
      ...
      ObSysVars[760].id_ = SYS_VAR_SKIP_SHOW_DATABASE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_SHOW_DATABASE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_SHOW_DATABASE] = 760 ;
      ObSysVars[760].base_value_ = "0" ;
    ObSysVars[760].alias_ = "OB_SV_SKIP_SHOW_DATABASE" ;
    }();

    [&] (){
      ObSysVars[761].default_value_ = "" ;
      ObSysVars[761].info_ = "This option tells the server to load the named plugins at startup" ;
      ObSysVars[761].name_ = "plugin_load" ;
      ...
      ObSysVars[761].id_ = SYS_VAR_PLUGIN_LOAD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_LOAD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_LOAD] = 761 ;
      ObSysVars[761].base_value_ = "" ;
    ObSysVars[761].alias_ = "OB_SV_PLUGIN_LOAD" ;
    }();

    [&] (){
      ObSysVars[762].default_value_ = "" ;
      ObSysVars[762].info_ = "adds a plugin or plugins to the set of plugins to be loaded at startup" ;
      ObSysVars[762].name_ = "plugin_load_add" ;
      ObSysVars[762].data_type_ = ObVarcharType ;
      ObSysVars[762].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[762].id_ = SYS_VAR_PLUGIN_LOAD_ADD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_LOAD_ADD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_LOAD_ADD] = 762 ;
      ObSysVars[762].base_value_ = "" ;
    ObSysVars[762].alias_ = "OB_SV_PLUGIN_LOAD_ADD" ;
    }();

    [&] (){
      ObSysVars[763].default_value_ = "0" ;
      ObSysVars[763].info_ = "the server stores all temporary tables on disk rather than in memory" ;
      ObSysVars[763].name_ = "big_tables" ;
      ...
      ObSysVars[763].id_ = SYS_VAR_BIG_TABLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BIG_TABLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BIG_TABLES] = 763 ;
      ObSysVars[763].base_value_ = "0" ;
    ObSysVars[763].alias_ = "OB_SV_BIG_TABLES" ;
    }();

    [&] (){
      ObSysVars[764].default_value_ = "0" ;
      ObSysVars[764].info_ = "If the check_proxy_users system variable is enabled, the server performs proxy user mapping for any authentication plugins that make such a request" ;
      ObSysVars[764].name_ = "check_proxy_users" ;
      ObSysVars[764].data_type_ = ObIntType ;
      ObSysVars[764].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[764].id_ = SYS_VAR_CHECK_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CHECK_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CHECK_PROXY_USERS] = 764 ;
      ObSysVars[764].base_value_ = "0" ;
    ObSysVars[764].alias_ = "OB_SV_CHECK_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[765].default_value_ = "0" ;
      ObSysVars[765].info_ = "The number of consecutive failed connection attempts permitted to accounts before the server adds a delay for subsequent connection attempts" ;
      ObSysVars[765].name_ = "connection_control_failed_connections_threshold" ;
      ObSysVars[765].data_type_ = ObIntType ;
      ObSysVars[765].min_val_ = "0" ;
      ObSysVars[765].max_val_ = "2147483647" ;
      ObSysVars[765].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[765].id_ = SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD] = 765 ;
      ObSysVars[765].base_value_ = "0" ;
    ObSysVars[765].alias_ = "OB_SV_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[766].default_value_ = "2147483647" ;
      ObSysVars[766].info_ = "The maximum delay in milliseconds for server response to failed connection attempts, if connection_control_failed_connections_threshold is greater than zero" ;
      ObSysVars[766].name_ = "connection_control_max_connection_delay" ;
      ...
      ObSysVars[766].id_ = SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY] = 766 ;
      ObSysVars[766].base_value_ = "2147483647" ;
    ObSysVars[766].alias_ = "OB_SV_CONNECTION_CONTROL_MAX_CONNECTION_DELAY" ;
    }();

    [&] (){
      ObSysVars[767].default_value_ = "1000" ;
      ObSysVars[767].info_ = "The minmum delay in milliseconds for server response to failed connection attempts, if connection_control_failed_connections_threshold is greater than zero" ;
      ObSysVars[767].name_ = "connection_control_min_connection_delay" ;
      ObSysVars[767].data_type_ = ObIntType ;
      ObSysVars[767].min_val_ = "1000" ;
      ObSysVars[767].max_val_ = "2147483647" ;
      ObSysVars[767].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[767].id_ = SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY] = 767 ;
      ObSysVars[767].base_value_ = "1000" ;
    ObSysVars[767].alias_ = "OB_SV_CONNECTION_CONTROL_MIN_CONNECTION_DELAY" ;
    }();

    [&] (){
      ObSysVars[768].default_value_ = "0" ;
      ObSysVars[768].info_ = "The default mode value to use for the WEEK() function" ;
      ObSysVars[768].name_ = "default_week_format" ;
      ObSysVars[768].data_type_ = ObIntType ;
      ObSysVars[768].min_val_ = "0" ;
      ObSysVars[768].max_val_ = "7" ;
      ObSysVars[768].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[768].id_ = SYS_VAR_DEFAULT_WEEK_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_WEEK_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_WEEK_FORMAT] = 768 ;
      ObSysVars[768].base_value_ = "0" ;
    ObSysVars[768].alias_ = "OB_SV_DEFAULT_WEEK_FORMAT" ;
    }();

    [&] (){
      ObSysVars[769].default_value_ = "300" ;
      ObSysVars[769].info_ = "" ;
      ObSysVars[769].name_ = "delayed_insert_timeout" ;
      ObSysVars[769].data_type_ = ObIntType ;
      ObSysVars[769].min_val_ = "1" ;
      ObSysVars[769].max_val_ = "31536000" ;
      ObSysVars[769].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[769].id_ = SYS_VAR_DELAYED_INSERT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_INSERT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_INSERT_TIMEOUT] = 769 ;
      ObSysVars[769].base_value_ = "300" ;
    ObSysVars[769].alias_ = "OB_SV_DELAYED_INSERT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[770].default_value_ = "1000" ;
      ObSysVars[770].info_ = "" ;
      ObSysVars[770].name_ = "delayed_queue_size" ;
      ObSysVars[770].data_type_ = ObUInt64Type ;
      ObSysVars[770].min_val_ = "1" ;
      ObSysVars[770].max_val_ = "18446744073709551615" ;
      ObSysVars[770].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[770].id_ = SYS_VAR_DELAYED_QUEUE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_QUEUE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_QUEUE_SIZE] = 770 ;
      ObSysVars[770].base_value_ = "1000" ;
    ObSysVars[770].alias_ = "OB_SV_DELAYED_QUEUE_SIZE" ;
    }();

    [&] (){
      ObSysVars[771].default_value_ = "200" ;
      ObSysVars[771].info_ = "This variable indicates the number of equality ranges in an equality comparison condition when the optimizer should switch from using index dives to index statistics in estimating the number of qualifying rows" ;
      ObSysVars[771].name_ = "eq_range_index_dive_limit" ;
      ObSysVars[771].data_type_ = ObIntType ;
      ObSysVars[771].min_val_ = "0" ;
      ObSysVars[771].max_val_ = "4294967295" ;
      ObSysVars[771].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[771].id_ = SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT] = 771 ;
      ObSysVars[771].base_value_ = "200" ;
    ObSysVars[771].alias_ = "OB_SV_EQ_RANGE_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[772].default_value_ = "1" ;
      ObSysVars[772].info_ = "Causes InnoDB to automatically recalculate persistent statistics after the data in a table is changed substantially, merely simulates MySQL 5.7" ;
      ObSysVars[772].name_ = "innodb_stats_auto_recalc" ;
      ObSysVars[772].data_type_ = ObIntType ;
      ObSysVars[772].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[772].id_ = SYS_VAR_INNODB_STATS_AUTO_RECALC ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_AUTO_RECALC)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_AUTO_RECALC] = 772 ;
      ObSysVars[772].base_value_ = "1" ;
    ObSysVars[772].alias_ = "OB_SV_INNODB_STATS_AUTO_RECALC" ;
    }();

    [&] (){
      ObSysVars[773].default_value_ = "0" ;
      ObSysVars[773].info_ = "When innodb_stats_include_delete_marked is enabled, ANALYZE TABLE considers delete-marked records when recalculating statistics" ;
      ObSysVars[773].name_ = "innodb_stats_include_delete_marked" ;
      ObSysVars[773].data_type_ = ObIntType ;
      ObSysVars[773].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[773].id_ = SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED] = 773 ;
      ObSysVars[773].base_value_ = "0" ;
    ObSysVars[773].alias_ = "OB_SV_INNODB_STATS_INCLUDE_DELETE_MARKED" ;
    }();

    [&] (){
      ObSysVars[774].default_value_ = "0" ;
      ObSysVars[774].info_ = "How the server treats NULL values when collecting statistics about the distribution of index values for InnoDB tables" ;
      ObSysVars[774].name_ = "innodb_stats_method" ;
      ObSysVars[774].data_type_ = ObIntType ;
      ObSysVars[774].enum_names_ = "[u'nulls_equal', u'nulls_unequal', u'nulls_ignored']" ;
      ObSysVars[774].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[774].id_ = SYS_VAR_INNODB_STATS_METHOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_METHOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_METHOD] = 774 ;
      ObSysVars[774].base_value_ = "0" ;
    ObSysVars[774].alias_ = "OB_SV_INNODB_STATS_METHOD" ;
    }();

    [&] (){
      ObSysVars[775].default_value_ = "0" ;
      ObSysVars[775].info_ = "When innodb_stats_on_metadata is enabled, InnoDB updates non-persistent statistics when metadata statements such as SHOW TABLE STATUS or when accessing the Information Schema TABLES or STATISTICS tables" ;
      ObSysVars[775].name_ = "innodb_stats_on_metadata" ;
      ObSysVars[775].data_type_ = ObIntType ;
      ObSysVars[775].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[775].id_ = SYS_VAR_INNODB_STATS_ON_METADATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_ON_METADATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_ON_METADATA] = 775 ;
      ObSysVars[775].base_value_ = "0" ;
    ObSysVars[775].alias_ = "OB_SV_INNODB_STATS_ON_METADATA" ;
    }();

    [&] (){
      ObSysVars[776].default_value_ = "" ;
      ObSysVars[776].info_ = "The session value of this variable specifies the client version token list and indicates the tokens that the client session requires the server version token list to have, merely simulates MySQL 5.7" ;
      ObSysVars[776].name_ = "version_tokens_session" ;
      ObSysVars[776].data_type_ = ObVarcharType ;
      ObSysVars[776].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[776].id_ = SYS_VAR_VERSION_TOKENS_SESSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VERSION_TOKENS_SESSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VERSION_TOKENS_SESSION] = 776 ;
      ObSysVars[776].base_value_ = "" ;
    ObSysVars[776].alias_ = "OB_SV_VERSION_TOKENS_SESSION" ;
    }();

    [&] (){
      ObSysVars[777].default_value_ = "20" ;
      ...
      ObSysVars[777].name_ = "innodb_stats_persistent_sample_pages" ;
      ...
      ObSysVars[777].id_ = SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES] = 777 ;
      ObSysVars[777].base_value_ = "20" ;
    ObSysVars[777].alias_ = "OB_SV_INNODB_STATS_PERSISTENT_SAMPLE_PAGES" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[778].name_ = "innodb_stats_sample_pages" ;
      ...
      ObSysVars[778].id_ = SYS_VAR_INNODB_STATS_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_SAMPLE_PAGES] = 778 ;
      ObSysVars[778].base_value_ = "8" ;
    ObSysVars[778].alias_ = "OB_SV_INNODB_STATS_SAMPLE_PAGES" ;
    }();

    [&] (){
      ObSysVars[779].default_value_ = "8" ;
      ...
      ObSysVars[779].name_ = "innodb_stats_transient_sample_pages" ;
      ...
      ObSysVars[779].id_ = SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES] = 779 ;
      ObSysVars[779].base_value_ = "8" ;
    ObSysVars[779].alias_ = "OB_SV_INNODB_STATS_TRANSIENT_SAMPLE_PAGES" ;
    }();

    [&] (){
      ObSysVars[780].default_value_ = "" ;
      ObSysVars[780].info_ = "The customer master key (CMK) ID obtained from the AWS KMS server and used by the keyring_aws plugin" ;
      ObSysVars[780].name_ = "keyring_aws_cmk_id" ;
      ObSysVars[780].data_type_ = ObVarcharType ;
      ObSysVars[780].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[780].id_ = SYS_VAR_KEYRING_AWS_CMK_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_CMK_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_CMK_ID] = 780 ;
      ObSysVars[780].base_value_ = "" ;
    ObSysVars[780].alias_ = "OB_SV_KEYRING_AWS_CMK_ID" ;
    }();

    [&] (){
      ObSysVars[781].default_value_ = "19" ;
      ObSysVars[781].info_ = "The AWS region for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[781].name_ = "keyring_aws_region" ;
      ObSysVars[781].data_type_ = ObIntType ;
      ObSysVars[781].enum_names_ = "[u'af-south-1', u'ap-east-1', u'ap-northeast-1', u'ap-northeast-2', u'ap-northeast-3', u'ap-south-1', u'ap-southeast-1', u'ap-southeast-2', u'ca-central-1', u'cn-north-1', u'cn-northwest-1', u'eu-central-1', u'eu-north-1', u'eu-south-1', u'eu-west-1', u'eu-west-2', u'eu-west-3', u'me-south-1', u'sa-east-1', u'us-east-1', u'us-east-2', u'us-gov-east-1', u'us-iso-east-1', u'us-iso-west-1', u'us-isob-east-1', u'us-west-1', u'us-west-2']" ;
      ObSysVars[781].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[781].id_ = SYS_VAR_KEYRING_AWS_REGION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_REGION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_REGION] = 781 ;
      ObSysVars[781].base_value_ = "19" ;
    ObSysVars[781].alias_ = "OB_SV_KEYRING_AWS_REGION" ;
    }();

    [&] (){
      ObSysVars[782].default_value_ = "" ;
      ObSysVars[782].info_ = "The path name of the data file used for secure data storage by the keyring_encrypted_file plugin" ;
      ObSysVars[782].name_ = "keyring_encrypted_file_data" ;
      ObSysVars[782].data_type_ = ObVarcharType ;
      ObSysVars[782].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[782].id_ = SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA] = 782 ;
      ObSysVars[782].base_value_ = "" ;
    ObSysVars[782].alias_ = "OB_SV_KEYRING_ENCRYPTED_FILE_DATA" ;
    }();

    [&] (){
      ObSysVars[783].default_value_ = "" ;
      ObSysVars[783].info_ = "The password used by the keyring_encrypted_file pluginn" ;
      ObSysVars[783].name_ = "keyring_encrypted_file_password" ;
      ObSysVars[783].data_type_ = ObVarcharType ;
      ObSysVars[783].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[783].id_ = SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD] = 783 ;
      ObSysVars[783].base_value_ = "" ;
    ObSysVars[783].alias_ = "OB_SV_KEYRING_ENCRYPTED_FILE_PASSWORD" ;
    }();

    [&] (){
      ObSysVars[784].default_value_ = "" ;
      ObSysVars[784].info_ = "The path name of the data file used for secure data storage by the keyring_file plugin" ;
      ObSysVars[784].name_ = "keyring_file_data" ;
      ObSysVars[784].data_type_ = ObVarcharType ;
      ObSysVars[784].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[784].id_ = SYS_VAR_KEYRING_FILE_DATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_FILE_DATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_FILE_DATA] = 784 ;
      ObSysVars[784].base_value_ = "" ;
    ObSysVars[784].alias_ = "OB_SV_KEYRING_FILE_DATA" ;
    }();

    [&] (){
      ObSysVars[785].default_value_ = "" ;
      ObSysVars[785].info_ = "The path name of the directory that stores configuration information used by the keyring_okv plugin" ;
      ObSysVars[785].name_ = "keyring_okv_conf_dir" ;
      ObSysVars[785].data_type_ = ObVarcharType ;
      ObSysVars[785].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[785].id_ = SYS_VAR_KEYRING_OKV_CONF_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_OKV_CONF_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_OKV_CONF_DIR] = 785 ;
      ObSysVars[785].base_value_ = "" ;
    ObSysVars[785].alias_ = "OB_SV_KEYRING_OKV_CONF_DIR" ;
    }();

    [&] (){
      ObSysVars[786].default_value_ = "1" ;
      ObSysVars[786].info_ = "Whether keyring operations are enabled. This variable is used during key migration operations" ;
      ObSysVars[786].name_ = "keyring_operations" ;
      ObSysVars[786].data_type_ = ObIntType ;
      ObSysVars[786].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[786].id_ = SYS_VAR_KEYRING_OPERATIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_OPERATIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_OPERATIONS] = 786 ;
      ObSysVars[786].base_value_ = "1" ;
    ObSysVars[786].alias_ = "OB_SV_KEYRING_OPERATIONS" ;
    }();

    [&] (){
      ObSysVars[787].default_value_ = "" ;
      ObSysVars[787].info_ = "enables control over optimizer behavior" ;
      ObSysVars[787].name_ = "optimizer_switch" ;
      ...
      ObSysVars[787].id_ = SYS_VAR_OPTIMIZER_SWITCH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_SWITCH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_SWITCH] = 787 ;
      ObSysVars[787].base_value_ = "" ;
    ObSysVars[787].alias_ = "OB_SV_OPTIMIZER_SWITCH" ;
    }();

    [&] (){
      ObSysVars[788].default_value_ = "100" ;
      ObSysVars[788].info_ = "After max_connect_errors successive connection requests from a host are interrupted without a successful connection, the server blocks that host from further connections" ;
      ObSysVars[788].name_ = "max_connect_errors" ;
      ObSysVars[788].data_type_ = ObUInt64Type ;
      ObSysVars[788].min_val_ = "1" ;
      ObSysVars[788].max_val_ = "18446744073709551615" ;
      ObSysVars[788].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[788].id_ = SYS_VAR_MAX_CONNECT_ERRORS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_CONNECT_ERRORS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_CONNECT_ERRORS] = 788 ;
      ObSysVars[788].base_value_ = "100" ;
    ObSysVars[788].alias_ = "OB_SV_MAX_CONNECT_ERRORS" ;
    }();

    [&] (){
      ObSysVars[789].default_value_ = "0" ;
      ObSysVars[789].info_ = "Whether MySQL Enterprise Firewall is enabled (the default) or disabled" ;
      ObSysVars[789].name_ = "mysql_firewall_mode" ;
      ObSysVars[789].data_type_ = ObIntType ;
      ObSysVars[789].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[789].id_ = SYS_VAR_MYSQL_FIREWALL_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_FIREWALL_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_FIREWALL_MODE] = 789 ;
      ObSysVars[789].base_value_ = "0" ;
    ObSysVars[789].alias_ = "OB_SV_MYSQL_FIREWALL_MODE" ;
    }();

    [&] (){
      ObSysVars[790].default_value_ = "0" ;
      ObSysVars[790].info_ = "Whether the MySQL Enterprise Firewall trace is enabled or disabled (the default)" ;
      ObSysVars[790].name_ = "mysql_firewall_trace" ;
      ObSysVars[790].data_type_ = ObIntType ;
      ObSysVars[790].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[790].id_ = SYS_VAR_MYSQL_FIREWALL_TRACE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_FIREWALL_TRACE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_FIREWALL_TRACE] = 790 ;
      ObSysVars[790].base_value_ = "0" ;
    ObSysVars[790].alias_ = "OB_SV_MYSQL_FIREWALL_TRACE" ;
    }();

    [&] (){
      ObSysVars[791].default_value_ = "0" ;
      ObSysVars[791].info_ = "This variable controls whether the mysql_native_password built-in authentication plugin supports proxy users" ;
      ObSysVars[791].name_ = "mysql_native_password_proxy_users" ;
      ObSysVars[791].data_type_ = ObIntType ;
      ObSysVars[791].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[791].id_ = SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS] = 791 ;
      ObSysVars[791].base_value_ = "0" ;
    ObSysVars[791].alias_ = "OB_SV_MYSQL_NATIVE_PASSWORD_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[792].default_value_ = "10" ;
      ObSysVars[792].info_ = "If a read or write on a communication port is interrupted, retry this many times before giving up. This value should be set quite high on FreeBSD because internal interrupts are sent to all threads" ;
      ObSysVars[792].name_ = "net_retry_count" ;
      ObSysVars[792].data_type_ = ObUInt64Type ;
      ObSysVars[792].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[792].id_ = SYS_VAR_NET_RETRY_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NET_RETRY_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NET_RETRY_COUNT] = 792 ;
      ObSysVars[792].base_value_ = "10" ;
    ObSysVars[792].alias_ = "OB_SV_NET_RETRY_COUNT" ;
    }();

    [&] (){
      ObSysVars[793].default_value_ = "0" ;
      ObSysVars[793].info_ = "This variable was used in MySQL 4.0 to turn on some 4.1 behaviors, and is retained for backward compatibility. Its value is always OFF" ;
      ObSysVars[793].name_ = "new" ;
      ...
      ObSysVars[793].id_ = SYS_VAR_NEW ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NEW)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NEW] = 793 ;
      ObSysVars[793].base_value_ = "0" ;
    ObSysVars[793].alias_ = "OB_SV_NEW" ;
    }();

    [&] (){
      ObSysVars[794].default_value_ = "0" ;
      ObSysVars[794].info_ = "This variable controls the password hashing method used by the PASSWORD() function. It also influences password hashing performed by CREATE USER and GRANT statements that specify a password using an IDENTIFIED BY clause" ;
      ObSysVars[794].name_ = "old_passwords" ;
      ObSysVars[794].data_type_ = ObIntType ;
      ObSysVars[794].enum_names_ = "[u'0', u'1', u'2']" ;
      ObSysVars[794].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[794].id_ = SYS_VAR_OLD_PASSWORDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD_PASSWORDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD_PASSWORDS] = 794 ;
      ObSysVars[794].base_value_ = "0" ;
    ObSysVars[794].alias_ = "OB_SV_OLD_PASSWORDS" ;
    }();

    [&] (){
      ObSysVars[795].default_value_ = "1" ;
      ObSysVars[795].info_ = "Controls the heuristics applied during query optimization to prune less-promising partial plans from the optimizer search space" ;
      ObSysVars[795].name_ = "optimizer_prune_level" ;
      ObSysVars[795].data_type_ = ObIntType ;
      ObSysVars[795].min_val_ = "0" ;
      ObSysVars[795].max_val_ = "1" ;
      ObSysVars[795].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[795].id_ = SYS_VAR_OPTIMIZER_PRUNE_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_PRUNE_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_PRUNE_LEVEL] = 795 ;
      ObSysVars[795].base_value_ = "1" ;
    ObSysVars[795].alias_ = "OB_SV_OPTIMIZER_PRUNE_LEVEL" ;
    }();

    [&] (){
      ObSysVars[796].default_value_ = "62" ;
      ObSysVars[796].info_ = "The maximum depth of search performed by the query optimizer" ;
      ObSysVars[796].name_ = "optimizer_search_depth" ;
      ObSysVars[796].data_type_ = ObIntType ;
      ObSysVars[796].min_val_ = "0" ;
      ObSysVars[796].max_val_ = "62" ;
      ObSysVars[796].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[796].id_ = SYS_VAR_OPTIMIZER_SEARCH_DEPTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_SEARCH_DEPTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_SEARCH_DEPTH] = 796 ;
      ObSysVars[796].base_value_ = "62" ;
    ObSysVars[796].alias_ = "OB_SV_OPTIMIZER_SEARCH_DEPTH" ;
    }();

    [&] (){
      ObSysVars[797].default_value_ = "" ;
      ObSysVars[797].info_ = "This variable controls optimizer tracing" ;
      ObSysVars[797].name_ = "optimizer_trace" ;
      ...
      ObSysVars[797].id_ = SYS_VAR_OPTIMIZER_TRACE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE] = 797 ;
      ObSysVars[797].base_value_ = "" ;
    ObSysVars[797].alias_ = "OB_SV_OPTIMIZER_TRACE" ;
    }();

    [&] (){
      ObSysVars[798].default_value_ = "" ;
      ObSysVars[798].info_ = "This variable enables or disables selected optimizer tracing features" ;
      ObSysVars[798].name_ = "optimizer_trace_features" ;
      ...
      ObSysVars[798].id_ = SYS_VAR_OPTIMIZER_TRACE_FEATURES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_FEATURES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_FEATURES] = 798 ;
      ObSysVars[798].base_value_ = "" ;
    ObSysVars[798].alias_ = "OB_SV_OPTIMIZER_TRACE_FEATURES" ;
    }();

    [&] (){
      ObSysVars[799].default_value_ = "1" ;
      ObSysVars[799].info_ = "The maximum number of optimizer traces to display" ;
      ObSysVars[799].name_ = "optimizer_trace_limit" ;
      ...
      ObSysVars[799].id_ = SYS_VAR_OPTIMIZER_TRACE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_LIMIT] = 799 ;
      ObSysVars[799].base_value_ = "1" ;
    ObSysVars[799].alias_ = "OB_SV_OPTIMIZER_TRACE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[800].default_value_ = "16384" ;
      ObSysVars[800].info_ = "The maximum cumulative size of stored optimizer traces" ;
      ObSysVars[800].name_ = "optimizer_trace_max_mem_size" ;
      ObSysVars[800].data_type_ = ObUInt64Type ;
      ObSysVars[800].min_val_ = "0" ;
      ObSysVars[800].max_val_ = "4294967295" ;
      ObSysVars[800].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[800].id_ = SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE] = 800 ;
      ObSysVars[800].base_value_ = "16384" ;
    ObSysVars[800].alias_ = "OB_SV_OPTIMIZER_TRACE_MAX_MEM_SIZE" ;
    }();

    [&] (){
      ObSysVars[801].default_value_ = "-1" ;
      ObSysVars[801].info_ = "The offset of optimizer traces to display" ;
      ObSysVars[801].name_ = "optimizer_trace_offset" ;
      ObSysVars[801].data_type_ = ObIntType ;
      ObSysVars[801].min_val_ = "-2147483647" ;
      ...
      ObSysVars[801].id_ = SYS_VAR_OPTIMIZER_TRACE_OFFSET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_OFFSET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_OFFSET] = 801 ;
      ObSysVars[801].base_value_ = "-1" ;
    ObSysVars[801].alias_ = "OB_SV_OPTIMIZER_TRACE_OFFSET" ;
    }();

    [&] (){
      ObSysVars[802].default_value_ = "18446744073709551615" ;
      ObSysVars[802].info_ = "The maximum amount of memory available to the parser" ;
      ObSysVars[802].name_ = "parser_max_mem_size" ;
      ObSysVars[802].data_type_ = ObUInt64Type ;
      ObSysVars[802].min_val_ = "10000000" ;
      ObSysVars[802].max_val_ = "18446744073709551615" ;
      ObSysVars[802].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[802].id_ = SYS_VAR_PARSER_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARSER_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PARSER_MAX_MEM_SIZE] = 802 ;
      ObSysVars[802].base_value_ = "18446744073709551615" ;
    ObSysVars[802].alias_ = "OB_SV_PARSER_MAX_MEM_SIZE" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[803].name_ = "rand_seed1" ;
      ...
      ObSysVars[803].id_ = SYS_VAR_RAND_SEED1 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RAND_SEED1)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RAND_SEED1] = 803 ;
      ObSysVars[803].base_value_ = "0" ;
    ObSysVars[803].alias_ = "OB_SV_RAND_SEED1" ;
    }();

    [&] (){
      ObSysVars[804].default_value_ = "0" ;
      ObSysVars[804].info_ = "For statements that invoke RAND(), the source passes two values to the replica, where they are used to seed the random number generator" ;
      ObSysVars[804].name_ = "rand_seed2" ;
      ObSysVars[804].data_type_ = ObUInt64Type ;
      ObSysVars[804].min_val_ = "0" ;
      ObSysVars[804].max_val_ = "4294967295" ;
      ObSysVars[804].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[804].id_ = SYS_VAR_RAND_SEED2 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RAND_SEED2)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RAND_SEED2] = 804 ;
      ObSysVars[804].base_value_ = "0" ;
    ObSysVars[804].alias_ = "OB_SV_RAND_SEED2" ;
    }();

    [&] (){
      ObSysVars[805].default_value_ = "4096" ;
      ObSysVars[805].info_ = "The size in bytes of blocks that are allocated when doing range optimization" ;
      ObSysVars[805].name_ = "range_alloc_block_size" ;
      ObSysVars[805].data_type_ = ObUInt64Type ;
      ObSysVars[805].min_val_ = "4096" ;
      ObSysVars[805].max_val_ = "18446744073709550592" ;
      ObSysVars[805].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[805].id_ = SYS_VAR_RANGE_ALLOC_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_ALLOC_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_ALLOC_BLOCK_SIZE] = 805 ;
      ObSysVars[805].base_value_ = "4096" ;
    ObSysVars[805].alias_ = "OB_SV_RANGE_ALLOC_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[806].default_value_ = "8388608" ;
      ObSysVars[806].info_ = "The limit on memory consumption for the range optimizer" ;
      ObSysVars[806].name_ = "range_optimizer_max_mem_size" ;
      ObSysVars[806].data_type_ = ObUInt64Type ;
      ObSysVars[806].min_val_ = "0" ;
      ObSysVars[806].max_val_ = "18446744073709551615" ;
      ObSysVars[806].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[806].id_ = SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE] = 806 ;
      ObSysVars[806].base_value_ = "8388608" ;
    ObSysVars[806].alias_ = "OB_SV_RANGE_OPTIMIZER_MAX_MEM_SIZE" ;
    }();

    [&] (){
      ObSysVars[807].default_value_ = "1" ;
      ObSysVars[807].info_ = "Whether the Rewriter query rewrite plugin is enabled" ;
      ObSysVars[807].name_ = "rewriter_enabled" ;
      ObSysVars[807].data_type_ = ObIntType ;
      ObSysVars[807].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[807].id_ = SYS_VAR_REWRITER_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REWRITER_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REWRITER_ENABLED] = 807 ;
      ObSysVars[807].base_value_ = "1" ;
    ObSysVars[807].alias_ = "OB_SV_REWRITER_ENABLED" ;
    }();

    [&] (){
      ObSysVars[808].default_value_ = "0" ;
      ObSysVars[808].info_ = "For internal use in MySQL" ;
      ObSysVars[808].name_ = "rewriter_verbose" ;
      ObSysVars[808].data_type_ = ObIntType ;
      ObSysVars[808].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[808].id_ = SYS_VAR_REWRITER_VERBOSE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REWRITER_VERBOSE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REWRITER_VERBOSE] = 808 ;
      ObSysVars[808].base_value_ = "0" ;
    ObSysVars[808].alias_ = "OB_SV_REWRITER_VERBOSE" ;
    }();

    [&] (){
      ObSysVars[809].default_value_ = "1" ;
      ObSysVars[809].info_ = "If this variable is enabled, the server blocks connections by clients that attempt to use accounts that have passwords stored in the old (pre-4.1) format" ;
      ObSysVars[809].name_ = "secure_auth" ;
      ObSysVars[809].data_type_ = ObIntType ;
      ObSysVars[809].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[809].id_ = SYS_VAR_SECURE_AUTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SECURE_AUTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SECURE_AUTH] = 809 ;
      ObSysVars[809].base_value_ = "1" ;
    ObSysVars[809].alias_ = "OB_SV_SECURE_AUTH" ;
    }();

    [&] (){
      ObSysVars[810].default_value_ = "0" ;
      ObSysVars[810].info_ = "This variable controls whether the sha256_password built-in authentication plugin supports proxy users" ;
      ObSysVars[810].name_ = "sha256_password_proxy_users" ;
      ObSysVars[810].data_type_ = ObIntType ;
      ObSysVars[810].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[810].id_ = SYS_VAR_SHA256_PASSWORD_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PROXY_USERS] = 810 ;
      ObSysVars[810].base_value_ = "0" ;
    ObSysVars[810].alias_ = "OB_SV_SHA256_PASSWORD_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[811].default_value_ = "0" ;
      ObSysVars[811].info_ = "which affects whether MySQL 5.6 compatibility is enabled with respect to how system and status variable information is provided by the INFORMATION_SCHEMA and Performance Schema tables, and also by the SHOW VARIABLES and SHOW STATUS statements" ;
      ObSysVars[811].name_ = "show_compatibility_56" ;
      ObSysVars[811].data_type_ = ObIntType ;
      ObSysVars[811].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[811].id_ = SYS_VAR_SHOW_COMPATIBILITY_56 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_COMPATIBILITY_56)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_COMPATIBILITY_56] = 811 ;
      ObSysVars[811].base_value_ = "0" ;
    ObSysVars[811].alias_ = "OB_SV_SHOW_COMPATIBILITY_56" ;
    }();

    [&] (){
      ObSysVars[812].default_value_ = "0" ;
      ObSysVars[812].info_ = "Enabling this variable causes SHOW CREATE TABLE to display ROW_FORMAT regardless of whether it is the default format" ;
      ObSysVars[812].name_ = "show_create_table_verbosity" ;
      ...
      ObSysVars[812].id_ = SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY] = 812 ;
      ObSysVars[812].base_value_ = "0" ;
    ObSysVars[812].alias_ = "OB_SV_SHOW_CREATE_TABLE_VERBOSITY" ;
    }();

    [&] (){
      ObSysVars[813].default_value_ = "0" ;
      ObSysVars[813].info_ = "Whether SHOW CREATE TABLE output includes comments" ;
      ObSysVars[813].name_ = "show_old_temporals" ;
      ...
      ObSysVars[813].id_ = SYS_VAR_SHOW_OLD_TEMPORALS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_OLD_TEMPORALS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_OLD_TEMPORALS] = 813 ;
      ObSysVars[813].base_value_ = "0" ;
    ObSysVars[813].alias_ = "OB_SV_SHOW_OLD_TEMPORALS" ;
    }();

    [&] (){
      ObSysVars[814].default_value_ = "1" ;
      ObSysVars[814].info_ = "If set to OFF, MySQL aborts SELECT statements that are likely to take a very long time to execute" ;
      ObSysVars[814].name_ = "sql_big_selects" ;
      ...
      ObSysVars[814].id_ = SYS_VAR_SQL_BIG_SELECTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_BIG_SELECTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SQL_BIG_SELECTS] = 814 ;
      ObSysVars[814].base_value_ = "1" ;
    ObSysVars[814].alias_ = "OB_SV_SQL_BIG_SELECTS" ;
    }();

    [&] (){
      ObSysVars[815].default_value_ = "1" ;
      ObSysVars[815].info_ = "This variable controls whether updates to a view can be made when the view does not contain all columns of the primary key defined in the underlying table, if the update statement contains a LIMIT clause" ;
      ObSysVars[815].name_ = "updatable_views_with_limit" ;
      ObSysVars[815].data_type_ = ObIntType ;
      ObSysVars[815].enum_names_ = "[u'OFF', u'ON', u'NO', u'YES']" ;
      ObSysVars[815].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[815].id_ = SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT] = 815 ;
      ObSysVars[815].base_value_ = "1" ;
    ObSysVars[815].alias_ = "OB_SV_UPDATABLE_VIEWS_WITH_LIMIT" ;
    }();

    [&] (){
      ObSysVars[816].default_value_ = "" ;
      ObSysVars[816].info_ = "The path name of the dictionary file that validate_password uses for checking passwords." ;
      ObSysVars[816].name_ = "validate_password_dictionary_file" ;
      ObSysVars[816].data_type_ = ObVarcharType ;
      ObSysVars[816].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[816].id_ = SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE] = 816 ;
      ObSysVars[816].base_value_ = "" ;
    ObSysVars[816].alias_ = "OB_SV_VALIDATE_PASSWORD_DICTIONARY_FILE" ;
    }();

    [&] (){
      ObSysVars[817].default_value_ = "100" ;
      ObSysVars[817].info_ = "" ;
      ObSysVars[817].name_ = "delayed_insert_limit" ;
      ObSysVars[817].data_type_ = ObUInt64Type ;
      ObSysVars[817].min_val_ = "1" ;
      ObSysVars[817].max_val_ = "18446744073709551615" ;
      ObSysVars[817].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[817].id_ = SYS_VAR_DELAYED_INSERT_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_INSERT_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_INSERT_LIMIT] = 817 ;
      ObSysVars[817].base_value_ = "100" ;
    ObSysVars[817].alias_ = "OB_SV_DELAYED_INSERT_LIMIT" ;
    }();

    [&] (){
      ObSysVars[818].default_value_ = "" ;
      ObSysVars[818].info_ = "NDB engine version in ndb-x.y.z format" ;
      ObSysVars[818].name_ = "ndb_version" ;
      ...
      ObSysVars[818].id_ = SYS_VAR_NDB_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_VERSION] = 818 ;
      ObSysVars[818].base_value_ = "" ;
    ObSysVars[818].alias_ = "OB_SV_NDB_VERSION" ;
    }();

    [&] (){
      ObSysVars[819].default_value_ = "1" ;
      ObSysVars[819].info_ = "This variable is available if the server was compiled using OpenSSL. It controls whether the server autogenerates SSL key and certificate files in the data directory, if they do not already exist" ;
      ObSysVars[819].name_ = "auto_generate_certs" ;
      ObSysVars[819].data_type_ = ObIntType ;
      ObSysVars[819].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[819].id_ = SYS_VAR_AUTO_GENERATE_CERTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AUTO_GENERATE_CERTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_AUTO_GENERATE_CERTS] = 819 ;
      ObSysVars[819].base_value_ = "1" ;
    ObSysVars[819].alias_ = "OB_SV_AUTO_GENERATE_CERTS" ;
    }();

    [&] (){
      ObSysVars[820].default_value_ = "1" ;
      ObSysVars[820].info_ = "control cost-based transformation search policy" ;
      ObSysVars[820].name_ = "_optimizer_cost_based_transformation" ;
      ObSysVars[820].data_type_ = ObIntType ;
      ObSysVars[820].min_val_ = "0" ;
      ObSysVars[820].max_val_ = "2" ;
      ObSysVars[820].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[820].id_ = SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION] = 820 ;
      ObSysVars[820].base_value_ = "1" ;
    ObSysVars[820].alias_ = "OB_SV__OPTIMIZER_COST_BASED_TRANSFORMATION" ;
    }();

    [&] (){
      ObSysVars[821].default_value_ = "10" ;
      ObSysVars[821].info_ = "Indicate the limit on the number of ranges when optimizer use storage cardinality estimation" ;
      ObSysVars[821].name_ = "range_index_dive_limit" ;
      ObSysVars[821].data_type_ = ObIntType ;
      ObSysVars[821].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE ;
      ObSysVars[821].id_ = SYS_VAR_RANGE_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_INDEX_DIVE_LIMIT] = 821 ;
      ObSysVars[821].base_value_ = "10" ;
    ObSysVars[821].alias_ = "OB_SV_RANGE_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[822].default_value_ = "10" ;
      ObSysVars[822].info_ = "Indicate the limit on the number of partitions when optimizer use storage cardinality estimation" ;
      ObSysVars[822].name_ = "partition_index_dive_limit" ;
      ObSysVars[822].data_type_ = ObIntType ;
      ObSysVars[822].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE ;
      ObSysVars[822].id_ = SYS_VAR_PARTITION_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARTITION_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PARTITION_INDEX_DIVE_LIMIT] = 822 ;
      ObSysVars[822].base_value_ = "10" ;
    ObSysVars[822].alias_ = "OB_SV_PARTITION_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[823].default_value_ = "2" ;
      ObSysVars[823].info_ = "Control the optimizer to generate a table access plan that prefers a specific storage format." ;
      ObSysVars[823].name_ = "ob_table_access_policy" ;
      ObSysVars[823].data_type_ = ObIntType ;
      ObSysVars[823].enum_names_ = "[u'ROW_STORE', u'COLUMN_STORE', u'AUTO']" ;
      ObSysVars[823].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[823].id_ = SYS_VAR_OB_TABLE_ACCESS_POLICY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TABLE_ACCESS_POLICY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_TABLE_ACCESS_POLICY] = 823 ;
      ObSysVars[823].base_value_ = "2" ;
    ObSysVars[823].alias_ = "OB_SV_TABLE_ACCESS_POLICY" ;
    }();

    [&] (){
      ObSysVars[824].default_value_ = "3" ;
      ObSysVars[824].info_ = "The path name of the file in which the server writes its process ID" ;
      ObSysVars[824].name_ = "pid_file" ;
      ...
      ObSysVars[824].id_ = SYS_VAR_PID_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PID_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PID_FILE] = 824 ;
      ObSysVars[824].base_value_ = "3" ;
    ObSysVars[824].alias_ = "OB_SV_PID_FILE" ;
    }();

    [&] (){
      ObSysVars[825].default_value_ = "3" ;
      ObSysVars[825].info_ = "The number of the port on which the server listens for TCP/IP connections" ;
      ObSysVars[825].name_ = "port" ;
      ...
      ObSysVars[825].id_ = SYS_VAR_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PORT] = 825 ;
      ObSysVars[825].base_value_ = "3" ;
    ObSysVars[825].alias_ = "OB_SV_PORT" ;
    }();

    [&] (){
      ObSysVars[826].default_value_ = "3" ;
      ObSysVars[826].info_ = "the name of the socket file that is used for local client connections" ;
      ObSysVars[826].name_ = "socket" ;
      ...
      ObSysVars[826].id_ = SYS_VAR_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SOCKET] = 826 ;
      ObSysVars[826].base_value_ = "3" ;
    ObSysVars[826].alias_ = "OB_SV_SOCKET" ;
    }();

    [&] (){
      ObSysVars[827].default_value_ = "4" ;
      ObSysVars[827].info_ = "The default refresh parallelism of materialized view" ;
      ObSysVars[827].name_ = "mview_refresh_dop" ;
      ObSysVars[827].data_type_ = ObUInt64Type ;
      ObSysVars[827].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[827].id_ = SYS_VAR_MVIEW_REFRESH_DOP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MVIEW_REFRESH_DOP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MVIEW_REFRESH_DOP] = 827 ;
      ObSysVars[827].base_value_ = "4" ;
    ObSysVars[827].alias_ = "OB_SV_MVIEW_REFRESH_DOP" ;
    }();

    [&] (){
      ObSysVars[828].default_value_ = "1" ;
      ObSysVars[828].info_ = "Control whether the optimizer considers the impact of rowgoal (such as the LIMIT operator, etc.) during cardinality estimation." ;
      ObSysVars[828].name_ = "enable_optimizer_rowgoal" ;
      ObSysVars[828].data_type_ = ObIntType ;
      ObSysVars[828].enum_names_ = "[u'OFF', u'AUTO', u'ON']" ;
      ObSysVars[828].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[828].id_ = SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL] = 828 ;
      ObSysVars[828].base_value_ = "1" ;
    ObSysVars[828].alias_ = "OB_SV_ENABLE_OPTIMIZER_ROWGOAL" ;
    }();

    [&] (){
      ObSysVars[829].default_value_ = "8" ;
      ObSysVars[829].info_ = "The number of nearest cluster centers from the IVF vector index searched during this session." ;
      ObSysVars[829].name_ = "ob_ivf_nprobes" ;
      ObSysVars[829].data_type_ = ObUInt64Type ;
      ObSysVars[829].min_val_ = "1" ;
      ObSysVars[829].max_val_ = "65536" ;
      ObSysVars[829].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[829].id_ = SYS_VAR_OB_IVF_NPROBES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_IVF_NPROBES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_IVF_NPROBES] = 829 ;
      ObSysVars[829].base_value_ = "8" ;
    ObSysVars[829].alias_ = "OB_SV_IVF_NPROBES" ;
    }();

    [&] (){
      ObSysVars[830].default_value_ = "0" ;
      ObSysVars[830].info_ = "The default catalog for session." ;
      ObSysVars[830].name_ = "_current_default_catalog" ;
      ObSysVars[830].data_type_ = ObUInt64Type ;
      ObSysVars[830].min_val_ = "0" ;
      ObSysVars[830].max_val_ = "18446744073709551615" ;
      ObSysVars[830].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::READONLY ;
      ObSysVars[830].id_ = SYS_VAR__CURRENT_DEFAULT_CATALOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__CURRENT_DEFAULT_CATALOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__CURRENT_DEFAULT_CATALOG] = 830 ;
      ObSysVars[830].base_value_ = "0" ;
    ObSysVars[830].alias_ = "OB_SV__CURRENT_DEFAULT_CATALOG" ;
    }();

    [&] (){
      ObSysVars[831].default_value_ = "1" ;
      ObSysVars[831].info_ = "wether use parameter anonymous_block in ps mode" ;
      ObSysVars[831].name_ = "ob_enable_ps_parameter_anonymous_block" ;
      ObSysVars[831].data_type_ = ObIntType ;
      ObSysVars[831].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[831].id_ = SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK] = 831 ;
      ObSysVars[831].base_value_ = "1" ;
    ObSysVars[831].alias_ = "OB_SV_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK" ;
    }();
    ...
    [&] (){
      ObSysVars[834].default_value_ = "0" ;
      ObSysVars[834].info_ = "set the smallest drop_ratio of values across all dimensions of the query vector to zero" ;
      ObSysVars[834].name_ = "ob_sparse_drop_ratio_search" ;
      ObSysVars[834].data_type_ = ObUInt64Type ;
      ObSysVars[834].min_val_ = "0" ;
      ObSysVars[834].max_val_ = "100" ;
      ObSysVars[834].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[834].id_ = SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH] = 834 ;
      ObSysVars[834].base_value_ = "0" ;
    ObSysVars[834].alias_ = "OB_SV_SPARSE_DROP_RATIO_SEARCH" ;
    }();
