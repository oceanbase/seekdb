...
static struct VarsInit{
  VarsInit(){
    ...
    [&] (){
      ObSysVars[234].default_value_ = "1.0.0.0" ;
    ...
    [&] (){
      ...
      ObSysVars[260].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::INFLUENCE_PL ;
    ...
    [&] (){
      ...
      ObSysVars[410].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PL ;
    ...
    [&] (){
      ...
      ObSysVars[476].info_ = "Whether the MySQL Event Scheduler is enabled." ;
      ObSysVars[476].name_ = "event_scheduler" ;
      ObSysVars[476].data_type_ = ObIntType ;
      ObSysVars[476].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[476].id_ = SYS_VAR_EVENT_SCHEDULER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EVENT_SCHEDULER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EVENT_SCHEDULER] = 476 ;
      ObSysVars[476].base_value_ = "0" ;
    ObSysVars[476].alias_ = "OB_SV_EVENT_SCHEDULER" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[477].max_val_ = "3" ;
      ObSysVars[477].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[477].id_ = SYS_VAR_PLSQL_OPTIMIZE_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLSQL_OPTIMIZE_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PLSQL_OPTIMIZE_LEVEL] = 477 ;
      ObSysVars[477].base_value_ = "2" ;
    ObSysVars[477].alias_ = "OB_SV_PLSQL_OPTIMIZE_LEVEL" ;
    }();

    [&] (){
      ObSysVars[478].default_value_ = "0" ;
      ObSysVars[478].info_ = "mock for mysql5.7" ;
      ObSysVars[478].name_ = "low_priority_updates" ;
      ...
      ObSysVars[478].id_ = SYS_VAR_LOW_PRIORITY_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOW_PRIORITY_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOW_PRIORITY_UPDATES] = 478 ;
      ObSysVars[478].base_value_ = "0" ;
    ObSysVars[478].alias_ = "OB_SV_LOW_PRIORITY_UPDATES" ;
    }();

    [&] (){
      ObSysVars[479].default_value_ = "64" ;
      ObSysVars[479].info_ = "mock for mysql5.7" ;
      ObSysVars[479].name_ = "max_error_count" ;
      ObSysVars[479].data_type_ = ObIntType ;
      ObSysVars[479].min_val_ = "0" ;
      ObSysVars[479].max_val_ = "65535" ;
      ObSysVars[479].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[479].id_ = SYS_VAR_MAX_ERROR_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_ERROR_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_ERROR_COUNT] = 479 ;
      ObSysVars[479].base_value_ = "64" ;
    ObSysVars[479].alias_ = "OB_SV_MAX_ERROR_COUNT" ;
    }();

    [&] (){
      ObSysVars[480].default_value_ = "0" ;
      ObSysVars[480].info_ = "mock for mysql5.7" ;
      ObSysVars[480].name_ = "max_insert_delayed_threads" ;
      ObSysVars[480].data_type_ = ObIntType ;
      ObSysVars[480].min_val_ = "20" ;
      ObSysVars[480].max_val_ = "16384" ;
      ObSysVars[480].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[480].id_ = SYS_VAR_MAX_INSERT_DELAYED_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_INSERT_DELAYED_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_INSERT_DELAYED_THREADS] = 480 ;
      ObSysVars[480].base_value_ = "0" ;
    ObSysVars[480].alias_ = "OB_SV_MAX_INSERT_DELAYED_THREADS" ;
    }();

    [&] (){
      ObSysVars[481].default_value_ = "built-in" ;
      ObSysVars[481].info_ = "mock for mysql5.7" ;
      ObSysVars[481].name_ = "ft_stopword_file" ;
      ObSysVars[481].data_type_ = ObVarcharType ;
      ObSysVars[481].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[481].id_ = SYS_VAR_FT_STOPWORD_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_FT_STOPWORD_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_FT_STOPWORD_FILE] = 481 ;
      ObSysVars[481].base_value_ = "built-in" ;
    ObSysVars[481].alias_ = "OB_SV_FT_STOPWORD_FILE" ;
    }();

    [&] (){
      ObSysVars[482].default_value_ = "8000000" ;
      ObSysVars[482].info_ = "mock for mysql5.7" ;
      ObSysVars[482].name_ = "innodb_ft_cache_size" ;
      ObSysVars[482].data_type_ = ObIntType ;
      ObSysVars[482].min_val_ = "1600000" ;
      ObSysVars[482].max_val_ = "80000000" ;
      ObSysVars[482].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[482].id_ = SYS_VAR_INNODB_FT_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_CACHE_SIZE] = 482 ;
      ObSysVars[482].base_value_ = "8000000" ;
    ObSysVars[482].alias_ = "OB_SV_INNODB_FT_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[483].default_value_ = "2" ;
      ObSysVars[483].info_ = "mock for mysql5.7" ;
      ObSysVars[483].name_ = "innodb_ft_sort_pll_degree" ;
      ObSysVars[483].data_type_ = ObIntType ;
      ObSysVars[483].min_val_ = "1" ;
      ObSysVars[483].max_val_ = "16" ;
      ObSysVars[483].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[483].id_ = SYS_VAR_INNODB_FT_SORT_PLL_DEGREE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_SORT_PLL_DEGREE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_SORT_PLL_DEGREE] = 483 ;
      ObSysVars[483].base_value_ = "2" ;
    ObSysVars[483].alias_ = "OB_SV_INNODB_FT_SORT_PLL_DEGREE" ;
    }();

    [&] (){
      ObSysVars[484].default_value_ = "640000000" ;
      ObSysVars[484].info_ = "mock for mysql5.7" ;
      ObSysVars[484].name_ = "innodb_ft_total_cache_size" ;
      ObSysVars[484].data_type_ = ObIntType ;
      ObSysVars[484].min_val_ = "32000000" ;
      ObSysVars[484].max_val_ = "1600000000" ;
      ObSysVars[484].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[484].id_ = SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_TOTAL_CACHE_SIZE] = 484 ;
      ObSysVars[484].base_value_ = "640000000" ;
    ObSysVars[484].alias_ = "OB_SV_INNODB_FT_TOTAL_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[485].default_value_ = "" ;
      ObSysVars[485].info_ = "mock for mysql5.7" ;
      ObSysVars[485].name_ = "mecab_rc_file" ;
      ObSysVars[485].data_type_ = ObVarcharType ;
      ObSysVars[485].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[485].id_ = SYS_VAR_MECAB_RC_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MECAB_RC_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MECAB_RC_FILE] = 485 ;
      ObSysVars[485].base_value_ = "" ;
    ObSysVars[485].alias_ = "OB_SV_MECAB_RC_FILE" ;
    }();

    [&] (){
      ObSysVars[486].default_value_ = "1024" ;
      ObSysVars[486].info_ = "mock for mysql5.7" ;
      ObSysVars[486].name_ = "metadata_locks_cache_size" ;
      ObSysVars[486].data_type_ = ObIntType ;
      ObSysVars[486].min_val_ = "1" ;
      ObSysVars[486].max_val_ = "1048576" ;
      ObSysVars[486].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[486].id_ = SYS_VAR_METADATA_LOCKS_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_METADATA_LOCKS_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_METADATA_LOCKS_CACHE_SIZE] = 486 ;
      ObSysVars[486].base_value_ = "1024" ;
    ObSysVars[486].alias_ = "OB_SV_METADATA_LOCKS_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[487].default_value_ = "8" ;
      ObSysVars[487].info_ = "mock for mysql5.7" ;
      ObSysVars[487].name_ = "metadata_locks_hash_instances" ;
      ObSysVars[487].data_type_ = ObIntType ;
      ObSysVars[487].min_val_ = "1" ;
      ObSysVars[487].max_val_ = "1024" ;
      ObSysVars[487].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[487].id_ = SYS_VAR_METADATA_LOCKS_HASH_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_METADATA_LOCKS_HASH_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_METADATA_LOCKS_HASH_INSTANCES] = 487 ;
      ObSysVars[487].base_value_ = "8" ;
    ObSysVars[487].alias_ = "OB_SV_METADATA_LOCKS_HASH_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[488].default_value_ = "ibtmp1:12M:autoextend" ;
      ObSysVars[488].info_ = "mock for mysql5.7" ;
      ObSysVars[488].name_ = "innodb_temp_data_file_path" ;
      ObSysVars[488].data_type_ = ObVarcharType ;
      ObSysVars[488].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[488].id_ = SYS_VAR_INNODB_TEMP_DATA_FILE_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TEMP_DATA_FILE_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TEMP_DATA_FILE_PATH] = 488 ;
      ObSysVars[488].base_value_ = "ibtmp1:12M:autoextend" ;
    ObSysVars[488].alias_ = "OB_SV_INNODB_TEMP_DATA_FILE_PATH" ;
    }();

    [&] (){
      ObSysVars[489].default_value_ = "ibdata1:12M:autoextend" ;
      ObSysVars[489].info_ = "mock for mysql5.7" ;
      ObSysVars[489].name_ = "innodb_data_file_path" ;
      ObSysVars[489].data_type_ = ObVarcharType ;
      ObSysVars[489].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[489].id_ = SYS_VAR_INNODB_DATA_FILE_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DATA_FILE_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DATA_FILE_PATH] = 489 ;
      ObSysVars[489].base_value_ = "ibdata1:12M:autoextend" ;
    ObSysVars[489].alias_ = "OB_SV_INNODB_DATA_FILE_PATH" ;
    }();

    [&] (){
      ObSysVars[490].default_value_ = "" ;
      ObSysVars[490].info_ = "mock for mysql5.7" ;
      ObSysVars[490].name_ = "innodb_data_home_dir" ;
      ObSysVars[490].data_type_ = ObVarcharType ;
      ObSysVars[490].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[490].id_ = SYS_VAR_INNODB_DATA_HOME_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_DATA_HOME_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_DATA_HOME_DIR] = 490 ;
      ObSysVars[490].base_value_ = "" ;
    ObSysVars[490].alias_ = "OB_SV_INNODB_DATA_HOME_DIR" ;
    }();

    [&] (){
      ObSysVars[491].default_value_ = "0" ;
      ObSysVars[491].info_ = "mock for mysql5.7" ;
      ObSysVars[491].name_ = "avoid_temporal_upgrade" ;
      ObSysVars[491].data_type_ = ObIntType ;
      ObSysVars[491].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[491].id_ = SYS_VAR_AVOID_TEMPORAL_UPGRADE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AVOID_TEMPORAL_UPGRADE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_AVOID_TEMPORAL_UPGRADE] = 491 ;
      ObSysVars[491].base_value_ = "0" ;
    ObSysVars[491].alias_ = "OB_SV_AVOID_TEMPORAL_UPGRADE" ;
    }();

    [&] (){
      ObSysVars[492].default_value_ = "0" ;
      ObSysVars[492].info_ = "mock for mysql5.7" ;
      ObSysVars[492].name_ = "default_tmp_storage_engine" ;
      ObSysVars[492].data_type_ = ObIntType ;
      ObSysVars[492].enum_names_ = "[u'InnoDB']" ;
      ObSysVars[492].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[492].id_ = SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_TMP_STORAGE_ENGINE] = 492 ;
      ObSysVars[492].base_value_ = "0" ;
    ObSysVars[492].alias_ = "OB_SV_DEFAULT_TMP_STORAGE_ENGINE" ;
    }();

    [&] (){
      ObSysVars[493].default_value_ = "0" ;
      ObSysVars[493].info_ = "mock for mysql5.7" ;
      ObSysVars[493].name_ = "innodb_ft_enable_diag_print" ;
      ObSysVars[493].data_type_ = ObIntType ;
      ObSysVars[493].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[493].id_ = SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_ENABLE_DIAG_PRINT] = 493 ;
      ObSysVars[493].base_value_ = "0" ;
    ObSysVars[493].alias_ = "OB_SV_INNODB_FT_ENABLE_DIAG_PRINT" ;
    }();

    [&] (){
      ObSysVars[494].default_value_ = "2000" ;
      ObSysVars[494].info_ = "mock for mysql5.7" ;
      ObSysVars[494].name_ = "innodb_ft_num_word_optimize" ;
      ObSysVars[494].data_type_ = ObIntType ;
      ObSysVars[494].min_val_ = "1000" ;
      ObSysVars[494].max_val_ = "10000" ;
      ObSysVars[494].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[494].id_ = SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_NUM_WORD_OPTIMIZE] = 494 ;
      ObSysVars[494].base_value_ = "2000" ;
    ObSysVars[494].alias_ = "OB_SV_INNODB_FT_NUM_WORD_OPTIMIZE" ;
    }();

    [&] (){
      ObSysVars[495].default_value_ = "2000000000" ;
      ObSysVars[495].info_ = "mock for mysql5.7" ;
      ObSysVars[495].name_ = "innodb_ft_result_cache_limit" ;
      ObSysVars[495].data_type_ = ObUInt64Type ;
      ObSysVars[495].min_val_ = "1000000" ;
      ObSysVars[495].max_val_ = "4294967295" ;
      ObSysVars[495].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[495].id_ = SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_RESULT_CACHE_LIMIT] = 495 ;
      ObSysVars[495].base_value_ = "2000000000" ;
    ObSysVars[495].alias_ = "OB_SV_INNODB_FT_RESULT_CACHE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[496].default_value_ = "" ;
      ObSysVars[496].info_ = "mock for mysql5.7" ;
      ObSysVars[496].name_ = "innodb_ft_server_stopword_table" ;
      ObSysVars[496].data_type_ = ObVarcharType ;
      ObSysVars[496].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[496].id_ = SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_FT_SERVER_STOPWORD_TABLE] = 496 ;
      ObSysVars[496].base_value_ = "" ;
    ObSysVars[496].alias_ = "OB_SV_INNODB_FT_SERVER_STOPWORD_TABLE" ;
    }();

    [&] (){
      ObSysVars[497].default_value_ = "0" ;
      ObSysVars[497].info_ = "mock for mysql5.7" ;
      ObSysVars[497].name_ = "innodb_optimize_fulltext_only" ;
      ObSysVars[497].data_type_ = ObIntType ;
      ObSysVars[497].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[497].id_ = SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_OPTIMIZE_FULLTEXT_ONLY] = 497 ;
      ObSysVars[497].base_value_ = "0" ;
    ObSysVars[497].alias_ = "OB_SV_INNODB_OPTIMIZE_FULLTEXT_ONLY" ;
    }();

    [&] (){
      ObSysVars[498].default_value_ = "32" ;
      ObSysVars[498].info_ = "mock for mysql5.7" ;
      ObSysVars[498].name_ = "max_tmp_tables" ;
      ObSysVars[498].data_type_ = ObIntType ;
      ObSysVars[498].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[498].id_ = SYS_VAR_MAX_TMP_TABLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_TMP_TABLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_TMP_TABLES] = 498 ;
      ObSysVars[498].base_value_ = "32" ;
    ObSysVars[498].alias_ = "OB_SV_MAX_TMP_TABLES" ;
    }();

    [&] (){
      ObSysVars[499].default_value_ = "" ;
      ObSysVars[499].info_ = "mock for mysql5.7" ;
      ObSysVars[499].name_ = "innodb_tmpdir" ;
      ObSysVars[499].data_type_ = ObVarcharType ;
      ObSysVars[499].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[499].id_ = SYS_VAR_INNODB_TMPDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_TMPDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_TMPDIR] = 499 ;
      ObSysVars[499].base_value_ = "" ;
    ObSysVars[499].alias_ = "OB_SV_INNODB_TMPDIR" ;
    }();

    [&] (){
      ObSysVars[500].default_value_ = "" ;
      ObSysVars[500].info_ = "A list of group members to which a joining member can connect to obtain details of all the current group members" ;
      ObSysVars[500].name_ = "group_replication_group_seeds" ;
      ObSysVars[500].data_type_ = ObVarcharType ;
      ObSysVars[500].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[500].id_ = SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_GROUP_REPLICATION_GROUP_SEEDS] = 500 ;
      ObSysVars[500].base_value_ = "" ;
    ObSysVars[500].alias_ = "OB_SV_GROUP_REPLICATION_GROUP_SEEDS" ;
    }();

    [&] (){
      ObSysVars[501].default_value_ = "0" ;
      ObSysVars[501].info_ = "When preparing batches of rows for row-based logging and replication, this variable controls how the rows are searched for matches" ;
      ObSysVars[501].name_ = "slave_rows_search_algorithms" ;
      ObSysVars[501].data_type_ = ObIntType ;
      ObSysVars[501].enum_names_ = "[u'TABLE_SCAN,INDEX_SCAN', u'INDEX_SCAN,HASH_SCAN', u'TABLE_SCAN,HASH_SCAN', u'TABLE_SCAN,INDEX_SCAN,HASH_SCAN']" ;
      ObSysVars[501].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[501].id_ = SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_ROWS_SEARCH_ALGORITHMS] = 501 ;
      ObSysVars[501].base_value_ = "0" ;
    ObSysVars[501].alias_ = "OB_SV_SLAVE_ROWS_SEARCH_ALGORITHMS" ;
    }();

    [&] (){
      ObSysVars[502].default_value_ = "0" ;
      ObSysVars[502].info_ = "Controls the type conversion mode in effect on the replica when using row-based replication" ;
      ObSysVars[502].name_ = "slave_type_conversions" ;
      ObSysVars[502].data_type_ = ObIntType ;
      ObSysVars[502].enum_names_ = "[u'ALL_LOSSY', u'ALL_NON_LOSSY', u'ALL_SIGNED', u'ALL_UNSIGNED']" ;
      ObSysVars[502].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[502].id_ = SYS_VAR_SLAVE_TYPE_CONVERSIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLAVE_TYPE_CONVERSIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLAVE_TYPE_CONVERSIONS] = 502 ;
      ObSysVars[502].base_value_ = "0" ;
    ObSysVars[502].alias_ = "OB_SV_SLAVE_TYPE_CONVERSIONS" ;
    }();

    [&] (){
      ObSysVars[503].default_value_ = "64" ;
      ObSysVars[503].info_ = "The number of neighbor nodes considered during any HNSW vector index search on the session" ;
      ...
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_HNSW_EF_SEARCH] = 503 ;
      ObSysVars[503].base_value_ = "40" ;
    ObSysVars[503].alias_ = "OB_SV_HNSW_EF_SEARCH" ;
    }();

    [&] (){
      ObSysVars[504].default_value_ = "0" ;
      ObSysVars[504].info_ = "mock for mysql5.7" ;
      ObSysVars[504].name_ = "ndb_allow_copying_alter_table" ;
      ...
      ObSysVars[504].id_ = SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_ALLOW_COPYING_ALTER_TABLE] = 504 ;
      ObSysVars[504].base_value_ = "0" ;
    ObSysVars[504].alias_ = "OB_SV_NDB_ALLOW_COPYING_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[505].default_value_ = "1" ;
      ObSysVars[505].info_ = "mock for mysql5.7" ;
      ObSysVars[505].name_ = "ndb_autoincrement_prefetch_sz" ;
      ...
      ObSysVars[505].id_ = SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_AUTOINCREMENT_PREFETCH_SZ] = 505 ;
      ObSysVars[505].base_value_ = "1" ;
    ObSysVars[505].alias_ = "OB_SV_NDB_AUTOINCREMENT_PREFETCH_SZ" ;
    }();

    [&] (){
      ObSysVars[506].default_value_ = "65536" ;
      ObSysVars[506].info_ = "mock for mysql5.7" ;
      ObSysVars[506].name_ = "ndb_blob_read_batch_bytes" ;
      ...
      ObSysVars[506].id_ = SYS_VAR_NDB_BLOB_READ_BATCH_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_BLOB_READ_BATCH_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_BLOB_READ_BATCH_BYTES] = 506 ;
      ObSysVars[506].base_value_ = "65536" ;
    ObSysVars[506].alias_ = "OB_SV_NDB_BLOB_READ_BATCH_BYTES" ;
    }();

    [&] (){
      ObSysVars[507].default_value_ = "65536" ;
      ObSysVars[507].info_ = "mock for mysql5.7" ;
      ObSysVars[507].name_ = "ndb_blob_write_batch_bytes" ;
    ...
    [&] (){
      ...
      ObSysVars[518].id_ = SYS_VAR_NDB_FULLY_REPLICATED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_FULLY_REPLICATED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_FULLY_REPLICATED] = 518 ;
      ObSysVars[518].base_value_ = "0" ;
    ObSysVars[518].alias_ = "OB_SV_NDB_FULLY_REPLICATED" ;
    }();

    [&] (){
      ObSysVars[519].default_value_ = "0" ;
      ObSysVars[519].info_ = "mock for mysql5.7" ;
      ObSysVars[519].name_ = "ndb_index_stat_enable" ;
      ...
      ObSysVars[519].id_ = SYS_VAR_NDB_INDEX_STAT_ENABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_INDEX_STAT_ENABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_INDEX_STAT_ENABLE] = 519 ;
      ObSysVars[519].base_value_ = "0" ;
    ObSysVars[519].alias_ = "OB_SV_NDB_INDEX_STAT_ENABLE" ;
    }();

    [&] (){
      ObSysVars[520].default_value_ = "loop_checkon=1000ms,loop_idle=1000ms,loop_busy=100ms, update_batch=1,read_batch=4,idle_batch=32,check_batch=32, check_delay=1m,delete_batch=8,clean_delay=0,error_batch=4, error_delay=1m,evict_batch=8,evict_delay=1m,cache_limit=32M, cache_lowpct=90" ;
      ObSysVars[520].info_ = "mock for mysql5.7" ;
      ObSysVars[520].name_ = "ndb_index_stat_option" ;
      ...
      ObSysVars[520].id_ = SYS_VAR_NDB_INDEX_STAT_OPTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_INDEX_STAT_OPTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_INDEX_STAT_OPTION] = 520 ;
      ObSysVars[520].base_value_ = "loop_checkon=1000ms,loop_idle=1000ms,loop_busy=100ms, update_batch=1,read_batch=4,idle_batch=32,check_batch=32, check_delay=1m,delete_batch=8,clean_delay=0,error_batch=4, error_delay=1m,evict_batch=8,evict_delay=1m,cache_limit=32M, cache_lowpct=90" ;
    ObSysVars[520].alias_ = "OB_SV_NDB_INDEX_STAT_OPTION" ;
    }();

    [&] (){
      ObSysVars[521].default_value_ = "0" ;
      ObSysVars[521].info_ = "mock for mysql5.7" ;
      ObSysVars[521].name_ = "ndb_join_pushdown" ;
    ...
    [&] (){
      ...
      ObSysVars[540].id_ = SYS_VAR_NDB_USE_EXACT_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_EXACT_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_EXACT_COUNT] = 540 ;
      ObSysVars[540].base_value_ = "0" ;
    ObSysVars[540].alias_ = "OB_SV_NDB_USE_EXACT_COUNT" ;
    }();

    [&] (){
      ObSysVars[541].default_value_ = "0" ;
      ObSysVars[541].info_ = "mock for mysql5.7" ;
      ObSysVars[541].name_ = "ndb_use_transactions" ;
      ...
      ObSysVars[541].id_ = SYS_VAR_NDB_USE_TRANSACTIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_TRANSACTIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_TRANSACTIONS] = 541 ;
      ObSysVars[541].base_value_ = "0" ;
    ObSysVars[541].alias_ = "OB_SV_NDB_USE_TRANSACTIONS" ;
    }();

    [&] (){
      ObSysVars[542].default_value_ = "0" ;
      ObSysVars[542].info_ = "mock for mysql5.7" ;
      ObSysVars[542].name_ = "ndbinfo_max_bytes" ;
      ...
      ObSysVars[542].id_ = SYS_VAR_NDBINFO_MAX_BYTES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_MAX_BYTES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_MAX_BYTES] = 542 ;
      ObSysVars[542].base_value_ = "0" ;
    ObSysVars[542].alias_ = "OB_SV_NDBINFO_MAX_BYTES" ;
    }();

    [&] (){
      ObSysVars[543].default_value_ = "10" ;
      ObSysVars[543].info_ = "mock for mysql5.7" ;
      ObSysVars[543].name_ = "ndbinfo_max_rows" ;
      ...
      ObSysVars[543].id_ = SYS_VAR_NDBINFO_MAX_ROWS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_MAX_ROWS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_MAX_ROWS] = 543 ;
      ObSysVars[543].base_value_ = "10" ;
    ObSysVars[543].alias_ = "OB_SV_NDBINFO_MAX_ROWS" ;
    }();

    [&] (){
      ObSysVars[544].default_value_ = "0" ;
      ObSysVars[544].info_ = "mock for mysql5.7" ;
      ObSysVars[544].name_ = "ndbinfo_offline" ;
      ObSysVars[544].data_type_ = ObIntType ;
      ObSysVars[544].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[544].id_ = SYS_VAR_NDBINFO_OFFLINE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_OFFLINE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_OFFLINE] = 544 ;
      ObSysVars[544].base_value_ = "0" ;
    ObSysVars[544].alias_ = "OB_SV_NDBINFO_OFFLINE" ;
    }();

    [&] (){
      ObSysVars[545].default_value_ = "0" ;
      ObSysVars[545].info_ = "mock for mysql5.7" ;
      ObSysVars[545].name_ = "ndbinfo_show_hidden" ;
      ObSysVars[545].data_type_ = ObIntType ;
      ObSysVars[545].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[545].id_ = SYS_VAR_NDBINFO_SHOW_HIDDEN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_SHOW_HIDDEN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_SHOW_HIDDEN] = 545 ;
      ObSysVars[545].base_value_ = "0" ;
    ObSysVars[545].alias_ = "OB_SV_NDBINFO_SHOW_HIDDEN" ;
    }();

    [&] (){
      ObSysVars[546].default_value_ = "6" ;
      ObSysVars[546].info_ = "mock for mysql5.7" ;
      ObSysVars[546].name_ = "myisam_data_pointer_size" ;
      ObSysVars[546].data_type_ = ObIntType ;
      ObSysVars[546].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[546].id_ = SYS_VAR_MYISAM_DATA_POINTER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_DATA_POINTER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_DATA_POINTER_SIZE] = 546 ;
      ObSysVars[546].base_value_ = "6" ;
    ObSysVars[546].alias_ = "OB_SV_MYISAM_DATA_POINTER_SIZE" ;
    }();

    [&] (){
      ObSysVars[547].default_value_ = "9223372036853720064" ;
      ObSysVars[547].info_ = "mock for mysql5.7" ;
      ObSysVars[547].name_ = "myisam_max_sort_file_size" ;
      ObSysVars[547].data_type_ = ObIntType ;
      ObSysVars[547].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[547].id_ = SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_MAX_SORT_FILE_SIZE] = 547 ;
      ObSysVars[547].base_value_ = "9223372036853720064" ;
    ObSysVars[547].alias_ = "OB_SV_MYISAM_MAX_SORT_FILE_SIZE" ;
    }();

    [&] (){
      ObSysVars[548].default_value_ = "1" ;
      ObSysVars[548].info_ = "mock for mysql5.7" ;
      ObSysVars[548].name_ = "myisam_repair_threads" ;
      ...
      ObSysVars[548].id_ = SYS_VAR_MYISAM_REPAIR_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_REPAIR_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_REPAIR_THREADS] = 548 ;
      ObSysVars[548].base_value_ = "1" ;
    ObSysVars[548].alias_ = "OB_SV_MYISAM_REPAIR_THREADS" ;
    }();

    [&] (){
      ObSysVars[549].default_value_ = "8388608" ;
      ObSysVars[549].info_ = "mock for mysql5.7" ;
      ObSysVars[549].name_ = "myisam_sort_buffer_size" ;
      ...
      ObSysVars[549].id_ = SYS_VAR_MYISAM_SORT_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_SORT_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_SORT_BUFFER_SIZE] = 549 ;
      ObSysVars[549].base_value_ = "8388608" ;
    ObSysVars[549].alias_ = "OB_SV_MYISAM_SORT_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[550].default_value_ = "0" ;
      ObSysVars[550].info_ = "mock for mysql5.7" ;
      ObSysVars[550].name_ = "myisam_stats_method" ;
      ObSysVars[550].data_type_ = ObIntType ;
      ObSysVars[550].enum_names_ = "[u'nulls_unequal', u'nulls_equal', u'nulls_ignored']" ;
      ObSysVars[550].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[550].id_ = SYS_VAR_MYISAM_STATS_METHOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_STATS_METHOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_STATS_METHOD] = 550 ;
      ObSysVars[550].base_value_ = "0" ;
    ObSysVars[550].alias_ = "OB_SV_MYISAM_STATS_METHOD" ;
    }();

    [&] (){
      ObSysVars[551].default_value_ = "0" ;
      ObSysVars[551].info_ = "mock for mysql5.7" ;
      ObSysVars[551].name_ = "myisam_use_mmap" ;
      ObSysVars[551].data_type_ = ObIntType ;
      ObSysVars[551].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[551].id_ = SYS_VAR_MYISAM_USE_MMAP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYISAM_USE_MMAP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYISAM_USE_MMAP] = 551 ;
      ObSysVars[551].base_value_ = "0" ;
    ObSysVars[551].alias_ = "OB_SV_MYISAM_USE_MMAP" ;
    }();

    [&] (){
      ObSysVars[552].default_value_ = "32768" ;
      ObSysVars[552].info_ = "mock for mysql5.7" ;
      ObSysVars[552].name_ = "preload_buffer_size" ;
      ...
      ObSysVars[552].id_ = SYS_VAR_PRELOAD_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PRELOAD_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PRELOAD_BUFFER_SIZE] = 552 ;
      ObSysVars[552].base_value_ = "32768" ;
    ObSysVars[552].alias_ = "OB_SV_PRELOAD_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[553].default_value_ = "131072" ;
      ObSysVars[553].info_ = "mock for mysql5.7" ;
      ObSysVars[553].name_ = "read_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[574].id_ = SYS_VAR_KEEP_FILES_ON_CREATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEEP_FILES_ON_CREATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEEP_FILES_ON_CREATE] = 574 ;
      ObSysVars[574].base_value_ = "0" ;
    ObSysVars[574].alias_ = "OB_SV_KEEP_FILES_ON_CREATE" ;
    }();

    [&] (){
      ObSysVars[575].default_value_ = "16777216" ;
      ObSysVars[575].info_ = "mock for mysql5.7" ;
      ObSysVars[575].name_ = "max_heap_table_size" ;
      ...
      ObSysVars[575].id_ = SYS_VAR_MAX_HEAP_TABLE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_HEAP_TABLE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_HEAP_TABLE_SIZE] = 575 ;
      ObSysVars[575].base_value_ = "16777216" ;
    ObSysVars[575].alias_ = "OB_SV_MAX_HEAP_TABLE_SIZE" ;
    }();

    [&] (){
      ObSysVars[576].default_value_ = "8388608" ;
      ObSysVars[576].info_ = "mock for mysql5.7" ;
      ObSysVars[576].name_ = "bulk_insert_buffer_size" ;
    ...
    [&] (){
      ...
      ObSysVars[597].id_ = SYS_VAR_MAX_DELAYED_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_DELAYED_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_DELAYED_THREADS] = 597 ;
      ObSysVars[597].base_value_ = "20" ;
    ObSysVars[597].alias_ = "OB_SV_MAX_DELAYED_THREADS" ;
    }();

    [&] (){
      ObSysVars[598].default_value_ = "0" ;
      ObSysVars[598].info_ = "mock for mysql5.7" ;
      ObSysVars[598].name_ = "offline_mode" ;
      ObSysVars[598].data_type_ = ObIntType ;
      ObSysVars[598].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[598].id_ = SYS_VAR_OFFLINE_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OFFLINE_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OFFLINE_MODE] = 598 ;
      ObSysVars[598].base_value_ = "0" ;
    ObSysVars[598].alias_ = "OB_SV_OFFLINE_MODE" ;
    }();

    [&] (){
      ObSysVars[599].default_value_ = "0" ;
      ObSysVars[599].info_ = "mock for mysql5.7" ;
      ObSysVars[599].name_ = "require_secure_transport" ;
      ObSysVars[599].data_type_ = ObIntType ;
      ObSysVars[599].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[599].id_ = SYS_VAR_REQUIRE_SECURE_TRANSPORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REQUIRE_SECURE_TRANSPORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REQUIRE_SECURE_TRANSPORT] = 599 ;
      ObSysVars[599].base_value_ = "0" ;
    ObSysVars[599].alias_ = "OB_SV_REQUIRE_SECURE_TRANSPORT" ;
    }();

    [&] (){
      ObSysVars[600].default_value_ = "2" ;
      ObSysVars[600].info_ = "mock for mysql5.7" ;
      ObSysVars[600].name_ = "slow_launch_time" ;
      ObSysVars[600].data_type_ = ObIntType ;
      ObSysVars[600].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[600].id_ = SYS_VAR_SLOW_LAUNCH_TIME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SLOW_LAUNCH_TIME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SLOW_LAUNCH_TIME] = 600 ;
      ObSysVars[600].base_value_ = "2" ;
    ObSysVars[600].alias_ = "OB_SV_SLOW_LAUNCH_TIME" ;
    }();

    [&] (){
      ObSysVars[601].default_value_ = "0" ;
      ObSysVars[601].info_ = "mock for mysql5.7" ;
      ObSysVars[601].name_ = "sql_log_off" ;
      ObSysVars[601].data_type_ = ObIntType ;
      ObSysVars[601].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[601].id_ = SYS_VAR_SQL_LOG_OFF ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_LOG_OFF)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SQL_LOG_OFF] = 601 ;
      ObSysVars[601].base_value_ = "0" ;
    ObSysVars[601].alias_ = "OB_SV_SQL_LOG_OFF" ;
    }();

    [&] (){
      ObSysVars[602].default_value_ = "9" ;
      ObSysVars[602].info_ = "mock for mysql5.7" ;
      ObSysVars[602].name_ = "thread_cache_size" ;
      ObSysVars[602].data_type_ = ObIntType ;
      ObSysVars[602].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[602].id_ = SYS_VAR_THREAD_CACHE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_CACHE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_CACHE_SIZE] = 602 ;
      ObSysVars[602].base_value_ = "9" ;
    ObSysVars[602].alias_ = "OB_SV_THREAD_CACHE_SIZE" ;
    }();

    [&] (){
      ObSysVars[603].default_value_ = "0" ;
      ObSysVars[603].info_ = "mock for mysql5.7" ;
      ObSysVars[603].name_ = "thread_pool_high_priority_connection" ;
      ObSysVars[603].data_type_ = ObIntType ;
      ObSysVars[603].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[603].id_ = SYS_VAR_THREAD_POOL_HIGH_PRIORITY_CONNECTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_HIGH_PRIORITY_CONNECTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_HIGH_PRIORITY_CONNECTION] = 603 ;
      ObSysVars[603].base_value_ = "0" ;
    ObSysVars[603].alias_ = "OB_SV_THREAD_POOL_HIGH_PRIORITY_CONNECTION" ;
    }();

    [&] (){
      ObSysVars[604].default_value_ = "0" ;
      ObSysVars[604].info_ = "mock for mysql5.7" ;
      ObSysVars[604].name_ = "thread_pool_max_unused_threads" ;
      ObSysVars[604].data_type_ = ObIntType ;
      ObSysVars[604].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[604].id_ = SYS_VAR_THREAD_POOL_MAX_UNUSED_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_MAX_UNUSED_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_MAX_UNUSED_THREADS] = 604 ;
      ObSysVars[604].base_value_ = "0" ;
    ObSysVars[604].alias_ = "OB_SV_THREAD_POOL_MAX_UNUSED_THREADS" ;
    }();

    [&] (){
      ObSysVars[605].default_value_ = "1000" ;
      ObSysVars[605].info_ = "mock for mysql5.7" ;
      ObSysVars[605].name_ = "thread_pool_prio_kickup_timer" ;
      ObSysVars[605].data_type_ = ObIntType ;
      ObSysVars[605].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[605].id_ = SYS_VAR_THREAD_POOL_PRIO_KICKUP_TIMER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_PRIO_KICKUP_TIMER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_PRIO_KICKUP_TIMER] = 605 ;
      ObSysVars[605].base_value_ = "1000" ;
    ObSysVars[605].alias_ = "OB_SV_THREAD_POOL_PRIO_KICKUP_TIMER" ;
    }();

    [&] (){
      ObSysVars[606].default_value_ = "6" ;
      ObSysVars[606].info_ = "mock for mysql5.7" ;
      ObSysVars[606].name_ = "thread_pool_stall_limit" ;
      ObSysVars[606].data_type_ = ObIntType ;
      ObSysVars[606].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[606].id_ = SYS_VAR_THREAD_POOL_STALL_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_STALL_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_STALL_LIMIT] = 606 ;
      ObSysVars[606].base_value_ = "6" ;
    ObSysVars[606].alias_ = "OB_SV_THREAD_POOL_STALL_LIMIT" ;
    }();

    [&] (){
      ObSysVars[607].default_value_ = "1" ;
      ObSysVars[607].info_ = "mock for mysql5.7" ;
      ObSysVars[607].name_ = "have_statement_timeout" ;
      ...
      ObSysVars[607].id_ = SYS_VAR_HAVE_STATEMENT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_STATEMENT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_STATEMENT_TIMEOUT] = 607 ;
      ObSysVars[607].base_value_ = "1" ;
    ObSysVars[607].alias_ = "OB_SV_HAVE_STATEMENT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[608].default_value_ = "*" ;
      ObSysVars[608].info_ = "mock for mysql5.7" ;
      ObSysVars[608].name_ = "mysqlx_bind_address" ;
      ...
      ObSysVars[608].id_ = SYS_VAR_MYSQLX_BIND_ADDRESS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_BIND_ADDRESS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_BIND_ADDRESS] = 608 ;
      ObSysVars[608].base_value_ = "*" ;
    ObSysVars[608].alias_ = "OB_SV_MYSQLX_BIND_ADDRESS" ;
    }();

    [&] (){
      ObSysVars[609].default_value_ = "33060" ;
      ObSysVars[609].info_ = "mock for mysql5.7" ;
      ObSysVars[609].name_ = "mysqlx_port" ;
      ...
      ObSysVars[609].id_ = SYS_VAR_MYSQLX_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT] = 609 ;
      ObSysVars[609].base_value_ = "33060" ;
    ObSysVars[609].alias_ = "OB_SV_MYSQLX_PORT" ;
    }();

    [&] (){
      ObSysVars[610].default_value_ = "0" ;
      ObSysVars[610].info_ = "mock for mysql5.7" ;
      ObSysVars[610].name_ = "mysqlx_port_open_timeout" ;
      ...
      ObSysVars[610].id_ = SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_PORT_OPEN_TIMEOUT] = 610 ;
      ObSysVars[610].base_value_ = "0" ;
    ObSysVars[610].alias_ = "OB_SV_MYSQLX_PORT_OPEN_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[611].default_value_ = "/tmp/mysqlx.sock" ;
      ObSysVars[611].info_ = "mock for mysql5.7" ;
      ObSysVars[611].name_ = "mysqlx_socket" ;
      ...
      ObSysVars[611].id_ = SYS_VAR_MYSQLX_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SOCKET] = 611 ;
      ObSysVars[611].base_value_ = "/tmp/mysqlx.sock" ;
    ObSysVars[611].alias_ = "OB_SV_MYSQLX_SOCKET" ;
    }();

    [&] (){
      ObSysVars[612].default_value_ = "" ;
      ObSysVars[612].info_ = "mock for mysql5.7" ;
      ObSysVars[612].name_ = "mysqlx_ssl_ca" ;
    ...
    [&] (){
      ...
      ObSysVars[613].id_ = SYS_VAR_MYSQLX_SSL_CAPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CAPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CAPATH] = 613 ;
      ObSysVars[613].base_value_ = "" ;
    ObSysVars[613].alias_ = "OB_SV_MYSQLX_SSL_CAPATH" ;
    }();

    [&] (){
      ObSysVars[614].default_value_ = "" ;
      ObSysVars[614].info_ = "mock for mysql5.7" ;
      ObSysVars[614].name_ = "mysqlx_ssl_cert" ;
      ...
      ObSysVars[614].id_ = SYS_VAR_MYSQLX_SSL_CERT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CERT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CERT] = 614 ;
      ObSysVars[614].base_value_ = "" ;
    ObSysVars[614].alias_ = "OB_SV_MYSQLX_SSL_CERT" ;
    }();

    [&] (){
      ObSysVars[615].default_value_ = "" ;
      ObSysVars[615].info_ = "mock for mysql5.7" ;
      ObSysVars[615].name_ = "mysqlx_ssl_cipher" ;
      ...
      ObSysVars[615].id_ = SYS_VAR_MYSQLX_SSL_CIPHER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CIPHER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CIPHER] = 615 ;
      ObSysVars[615].base_value_ = "" ;
    ObSysVars[615].alias_ = "OB_SV_MYSQLX_SSL_CIPHER" ;
    }();

    [&] (){
      ObSysVars[616].default_value_ = "" ;
      ObSysVars[616].info_ = "mock for mysql5.7" ;
      ObSysVars[616].name_ = "mysqlx_ssl_crl" ;
      ...
      ObSysVars[616].id_ = SYS_VAR_MYSQLX_SSL_CRL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRL] = 616 ;
      ObSysVars[616].base_value_ = "" ;
    ObSysVars[616].alias_ = "OB_SV_MYSQLX_SSL_CRL" ;
    }();

    [&] (){
      ObSysVars[617].default_value_ = "" ;
      ObSysVars[617].info_ = "mock for mysql5.7" ;
      ObSysVars[617].name_ = "mysqlx_ssl_crlpath" ;
      ...
      ObSysVars[617].id_ = SYS_VAR_MYSQLX_SSL_CRLPATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQLX_SSL_CRLPATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQLX_SSL_CRLPATH] = 617 ;
      ObSysVars[617].base_value_ = "" ;
    ObSysVars[617].alias_ = "OB_SV_MYSQLX_SSL_CRLPATH" ;
    }();

    [&] (){
      ObSysVars[618].default_value_ = "" ;
      ObSysVars[618].info_ = "mock for mysql5.7" ;
      ObSysVars[618].name_ = "mysqlx_ssl_key" ;
    ...
    [&] (){
      ...
      ObSysVars[620].id_ = SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE] = 620 ;
      ObSysVars[620].base_value_ = "-1" ;
    ObSysVars[620].alias_ = "OB_SV_PERFORMANCE_SCHEMA_ACCOUNTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[621].default_value_ = "10000" ;
      ObSysVars[621].info_ = "mock for mysql5.7" ;
      ObSysVars[621].name_ = "performance_schema_digests_size" ;
      ...
      ObSysVars[621].id_ = SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_DIGESTS_SIZE] = 621 ;
      ObSysVars[621].base_value_ = "10000" ;
    ObSysVars[621].alias_ = "OB_SV_PERFORMANCE_SCHEMA_DIGESTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[622].default_value_ = "10000" ;
      ObSysVars[622].info_ = "mock for mysql5.7" ;
      ObSysVars[622].name_ = "performance_schema_events_stages_history_long_size" ;
      ...
      ObSysVars[622].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE] = 622 ;
      ObSysVars[622].base_value_ = "10000" ;
    ObSysVars[622].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[623].default_value_ = "10" ;
      ObSysVars[623].info_ = "mock for mysql5.7" ;
      ObSysVars[623].name_ = "performance_schema_events_stages_history_size" ;
      ...
      ObSysVars[623].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE] = 623 ;
      ObSysVars[623].base_value_ = "10" ;
    ObSysVars[623].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STAGES_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[624].default_value_ = "10000" ;
      ObSysVars[624].info_ = "mock for mysql5.7" ;
      ObSysVars[624].name_ = "performance_schema_events_statements_history_long_size" ;
      ...
      ObSysVars[624].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE] = 624 ;
      ObSysVars[624].base_value_ = "10000" ;
    ObSysVars[624].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[625].default_value_ = "10" ;
      ObSysVars[625].info_ = "mock for mysql5.7" ;
      ObSysVars[625].name_ = "performance_schema_events_statements_history_size" ;
      ...
      ObSysVars[625].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE] = 625 ;
      ObSysVars[625].base_value_ = "10" ;
    ObSysVars[625].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_STATEMENTS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[626].default_value_ = "10000" ;
      ObSysVars[626].info_ = "mock for mysql5.7" ;
      ObSysVars[626].name_ = "performance_schema_events_transactions_history_long_size" ;
      ...
      ObSysVars[626].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE] = 626 ;
      ObSysVars[626].base_value_ = "10000" ;
    ObSysVars[626].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[627].default_value_ = "10" ;
      ObSysVars[627].info_ = "mock for mysql5.7" ;
      ObSysVars[627].name_ = "performance_schema_events_transactions_history_size" ;
      ...
      ObSysVars[627].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE] = 627 ;
      ObSysVars[627].base_value_ = "10" ;
    ObSysVars[627].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_TRANSACTIONS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[628].default_value_ = "10000" ;
      ObSysVars[628].info_ = "mock for mysql5.7" ;
      ObSysVars[628].name_ = "performance_schema_events_waits_history_long_size" ;
      ...
      ObSysVars[628].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE] = 628 ;
      ObSysVars[628].base_value_ = "10000" ;
    ObSysVars[628].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_LONG_SIZE" ;
    }();

    [&] (){
      ObSysVars[629].default_value_ = "10" ;
      ObSysVars[629].info_ = "mock for mysql5.7" ;
      ObSysVars[629].name_ = "performance_schema_events_waits_history_size" ;
      ...
      ObSysVars[629].id_ = SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE] = 629 ;
      ObSysVars[629].base_value_ = "10" ;
    ObSysVars[629].alias_ = "OB_SV_PERFORMANCE_SCHEMA_EVENTS_WAITS_HISTORY_SIZE" ;
    }();

    [&] (){
      ObSysVars[630].default_value_ = "-1" ;
      ObSysVars[630].info_ = "mock for mysql5.7" ;
      ObSysVars[630].name_ = "performance_schema_hosts_size" ;
      ...
      ObSysVars[630].id_ = SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_HOSTS_SIZE] = 630 ;
      ObSysVars[630].base_value_ = "-1" ;
    ObSysVars[630].alias_ = "OB_SV_PERFORMANCE_SCHEMA_HOSTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[631].default_value_ = "80" ;
      ObSysVars[631].info_ = "mock for mysql5.7" ;
      ObSysVars[631].name_ = "performance_schema_max_cond_classes" ;
      ...
      ObSysVars[631].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_CLASSES] = 631 ;
      ObSysVars[631].base_value_ = "80" ;
    ObSysVars[631].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_CLASSES" ;
    }();

    [&] (){
      ObSysVars[632].default_value_ = "-1" ;
      ObSysVars[632].info_ = "mock for mysql5.7" ;
      ObSysVars[632].name_ = "performance_schema_max_cond_instances" ;
      ...
      ObSysVars[632].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES] = 632 ;
      ObSysVars[632].base_value_ = "-1" ;
    ObSysVars[632].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_COND_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[633].default_value_ = "1024" ;
      ObSysVars[633].info_ = "mock for mysql5.7" ;
      ObSysVars[633].name_ = "performance_schema_max_digest_length" ;
      ...
      ObSysVars[633].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH] = 633 ;
      ObSysVars[633].base_value_ = "1024" ;
    ObSysVars[633].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_DIGEST_LENGTH" ;
    }();

    [&] (){
      ObSysVars[634].default_value_ = "80" ;
      ObSysVars[634].info_ = "mock for mysql5.7" ;
      ObSysVars[634].name_ = "performance_schema_max_file_classes" ;
      ...
      ObSysVars[634].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES] = 634 ;
      ObSysVars[634].base_value_ = "80" ;
    ObSysVars[634].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[635].default_value_ = "32768" ;
      ObSysVars[635].info_ = "mock for mysql5.7" ;
      ObSysVars[635].name_ = "performance_schema_max_file_handles" ;
      ...
      ObSysVars[635].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES] = 635 ;
      ObSysVars[635].base_value_ = "32768" ;
    ObSysVars[635].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[636].default_value_ = "-1" ;
      ObSysVars[636].info_ = "mock for mysql5.7" ;
      ObSysVars[636].name_ = "performance_schema_max_file_instances" ;
      ...
      ObSysVars[636].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES] = 636 ;
      ObSysVars[636].base_value_ = "-1" ;
    ObSysVars[636].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_FILE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[637].default_value_ = "-1" ;
      ObSysVars[637].info_ = "mock for mysql5.7" ;
      ObSysVars[637].name_ = "performance_schema_max_index_stat" ;
      ...
      ObSysVars[637].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_INDEX_STAT] = 637 ;
      ObSysVars[637].base_value_ = "-1" ;
    ObSysVars[637].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_INDEX_STAT" ;
    }();

    [&] (){
      ObSysVars[638].default_value_ = "320" ;
      ObSysVars[638].info_ = "mock for mysql5.7" ;
      ObSysVars[638].name_ = "performance_schema_max_memory_classes" ;
      ...
      ObSysVars[638].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES] = 638 ;
      ObSysVars[638].base_value_ = "320" ;
    ObSysVars[638].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MEMORY_CLASSES" ;
    }();

    [&] (){
      ObSysVars[639].default_value_ = "-1" ;
      ObSysVars[639].info_ = "mock for mysql5.7" ;
      ObSysVars[639].name_ = "performance_schema_max_metadata_locks" ;
      ...
      ObSysVars[639].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS] = 639 ;
      ObSysVars[639].base_value_ = "-1" ;
    ObSysVars[639].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_METADATA_LOCKS" ;
    }();

    [&] (){
      ObSysVars[640].default_value_ = "210" ;
      ObSysVars[640].info_ = "mock for mysql5.7" ;
      ObSysVars[640].name_ = "performance_schema_max_mutex_classes" ;
      ...
      ObSysVars[640].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES] = 640 ;
      ObSysVars[640].base_value_ = "210" ;
    ObSysVars[640].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_CLASSES" ;
    }();

    [&] (){
      ObSysVars[641].default_value_ = "-1" ;
      ObSysVars[641].info_ = "mock for mysql5.7" ;
      ObSysVars[641].name_ = "performance_schema_max_mutex_instances" ;
      ...
      ObSysVars[641].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES] = 641 ;
      ObSysVars[641].base_value_ = "-1" ;
    ObSysVars[641].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_MUTEX_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[642].default_value_ = "-1" ;
      ObSysVars[642].info_ = "mock for mysql5.7" ;
      ObSysVars[642].name_ = "performance_schema_max_prepared_statements_instances" ;
      ...
      ObSysVars[642].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES] = 642 ;
      ObSysVars[642].base_value_ = "-1" ;
    ObSysVars[642].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PREPARED_STATEMENTS_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[643].default_value_ = "-1" ;
      ObSysVars[643].info_ = "mock for mysql5.7" ;
      ObSysVars[643].name_ = "performance_schema_max_program_instances" ;
      ...
      ObSysVars[643].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES] = 643 ;
      ObSysVars[643].base_value_ = "-1" ;
    ObSysVars[643].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_PROGRAM_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[644].default_value_ = "50" ;
      ObSysVars[644].info_ = "mock for mysql5.7" ;
      ObSysVars[644].name_ = "performance_schema_max_rwlock_classes" ;
      ...
      ObSysVars[644].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES] = 644 ;
      ObSysVars[644].base_value_ = "50" ;
    ObSysVars[644].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES" ;
    }();

    [&] (){
      ObSysVars[645].default_value_ = "-1" ;
      ObSysVars[645].info_ = "mock for mysql5.7" ;
      ObSysVars[645].name_ = "performance_schema_max_rwlock_instances" ;
      ...
      ObSysVars[645].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES] = 645 ;
      ObSysVars[645].base_value_ = "-1" ;
    ObSysVars[645].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[646].default_value_ = "10" ;
      ObSysVars[646].info_ = "mock for mysql5.7" ;
      ObSysVars[646].name_ = "performance_schema_max_socket_classes" ;
      ...
      ObSysVars[646].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES] = 646 ;
      ObSysVars[646].base_value_ = "10" ;
    ObSysVars[646].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_CLASSES" ;
    }();

    [&] (){
      ObSysVars[647].default_value_ = "-1" ;
      ObSysVars[647].info_ = "mock for mysql5.7" ;
      ObSysVars[647].name_ = "performance_schema_max_socket_instances" ;
      ...
      ObSysVars[647].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES] = 647 ;
      ObSysVars[647].base_value_ = "-1" ;
    ObSysVars[647].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SOCKET_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[648].default_value_ = "1024" ;
      ObSysVars[648].info_ = "mock for mysql5.7" ;
      ObSysVars[648].name_ = "performance_schema_max_sql_text_length" ;
      ...
      ObSysVars[648].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH] = 648 ;
      ObSysVars[648].base_value_ = "1024" ;
    ObSysVars[648].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_SQL_TEXT_LENGTH" ;
    }();

    [&] (){
      ObSysVars[649].default_value_ = "150" ;
      ObSysVars[649].info_ = "mock for mysql5.7" ;
      ObSysVars[649].name_ = "performance_schema_max_stage_classes" ;
      ...
      ObSysVars[649].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES] = 649 ;
      ObSysVars[649].base_value_ = "150" ;
    ObSysVars[649].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STAGE_CLASSES" ;
    }();

    [&] (){
      ObSysVars[650].default_value_ = "193" ;
      ObSysVars[650].info_ = "mock for mysql5.7" ;
      ObSysVars[650].name_ = "performance_schema_max_statement_classes" ;
      ...
      ObSysVars[650].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES] = 650 ;
      ObSysVars[650].base_value_ = "193" ;
    ObSysVars[650].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_CLASSES" ;
    }();

    [&] (){
      ObSysVars[651].default_value_ = "10" ;
      ObSysVars[651].info_ = "mock for mysql5.7" ;
      ObSysVars[651].name_ = "performance_schema_max_statement_stack" ;
      ...
      ObSysVars[651].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK] = 651 ;
      ObSysVars[651].base_value_ = "10" ;
    ObSysVars[651].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_STATEMENT_STACK" ;
    }();

    [&] (){
      ObSysVars[652].default_value_ = "-1" ;
      ObSysVars[652].info_ = "mock for mysql5.7" ;
      ObSysVars[652].name_ = "performance_schema_max_table_handles" ;
      ...
      ObSysVars[652].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES] = 652 ;
      ObSysVars[652].base_value_ = "-1" ;
    ObSysVars[652].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_HANDLES" ;
    }();

    [&] (){
      ObSysVars[653].default_value_ = "-1" ;
      ObSysVars[653].info_ = "mock for mysql5.7" ;
      ObSysVars[653].name_ = "performance_schema_max_table_instances" ;
      ...
      ObSysVars[653].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES] = 653 ;
      ObSysVars[653].base_value_ = "-1" ;
    ObSysVars[653].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[654].default_value_ = "-1" ;
      ObSysVars[654].info_ = "mock for mysql5.7" ;
      ObSysVars[654].name_ = "performance_schema_max_table_lock_stat" ;
      ...
      ObSysVars[654].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT] = 654 ;
      ObSysVars[654].base_value_ = "-1" ;
    ObSysVars[654].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_TABLE_LOCK_STAT" ;
    }();

    [&] (){
      ObSysVars[655].default_value_ = "50" ;
      ObSysVars[655].info_ = "mock for mysql5.7" ;
      ObSysVars[655].name_ = "performance_schema_max_thread_classes" ;
      ...
      ObSysVars[655].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES] = 655 ;
      ObSysVars[655].base_value_ = "50" ;
    ObSysVars[655].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_CLASSES" ;
    }();

    [&] (){
      ObSysVars[656].default_value_ = "-1" ;
      ObSysVars[656].info_ = "mock for mysql5.7" ;
      ObSysVars[656].name_ = "performance_schema_max_thread_instances" ;
      ...
      ObSysVars[656].id_ = SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES] = 656 ;
      ObSysVars[656].base_value_ = "-1" ;
    ObSysVars[656].alias_ = "OB_SV_PERFORMANCE_SCHEMA_MAX_THREAD_INSTANCES" ;
    }();

    [&] (){
      ObSysVars[657].default_value_ = "512" ;
      ObSysVars[657].info_ = "mock for mysql5.7" ;
      ObSysVars[657].name_ = "performance_schema_session_connect_attrs_size" ;
      ...
      ObSysVars[657].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE] = 657 ;
      ObSysVars[657].base_value_ = "512" ;
    ObSysVars[657].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SESSION_CONNECT_ATTRS_SIZE" ;
    }();

    [&] (){
      ObSysVars[658].default_value_ = "-1" ;
      ObSysVars[658].info_ = "mock for mysql5.7" ;
      ObSysVars[658].name_ = "performance_schema_setup_actors_size" ;
      ...
      ObSysVars[658].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE] = 658 ;
      ObSysVars[658].base_value_ = "-1" ;
    ObSysVars[658].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_ACTORS_SIZE" ;
    }();

    [&] (){
      ObSysVars[659].default_value_ = "-1" ;
      ObSysVars[659].info_ = "mock for mysql5.7" ;
      ObSysVars[659].name_ = "performance_schema_setup_objects_size" ;
      ...
      ObSysVars[659].id_ = SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE] = 659 ;
      ObSysVars[659].base_value_ = "-1" ;
    ObSysVars[659].alias_ = "OB_SV_PERFORMANCE_SCHEMA_SETUP_OBJECTS_SIZE" ;
    }();

    [&] (){
      ObSysVars[660].default_value_ = "-1" ;
      ObSysVars[660].info_ = "mock for mysql5.7" ;
      ObSysVars[660].name_ = "performance_schema_users_size" ;
      ...
      ObSysVars[660].id_ = SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PERFORMANCE_SCHEMA_USERS_SIZE] = 660 ;
      ObSysVars[660].base_value_ = "-1" ;
    ObSysVars[660].alias_ = "OB_SV_PERFORMANCE_SCHEMA_USERS_SIZE" ;
    }();

    [&] (){
      ObSysVars[661].default_value_ = "0" ;
      ObSysVars[661].info_ = "mock for mysql5.7" ;
      ObSysVars[661].name_ = "version_tokens_session_number" ;
      ...
      ObSysVars[661].id_ = SYS_VAR_VERSION_TOKENS_SESSION_NUMBER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VERSION_TOKENS_SESSION_NUMBER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VERSION_TOKENS_SESSION_NUMBER] = 661 ;
      ObSysVars[661].base_value_ = "0" ;
    ObSysVars[661].alias_ = "OB_SV_VERSION_TOKENS_SESSION_NUMBER" ;
    }();

    [&] (){
      ObSysVars[662].default_value_ = "80" ;
      ObSysVars[662].info_ = "mock for mysql5.7" ;
      ObSysVars[662].name_ = "back_log" ;
      ...
      ObSysVars[662].id_ = SYS_VAR_BACK_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BACK_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BACK_LOG] = 662 ;
      ObSysVars[662].base_value_ = "80" ;
    ObSysVars[662].alias_ = "OB_SV_BACK_LOG" ;
    }();

    [&] (){
      ObSysVars[663].default_value_ = "/usr/local/mysql/" ;
      ObSysVars[663].info_ = "mock for mysql5.7" ;
      ObSysVars[663].name_ = "basedir" ;
      ...
      ObSysVars[663].id_ = SYS_VAR_BASEDIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BASEDIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BASEDIR] = 663 ;
      ObSysVars[663].base_value_ = "/usr/local/mysql/" ;
    ObSysVars[663].alias_ = "OB_SV_BASEDIR" ;
    }();

    [&] (){
      ObSysVars[664].default_value_ = "*" ;
      ObSysVars[664].info_ = "mock for mysql5.7" ;
      ObSysVars[664].name_ = "bind_address" ;
    ...
    [&] (){
      ...
      ObSysVars[665].id_ = SYS_VAR_CORE_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CORE_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CORE_FILE] = 665 ;
      ObSysVars[665].base_value_ = "0" ;
    ObSysVars[665].alias_ = "OB_SV_CORE_FILE" ;
    }();

    [&] (){
      ObSysVars[666].default_value_ = "1" ;
      ObSysVars[666].info_ = "mock for mysql5.7" ;
      ObSysVars[666].name_ = "have_compress" ;
      ...
      ObSysVars[666].id_ = SYS_VAR_HAVE_COMPRESS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_COMPRESS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_COMPRESS] = 666 ;
      ObSysVars[666].base_value_ = "1" ;
    ObSysVars[666].alias_ = "OB_SV_HAVE_COMPRESS" ;
    }();

    [&] (){
      ObSysVars[667].default_value_ = "null" ;
      ObSysVars[667].info_ = "mock for mysql5.7" ;
      ObSysVars[667].name_ = "ignore_db_dirs" ;
      ...
      ObSysVars[667].id_ = SYS_VAR_IGNORE_DB_DIRS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_IGNORE_DB_DIRS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_IGNORE_DB_DIRS] = 667 ;
      ObSysVars[667].base_value_ = "null" ;
    ObSysVars[667].alias_ = "OB_SV_IGNORE_DB_DIRS" ;
    }();

    [&] (){
      ObSysVars[668].default_value_ = "null" ;
      ObSysVars[668].info_ = "mock for mysql5.7" ;
      ObSysVars[668].name_ = "init_file" ;
      ...
      ObSysVars[668].id_ = SYS_VAR_INIT_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INIT_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INIT_FILE] = 668 ;
      ObSysVars[668].base_value_ = "null" ;
    ObSysVars[668].alias_ = "OB_SV_INIT_FILE" ;
    }();

    [&] (){
      ObSysVars[669].default_value_ = "0" ;
      ObSysVars[669].info_ = "mock for mysql5.7" ;
      ObSysVars[669].name_ = "innodb_numa_interleave" ;
      ...
      ObSysVars[669].id_ = SYS_VAR_INNODB_NUMA_INTERLEAVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_NUMA_INTERLEAVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_NUMA_INTERLEAVE] = 669 ;
      ObSysVars[669].base_value_ = "0" ;
    ObSysVars[669].alias_ = "OB_SV_INNODB_NUMA_INTERLEAVE" ;
    }();

    [&] (){
      ObSysVars[670].default_value_ = "2000" ;
      ObSysVars[670].info_ = "mock for mysql5.7" ;
      ObSysVars[670].name_ = "innodb_open_files" ;
      ...
      ObSysVars[670].id_ = SYS_VAR_INNODB_OPEN_FILES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_OPEN_FILES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_OPEN_FILES] = 670 ;
      ObSysVars[670].base_value_ = "2000" ;
    ObSysVars[670].alias_ = "OB_SV_INNODB_OPEN_FILES" ;
    }();

    [&] (){
      ObSysVars[671].default_value_ = "1" ;
      ObSysVars[671].info_ = "mock for mysql5.7" ;
      ObSysVars[671].name_ = "innodb_page_cleaners" ;
      ...
      ObSysVars[671].id_ = SYS_VAR_INNODB_PAGE_CLEANERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PAGE_CLEANERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PAGE_CLEANERS] = 671 ;
      ObSysVars[671].base_value_ = "1" ;
    ObSysVars[671].alias_ = "OB_SV_INNODB_PAGE_CLEANERS" ;
    }();

    [&] (){
      ObSysVars[672].default_value_ = "4" ;
      ObSysVars[672].info_ = "mock for mysql5.7" ;
      ObSysVars[672].name_ = "innodb_purge_threads" ;
      ...
      ObSysVars[672].id_ = SYS_VAR_INNODB_PURGE_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_PURGE_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_PURGE_THREADS] = 672 ;
      ObSysVars[672].base_value_ = "4" ;
    ObSysVars[672].alias_ = "OB_SV_INNODB_PURGE_THREADS" ;
    }();

    [&] (){
      ObSysVars[673].default_value_ = "4" ;
      ObSysVars[673].info_ = "mock for mysql5.7" ;
      ObSysVars[673].name_ = "innodb_read_io_threads" ;
      ...
      ObSysVars[673].id_ = SYS_VAR_INNODB_READ_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_READ_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_READ_IO_THREADS] = 673 ;
      ObSysVars[673].base_value_ = "4" ;
    ObSysVars[673].alias_ = "OB_SV_INNODB_READ_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[674].default_value_ = "1" ;
      ObSysVars[674].info_ = "mock for mysql5.7" ;
      ObSysVars[674].name_ = "innodb_sync_array_size" ;
      ...
      ObSysVars[674].id_ = SYS_VAR_INNODB_SYNC_ARRAY_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SYNC_ARRAY_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SYNC_ARRAY_SIZE] = 674 ;
      ObSysVars[674].base_value_ = "1" ;
    ObSysVars[674].alias_ = "OB_SV_INNODB_SYNC_ARRAY_SIZE" ;
    }();

    [&] (){
      ObSysVars[675].default_value_ = "1" ;
      ObSysVars[675].info_ = "mock for mysql5.7" ;
      ObSysVars[675].name_ = "innodb_use_native_aio" ;
      ...
      ObSysVars[675].id_ = SYS_VAR_INNODB_USE_NATIVE_AIO ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_USE_NATIVE_AIO)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_USE_NATIVE_AIO] = 675 ;
      ObSysVars[675].base_value_ = "1" ;
    ObSysVars[675].alias_ = "OB_SV_INNODB_USE_NATIVE_AIO" ;
    }();

    [&] (){
      ObSysVars[676].default_value_ = "4" ;
      ObSysVars[676].info_ = "mock for mysql5.7" ;
      ObSysVars[676].name_ = "innodb_write_io_threads" ;
      ...
      ObSysVars[676].id_ = SYS_VAR_INNODB_WRITE_IO_THREADS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_WRITE_IO_THREADS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_WRITE_IO_THREADS] = 676 ;
      ObSysVars[676].base_value_ = "4" ;
    ObSysVars[676].alias_ = "OB_SV_INNODB_WRITE_IO_THREADS" ;
    }();

    [&] (){
      ObSysVars[677].default_value_ = "1" ;
      ObSysVars[677].info_ = "mock for mysql5.7" ;
      ObSysVars[677].name_ = "large_files_support" ;
      ...
      ObSysVars[677].id_ = SYS_VAR_LARGE_FILES_SUPPORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LARGE_FILES_SUPPORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LARGE_FILES_SUPPORT] = 677 ;
      ObSysVars[677].base_value_ = "1" ;
    ObSysVars[677].alias_ = "OB_SV_LARGE_FILES_SUPPORT" ;
    }();

    [&] (){
      ObSysVars[678].default_value_ = "0" ;
      ObSysVars[678].info_ = "mock for mysql5.7" ;
      ObSysVars[678].name_ = "large_pages" ;
    ...
    [&] (){
      ...
      ObSysVars[680].id_ = SYS_VAR_LOCKED_IN_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOCKED_IN_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOCKED_IN_MEMORY] = 680 ;
      ObSysVars[680].base_value_ = "0" ;
    ObSysVars[680].alias_ = "OB_SV_LOCKED_IN_MEMORY" ;
    }();

    [&] (){
      ObSysVars[681].default_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
      ObSysVars[681].info_ = "mock for mysql5.7" ;
      ObSysVars[681].name_ = "log_error" ;
      ...
      ObSysVars[681].id_ = SYS_VAR_LOG_ERROR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_ERROR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_ERROR] = 681 ;
      ObSysVars[681].base_value_ = "./obrd.16c.vd3-s2h6-n3.err" ;
    ObSysVars[681].alias_ = "OB_SV_LOG_ERROR" ;
    }();

    [&] (){
      ObSysVars[682].default_value_ = "0" ;
      ObSysVars[682].info_ = "mock for mysql5.7" ;
      ObSysVars[682].name_ = "named_pipe" ;
      ...
      ObSysVars[682].id_ = SYS_VAR_NAMED_PIPE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NAMED_PIPE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NAMED_PIPE] = 682 ;
      ObSysVars[682].base_value_ = "0" ;
    ObSysVars[682].alias_ = "OB_SV_NAMED_PIPE" ;
    }();

    [&] (){
      ObSysVars[683].default_value_ = "empty string" ;
      ObSysVars[683].info_ = "mock for mysql5.7" ;
      ObSysVars[683].name_ = "named_pipe_full_access_group" ;
      ...
      ObSysVars[683].id_ = SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NAMED_PIPE_FULL_ACCESS_GROUP] = 683 ;
      ObSysVars[683].base_value_ = "empty string" ;
    ObSysVars[683].alias_ = "OB_SV_NAMED_PIPE_FULL_ACCESS_GROUP" ;
    }();

    [&] (){
      ObSysVars[684].default_value_ = "655360" ;
      ObSysVars[684].info_ = "mock for mysql5.7" ;
      ObSysVars[684].name_ = "open_files_limit" ;
      ...
      ObSysVars[684].id_ = SYS_VAR_OPEN_FILES_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPEN_FILES_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPEN_FILES_LIMIT] = 684 ;
      ObSysVars[684].base_value_ = "655360" ;
    ObSysVars[684].alias_ = "OB_SV_OPEN_FILES_LIMIT" ;
    }();

    [&] (){
      ObSysVars[685].default_value_ = "null" ;
      ObSysVars[685].info_ = "mock for mysql5.7" ;
      ObSysVars[685].name_ = "report_host" ;
    ...
    [&] (){
      ...
      ObSysVars[687].id_ = SYS_VAR_REPORT_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPORT_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPORT_PORT] = 687 ;
      ObSysVars[687].base_value_ = "null" ;
    ObSysVars[687].alias_ = "OB_SV_REPORT_PORT" ;
    }();

    [&] (){
      ObSysVars[688].default_value_ = "null" ;
      ObSysVars[688].info_ = "mock for mysql5.7" ;
      ObSysVars[688].name_ = "report_user" ;
      ...
      ObSysVars[688].id_ = SYS_VAR_REPORT_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REPORT_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REPORT_USER] = 688 ;
      ObSysVars[688].base_value_ = "null" ;
    ObSysVars[688].alias_ = "OB_SV_REPORT_USER" ;
    }();

    [&] (){
      ObSysVars[689].default_value_ = "32" ;
      ObSysVars[689].info_ = "mock for mysql5.7" ;
      ObSysVars[689].name_ = "server_id_bits" ;
      ...
      ObSysVars[689].id_ = SYS_VAR_SERVER_ID_BITS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SERVER_ID_BITS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SERVER_ID_BITS] = 689 ;
      ObSysVars[689].base_value_ = "32" ;
    ObSysVars[689].alias_ = "OB_SV_SERVER_ID_BITS" ;
    }();

    [&] (){
      ObSysVars[690].default_value_ = "0" ;
      ObSysVars[690].info_ = "mock for mysql5.7" ;
      ObSysVars[690].name_ = "shared_memory" ;
      ...
      ObSysVars[690].id_ = SYS_VAR_SHARED_MEMORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY] = 690 ;
      ObSysVars[690].base_value_ = "0" ;
    ObSysVars[690].alias_ = "OB_SV_SHARED_MEMORY" ;
    }();

    [&] (){
      ObSysVars[691].default_value_ = "MYSQL" ;
      ObSysVars[691].info_ = "mock for mysql5.7" ;
      ObSysVars[691].name_ = "shared_memory_base_name" ;
      ...
      ObSysVars[691].id_ = SYS_VAR_SHARED_MEMORY_BASE_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHARED_MEMORY_BASE_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHARED_MEMORY_BASE_NAME] = 691 ;
      ObSysVars[691].base_value_ = "MYSQL" ;
    ObSysVars[691].alias_ = "OB_SV_SHARED_MEMORY_BASE_NAME" ;
    }();

    [&] (){
      ObSysVars[692].default_value_ = "0" ;
      ObSysVars[692].info_ = "mock for mysql5.7" ;
      ObSysVars[692].name_ = "skip_name_resolve" ;
      ...
      ObSysVars[692].id_ = SYS_VAR_SKIP_NAME_RESOLVE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_NAME_RESOLVE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_NAME_RESOLVE] = 692 ;
      ObSysVars[692].base_value_ = "0" ;
    ObSysVars[692].alias_ = "OB_SV_SKIP_NAME_RESOLVE" ;
    }();

    [&] (){
      ObSysVars[693].default_value_ = "0" ;
      ObSysVars[693].info_ = "mock for mysql5.7" ;
      ObSysVars[693].name_ = "skip_networking" ;
    ...
    [&] (){
      ...
      ObSysVars[695].id_ = SYS_VAR_THREAD_POOL_ALGORITHM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_ALGORITHM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_ALGORITHM] = 695 ;
      ObSysVars[695].base_value_ = "0" ;
    ObSysVars[695].alias_ = "OB_SV_THREAD_POOL_ALGORITHM" ;
    }();

    [&] (){
      ObSysVars[696].default_value_ = "16" ;
      ObSysVars[696].info_ = "mock for mysql5.7" ;
      ObSysVars[696].name_ = "thread_pool_size" ;
      ObSysVars[696].data_type_ = ObIntType ;
      ObSysVars[696].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[696].id_ = SYS_VAR_THREAD_POOL_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_POOL_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_POOL_SIZE] = 696 ;
      ObSysVars[696].base_value_ = "16" ;
    ObSysVars[696].alias_ = "OB_SV_THREAD_POOL_SIZE" ;
    }();

    [&] (){
      ObSysVars[697].default_value_ = "262144" ;
      ObSysVars[697].info_ = "mock for mysql5.7" ;
      ObSysVars[697].name_ = "thread_stack" ;
      ...
      ObSysVars[697].id_ = SYS_VAR_THREAD_STACK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_THREAD_STACK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_THREAD_STACK] = 697 ;
      ObSysVars[697].base_value_ = "262144" ;
    ObSysVars[697].alias_ = "OB_SV_THREAD_STACK" ;
    }();

    [&] (){
      ObSysVars[698].default_value_ = "1" ;
      ObSysVars[698].info_ = "mock for mysql5.7" ;
      ObSysVars[698].name_ = "binlog_gtid_simple_recovery" ;
      ...
      ObSysVars[698].id_ = SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BINLOG_GTID_SIMPLE_RECOVERY] = 698 ;
      ObSysVars[698].base_value_ = "1" ;
    ObSysVars[698].alias_ = "OB_SV_BINLOG_GTID_SIMPLE_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[699].default_value_ = "0" ;
      ObSysVars[699].info_ = "mock for mysql5.7" ;
      ObSysVars[699].name_ = "innodb_api_enable_binlog" ;
      ...
      ObSysVars[699].id_ = SYS_VAR_INNODB_API_ENABLE_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_API_ENABLE_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_API_ENABLE_BINLOG] = 699 ;
      ObSysVars[699].base_value_ = "0" ;
    ObSysVars[699].alias_ = "OB_SV_INNODB_API_ENABLE_BINLOG" ;
    }();

    [&] (){
      ObSysVars[700].default_value_ = "0" ;
      ObSysVars[700].info_ = "mock for mysql5.7" ;
      ObSysVars[700].name_ = "innodb_locks_unsafe_for_binlog" ;
      ...
      ObSysVars[700].id_ = SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOCKS_UNSAFE_FOR_BINLOG] = 700 ;
      ObSysVars[700].base_value_ = "0" ;
    ObSysVars[700].alias_ = "OB_SV_INNODB_LOCKS_UNSAFE_FOR_BINLOG" ;
    }();

    [&] (){
      ObSysVars[701].default_value_ = "16777216" ;
      ObSysVars[701].info_ = "mock for mysql5.7" ;
      ObSysVars[701].name_ = "innodb_log_buffer_size" ;
      ...
      ObSysVars[701].id_ = SYS_VAR_INNODB_LOG_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_BUFFER_SIZE] = 701 ;
      ObSysVars[701].base_value_ = "16777216" ;
    ObSysVars[701].alias_ = "OB_SV_INNODB_LOG_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[702].default_value_ = "2" ;
      ObSysVars[702].info_ = "mock for mysql5.7" ;
      ObSysVars[702].name_ = "innodb_log_files_in_group" ;
      ...
      ObSysVars[702].id_ = SYS_VAR_INNODB_LOG_FILES_IN_GROUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILES_IN_GROUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILES_IN_GROUP] = 702 ;
      ObSysVars[702].base_value_ = "2" ;
    ObSysVars[702].alias_ = "OB_SV_INNODB_LOG_FILES_IN_GROUP" ;
    }();

    [&] (){
      ObSysVars[703].default_value_ = "50331648" ;
      ObSysVars[703].info_ = "mock for mysql5.7" ;
      ObSysVars[703].name_ = "innodb_log_file_size" ;
      ...
      ObSysVars[703].id_ = SYS_VAR_INNODB_LOG_FILE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_FILE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_FILE_SIZE] = 703 ;
      ObSysVars[703].base_value_ = "50331648" ;
    ObSysVars[703].alias_ = "OB_SV_INNODB_LOG_FILE_SIZE" ;
    }();

    [&] (){
      ObSysVars[704].default_value_ = "./" ;
      ObSysVars[704].info_ = "mock for mysql5.7" ;
      ObSysVars[704].name_ = "innodb_log_group_home_dir" ;
      ...
      ObSysVars[704].id_ = SYS_VAR_INNODB_LOG_GROUP_HOME_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LOG_GROUP_HOME_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LOG_GROUP_HOME_DIR] = 704 ;
      ObSysVars[704].base_value_ = "./" ;
    ObSysVars[704].alias_ = "OB_SV_INNODB_LOG_GROUP_HOME_DIR" ;
    }();

    [&] (){
      ObSysVars[705].default_value_ = "./" ;
      ObSysVars[705].info_ = "mock for mysql5.7" ;
      ObSysVars[705].name_ = "innodb_undo_directory" ;
      ObSysVars[705].data_type_ = ObVarcharType ;
      ObSysVars[705].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[705].id_ = SYS_VAR_INNODB_UNDO_DIRECTORY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_DIRECTORY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_DIRECTORY] = 705 ;
      ObSysVars[705].base_value_ = "./" ;
    ObSysVars[705].alias_ = "OB_SV_INNODB_UNDO_DIRECTORY" ;
    }();

    [&] (){
      ObSysVars[706].default_value_ = "0" ;
      ObSysVars[706].info_ = "mock for mysql5.7" ;
      ObSysVars[706].name_ = "innodb_undo_tablespaces" ;
      ...
      ObSysVars[706].id_ = SYS_VAR_INNODB_UNDO_TABLESPACES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_UNDO_TABLESPACES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_UNDO_TABLESPACES] = 706 ;
      ObSysVars[706].base_value_ = "0" ;
    ObSysVars[706].alias_ = "OB_SV_INNODB_UNDO_TABLESPACES" ;
    }();

    [&] (){
      ObSysVars[707].default_value_ = "null" ;
      ObSysVars[707].info_ = "mock for mysql5.7" ;
      ObSysVars[707].name_ = "log_bin_basename" ;
    ...
    [&] (){
      ...
      ObSysVars[708].id_ = SYS_VAR_LOG_BIN_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_BIN_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_BIN_INDEX] = 708 ;
      ObSysVars[708].base_value_ = "null" ;
    ObSysVars[708].alias_ = "OB_SV_LOG_BIN_INDEX" ;
    }();

    [&] (){
      ObSysVars[709].default_value_ = "0" ;
      ObSysVars[709].info_ = "mock for mysql5.7" ;
      ObSysVars[709].name_ = "log_slave_updates" ;
      ObSysVars[709].data_type_ = ObIntType ;
      ObSysVars[709].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[709].id_ = SYS_VAR_LOG_SLAVE_UPDATES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOG_SLAVE_UPDATES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOG_SLAVE_UPDATES] = 709 ;
      ObSysVars[709].base_value_ = "0" ;
    ObSysVars[709].alias_ = "OB_SV_LOG_SLAVE_UPDATES" ;
    }();

    [&] (){
      ObSysVars[710].default_value_ = "null" ;
      ObSysVars[710].info_ = "mock for mysql5.7" ;
      ObSysVars[710].name_ = "relay_log" ;
      ...
      ObSysVars[710].id_ = SYS_VAR_RELAY_LOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG] = 710 ;
      ObSysVars[710].base_value_ = "null" ;
    ObSysVars[710].alias_ = "OB_SV_RELAY_LOG" ;
    }();

    [&] (){
      ObSysVars[711].default_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
      ObSysVars[711].info_ = "mock for mysql5.7" ;
      ObSysVars[711].name_ = "relay_log_basename" ;
      ...
      ObSysVars[711].id_ = SYS_VAR_RELAY_LOG_BASENAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_BASENAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_BASENAME] = 711 ;
      ObSysVars[711].base_value_ = "/usr/local/mysql/data/obrd-relay-bin" ;
    ObSysVars[711].alias_ = "OB_SV_RELAY_LOG_BASENAME" ;
    }();

    [&] (){
      ObSysVars[712].default_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
      ObSysVars[712].info_ = "mock for mysql5.7" ;
      ObSysVars[712].name_ = "relay_log_index" ;
      ...
      ObSysVars[712].id_ = SYS_VAR_RELAY_LOG_INDEX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INDEX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INDEX] = 712 ;
      ObSysVars[712].base_value_ = "/usr/local/mysql/data/obrd-relay-bin.index" ;
    ObSysVars[712].alias_ = "OB_SV_RELAY_LOG_INDEX" ;
    }();

    [&] (){
      ObSysVars[713].default_value_ = "relay-log.info" ;
      ObSysVars[713].info_ = "mock for mysql5.7" ;
      ObSysVars[713].name_ = "relay_log_info_file" ;
      ...
      ObSysVars[713].id_ = SYS_VAR_RELAY_LOG_INFO_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_INFO_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_INFO_FILE] = 713 ;
      ObSysVars[713].base_value_ = "relay-log.info" ;
    ObSysVars[713].alias_ = "OB_SV_RELAY_LOG_INFO_FILE" ;
    }();

    [&] (){
      ObSysVars[714].default_value_ = "0" ;
      ObSysVars[714].info_ = "mock for mysql5.7" ;
      ObSysVars[714].name_ = "relay_log_recovery" ;
      ...
      ObSysVars[714].id_ = SYS_VAR_RELAY_LOG_RECOVERY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_RECOVERY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_RECOVERY] = 714 ;
      ObSysVars[714].base_value_ = "0" ;
    ObSysVars[714].alias_ = "OB_SV_RELAY_LOG_RECOVERY" ;
    }();

    [&] (){
      ObSysVars[715].default_value_ = "0" ;
      ObSysVars[715].info_ = "mock for mysql5.7" ;
      ObSysVars[715].name_ = "relay_log_space_limit" ;
      ObSysVars[715].data_type_ = ObIntType ;
      ObSysVars[715].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[715].id_ = SYS_VAR_RELAY_LOG_SPACE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RELAY_LOG_SPACE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RELAY_LOG_SPACE_LIMIT] = 715 ;
      ObSysVars[715].base_value_ = "0" ;
    ObSysVars[715].alias_ = "OB_SV_RELAY_LOG_SPACE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[716].default_value_ = "0" ;
      ObSysVars[716].info_ = "This variable specifies how to use delayed key writes. It applies only to MyISAM tables. Delayed key writing causes key buffers not to be flushed between writes, merely simulates MySQL 5.7" ;
      ObSysVars[716].name_ = "delay_key_write" ;
      ObSysVars[716].data_type_ = ObIntType ;
      ObSysVars[716].enum_names_ = "[u'ON', u'OFF', u'ALL']" ;
      ObSysVars[716].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[716].id_ = SYS_VAR_DELAY_KEY_WRITE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAY_KEY_WRITE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAY_KEY_WRITE] = 716 ;
      ObSysVars[716].base_value_ = "0" ;
    ObSysVars[716].alias_ = "OB_SV_DELAY_KEY_WRITE" ;
    }();

    [&] (){
      ObSysVars[717].default_value_ = "0" ;
      ObSysVars[717].info_ = "When this option is enabled, index key prefixes longer than 767 bytes (up to 3072 bytes) are allowed for InnoDB tables that use DYNAMIC or COMPRESSED row format, merely simulates MySQL 5.7" ;
      ObSysVars[717].name_ = "innodb_large_prefix" ;
      ObSysVars[717].data_type_ = ObIntType ;
      ObSysVars[717].enum_names_ = "[u'ON', u'OFF']" ;
      ObSysVars[717].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[717].id_ = SYS_VAR_INNODB_LARGE_PREFIX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_LARGE_PREFIX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_LARGE_PREFIX] = 717 ;
      ObSysVars[717].base_value_ = "0" ;
    ObSysVars[717].alias_ = "OB_SV_INNODB_LARGE_PREFIX" ;
    }();

    [&] (){
      ObSysVars[718].default_value_ = "8388608" ;
      ObSysVars[718].info_ = "The size of the buffer used for index blocks, merely simulates MySQL 5.7" ;
      ObSysVars[718].name_ = "key_buffer_size" ;
      ObSysVars[718].data_type_ = ObIntType ;
      ObSysVars[718].min_val_ = "0" ;
      ObSysVars[718].max_val_ = "4294967295" ;
      ObSysVars[718].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[718].id_ = SYS_VAR_KEY_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_BUFFER_SIZE] = 718 ;
      ObSysVars[718].base_value_ = "8388608" ;
    ObSysVars[718].alias_ = "OB_SV_KEY_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[719].default_value_ = "300" ;
      ObSysVars[719].info_ = "This value controls the demotion of buffers from the hot sublist of a key cache to the warm sublist. Lower values cause demotion to happen more quickly, merely simulates MySQL 5.7" ;
      ObSysVars[719].name_ = "key_cache_age_threshold" ;
      ObSysVars[719].data_type_ = ObUInt64Type ;
      ObSysVars[719].min_val_ = "100" ;
      ObSysVars[719].max_val_ = "18446744073709551516" ;
      ObSysVars[719].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[719].id_ = SYS_VAR_KEY_CACHE_AGE_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_AGE_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_AGE_THRESHOLD] = 719 ;
      ObSysVars[719].base_value_ = "300" ;
    ObSysVars[719].alias_ = "OB_SV_KEY_CACHE_AGE_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[720].default_value_ = "100" ;
      ObSysVars[720].info_ = "The division point between the hot and warm sublists of the key cache buffer list, merely simulates MySQL 5.7" ;
      ObSysVars[720].name_ = "key_cache_division_limit" ;
      ObSysVars[720].data_type_ = ObIntType ;
      ObSysVars[720].min_val_ = "1" ;
      ObSysVars[720].max_val_ = "100" ;
      ObSysVars[720].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[720].id_ = SYS_VAR_KEY_CACHE_DIVISION_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_DIVISION_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_DIVISION_LIMIT] = 720 ;
      ObSysVars[720].base_value_ = "100" ;
    ObSysVars[720].alias_ = "OB_SV_KEY_CACHE_DIVISION_LIMIT" ;
    }();

    [&] (){
      ObSysVars[721].default_value_ = "18446744073709551615" ;
      ObSysVars[721].info_ = "Limit the assumed maximum number of seeks when looking up rows based on a key, merely simulates MySQL 5.7" ;
      ObSysVars[721].name_ = "max_seeks_for_key" ;
      ...
      ObSysVars[721].id_ = SYS_VAR_MAX_SEEKS_FOR_KEY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_SEEKS_FOR_KEY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_SEEKS_FOR_KEY] = 721 ;
      ObSysVars[721].base_value_ = "18446744073709551615" ;
    ObSysVars[721].alias_ = "OB_SV_MAX_SEEKS_FOR_KEY" ;
    }();

    [&] (){
      ObSysVars[722].default_value_ = "0" ;
      ObSysVars[722].info_ = "When this variable is enabled, the server does not use the optimized method of processing an ALTER TABLE operation, merely simulates MySQL 5.7" ;
      ObSysVars[722].name_ = "old_alter_table" ;
      ObSysVars[722].data_type_ = ObIntType ;
      ObSysVars[722].enum_names_ = "[u'OFF', u'ON']" ;
      ObSysVars[722].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[722].id_ = SYS_VAR_OLD_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD_ALTER_TABLE] = 722 ;
      ObSysVars[722].base_value_ = "0" ;
    ObSysVars[722].alias_ = "OB_SV_OLD_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[723].default_value_ = "-1" ;
      ObSysVars[723].info_ = "The number of table definitions that can be stored in the table definition cache, merely simulates MySQL 5.7" ;
      ObSysVars[723].name_ = "table_definition_cache" ;
      ObSysVars[723].data_type_ = ObIntType ;
      ObSysVars[723].min_val_ = "400" ;
      ObSysVars[723].max_val_ = "524288" ;
      ObSysVars[723].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[723].id_ = SYS_VAR_TABLE_DEFINITION_CACHE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_TABLE_DEFINITION_CACHE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_TABLE_DEFINITION_CACHE] = 723 ;
      ObSysVars[723].base_value_ = "-1" ;
    ObSysVars[723].alias_ = "OB_SV_TABLE_DEFINITION_CACHE" ;
    }();

    [&] (){
      ObSysVars[724].default_value_ = "1048576" ;
      ObSysVars[724].info_ = "The sort buffer size for online DDL operations that create or rebuild secondary indexes, merely simulates MySQL 5.7" ;
      ObSysVars[724].name_ = "innodb_sort_buffer_size" ;
      ObSysVars[724].data_type_ = ObIntType ;
      ObSysVars[724].min_val_ = "65536" ;
      ObSysVars[724].max_val_ = "67108864" ;
      ObSysVars[724].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[724].id_ = SYS_VAR_INNODB_SORT_BUFFER_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_SORT_BUFFER_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_SORT_BUFFER_SIZE] = 724 ;
      ObSysVars[724].base_value_ = "1048576" ;
    ObSysVars[724].alias_ = "OB_SV_INNODB_SORT_BUFFER_SIZE" ;
    }();

    [&] (){
      ObSysVars[725].default_value_ = "1024" ;
      ObSysVars[725].info_ = "The size in bytes of blocks in the key cache, merely simulates MySQL 5.7" ;
      ObSysVars[725].name_ = "key_cache_block_size" ;
      ObSysVars[725].data_type_ = ObIntType ;
      ObSysVars[725].min_val_ = "512" ;
      ObSysVars[725].max_val_ = "16384" ;
      ObSysVars[725].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[725].id_ = SYS_VAR_KEY_CACHE_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEY_CACHE_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEY_CACHE_BLOCK_SIZE] = 725 ;
      ObSysVars[725].base_value_ = "1024" ;
    ObSysVars[725].alias_ = "OB_SV_KEY_CACHE_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[726].default_value_ = "0" ;
      ObSysVars[726].info_ = "Use this variable to select the interface mode for the OBKV tenant. You can select one of 'ALL, TABLEAPI, HBASE, REDIS, NONE', where 'ALL' is the default and 'NONE' represents the non-OBKV interface mode." ;
      ObSysVars[726].name_ = "ob_kv_mode" ;
      ObSysVars[726].data_type_ = ObIntType ;
      ObSysVars[726].enum_names_ = "[u'ALL', u'TABLEAPI', u'HBASE', u'REDIS', u'NONE']" ;
      ObSysVars[726].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY ;
      ObSysVars[726].id_ = SYS_VAR_OB_KV_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_KV_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_KV_MODE] = 726 ;
      ObSysVars[726].base_value_ = "0" ;
    ObSysVars[726].alias_ = "OB_SV_KV_MODE" ;
    }();

    [&] (){
      ObSysVars[727].default_value_ = "0" ;
      ObSysVars[727].info_ = "Indicate features that observer supports, readonly after modified by first observer" ;
      ObSysVars[727].name_ = "__ob_client_capability_flag" ;
      ObSysVars[727].data_type_ = ObUInt64Type ;
      ObSysVars[727].min_val_ = "0" ;
      ObSysVars[727].max_val_ = "18446744073709551615" ;
      ObSysVars[727].flags_ = ObSysVarFlag::READONLY | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INVISIBLE ;
      ObSysVars[727].id_ = SYS_VAR___OB_CLIENT_CAPABILITY_FLAG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR___OB_CLIENT_CAPABILITY_FLAG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR___OB_CLIENT_CAPABILITY_FLAG] = 727 ;
      ObSysVars[727].base_value_ = "0" ;
    ObSysVars[727].alias_ = "OB_SV___OB_CLIENT_CAPABILITY_FLAG" ;
    }();

    [&] (){
      ObSysVars[728].default_value_ = "1" ;
      ObSysVars[728].info_ = "wether use parameter anonymous_block" ;
      ObSysVars[728].name_ = "ob_enable_parameter_anonymous_block" ;
      ObSysVars[728].data_type_ = ObIntType ;
      ObSysVars[728].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[728].id_ = SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PARAMETER_ANONYMOUS_BLOCK] = 728 ;
      ObSysVars[728].base_value_ = "1" ;
    ObSysVars[728].alias_ = "OB_SV_ENABLE_PARAMETER_ANONYMOUS_BLOCK" ;
    }();

    [&] (){
      ObSysVars[729].default_value_ = "" ;
      ObSysVars[729].info_ = "The directory where character sets are installed" ;
      ObSysVars[729].name_ = "character_sets_dir" ;
      ...
      ObSysVars[729].id_ = SYS_VAR_CHARACTER_SETS_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CHARACTER_SETS_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CHARACTER_SETS_DIR] = 729 ;
      ObSysVars[729].base_value_ = "" ;
    ObSysVars[729].alias_ = "OB_SV_CHARACTER_SETS_DIR" ;
    }();

    [&] (){
      ObSysVars[730].default_value_ = "%Y-%m-%d" ;
      ObSysVars[730].info_ = "" ;
      ObSysVars[730].name_ = "date_format" ;
      ...
      ObSysVars[730].id_ = SYS_VAR_DATE_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DATE_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DATE_FORMAT] = 730 ;
      ObSysVars[730].base_value_ = "%Y-%m-%d" ;
    ObSysVars[730].alias_ = "OB_SV_DATE_FORMAT" ;
    }();

    [&] (){
      ObSysVars[731].default_value_ = "%Y-%m-%d %H:%i:%s" ;
      ObSysVars[731].info_ = "" ;
      ObSysVars[731].name_ = "datetime_format" ;
      ...
      ObSysVars[731].id_ = SYS_VAR_DATETIME_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DATETIME_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DATETIME_FORMAT] = 731 ;
      ObSysVars[731].base_value_ = "%Y-%m-%d %H:%i:%s" ;
    ObSysVars[731].alias_ = "OB_SV_DATETIME_FORMAT" ;
    }();

    [&] (){
      ObSysVars[732].default_value_ = "1" ;
      ObSysVars[732].info_ = "This variable controls how the server handles clients with expired passwords" ;
      ObSysVars[732].name_ = "disconnect_on_expired_password" ;
      ObSysVars[732].data_type_ = ObIntType ;
      ObSysVars[732].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[732].id_ = SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DISCONNECT_ON_EXPIRED_PASSWORD] = 732 ;
      ObSysVars[732].base_value_ = "1" ;
    ObSysVars[732].alias_ = "OB_SV_DISCONNECT_ON_EXPIRED_PASSWORD" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[733].name_ = "external_user" ;
      ObSysVars[733].data_type_ = ObVarcharType ;
      ObSysVars[733].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::NULLABLE | ObSysVarFlag::READONLY ;
      ObSysVars[733].id_ = SYS_VAR_EXTERNAL_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EXTERNAL_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EXTERNAL_USER] = 733 ;
      ObSysVars[733].base_value_ = "" ;
    ObSysVars[733].alias_ = "OB_SV_EXTERNAL_USER" ;
    }();

    [&] (){
      ObSysVars[734].default_value_ = "YES" ;
      ObSysVars[734].info_ = "The external user name used during the authentication process, as set by the plugin used to authenticate the client" ;
      ObSysVars[734].name_ = "have_crypt" ;
      ...
      ObSysVars[734].id_ = SYS_VAR_HAVE_CRYPT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_CRYPT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_CRYPT] = 734 ;
      ObSysVars[734].base_value_ = "YES" ;
    ObSysVars[734].alias_ = "OB_SV_HAVE_CRYPT" ;
    }();

    [&] (){
      ObSysVars[735].default_value_ = "YES" ;
      ObSysVars[735].info_ = "YES if mysqld supports dynamic loading of plugins, NO if not. If the value is NO, you cannot use options such as --plugin-load to load plugins at server startup, or the INSTALL PLUGIN statement to load plugins at runtime" ;
      ObSysVars[735].name_ = "have_dynamic_loading" ;
      ...
      ObSysVars[735].id_ = SYS_VAR_HAVE_DYNAMIC_LOADING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_HAVE_DYNAMIC_LOADING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_HAVE_DYNAMIC_LOADING] = 735 ;
      ObSysVars[735].base_value_ = "YES" ;
    ObSysVars[735].alias_ = "OB_SV_HAVE_DYNAMIC_LOADING" ;
    }();

    [&] (){
      ObSysVars[736].default_value_ = "" ;
      ObSysVars[736].info_ = "The location of the configuration file for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[736].name_ = "keyring_aws_conf_file" ;
      ...
      ObSysVars[736].id_ = SYS_VAR_KEYRING_AWS_CONF_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_CONF_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_CONF_FILE] = 736 ;
      ObSysVars[736].base_value_ = "" ;
    ObSysVars[736].alias_ = "OB_SV_KEYRING_AWS_CONF_FILE" ;
    }();

    [&] (){
      ObSysVars[737].default_value_ = "" ;
      ObSysVars[737].info_ = "The location of the storage file for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[737].name_ = "keyring_aws_data_file" ;
    ...
    [&] (){
      ...
      ObSysVars[738].id_ = SYS_VAR_LANGUAGE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LANGUAGE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LANGUAGE] = 738 ;
      ObSysVars[738].base_value_ = "" ;
    ObSysVars[738].alias_ = "OB_SV_LANGUAGE" ;
    }();

    [&] (){
      ObSysVars[739].default_value_ = "" ;
      ObSysVars[739].info_ = "The language to use for error messages" ;
      ObSysVars[739].name_ = "lc_messages_dir" ;
      ...
      ObSysVars[739].id_ = SYS_VAR_LC_MESSAGES_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LC_MESSAGES_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LC_MESSAGES_DIR] = 739 ;
      ObSysVars[739].base_value_ = "" ;
    ObSysVars[739].alias_ = "OB_SV_LC_MESSAGES_DIR" ;
    }();

    [&] (){
      ObSysVars[740].default_value_ = "0" ;
      ObSysVars[740].info_ = "This variable describes the case sensitivity of file names on the file system where the data directory is located" ;
      ObSysVars[740].name_ = "lower_case_file_system" ;
      ...
      ObSysVars[740].id_ = SYS_VAR_LOWER_CASE_FILE_SYSTEM ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_LOWER_CASE_FILE_SYSTEM)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_LOWER_CASE_FILE_SYSTEM] = 740 ;
      ObSysVars[740].base_value_ = "0" ;
    ObSysVars[740].alias_ = "OB_SV_LOWER_CASE_FILE_SYSTEM" ;
    }();

    [&] (){
      ObSysVars[741].default_value_ = "1024" ;
      ObSysVars[741].info_ = "The maximum number of bytes of memory reserved per session for computation of normalized statement digests" ;
      ObSysVars[741].name_ = "max_digest_length" ;
      ...
      ObSysVars[741].id_ = SYS_VAR_MAX_DIGEST_LENGTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_DIGEST_LENGTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_DIGEST_LENGTH] = 741 ;
      ObSysVars[741].base_value_ = "1024" ;
    ObSysVars[741].alias_ = "OB_SV_MAX_DIGEST_LENGTH" ;
    }();

    [&] (){
      ObSysVars[742].default_value_ = "ndbinfo" ;
      ObSysVars[742].info_ = "Shows the name used for the NDB information database" ;
      ObSysVars[742].name_ = "ndbinfo_database" ;
      ...
      ObSysVars[742].id_ = SYS_VAR_NDBINFO_DATABASE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_DATABASE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_DATABASE] = 742 ;
      ObSysVars[742].base_value_ = "ndbinfo" ;
    ObSysVars[742].alias_ = "OB_SV_NDBINFO_DATABASE" ;
    }();

    [&] (){
      ObSysVars[743].default_value_ = "ndb$" ;
      ObSysVars[743].info_ = "The prefix used in naming the ndbinfo database's base tables (normally hidden, unless exposed by setting ndbinfo_show_hidden" ;
      ObSysVars[743].name_ = "ndbinfo_table_prefix" ;
      ...
      ObSysVars[743].id_ = SYS_VAR_NDBINFO_TABLE_PREFIX ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_TABLE_PREFIX)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_TABLE_PREFIX] = 743 ;
      ObSysVars[743].base_value_ = "ndb$" ;
    ObSysVars[743].alias_ = "OB_SV_NDBINFO_TABLE_PREFIX" ;
    }();

    [&] (){
      ObSysVars[744].default_value_ = "" ;
      ObSysVars[744].info_ = "Shows the version of the ndbinfo engine in use" ;
      ObSysVars[744].name_ = "ndbinfo_version" ;
      ...
      ObSysVars[744].id_ = SYS_VAR_NDBINFO_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDBINFO_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDBINFO_VERSION] = 744 ;
      ObSysVars[744].base_value_ = "" ;
    ObSysVars[744].alias_ = "OB_SV_NDBINFO_VERSION" ;
    }();

    [&] (){
      ObSysVars[745].default_value_ = "32768" ;
      ObSysVars[745].info_ = "This sets the size in bytes that is used for NDB transaction batches" ;
      ObSysVars[745].name_ = "ndb_batch_size" ;
      ...
      ObSysVars[745].id_ = SYS_VAR_NDB_BATCH_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_BATCH_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_BATCH_SIZE] = 745 ;
      ObSysVars[745].base_value_ = "32768" ;
    ObSysVars[745].alias_ = "OB_SV_NDB_BATCH_SIZE" ;
    }();

    [&] (){
      ObSysVars[746].default_value_ = "1" ;
      ObSysVars[746].info_ = "a mysqld process can use multiple connections to the cluster, effectively mimicking several SQL nodes" ;
      ObSysVars[746].name_ = "ndb_cluster_connection_pool" ;
      ObSysVars[746].data_type_ = ObIntType ;
      ObSysVars[746].min_val_ = "1" ;
      ObSysVars[746].max_val_ = "63" ;
      ObSysVars[746].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[746].id_ = SYS_VAR_NDB_CLUSTER_CONNECTION_POOL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_CLUSTER_CONNECTION_POOL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_CLUSTER_CONNECTION_POOL] = 746 ;
      ObSysVars[746].base_value_ = "1" ;
    ObSysVars[746].alias_ = "OB_SV_NDB_CLUSTER_CONNECTION_POOL" ;
    }();

    [&] (){
      ObSysVars[747].default_value_ = "" ;
      ObSysVars[747].info_ = "Specifies a comma-separated list of node IDs for connections to the cluster used by an SQL node" ;
      ObSysVars[747].name_ = "ndb_cluster_connection_pool_nodeids" ;
      ObSysVars[747].data_type_ = ObVarcharType ;
      ObSysVars[747].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[747].id_ = SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_CLUSTER_CONNECTION_POOL_NODEIDS] = 747 ;
      ObSysVars[747].base_value_ = "" ;
    ObSysVars[747].alias_ = "OB_SV_NDB_CLUSTER_CONNECTION_POOL_NODEIDS" ;
    }();

    [&] (){
      ObSysVars[748].default_value_ = "0" ;
      ObSysVars[748].info_ = "Causes a replica mysqld to log any updates received from its immediate source to the mysql.ndb_apply_status table in its own binary log using its own server ID rather than the server ID of the source" ;
      ObSysVars[748].name_ = "ndb_log_apply_status" ;
      ...
      ObSysVars[748].id_ = SYS_VAR_NDB_LOG_APPLY_STATUS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_APPLY_STATUS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_APPLY_STATUS] = 748 ;
      ObSysVars[748].base_value_ = "0" ;
    ObSysVars[748].alias_ = "OB_SV_NDB_LOG_APPLY_STATUS" ;
    }();

    [&] (){
      ObSysVars[749].default_value_ = "1" ;
      ObSysVars[749].info_ = "Causes updates to NDB tables to be written to the binary log. Setting this variable has no effect if binary logging is not already enabled for the server using log_bin" ;
      ObSysVars[749].name_ = "ndb_log_bin" ;
      ObSysVars[749].data_type_ = ObIntType ;
      ObSysVars[749].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[749].id_ = SYS_VAR_NDB_LOG_BIN ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_BIN)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_BIN] = 749 ;
      ObSysVars[749].base_value_ = "1" ;
    ObSysVars[749].alias_ = "OB_SV_NDB_LOG_BIN" ;
    }();

    [&] (){
      ObSysVars[750].default_value_ = "0" ;
      ObSysVars[750].info_ = "When this option is specified, and complete logging of all found row events is not possible, the mysqld process is terminated" ;
      ObSysVars[750].name_ = "ndb_log_fail_terminate" ;
      ...
      ObSysVars[750].id_ = SYS_VAR_NDB_LOG_FAIL_TERMINATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_FAIL_TERMINATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_FAIL_TERMINATE] = 750 ;
      ObSysVars[750].base_value_ = "0" ;
    ObSysVars[750].alias_ = "OB_SV_NDB_LOG_FAIL_TERMINATE" ;
    }();

    [&] (){
      ObSysVars[751].default_value_ = "0" ;
      ObSysVars[751].info_ = "Shows whether the originating server ID and epoch are logged in the ndb_binlog_index table" ;
      ObSysVars[751].name_ = "ndb_log_orig" ;
      ...
      ObSysVars[751].id_ = SYS_VAR_NDB_LOG_ORIG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_ORIG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_ORIG] = 751 ;
      ObSysVars[751].base_value_ = "0" ;
    ObSysVars[751].alias_ = "OB_SV_NDB_LOG_ORIG" ;
    }();

    [&] (){
      ObSysVars[752].default_value_ = "0" ;
      ObSysVars[752].info_ = "shows whether a replica mysqld writes NDB transaction IDs in the binary log" ;
      ObSysVars[752].name_ = "ndb_log_transaction_id" ;
      ...
      ObSysVars[752].id_ = SYS_VAR_NDB_LOG_TRANSACTION_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_LOG_TRANSACTION_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_LOG_TRANSACTION_ID] = 752 ;
      ObSysVars[752].base_value_ = "0" ;
    ObSysVars[752].alias_ = "OB_SV_NDB_LOG_TRANSACTION_ID" ;
    }();

    [&] (){
      ObSysVars[753].default_value_ = "3" ;
      ObSysVars[753].info_ = "" ;
      ObSysVars[753].name_ = "ndb_optimized_node_selection" ;
      ...
      ObSysVars[753].id_ = SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_OPTIMIZED_NODE_SELECTION] = 753 ;
      ObSysVars[753].base_value_ = "3" ;
    ObSysVars[753].alias_ = "OB_SV_NDB_OPTIMIZED_NODE_SELECTION" ;
    }();

    [&] (){
      ObSysVars[754].default_value_ = "" ;
      ObSysVars[754].info_ = "If this MySQL Server is connected to an NDB cluster, this read-only variable shows the cluster system name. Otherwise, the value is an empty string" ;
      ObSysVars[754].name_ = "Ndb_system_name" ;
      ...
      ObSysVars[754].id_ = SYS_VAR_NDB_SYSTEM_NAME ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_SYSTEM_NAME)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_SYSTEM_NAME] = 754 ;
      ObSysVars[754].base_value_ = "" ;
    ObSysVars[754].alias_ = "OB_SV_NDB_SYSTEM_NAME" ;
    }();

    [&] (){
      ObSysVars[755].default_value_ = "0" ;
      ObSysVars[755].info_ = "Forces NDB to use copying of tables in the event of problems with online ALTER TABLE operations" ;
      ObSysVars[755].name_ = "ndb_use_copying_alter_table" ;
      ObSysVars[755].data_type_ = ObIntType ;
      ObSysVars[755].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[755].id_ = SYS_VAR_NDB_USE_COPYING_ALTER_TABLE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_USE_COPYING_ALTER_TABLE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_USE_COPYING_ALTER_TABLE] = 755 ;
      ObSysVars[755].base_value_ = "0" ;
    ObSysVars[755].alias_ = "OB_SV_NDB_USE_COPYING_ALTER_TABLE" ;
    }();

    [&] (){
      ObSysVars[756].default_value_ = "" ;
      ObSysVars[756].info_ = "NDB engine version in ndb-x.y.z format" ;
      ObSysVars[756].name_ = "ndb_version_string" ;
      ...
      ObSysVars[756].id_ = SYS_VAR_NDB_VERSION_STRING ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_VERSION_STRING)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_VERSION_STRING] = 756 ;
      ObSysVars[756].base_value_ = "" ;
    ObSysVars[756].alias_ = "OB_SV_NDB_VERSION_STRING" ;
    }();

    [&] (){
      ObSysVars[757].default_value_ = "30" ;
      ObSysVars[757].info_ = "This option sets the period of time that the MySQL server waits for connections to NDB Cluster management and data nodes to be established before accepting MySQL client connections." ;
      ObSysVars[757].name_ = "ndb_wait_connected" ;
      ...
      ObSysVars[757].id_ = SYS_VAR_NDB_WAIT_CONNECTED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_WAIT_CONNECTED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_WAIT_CONNECTED] = 757 ;
      ObSysVars[757].base_value_ = "30" ;
    ObSysVars[757].alias_ = "OB_SV_NDB_WAIT_CONNECTED" ;
    }();

    [&] (){
      ObSysVars[758].default_value_ = "30" ;
      ObSysVars[758].info_ = "This variable shows the period of time that the MySQL server waits for the NDB storage engine to complete setup before timing out and treating NDB as unavailable. The time is specified in seconds." ;
      ObSysVars[758].name_ = "ndb_wait_setup" ;
      ObSysVars[758].data_type_ = ObIntType ;
      ObSysVars[758].min_val_ = "0" ;
      ObSysVars[758].max_val_ = "31536000" ;
      ObSysVars[758].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[758].id_ = SYS_VAR_NDB_WAIT_SETUP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_WAIT_SETUP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_WAIT_SETUP] = 758 ;
      ObSysVars[758].base_value_ = "30" ;
    ObSysVars[758].alias_ = "OB_SV_NDB_WAIT_SETUP" ;
    }();

    [&] (){
      ObSysVars[759].default_value_ = "" ;
      ObSysVars[759].info_ = "If the current client is a proxy for another user, this variable is the proxy user account name" ;
      ObSysVars[759].name_ = "proxy_user" ;
      ...
      ObSysVars[759].id_ = SYS_VAR_PROXY_USER ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PROXY_USER)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PROXY_USER] = 759 ;
      ObSysVars[759].base_value_ = "" ;
    ObSysVars[759].alias_ = "OB_SV_PROXY_USER" ;
    }();

    [&] (){
      ObSysVars[760].default_value_ = "1" ;
      ObSysVars[760].info_ = "It controls whether the server autogenerates RSA private/public key-pair files in the data directory" ;
      ObSysVars[760].name_ = "sha256_password_auto_generate_rsa_keys" ;
      ObSysVars[760].data_type_ = ObIntType ;
      ObSysVars[760].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[760].id_ = SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS] = 760 ;
      ObSysVars[760].base_value_ = "1" ;
    ObSysVars[760].alias_ = "OB_SV_SHA256_PASSWORD_AUTO_GENERATE_RSA_KEYS" ;
    }();

    [&] (){
      ObSysVars[761].default_value_ = "private_key.pem" ;
      ObSysVars[761].info_ = "Its value is the path name of the RSA private key file for the sha256_password authentication plugin" ;
      ObSysVars[761].name_ = "sha256_password_private_key_path" ;
      ...
      ObSysVars[761].id_ = SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PRIVATE_KEY_PATH] = 761 ;
      ObSysVars[761].base_value_ = "private_key.pem" ;
    ObSysVars[761].alias_ = "OB_SV_SHA256_PASSWORD_PRIVATE_KEY_PATH" ;
    }();

    [&] (){
      ObSysVars[762].default_value_ = "public_key.pem" ;
      ObSysVars[762].info_ = "Its value is the path name of the RSA public key file for the sha256_password authentication plugin" ;
      ObSysVars[762].name_ = "sha256_password_public_key_path" ;
      ...
      ObSysVars[762].id_ = SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PUBLIC_KEY_PATH] = 762 ;
      ObSysVars[762].base_value_ = "public_key.pem" ;
    ObSysVars[762].alias_ = "OB_SV_SHA256_PASSWORD_PUBLIC_KEY_PATH" ;
    }();

    [&] (){
      ObSysVars[763].default_value_ = "0" ;
      ObSysVars[763].info_ = " If the variable value is ON, the SHOW DATABASES statement is permitted only to users who have the SHOW DATABASES privilege, and the statement displays all database names" ;
      ObSysVars[763].name_ = "skip_show_database" ;
      ObSysVars[763].data_type_ = ObVarcharType ;
      ObSysVars[763].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[763].id_ = SYS_VAR_SKIP_SHOW_DATABASE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SKIP_SHOW_DATABASE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SKIP_SHOW_DATABASE] = 763 ;
      ObSysVars[763].base_value_ = "0" ;
    ObSysVars[763].alias_ = "OB_SV_SKIP_SHOW_DATABASE" ;
    }();

    [&] (){
      ObSysVars[764].default_value_ = "" ;
      ObSysVars[764].info_ = "This option tells the server to load the named plugins at startup" ;
      ObSysVars[764].name_ = "plugin_load" ;
      ...
      ObSysVars[764].id_ = SYS_VAR_PLUGIN_LOAD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_LOAD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_LOAD] = 764 ;
      ObSysVars[764].base_value_ = "" ;
    ObSysVars[764].alias_ = "OB_SV_PLUGIN_LOAD" ;
    }();

    [&] (){
      ObSysVars[765].default_value_ = "" ;
      ObSysVars[765].info_ = "adds a plugin or plugins to the set of plugins to be loaded at startup" ;
      ObSysVars[765].name_ = "plugin_load_add" ;
      ObSysVars[765].data_type_ = ObVarcharType ;
      ObSysVars[765].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[765].id_ = SYS_VAR_PLUGIN_LOAD_ADD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PLUGIN_LOAD_ADD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PLUGIN_LOAD_ADD] = 765 ;
      ObSysVars[765].base_value_ = "" ;
    ObSysVars[765].alias_ = "OB_SV_PLUGIN_LOAD_ADD" ;
    }();

    [&] (){
      ObSysVars[766].default_value_ = "0" ;
      ObSysVars[766].info_ = "the server stores all temporary tables on disk rather than in memory" ;
      ObSysVars[766].name_ = "big_tables" ;
      ...
      ObSysVars[766].id_ = SYS_VAR_BIG_TABLES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_BIG_TABLES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_BIG_TABLES] = 766 ;
      ObSysVars[766].base_value_ = "0" ;
    ObSysVars[766].alias_ = "OB_SV_BIG_TABLES" ;
    }();

    [&] (){
      ObSysVars[767].default_value_ = "0" ;
      ObSysVars[767].info_ = "If the check_proxy_users system variable is enabled, the server performs proxy user mapping for any authentication plugins that make such a request" ;
      ObSysVars[767].name_ = "check_proxy_users" ;
      ObSysVars[767].data_type_ = ObIntType ;
      ObSysVars[767].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[767].id_ = SYS_VAR_CHECK_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CHECK_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CHECK_PROXY_USERS] = 767 ;
      ObSysVars[767].base_value_ = "0" ;
    ObSysVars[767].alias_ = "OB_SV_CHECK_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[768].default_value_ = "0" ;
      ObSysVars[768].info_ = "The number of consecutive failed connection attempts permitted to accounts before the server adds a delay for subsequent connection attempts" ;
      ObSysVars[768].name_ = "connection_control_failed_connections_threshold" ;
      ...
      ObSysVars[768].id_ = SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD] = 768 ;
      ObSysVars[768].base_value_ = "0" ;
    ObSysVars[768].alias_ = "OB_SV_CONNECTION_CONTROL_FAILED_CONNECTIONS_THRESHOLD" ;
    }();

    [&] (){
      ObSysVars[769].default_value_ = "2147483647" ;
      ObSysVars[769].info_ = "The maximum delay in milliseconds for server response to failed connection attempts, if connection_control_failed_connections_threshold is greater than zero" ;
      ObSysVars[769].name_ = "connection_control_max_connection_delay" ;
      ...
      ObSysVars[769].id_ = SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_MAX_CONNECTION_DELAY] = 769 ;
      ObSysVars[769].base_value_ = "2147483647" ;
    ObSysVars[769].alias_ = "OB_SV_CONNECTION_CONTROL_MAX_CONNECTION_DELAY" ;
    }();

    [&] (){
      ObSysVars[770].default_value_ = "1000" ;
      ObSysVars[770].info_ = "The minmum delay in milliseconds for server response to failed connection attempts, if connection_control_failed_connections_threshold is greater than zero" ;
      ObSysVars[770].name_ = "connection_control_min_connection_delay" ;
      ObSysVars[770].data_type_ = ObIntType ;
      ObSysVars[770].min_val_ = "1000" ;
      ObSysVars[770].max_val_ = "2147483647" ;
      ObSysVars[770].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[770].id_ = SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_CONNECTION_CONTROL_MIN_CONNECTION_DELAY] = 770 ;
      ObSysVars[770].base_value_ = "1000" ;
    ObSysVars[770].alias_ = "OB_SV_CONNECTION_CONTROL_MIN_CONNECTION_DELAY" ;
    }();

    [&] (){
      ObSysVars[771].default_value_ = "0" ;
      ObSysVars[771].info_ = "The default mode value to use for the WEEK() function" ;
      ObSysVars[771].name_ = "default_week_format" ;
      ObSysVars[771].data_type_ = ObIntType ;
      ObSysVars[771].min_val_ = "0" ;
      ObSysVars[771].max_val_ = "7" ;
      ObSysVars[771].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[771].id_ = SYS_VAR_DEFAULT_WEEK_FORMAT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DEFAULT_WEEK_FORMAT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DEFAULT_WEEK_FORMAT] = 771 ;
      ObSysVars[771].base_value_ = "0" ;
    ObSysVars[771].alias_ = "OB_SV_DEFAULT_WEEK_FORMAT" ;
    }();

    [&] (){
      ObSysVars[772].default_value_ = "300" ;
      ObSysVars[772].info_ = "" ;
      ObSysVars[772].name_ = "delayed_insert_timeout" ;
      ObSysVars[772].data_type_ = ObIntType ;
      ObSysVars[772].min_val_ = "1" ;
      ObSysVars[772].max_val_ = "31536000" ;
      ObSysVars[772].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[772].id_ = SYS_VAR_DELAYED_INSERT_TIMEOUT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_INSERT_TIMEOUT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_INSERT_TIMEOUT] = 772 ;
      ObSysVars[772].base_value_ = "300" ;
    ObSysVars[772].alias_ = "OB_SV_DELAYED_INSERT_TIMEOUT" ;
    }();

    [&] (){
      ObSysVars[773].default_value_ = "1000" ;
      ObSysVars[773].info_ = "" ;
      ObSysVars[773].name_ = "delayed_queue_size" ;
      ObSysVars[773].data_type_ = ObUInt64Type ;
      ObSysVars[773].min_val_ = "1" ;
      ObSysVars[773].max_val_ = "18446744073709551615" ;
      ObSysVars[773].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[773].id_ = SYS_VAR_DELAYED_QUEUE_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_QUEUE_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_QUEUE_SIZE] = 773 ;
      ObSysVars[773].base_value_ = "1000" ;
    ObSysVars[773].alias_ = "OB_SV_DELAYED_QUEUE_SIZE" ;
    }();

    [&] (){
      ObSysVars[774].default_value_ = "200" ;
      ObSysVars[774].info_ = "This variable indicates the number of equality ranges in an equality comparison condition when the optimizer should switch from using index dives to index statistics in estimating the number of qualifying rows" ;
      ObSysVars[774].name_ = "eq_range_index_dive_limit" ;
      ObSysVars[774].data_type_ = ObIntType ;
      ObSysVars[774].min_val_ = "0" ;
      ObSysVars[774].max_val_ = "4294967295" ;
      ObSysVars[774].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[774].id_ = SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_EQ_RANGE_INDEX_DIVE_LIMIT] = 774 ;
      ObSysVars[774].base_value_ = "200" ;
    ObSysVars[774].alias_ = "OB_SV_EQ_RANGE_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[775].default_value_ = "1" ;
      ObSysVars[775].info_ = "Causes InnoDB to automatically recalculate persistent statistics after the data in a table is changed substantially, merely simulates MySQL 5.7" ;
      ObSysVars[775].name_ = "innodb_stats_auto_recalc" ;
      ObSysVars[775].data_type_ = ObIntType ;
      ObSysVars[775].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[775].id_ = SYS_VAR_INNODB_STATS_AUTO_RECALC ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_AUTO_RECALC)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_AUTO_RECALC] = 775 ;
      ObSysVars[775].base_value_ = "1" ;
    ObSysVars[775].alias_ = "OB_SV_INNODB_STATS_AUTO_RECALC" ;
    }();

    [&] (){
      ObSysVars[776].default_value_ = "0" ;
      ObSysVars[776].info_ = "When innodb_stats_include_delete_marked is enabled, ANALYZE TABLE considers delete-marked records when recalculating statistics" ;
      ObSysVars[776].name_ = "innodb_stats_include_delete_marked" ;
      ObSysVars[776].data_type_ = ObIntType ;
      ObSysVars[776].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[776].id_ = SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_INCLUDE_DELETE_MARKED] = 776 ;
      ObSysVars[776].base_value_ = "0" ;
    ObSysVars[776].alias_ = "OB_SV_INNODB_STATS_INCLUDE_DELETE_MARKED" ;
    }();

    [&] (){
      ObSysVars[777].default_value_ = "0" ;
      ObSysVars[777].info_ = "How the server treats NULL values when collecting statistics about the distribution of index values for InnoDB tables" ;
      ObSysVars[777].name_ = "innodb_stats_method" ;
      ObSysVars[777].data_type_ = ObIntType ;
      ObSysVars[777].enum_names_ = "[u'nulls_equal', u'nulls_unequal', u'nulls_ignored']" ;
      ObSysVars[777].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[777].id_ = SYS_VAR_INNODB_STATS_METHOD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_METHOD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_METHOD] = 777 ;
      ObSysVars[777].base_value_ = "0" ;
    ObSysVars[777].alias_ = "OB_SV_INNODB_STATS_METHOD" ;
    }();

    [&] (){
      ObSysVars[778].default_value_ = "0" ;
      ObSysVars[778].info_ = "When innodb_stats_on_metadata is enabled, InnoDB updates non-persistent statistics when metadata statements such as SHOW TABLE STATUS or when accessing the Information Schema TABLES or STATISTICS tables" ;
      ObSysVars[778].name_ = "innodb_stats_on_metadata" ;
      ObSysVars[778].data_type_ = ObIntType ;
      ObSysVars[778].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[778].id_ = SYS_VAR_INNODB_STATS_ON_METADATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_ON_METADATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_ON_METADATA] = 778 ;
      ObSysVars[778].base_value_ = "0" ;
    ObSysVars[778].alias_ = "OB_SV_INNODB_STATS_ON_METADATA" ;
    }();

    [&] (){
      ObSysVars[779].default_value_ = "" ;
      ObSysVars[779].info_ = "The session value of this variable specifies the client version token list and indicates the tokens that the client session requires the server version token list to have, merely simulates MySQL 5.7" ;
      ObSysVars[779].name_ = "version_tokens_session" ;
      ...
      ObSysVars[779].id_ = SYS_VAR_VERSION_TOKENS_SESSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VERSION_TOKENS_SESSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VERSION_TOKENS_SESSION] = 779 ;
      ObSysVars[779].base_value_ = "" ;
    ObSysVars[779].alias_ = "OB_SV_VERSION_TOKENS_SESSION" ;
    }();

    [&] (){
      ObSysVars[780].default_value_ = "20" ;
      ...
      ObSysVars[780].name_ = "innodb_stats_persistent_sample_pages" ;
      ...
      ObSysVars[780].id_ = SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_PERSISTENT_SAMPLE_PAGES] = 780 ;
      ObSysVars[780].base_value_ = "20" ;
    ObSysVars[780].alias_ = "OB_SV_INNODB_STATS_PERSISTENT_SAMPLE_PAGES" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[781].name_ = "innodb_stats_sample_pages" ;
      ...
      ObSysVars[781].id_ = SYS_VAR_INNODB_STATS_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_SAMPLE_PAGES] = 781 ;
      ObSysVars[781].base_value_ = "8" ;
    ObSysVars[781].alias_ = "OB_SV_INNODB_STATS_SAMPLE_PAGES" ;
    }();

    [&] (){
      ObSysVars[782].default_value_ = "8" ;
      ObSysVars[782].info_ = "The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by ANALYZE TABLE" ;
      ObSysVars[782].name_ = "innodb_stats_transient_sample_pages" ;
      ObSysVars[782].data_type_ = ObUInt64Type ;
      ObSysVars[782].min_val_ = "1" ;
      ObSysVars[782].max_val_ = "18446744073709551615" ;
      ObSysVars[782].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[782].id_ = SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_INNODB_STATS_TRANSIENT_SAMPLE_PAGES] = 782 ;
      ObSysVars[782].base_value_ = "8" ;
    ObSysVars[782].alias_ = "OB_SV_INNODB_STATS_TRANSIENT_SAMPLE_PAGES" ;
    }();

    [&] (){
      ObSysVars[783].default_value_ = "" ;
      ObSysVars[783].info_ = "The customer master key (CMK) ID obtained from the AWS KMS server and used by the keyring_aws plugin" ;
      ObSysVars[783].name_ = "keyring_aws_cmk_id" ;
      ObSysVars[783].data_type_ = ObVarcharType ;
      ObSysVars[783].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[783].id_ = SYS_VAR_KEYRING_AWS_CMK_ID ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_CMK_ID)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_CMK_ID] = 783 ;
      ObSysVars[783].base_value_ = "" ;
    ObSysVars[783].alias_ = "OB_SV_KEYRING_AWS_CMK_ID" ;
    }();

    [&] (){
      ObSysVars[784].default_value_ = "19" ;
      ObSysVars[784].info_ = "The AWS region for the keyring_aws plugin. This variable is unavailable unless that plugin is installed" ;
      ObSysVars[784].name_ = "keyring_aws_region" ;
      ObSysVars[784].data_type_ = ObIntType ;
      ObSysVars[784].enum_names_ = "[u'af-south-1', u'ap-east-1', u'ap-northeast-1', u'ap-northeast-2', u'ap-northeast-3', u'ap-south-1', u'ap-southeast-1', u'ap-southeast-2', u'ca-central-1', u'cn-north-1', u'cn-northwest-1', u'eu-central-1', u'eu-north-1', u'eu-south-1', u'eu-west-1', u'eu-west-2', u'eu-west-3', u'me-south-1', u'sa-east-1', u'us-east-1', u'us-east-2', u'us-gov-east-1', u'us-iso-east-1', u'us-iso-west-1', u'us-isob-east-1', u'us-west-1', u'us-west-2']" ;
      ObSysVars[784].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[784].id_ = SYS_VAR_KEYRING_AWS_REGION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_AWS_REGION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_AWS_REGION] = 784 ;
      ObSysVars[784].base_value_ = "19" ;
    ObSysVars[784].alias_ = "OB_SV_KEYRING_AWS_REGION" ;
    }();

    [&] (){
      ObSysVars[785].default_value_ = "" ;
      ObSysVars[785].info_ = "The path name of the data file used for secure data storage by the keyring_encrypted_file plugin" ;
      ObSysVars[785].name_ = "keyring_encrypted_file_data" ;
      ObSysVars[785].data_type_ = ObVarcharType ;
      ObSysVars[785].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[785].id_ = SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_ENCRYPTED_FILE_DATA] = 785 ;
      ObSysVars[785].base_value_ = "" ;
    ObSysVars[785].alias_ = "OB_SV_KEYRING_ENCRYPTED_FILE_DATA" ;
    }();

    [&] (){
      ObSysVars[786].default_value_ = "" ;
      ObSysVars[786].info_ = "The password used by the keyring_encrypted_file pluginn" ;
      ObSysVars[786].name_ = "keyring_encrypted_file_password" ;
      ObSysVars[786].data_type_ = ObVarcharType ;
      ObSysVars[786].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[786].id_ = SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_ENCRYPTED_FILE_PASSWORD] = 786 ;
      ObSysVars[786].base_value_ = "" ;
    ObSysVars[786].alias_ = "OB_SV_KEYRING_ENCRYPTED_FILE_PASSWORD" ;
    }();

    [&] (){
      ObSysVars[787].default_value_ = "" ;
      ObSysVars[787].info_ = "The path name of the data file used for secure data storage by the keyring_file plugin" ;
      ObSysVars[787].name_ = "keyring_file_data" ;
      ObSysVars[787].data_type_ = ObVarcharType ;
      ObSysVars[787].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[787].id_ = SYS_VAR_KEYRING_FILE_DATA ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_FILE_DATA)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_FILE_DATA] = 787 ;
      ObSysVars[787].base_value_ = "" ;
    ObSysVars[787].alias_ = "OB_SV_KEYRING_FILE_DATA" ;
    }();

    [&] (){
      ObSysVars[788].default_value_ = "" ;
      ObSysVars[788].info_ = "The path name of the directory that stores configuration information used by the keyring_okv plugin" ;
      ObSysVars[788].name_ = "keyring_okv_conf_dir" ;
      ObSysVars[788].data_type_ = ObVarcharType ;
      ObSysVars[788].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[788].id_ = SYS_VAR_KEYRING_OKV_CONF_DIR ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_OKV_CONF_DIR)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_OKV_CONF_DIR] = 788 ;
      ObSysVars[788].base_value_ = "" ;
    ObSysVars[788].alias_ = "OB_SV_KEYRING_OKV_CONF_DIR" ;
    }();

    [&] (){
      ObSysVars[789].default_value_ = "1" ;
      ObSysVars[789].info_ = "Whether keyring operations are enabled. This variable is used during key migration operations" ;
      ObSysVars[789].name_ = "keyring_operations" ;
      ObSysVars[789].data_type_ = ObIntType ;
      ObSysVars[789].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[789].id_ = SYS_VAR_KEYRING_OPERATIONS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_KEYRING_OPERATIONS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_KEYRING_OPERATIONS] = 789 ;
      ObSysVars[789].base_value_ = "1" ;
    ObSysVars[789].alias_ = "OB_SV_KEYRING_OPERATIONS" ;
    }();

    [&] (){
      ObSysVars[790].default_value_ = "" ;
      ObSysVars[790].info_ = "enables control over optimizer behavior" ;
      ObSysVars[790].name_ = "optimizer_switch" ;
      ...
      ObSysVars[790].id_ = SYS_VAR_OPTIMIZER_SWITCH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_SWITCH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_SWITCH] = 790 ;
      ObSysVars[790].base_value_ = "" ;
    ObSysVars[790].alias_ = "OB_SV_OPTIMIZER_SWITCH" ;
    }();

    [&] (){
      ObSysVars[791].default_value_ = "100" ;
      ObSysVars[791].info_ = "After max_connect_errors successive connection requests from a host are interrupted without a successful connection, the server blocks that host from further connections" ;
      ObSysVars[791].name_ = "max_connect_errors" ;
      ObSysVars[791].data_type_ = ObUInt64Type ;
      ObSysVars[791].min_val_ = "1" ;
      ObSysVars[791].max_val_ = "18446744073709551615" ;
      ObSysVars[791].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[791].id_ = SYS_VAR_MAX_CONNECT_ERRORS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MAX_CONNECT_ERRORS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MAX_CONNECT_ERRORS] = 791 ;
      ObSysVars[791].base_value_ = "100" ;
    ObSysVars[791].alias_ = "OB_SV_MAX_CONNECT_ERRORS" ;
    }();

    [&] (){
      ObSysVars[792].default_value_ = "0" ;
      ObSysVars[792].info_ = "Whether MySQL Enterprise Firewall is enabled (the default) or disabled" ;
      ObSysVars[792].name_ = "mysql_firewall_mode" ;
      ObSysVars[792].data_type_ = ObIntType ;
      ObSysVars[792].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[792].id_ = SYS_VAR_MYSQL_FIREWALL_MODE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_FIREWALL_MODE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_FIREWALL_MODE] = 792 ;
      ObSysVars[792].base_value_ = "0" ;
    ObSysVars[792].alias_ = "OB_SV_MYSQL_FIREWALL_MODE" ;
    }();

    [&] (){
      ObSysVars[793].default_value_ = "0" ;
      ObSysVars[793].info_ = "Whether the MySQL Enterprise Firewall trace is enabled or disabled (the default)" ;
      ObSysVars[793].name_ = "mysql_firewall_trace" ;
      ObSysVars[793].data_type_ = ObIntType ;
      ObSysVars[793].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[793].id_ = SYS_VAR_MYSQL_FIREWALL_TRACE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_FIREWALL_TRACE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_FIREWALL_TRACE] = 793 ;
      ObSysVars[793].base_value_ = "0" ;
    ObSysVars[793].alias_ = "OB_SV_MYSQL_FIREWALL_TRACE" ;
    }();

    [&] (){
      ObSysVars[794].default_value_ = "0" ;
      ObSysVars[794].info_ = "This variable controls whether the mysql_native_password built-in authentication plugin supports proxy users" ;
      ObSysVars[794].name_ = "mysql_native_password_proxy_users" ;
      ObSysVars[794].data_type_ = ObIntType ;
      ObSysVars[794].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[794].id_ = SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MYSQL_NATIVE_PASSWORD_PROXY_USERS] = 794 ;
      ObSysVars[794].base_value_ = "0" ;
    ObSysVars[794].alias_ = "OB_SV_MYSQL_NATIVE_PASSWORD_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[795].default_value_ = "10" ;
      ObSysVars[795].info_ = "If a read or write on a communication port is interrupted, retry this many times before giving up. This value should be set quite high on FreeBSD because internal interrupts are sent to all threads" ;
      ObSysVars[795].name_ = "net_retry_count" ;
      ObSysVars[795].data_type_ = ObUInt64Type ;
      ObSysVars[795].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[795].id_ = SYS_VAR_NET_RETRY_COUNT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NET_RETRY_COUNT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NET_RETRY_COUNT] = 795 ;
      ObSysVars[795].base_value_ = "10" ;
    ObSysVars[795].alias_ = "OB_SV_NET_RETRY_COUNT" ;
    }();

    [&] (){
      ObSysVars[796].default_value_ = "0" ;
      ObSysVars[796].info_ = "This variable was used in MySQL 4.0 to turn on some 4.1 behaviors, and is retained for backward compatibility. Its value is always OFF" ;
      ObSysVars[796].name_ = "new" ;
      ...
      ObSysVars[796].id_ = SYS_VAR_NEW ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NEW)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NEW] = 796 ;
      ObSysVars[796].base_value_ = "0" ;
    ObSysVars[796].alias_ = "OB_SV_NEW" ;
    }();

    [&] (){
      ObSysVars[797].default_value_ = "0" ;
      ObSysVars[797].info_ = "This variable controls the password hashing method used by the PASSWORD() function. It also influences password hashing performed by CREATE USER and GRANT statements that specify a password using an IDENTIFIED BY clause" ;
      ObSysVars[797].name_ = "old_passwords" ;
      ObSysVars[797].data_type_ = ObIntType ;
      ObSysVars[797].enum_names_ = "[u'0', u'1', u'2']" ;
      ObSysVars[797].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[797].id_ = SYS_VAR_OLD_PASSWORDS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OLD_PASSWORDS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OLD_PASSWORDS] = 797 ;
      ObSysVars[797].base_value_ = "0" ;
    ObSysVars[797].alias_ = "OB_SV_OLD_PASSWORDS" ;
    }();

    [&] (){
      ObSysVars[798].default_value_ = "1" ;
      ObSysVars[798].info_ = "Controls the heuristics applied during query optimization to prune less-promising partial plans from the optimizer search space" ;
      ObSysVars[798].name_ = "optimizer_prune_level" ;
      ObSysVars[798].data_type_ = ObIntType ;
      ObSysVars[798].min_val_ = "0" ;
      ObSysVars[798].max_val_ = "1" ;
      ObSysVars[798].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[798].id_ = SYS_VAR_OPTIMIZER_PRUNE_LEVEL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_PRUNE_LEVEL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_PRUNE_LEVEL] = 798 ;
      ObSysVars[798].base_value_ = "1" ;
    ObSysVars[798].alias_ = "OB_SV_OPTIMIZER_PRUNE_LEVEL" ;
    }();

    [&] (){
      ObSysVars[799].default_value_ = "62" ;
      ObSysVars[799].info_ = "The maximum depth of search performed by the query optimizer" ;
      ObSysVars[799].name_ = "optimizer_search_depth" ;
      ObSysVars[799].data_type_ = ObIntType ;
      ObSysVars[799].min_val_ = "0" ;
      ObSysVars[799].max_val_ = "62" ;
      ObSysVars[799].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[799].id_ = SYS_VAR_OPTIMIZER_SEARCH_DEPTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_SEARCH_DEPTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_SEARCH_DEPTH] = 799 ;
      ObSysVars[799].base_value_ = "62" ;
    ObSysVars[799].alias_ = "OB_SV_OPTIMIZER_SEARCH_DEPTH" ;
    }();

    [&] (){
      ObSysVars[800].default_value_ = "" ;
      ObSysVars[800].info_ = "This variable controls optimizer tracing" ;
      ObSysVars[800].name_ = "optimizer_trace" ;
      ...
      ObSysVars[800].id_ = SYS_VAR_OPTIMIZER_TRACE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE] = 800 ;
      ObSysVars[800].base_value_ = "" ;
    ObSysVars[800].alias_ = "OB_SV_OPTIMIZER_TRACE" ;
    }();

    [&] (){
      ObSysVars[801].default_value_ = "" ;
      ObSysVars[801].info_ = "This variable enables or disables selected optimizer tracing features" ;
      ObSysVars[801].name_ = "optimizer_trace_features" ;
      ...
      ObSysVars[801].id_ = SYS_VAR_OPTIMIZER_TRACE_FEATURES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_FEATURES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_FEATURES] = 801 ;
      ObSysVars[801].base_value_ = "" ;
    ObSysVars[801].alias_ = "OB_SV_OPTIMIZER_TRACE_FEATURES" ;
    }();

    [&] (){
      ObSysVars[802].default_value_ = "1" ;
      ObSysVars[802].info_ = "The maximum number of optimizer traces to display" ;
      ObSysVars[802].name_ = "optimizer_trace_limit" ;
      ...
      ObSysVars[802].id_ = SYS_VAR_OPTIMIZER_TRACE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_LIMIT] = 802 ;
      ObSysVars[802].base_value_ = "1" ;
    ObSysVars[802].alias_ = "OB_SV_OPTIMIZER_TRACE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[803].default_value_ = "16384" ;
      ObSysVars[803].info_ = "The maximum cumulative size of stored optimizer traces" ;
      ObSysVars[803].name_ = "optimizer_trace_max_mem_size" ;
      ...
      ObSysVars[803].id_ = SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_MAX_MEM_SIZE] = 803 ;
      ObSysVars[803].base_value_ = "16384" ;
    ObSysVars[803].alias_ = "OB_SV_OPTIMIZER_TRACE_MAX_MEM_SIZE" ;
    }();

    [&] (){
      ObSysVars[804].default_value_ = "-1" ;
      ObSysVars[804].info_ = "The offset of optimizer traces to display" ;
      ObSysVars[804].name_ = "optimizer_trace_offset" ;
      ObSysVars[804].data_type_ = ObIntType ;
      ObSysVars[804].min_val_ = "-2147483647" ;
      ObSysVars[804].max_val_ = "2147483647" ;
      ObSysVars[804].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[804].id_ = SYS_VAR_OPTIMIZER_TRACE_OFFSET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OPTIMIZER_TRACE_OFFSET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OPTIMIZER_TRACE_OFFSET] = 804 ;
      ObSysVars[804].base_value_ = "-1" ;
    ObSysVars[804].alias_ = "OB_SV_OPTIMIZER_TRACE_OFFSET" ;
    }();

    [&] (){
      ObSysVars[805].default_value_ = "18446744073709551615" ;
      ObSysVars[805].info_ = "The maximum amount of memory available to the parser" ;
      ObSysVars[805].name_ = "parser_max_mem_size" ;
      ObSysVars[805].data_type_ = ObUInt64Type ;
      ObSysVars[805].min_val_ = "10000000" ;
      ...
      ObSysVars[805].id_ = SYS_VAR_PARSER_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARSER_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PARSER_MAX_MEM_SIZE] = 805 ;
      ObSysVars[805].base_value_ = "18446744073709551615" ;
    ObSysVars[805].alias_ = "OB_SV_PARSER_MAX_MEM_SIZE" ;
    }();
    ...
    [&] (){
      ...
      ObSysVars[806].name_ = "rand_seed1" ;
      ...
      ObSysVars[806].id_ = SYS_VAR_RAND_SEED1 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RAND_SEED1)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RAND_SEED1] = 806 ;
      ObSysVars[806].base_value_ = "0" ;
    ObSysVars[806].alias_ = "OB_SV_RAND_SEED1" ;
    }();

    [&] (){
      ObSysVars[807].default_value_ = "0" ;
      ObSysVars[807].info_ = "For statements that invoke RAND(), the source passes two values to the replica, where they are used to seed the random number generator" ;
      ObSysVars[807].name_ = "rand_seed2" ;
      ObSysVars[807].data_type_ = ObUInt64Type ;
      ObSysVars[807].min_val_ = "0" ;
      ObSysVars[807].max_val_ = "4294967295" ;
      ObSysVars[807].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[807].id_ = SYS_VAR_RAND_SEED2 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RAND_SEED2)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RAND_SEED2] = 807 ;
      ObSysVars[807].base_value_ = "0" ;
    ObSysVars[807].alias_ = "OB_SV_RAND_SEED2" ;
    }();

    [&] (){
      ObSysVars[808].default_value_ = "4096" ;
      ObSysVars[808].info_ = "The size in bytes of blocks that are allocated when doing range optimization" ;
      ObSysVars[808].name_ = "range_alloc_block_size" ;
      ObSysVars[808].data_type_ = ObUInt64Type ;
      ObSysVars[808].min_val_ = "4096" ;
      ObSysVars[808].max_val_ = "18446744073709550592" ;
      ObSysVars[808].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[808].id_ = SYS_VAR_RANGE_ALLOC_BLOCK_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_ALLOC_BLOCK_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_ALLOC_BLOCK_SIZE] = 808 ;
      ObSysVars[808].base_value_ = "4096" ;
    ObSysVars[808].alias_ = "OB_SV_RANGE_ALLOC_BLOCK_SIZE" ;
    }();

    [&] (){
      ObSysVars[809].default_value_ = "8388608" ;
      ObSysVars[809].info_ = "The limit on memory consumption for the range optimizer" ;
      ObSysVars[809].name_ = "range_optimizer_max_mem_size" ;
      ObSysVars[809].data_type_ = ObUInt64Type ;
      ObSysVars[809].min_val_ = "0" ;
      ObSysVars[809].max_val_ = "18446744073709551615" ;
      ObSysVars[809].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[809].id_ = SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_OPTIMIZER_MAX_MEM_SIZE] = 809 ;
      ObSysVars[809].base_value_ = "8388608" ;
    ObSysVars[809].alias_ = "OB_SV_RANGE_OPTIMIZER_MAX_MEM_SIZE" ;
    }();

    [&] (){
      ObSysVars[810].default_value_ = "1" ;
      ObSysVars[810].info_ = "Whether the Rewriter query rewrite plugin is enabled" ;
      ObSysVars[810].name_ = "rewriter_enabled" ;
      ObSysVars[810].data_type_ = ObIntType ;
      ObSysVars[810].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[810].id_ = SYS_VAR_REWRITER_ENABLED ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REWRITER_ENABLED)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REWRITER_ENABLED] = 810 ;
      ObSysVars[810].base_value_ = "1" ;
    ObSysVars[810].alias_ = "OB_SV_REWRITER_ENABLED" ;
    }();

    [&] (){
      ObSysVars[811].default_value_ = "0" ;
      ObSysVars[811].info_ = "For internal use in MySQL" ;
      ObSysVars[811].name_ = "rewriter_verbose" ;
      ObSysVars[811].data_type_ = ObIntType ;
      ObSysVars[811].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[811].id_ = SYS_VAR_REWRITER_VERBOSE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_REWRITER_VERBOSE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_REWRITER_VERBOSE] = 811 ;
      ObSysVars[811].base_value_ = "0" ;
    ObSysVars[811].alias_ = "OB_SV_REWRITER_VERBOSE" ;
    }();

    [&] (){
      ObSysVars[812].default_value_ = "1" ;
      ObSysVars[812].info_ = "If this variable is enabled, the server blocks connections by clients that attempt to use accounts that have passwords stored in the old (pre-4.1) format" ;
      ObSysVars[812].name_ = "secure_auth" ;
      ObSysVars[812].data_type_ = ObIntType ;
      ObSysVars[812].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[812].id_ = SYS_VAR_SECURE_AUTH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SECURE_AUTH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SECURE_AUTH] = 812 ;
      ObSysVars[812].base_value_ = "1" ;
    ObSysVars[812].alias_ = "OB_SV_SECURE_AUTH" ;
    }();

    [&] (){
      ObSysVars[813].default_value_ = "0" ;
      ObSysVars[813].info_ = "This variable controls whether the sha256_password built-in authentication plugin supports proxy users" ;
      ObSysVars[813].name_ = "sha256_password_proxy_users" ;
      ObSysVars[813].data_type_ = ObIntType ;
      ObSysVars[813].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[813].id_ = SYS_VAR_SHA256_PASSWORD_PROXY_USERS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHA256_PASSWORD_PROXY_USERS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHA256_PASSWORD_PROXY_USERS] = 813 ;
      ObSysVars[813].base_value_ = "0" ;
    ObSysVars[813].alias_ = "OB_SV_SHA256_PASSWORD_PROXY_USERS" ;
    }();

    [&] (){
      ObSysVars[814].default_value_ = "0" ;
      ObSysVars[814].info_ = "which affects whether MySQL 5.6 compatibility is enabled with respect to how system and status variable information is provided by the INFORMATION_SCHEMA and Performance Schema tables, and also by the SHOW VARIABLES and SHOW STATUS statements" ;
      ObSysVars[814].name_ = "show_compatibility_56" ;
      ObSysVars[814].data_type_ = ObIntType ;
      ObSysVars[814].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[814].id_ = SYS_VAR_SHOW_COMPATIBILITY_56 ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_COMPATIBILITY_56)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_COMPATIBILITY_56] = 814 ;
      ObSysVars[814].base_value_ = "0" ;
    ObSysVars[814].alias_ = "OB_SV_SHOW_COMPATIBILITY_56" ;
    }();

    [&] (){
      ObSysVars[815].default_value_ = "0" ;
      ObSysVars[815].info_ = "Enabling this variable causes SHOW CREATE TABLE to display ROW_FORMAT regardless of whether it is the default format" ;
      ObSysVars[815].name_ = "show_create_table_verbosity" ;
      ...
      ObSysVars[815].id_ = SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_CREATE_TABLE_VERBOSITY] = 815 ;
      ObSysVars[815].base_value_ = "0" ;
    ObSysVars[815].alias_ = "OB_SV_SHOW_CREATE_TABLE_VERBOSITY" ;
    }();

    [&] (){
      ObSysVars[816].default_value_ = "0" ;
      ObSysVars[816].info_ = "Whether SHOW CREATE TABLE output includes comments" ;
      ObSysVars[816].name_ = "show_old_temporals" ;
      ...
      ObSysVars[816].id_ = SYS_VAR_SHOW_OLD_TEMPORALS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SHOW_OLD_TEMPORALS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SHOW_OLD_TEMPORALS] = 816 ;
      ObSysVars[816].base_value_ = "0" ;
    ObSysVars[816].alias_ = "OB_SV_SHOW_OLD_TEMPORALS" ;
    }();

    [&] (){
      ObSysVars[817].default_value_ = "1" ;
      ObSysVars[817].info_ = "If set to OFF, MySQL aborts SELECT statements that are likely to take a very long time to execute" ;
      ObSysVars[817].name_ = "sql_big_selects" ;
      ...
      ObSysVars[817].id_ = SYS_VAR_SQL_BIG_SELECTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SQL_BIG_SELECTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SQL_BIG_SELECTS] = 817 ;
      ObSysVars[817].base_value_ = "1" ;
    ObSysVars[817].alias_ = "OB_SV_SQL_BIG_SELECTS" ;
    }();

    [&] (){
      ObSysVars[818].default_value_ = "1" ;
      ObSysVars[818].info_ = "This variable controls whether updates to a view can be made when the view does not contain all columns of the primary key defined in the underlying table, if the update statement contains a LIMIT clause" ;
      ObSysVars[818].name_ = "updatable_views_with_limit" ;
      ObSysVars[818].data_type_ = ObIntType ;
      ObSysVars[818].enum_names_ = "[u'OFF', u'ON', u'NO', u'YES']" ;
      ObSysVars[818].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[818].id_ = SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_UPDATABLE_VIEWS_WITH_LIMIT] = 818 ;
      ObSysVars[818].base_value_ = "1" ;
    ObSysVars[818].alias_ = "OB_SV_UPDATABLE_VIEWS_WITH_LIMIT" ;
    }();

    [&] (){
      ObSysVars[819].default_value_ = "" ;
      ObSysVars[819].info_ = "The path name of the dictionary file that validate_password uses for checking passwords." ;
      ObSysVars[819].name_ = "validate_password_dictionary_file" ;
      ObSysVars[819].data_type_ = ObVarcharType ;
      ObSysVars[819].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[819].id_ = SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_VALIDATE_PASSWORD_DICTIONARY_FILE] = 819 ;
      ObSysVars[819].base_value_ = "" ;
    ObSysVars[819].alias_ = "OB_SV_VALIDATE_PASSWORD_DICTIONARY_FILE" ;
    }();

    [&] (){
      ObSysVars[820].default_value_ = "100" ;
      ObSysVars[820].info_ = "" ;
      ObSysVars[820].name_ = "delayed_insert_limit" ;
      ObSysVars[820].data_type_ = ObUInt64Type ;
      ObSysVars[820].min_val_ = "1" ;
      ObSysVars[820].max_val_ = "18446744073709551615" ;
      ObSysVars[820].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[820].id_ = SYS_VAR_DELAYED_INSERT_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_DELAYED_INSERT_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_DELAYED_INSERT_LIMIT] = 820 ;
      ObSysVars[820].base_value_ = "100" ;
    ObSysVars[820].alias_ = "OB_SV_DELAYED_INSERT_LIMIT" ;
    }();

    [&] (){
      ObSysVars[821].default_value_ = "" ;
      ObSysVars[821].info_ = "NDB engine version in ndb-x.y.z format" ;
      ObSysVars[821].name_ = "ndb_version" ;
      ObSysVars[821].data_type_ = ObVarcharType ;
      ObSysVars[821].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[821].id_ = SYS_VAR_NDB_VERSION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_NDB_VERSION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_NDB_VERSION] = 821 ;
      ObSysVars[821].base_value_ = "" ;
    ObSysVars[821].alias_ = "OB_SV_NDB_VERSION" ;
    }();

    [&] (){
      ObSysVars[822].default_value_ = "1" ;
      ObSysVars[822].info_ = "This variable is available if the server was compiled using OpenSSL. It controls whether the server autogenerates SSL key and certificate files in the data directory, if they do not already exist" ;
      ObSysVars[822].name_ = "auto_generate_certs" ;
      ObSysVars[822].data_type_ = ObIntType ;
      ObSysVars[822].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::MYSQL_ONLY | ObSysVarFlag::READONLY ;
      ObSysVars[822].id_ = SYS_VAR_AUTO_GENERATE_CERTS ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_AUTO_GENERATE_CERTS)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_AUTO_GENERATE_CERTS] = 822 ;
      ObSysVars[822].base_value_ = "1" ;
    ObSysVars[822].alias_ = "OB_SV_AUTO_GENERATE_CERTS" ;
    }();

    [&] (){
      ObSysVars[823].default_value_ = "1" ;
      ObSysVars[823].info_ = "control cost-based transformation search policy" ;
      ObSysVars[823].name_ = "_optimizer_cost_based_transformation" ;
      ObSysVars[823].data_type_ = ObIntType ;
      ObSysVars[823].min_val_ = "0" ;
      ObSysVars[823].max_val_ = "2" ;
      ObSysVars[823].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[823].id_ = SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__OPTIMIZER_COST_BASED_TRANSFORMATION] = 823 ;
      ObSysVars[823].base_value_ = "1" ;
    ObSysVars[823].alias_ = "OB_SV__OPTIMIZER_COST_BASED_TRANSFORMATION" ;
    }();

    [&] (){
      ObSysVars[824].default_value_ = "10" ;
      ObSysVars[824].info_ = "Indicate the limit on the number of ranges when optimizer use storage cardinality estimation" ;
      ObSysVars[824].name_ = "range_index_dive_limit" ;
      ObSysVars[824].data_type_ = ObIntType ;
      ObSysVars[824].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE ;
      ObSysVars[824].id_ = SYS_VAR_RANGE_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_RANGE_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_RANGE_INDEX_DIVE_LIMIT] = 824 ;
      ObSysVars[824].base_value_ = "10" ;
    ObSysVars[824].alias_ = "OB_SV_RANGE_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[825].default_value_ = "10" ;
      ObSysVars[825].info_ = "Indicate the limit on the number of partitions when optimizer use storage cardinality estimation" ;
      ObSysVars[825].name_ = "partition_index_dive_limit" ;
      ObSysVars[825].data_type_ = ObIntType ;
      ObSysVars[825].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE ;
      ObSysVars[825].id_ = SYS_VAR_PARTITION_INDEX_DIVE_LIMIT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PARTITION_INDEX_DIVE_LIMIT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PARTITION_INDEX_DIVE_LIMIT] = 825 ;
      ObSysVars[825].base_value_ = "10" ;
    ObSysVars[825].alias_ = "OB_SV_PARTITION_INDEX_DIVE_LIMIT" ;
    }();

    [&] (){
      ObSysVars[826].default_value_ = "2" ;
      ObSysVars[826].info_ = "Control the optimizer to generate a table access plan that prefers a specific storage format." ;
      ObSysVars[826].name_ = "ob_table_access_policy" ;
      ObSysVars[826].data_type_ = ObIntType ;
      ObSysVars[826].enum_names_ = "[u'ROW_STORE', u'COLUMN_STORE', u'AUTO']" ;
      ObSysVars[826].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::INFLUENCE_PLAN | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[826].id_ = SYS_VAR_OB_TABLE_ACCESS_POLICY ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_TABLE_ACCESS_POLICY)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_TABLE_ACCESS_POLICY] = 826 ;
      ObSysVars[826].base_value_ = "2" ;
    ObSysVars[826].alias_ = "OB_SV_TABLE_ACCESS_POLICY" ;
    }();

    [&] (){
      ObSysVars[827].default_value_ = "3" ;
      ObSysVars[827].info_ = "The path name of the file in which the server writes its process ID" ;
      ObSysVars[827].name_ = "pid_file" ;
      ...
      ObSysVars[827].id_ = SYS_VAR_PID_FILE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PID_FILE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PID_FILE] = 827 ;
      ObSysVars[827].base_value_ = "3" ;
    ObSysVars[827].alias_ = "OB_SV_PID_FILE" ;
    }();

    [&] (){
      ObSysVars[828].default_value_ = "3" ;
      ObSysVars[828].info_ = "The number of the port on which the server listens for TCP/IP connections" ;
      ObSysVars[828].name_ = "port" ;
      ...
      ObSysVars[828].id_ = SYS_VAR_PORT ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_PORT)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_PORT] = 828 ;
      ObSysVars[828].base_value_ = "3" ;
    ObSysVars[828].alias_ = "OB_SV_PORT" ;
    }();

    [&] (){
      ObSysVars[829].default_value_ = "3" ;
      ObSysVars[829].info_ = "the name of the socket file that is used for local client connections" ;
      ObSysVars[829].name_ = "socket" ;
      ObSysVars[829].data_type_ = ObVarcharType ;
      ObSysVars[829].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::READONLY | ObSysVarFlag::MYSQL_ONLY ;
      ObSysVars[829].id_ = SYS_VAR_SOCKET ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_SOCKET)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_SOCKET] = 829 ;
      ObSysVars[829].base_value_ = "3" ;
    ObSysVars[829].alias_ = "OB_SV_SOCKET" ;
    }();

    [&] (){
      ObSysVars[830].default_value_ = "4" ;
      ObSysVars[830].info_ = "The default refresh parallelism of materialized view" ;
      ObSysVars[830].name_ = "mview_refresh_dop" ;
      ObSysVars[830].data_type_ = ObUInt64Type ;
      ObSysVars[830].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[830].id_ = SYS_VAR_MVIEW_REFRESH_DOP ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_MVIEW_REFRESH_DOP)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_MVIEW_REFRESH_DOP] = 830 ;
      ObSysVars[830].base_value_ = "4" ;
    ObSysVars[830].alias_ = "OB_SV_MVIEW_REFRESH_DOP" ;
    }();

    [&] (){
      ObSysVars[831].default_value_ = "1" ;
      ObSysVars[831].info_ = "Control whether the optimizer considers the impact of rowgoal (such as the LIMIT operator, etc.) during cardinality estimation." ;
      ObSysVars[831].name_ = "enable_optimizer_rowgoal" ;
      ObSysVars[831].data_type_ = ObIntType ;
      ObSysVars[831].enum_names_ = "[u'OFF', u'AUTO', u'ON']" ;
      ObSysVars[831].flags_ = ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[831].id_ = SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_ENABLE_OPTIMIZER_ROWGOAL] = 831 ;
      ObSysVars[831].base_value_ = "1" ;
    ObSysVars[831].alias_ = "OB_SV_ENABLE_OPTIMIZER_ROWGOAL" ;
    }();

    [&] (){
      ObSysVars[832].default_value_ = "8" ;
      ObSysVars[832].info_ = "The number of nearest cluster centers from the IVF vector index searched during this session." ;
      ObSysVars[832].name_ = "ob_ivf_nprobes" ;
      ObSysVars[832].data_type_ = ObUInt64Type ;
      ObSysVars[832].min_val_ = "1" ;
      ObSysVars[832].max_val_ = "65536" ;
      ObSysVars[832].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[832].id_ = SYS_VAR_OB_IVF_NPROBES ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_IVF_NPROBES)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_IVF_NPROBES] = 832 ;
      ObSysVars[832].base_value_ = "8" ;
    ObSysVars[832].alias_ = "OB_SV_IVF_NPROBES" ;
    }();

    [&] (){
      ObSysVars[833].default_value_ = "0" ;
      ObSysVars[833].info_ = "The default catalog for session." ;
      ObSysVars[833].name_ = "_current_default_catalog" ;
      ObSysVars[833].data_type_ = ObUInt64Type ;
      ObSysVars[833].min_val_ = "0" ;
      ObSysVars[833].max_val_ = "18446744073709551615" ;
      ObSysVars[833].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::NEED_SERIALIZE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::READONLY ;
      ObSysVars[833].id_ = SYS_VAR__CURRENT_DEFAULT_CATALOG ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__CURRENT_DEFAULT_CATALOG)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__CURRENT_DEFAULT_CATALOG] = 833 ;
      ObSysVars[833].base_value_ = "0" ;
    ObSysVars[833].alias_ = "OB_SV__CURRENT_DEFAULT_CATALOG" ;
    }();

    [&] (){
      ObSysVars[834].default_value_ = "1" ;
      ObSysVars[834].info_ = "wether use parameter anonymous_block in ps mode" ;
      ObSysVars[834].name_ = "ob_enable_ps_parameter_anonymous_block" ;
      ObSysVars[834].data_type_ = ObIntType ;
      ObSysVars[834].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::NEED_SERIALIZE ;
      ObSysVars[834].id_ = SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK] = 834 ;
      ObSysVars[834].base_value_ = "1" ;
    ObSysVars[834].alias_ = "OB_SV_ENABLE_PS_PARAMETER_ANONYMOUS_BLOCK" ;
    }();

    [&] (){
      ObSysVars[835].default_value_ = "1024" ;
      ObSysVars[835].info_ = "The extra info size threshold filled into the hnsw index param, when not specified during hnsw index creation." ;
      ObSysVars[835].name_ = "ob_hnsw_extra_info_max_size" ;
      ObSysVars[835].data_type_ = ObUInt64Type ;
      ObSysVars[835].min_val_ = "0" ;
      ObSysVars[835].max_val_ = "16384" ;
      ObSysVars[835].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE ;
      ObSysVars[835].id_ = SYS_VAR_OB_HNSW_EXTRA_INFO_MAX_SIZE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_HNSW_EXTRA_INFO_MAX_SIZE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_HNSW_EXTRA_INFO_MAX_SIZE] = 835 ;
      ObSysVars[835].base_value_ = "1024" ;
    ObSysVars[835].alias_ = "OB_SV_HNSW_EXTRA_INFO_MAX_SIZE" ;
    }();

    [&] (){
      ObSysVars[836].default_value_ = "1" ;
      ObSysVars[836].info_ = "control whether the optimizer pushes down join predicates to view" ;
      ObSysVars[836].name_ = "_push_join_predicate" ;
      ObSysVars[836].data_type_ = ObIntType ;
      ObSysVars[836].flags_ = ObSysVarFlag::SESSION_SCOPE | ObSysVarFlag::GLOBAL_SCOPE | ObSysVarFlag::INVISIBLE | ObSysVarFlag::INFLUENCE_PLAN ;
      ObSysVars[836].id_ = SYS_VAR__PUSH_JOIN_PREDICATE ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR__PUSH_JOIN_PREDICATE)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR__PUSH_JOIN_PREDICATE] = 836 ;
      ObSysVars[836].base_value_ = "1" ;
    ObSysVars[836].alias_ = "OB_SV__PUSH_JOIN_PREDICATE" ;
    }();

    [&] (){
      ObSysVars[837].default_value_ = "0" ;
      ObSysVars[837].info_ = "set the smallest drop_ratio of values across all dimensions of the query vector to zero" ;
      ObSysVars[837].name_ = "ob_sparse_drop_ratio_search" ;
      ObSysVars[837].data_type_ = ObUInt64Type ;
      ObSysVars[837].min_val_ = "0" ;
      ObSysVars[837].max_val_ = "100" ;
      ObSysVars[837].flags_ = ObSysVarFlag::SESSION_SCOPE ;
      ObSysVars[837].id_ = SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH ;
      cur_max_var_id = MAX(cur_max_var_id, static_cast<int64_t>(SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH)) ;
      ObSysVarsIdToArrayIdx[SYS_VAR_OB_SPARSE_DROP_RATIO_SEARCH] = 837 ;
      ObSysVars[837].base_value_ = "0" ;
