...
// fork-table value types(split from ob_fork_table_util.h;Util class has moved to rootserver/fork_table)
#ifndef OCEANBASE_SHARE_OB_FORK_TABLE_INFO_H
#define OCEANBASE_SHARE_OB_FORK_TABLE_INFO_H
...
#endif // OCEANBASE_SHARE_OB_FORK_TABLE_INFO_H
