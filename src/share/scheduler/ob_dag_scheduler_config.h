...
DAG_SCHEDULER_DAG_NET_TYPE_DEF(DAG_NET_TYPE_RESTORE_COMPLETE, "DAG_NET_RESTORE_COMPLETE")
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_INITIAL_COMPLETE_RESTORE, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::RESTORE_TASK, "INITIAL_COMPLETE_RESTORE", "RESTORE",
    true, 2, {"task_type", "src_info"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_WAIT_DATA_READY_RESTORE, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::RESTORE_TASK, "WAIT_DATA_READY_RESTORE", "RESTORE",
    true, 2, {"task_type", "src_info"})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_FINISH_COMPLETE_RESTORE, ObDagPrio::DAG_PRIO_HA_HIGH, ObSysTaskType::RESTORE_TASK, "FINISH_COMPLETE_RESTORE", "RESTORE",
    true, 2, {"task_type", "src_info"})
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_TTL, ObDagPrio::DAG_PRIO_TTL, ObSysTaskType::TTL_TASK, "TTL_DELETE_DAG", "TTL",
