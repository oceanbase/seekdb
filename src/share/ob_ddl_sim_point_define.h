...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, CHECK_RUNTIME_STANDBY_FAILED, 23, "check runtime standby state failed", RET_ERR(OB_TIMEOUT))
...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, LOCAL_BUILD_EXECUTOR_BUILD_FAILED, 40, "local build executor build failed", RET_ERR(OB_ALLOCATE_MEMORY_FAILED))
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, LOCAL_BUILD_EXECUTOR_SCHEDULE_TASK_FAILED, 41, "local build executor schedule task failed", RET_ERR(OB_EAGAIN))
...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, REAP_OLD_LOCAL_BUILD_TASK_FAILED, 44, "reap old local build task failed", RET_ERR(OB_EAGAIN))
...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, BUILD_LOCAL_ASYNC_TASK_FAILED, 47, "local build async t task failed", RET_ERR(OB_EAGAIN, OB_NOT_MASTER))
...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, DDL_TASK_SEND_LOCAL_BUILD_REQUEST_FAILED, 81, "ddl task send local build failed", RET_ERR(OB_EAGAIN))
...
DDL_SIM_POINT_DEFINE(SIM_TYPE_DDL, GENERATE_LOCAL_BUILD_SQL, 100, "generate local build sql failed", RET_ERR(OB_EAGAIN))
