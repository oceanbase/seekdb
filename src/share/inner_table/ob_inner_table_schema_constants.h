...
const uint64_t OB_WR_RES_MGR_SYSSTAT_TID = 526; // "__wr_res_mgr_sysstat"
...
const uint64_t OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_TID = 530; // "__wr_sql_plan_aux_key2snapshot"
...
const uint64_t OB_ALL_VIRTUAL_WR_RES_MGR_SYSSTAT_TID = 12502; // "__all_virtual_wr_res_mgr_sysstat"
...
const uint64_t OB_ALL_VIRTUAL_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_TID = 12511; // "__all_virtual_wr_sql_plan_aux_key2snapshot"
...
const uint64_t OB_ALL_VIRTUAL_CATALOG_TID = 12516; // "__all_virtual_catalog"
const uint64_t OB_ALL_VIRTUAL_CATALOG_HISTORY_TID = 12517; // "__all_virtual_catalog_history"
const uint64_t OB_ALL_VIRTUAL_CATALOG_PRIVILEGE_TID = 12518; // "__all_virtual_catalog_privilege"
const uint64_t OB_ALL_VIRTUAL_CATALOG_PRIVILEGE_HISTORY_TID = 12519; // "__all_virtual_catalog_privilege_history"
const uint64_t OB_ALL_VIRTUAL_PL_RECOMPILE_OBJINFO_TID = 12523; // "__all_virtual_pl_recompile_objinfo"
const uint64_t OB_ALL_VIRTUAL_VECTOR_INDEX_TASK_TID = 12524; // "__all_virtual_vector_index_task"
const uint64_t OB_ALL_VIRTUAL_VECTOR_INDEX_TASK_HISTORY_TID = 12525; // "__all_virtual_vector_index_task_history"
const uint64_t OB_TENANT_VIRTUAL_SHOW_CREATE_CATALOG_TID = 12526; // "__tenant_virtual_show_create_catalog"
const uint64_t OB_TENANT_VIRTUAL_SHOW_CATALOG_DATABASES_TID = 12527; // "__tenant_virtual_show_catalog_databases"
const uint64_t OB_ALL_VIRTUAL_STORAGE_CACHE_TASK_TID = 12529; // "__all_virtual_storage_cache_task"
const uint64_t OB_ALL_VIRTUAL_TABLET_LOCAL_CACHE_TID = 12530; // "__all_virtual_tablet_local_cache"
const uint64_t OB_ALL_VIRTUAL_CCL_RULE_TID = 12533; // "__all_virtual_ccl_rule"
...
const uint64_t OB_ALL_VIRTUAL_TENANT_EVENT_HISTORY_TID = 12562; // "__all_virtual_tenant_event_history"
...
const uint64_t OB_DBA_WR_RES_MGR_SYSSTAT_TID = 21614; // "DBA_WR_RES_MGR_SYSSTAT"
const uint64_t OB_CDB_WR_RES_MGR_SYSSTAT_TID = 21615; // "CDB_WR_RES_MGR_SYSSTAT"
...
const uint64_t OB_CDB_OB_VECTOR_INDEX_TASKS_TID = 21641; // "CDB_OB_VECTOR_INDEX_TASKS"
const uint64_t OB_DBA_OB_VECTOR_INDEX_TASK_HISTORY_TID = 21642; // "DBA_OB_VECTOR_INDEX_TASK_HISTORY"
const uint64_t OB_CDB_OB_VECTOR_INDEX_TASK_HISTORY_TID = 21643; // "CDB_OB_VECTOR_INDEX_TASK_HISTORY"
const uint64_t OB_GV_OB_STORAGE_CACHE_TASKS_TID = 21644; // "GV$OB_STORAGE_CACHE_TASKS"
const uint64_t OB_V_OB_STORAGE_CACHE_TASKS_TID = 21645; // "V$OB_STORAGE_CACHE_TASKS"
const uint64_t OB_GV_OB_TABLET_LOCAL_CACHE_TID = 21646; // "GV$OB_TABLET_LOCAL_CACHE"
const uint64_t OB_V_OB_TABLET_LOCAL_CACHE_TID = 21647; // "V$OB_TABLET_LOCAL_CACHE"
const uint64_t OB_DBA_OB_CCL_RULES_TID = 21648; // "DBA_OB_CCL_RULES"
const uint64_t OB_CDB_OB_CCL_RULES_TID = 21649; // "CDB_OB_CCL_RULES"
const uint64_t OB_GV_OB_SQL_CCL_STATUS_TID = 21650; // "GV$OB_SQL_CCL_STATUS"
...
const uint64_t OB_CDB_MVIEW_RUNNING_JOBS_TID = 21653; // "CDB_MVIEW_RUNNING_JOBS"
...
const uint64_t OB_CDB_OB_DYNAMIC_PARTITION_TABLES_TID = 21656; // "CDB_OB_DYNAMIC_PARTITION_TABLES"
...
const uint64_t OB_WR_RES_MGR_SYSSTAT_AUX_LOB_META_TID = 50526; // "__wr_res_mgr_sysstat_aux_lob_meta"
...
const uint64_t OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_AUX_LOB_META_TID = 50530; // "__wr_sql_plan_aux_key2snapshot_aux_lob_meta"
...
const uint64_t OB_WR_RES_MGR_SYSSTAT_AUX_LOB_PIECE_TID = 60526; // "__wr_res_mgr_sysstat_aux_lob_piece"
...
const uint64_t OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_AUX_LOB_PIECE_TID = 60530; // "__wr_sql_plan_aux_key2snapshot_aux_lob_piece"
...
const uint64_t OB_ALL_VIRTUAL_SESSION_EVENT_ALL_VIRTUAL_SESSION_EVENT_I1_TID = 14999; // "__all_virtual_session_event"
const uint64_t OB_ALL_VIRTUAL_SESSION_WAIT_ALL_VIRTUAL_SESSION_WAIT_I1_TID = 14998; // "__all_virtual_session_wait"
const uint64_t OB_ALL_VIRTUAL_SESSION_WAIT_HISTORY_ALL_VIRTUAL_SESSION_WAIT_HISTORY_I1_TID = 14997; // "__all_virtual_session_wait_history"
const uint64_t OB_ALL_VIRTUAL_SESSTAT_ALL_VIRTUAL_SESSTAT_I1_TID = 14996; // "__all_virtual_sesstat"
const uint64_t OB_ALL_VIRTUAL_SQL_AUDIT_ALL_VIRTUAL_SQL_AUDIT_I1_TID = 14995; // "__all_virtual_sql_audit"
const uint64_t OB_ALL_VIRTUAL_SQL_PLAN_MONITOR_ALL_VIRTUAL_SQL_PLAN_MONITOR_I1_TID = 14994; // "__all_virtual_sql_plan_monitor"
const uint64_t OB_ALL_VIRTUAL_ASH_ALL_VIRTUAL_ASH_I1_TID = 14993; // "__all_virtual_ash"
const uint64_t OB_ALL_VIRTUAL_DDL_DIAGNOSE_INFO_ALL_VIRTUAL_DDL_DIAGNOSE_INFO_I1_TID = 14992; // "__all_virtual_ddl_diagnose_info"
...
const char *const OB_WR_RES_MGR_SYSSTAT_TNAME = "__wr_res_mgr_sysstat";
...
const char *const OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_TNAME = "__wr_sql_plan_aux_key2snapshot";
...
const char *const OB_ALL_VIRTUAL_WR_RES_MGR_SYSSTAT_TNAME = "__all_virtual_wr_res_mgr_sysstat";
...
const char *const OB_ALL_VIRTUAL_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_TNAME = "__all_virtual_wr_sql_plan_aux_key2snapshot";
...
const char *const OB_ALL_VIRTUAL_CATALOG_TNAME = "__all_virtual_catalog";
const char *const OB_ALL_VIRTUAL_CATALOG_HISTORY_TNAME = "__all_virtual_catalog_history";
const char *const OB_ALL_VIRTUAL_CATALOG_PRIVILEGE_TNAME = "__all_virtual_catalog_privilege";
const char *const OB_ALL_VIRTUAL_CATALOG_PRIVILEGE_HISTORY_TNAME = "__all_virtual_catalog_privilege_history";
const char *const OB_ALL_VIRTUAL_PL_RECOMPILE_OBJINFO_TNAME = "__all_virtual_pl_recompile_objinfo";
const char *const OB_ALL_VIRTUAL_VECTOR_INDEX_TASK_TNAME = "__all_virtual_vector_index_task";
const char *const OB_ALL_VIRTUAL_VECTOR_INDEX_TASK_HISTORY_TNAME = "__all_virtual_vector_index_task_history";
const char *const OB_TENANT_VIRTUAL_SHOW_CREATE_CATALOG_TNAME = "__tenant_virtual_show_create_catalog";
const char *const OB_TENANT_VIRTUAL_SHOW_CATALOG_DATABASES_TNAME = "__tenant_virtual_show_catalog_databases";
const char *const OB_ALL_VIRTUAL_STORAGE_CACHE_TASK_TNAME = "__all_virtual_storage_cache_task";
const char *const OB_ALL_VIRTUAL_TABLET_LOCAL_CACHE_TNAME = "__all_virtual_tablet_local_cache";
const char *const OB_ALL_VIRTUAL_CCL_RULE_TNAME = "__all_virtual_ccl_rule";
...
const char *const OB_DBA_WR_RES_MGR_SYSSTAT_TNAME = "DBA_WR_RES_MGR_SYSSTAT";
const char *const OB_CDB_WR_RES_MGR_SYSSTAT_TNAME = "CDB_WR_RES_MGR_SYSSTAT";
...
const char *const OB_CDB_OB_VECTOR_INDEX_TASKS_TNAME = "CDB_OB_VECTOR_INDEX_TASKS";
const char *const OB_DBA_OB_VECTOR_INDEX_TASK_HISTORY_TNAME = "DBA_OB_VECTOR_INDEX_TASK_HISTORY";
const char *const OB_CDB_OB_VECTOR_INDEX_TASK_HISTORY_TNAME = "CDB_OB_VECTOR_INDEX_TASK_HISTORY";
const char *const OB_GV_OB_STORAGE_CACHE_TASKS_TNAME = "GV$OB_STORAGE_CACHE_TASKS";
const char *const OB_V_OB_STORAGE_CACHE_TASKS_TNAME = "V$OB_STORAGE_CACHE_TASKS";
const char *const OB_GV_OB_TABLET_LOCAL_CACHE_TNAME = "GV$OB_TABLET_LOCAL_CACHE";
const char *const OB_V_OB_TABLET_LOCAL_CACHE_TNAME = "V$OB_TABLET_LOCAL_CACHE";
const char *const OB_DBA_OB_CCL_RULES_TNAME = "DBA_OB_CCL_RULES";
const char *const OB_CDB_OB_CCL_RULES_TNAME = "CDB_OB_CCL_RULES";
const char *const OB_GV_OB_SQL_CCL_STATUS_TNAME = "GV$OB_SQL_CCL_STATUS";
...
const char *const OB_CDB_MVIEW_RUNNING_JOBS_TNAME = "CDB_MVIEW_RUNNING_JOBS";
...
const char *const OB_CDB_OB_DYNAMIC_PARTITION_TABLES_TNAME = "CDB_OB_DYNAMIC_PARTITION_TABLES";
...
const char *const OB_WR_RES_MGR_SYSSTAT_AUX_LOB_META_TNAME = "__wr_res_mgr_sysstat_aux_lob_meta";
...
const char *const OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_AUX_LOB_META_TNAME = "__wr_sql_plan_aux_key2snapshot_aux_lob_meta";
...
const char *const OB_WR_RES_MGR_SYSSTAT_AUX_LOB_PIECE_TNAME = "__wr_res_mgr_sysstat_aux_lob_piece";
...
const char *const OB_WR_SQL_PLAN_AUX_KEY2SNAPSHOT_AUX_LOB_PIECE_TNAME = "__wr_sql_plan_aux_key2snapshot_aux_lob_piece";
