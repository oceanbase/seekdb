...
enum ObDDLTaskStatus { // FARM COMPAT WHITELIST
  ...
  GENERATE_DOC_ROWKEY_SCHEMA = 50,
  WAIT_DOC_ROWKEY_TABLE_COMPLEMENT = 51,
  GENERATE_DOC_WORD_SCHEMA_FOR_FTS = 52,
  WAIT_DOC_WORD_TABLE_COMPLEMENT_FOR_FTS = 53,
  GENERATE_DOMAIN_INDEX_SCHEMA = 54,
  WAIT_DOMAIN_INDEX_TABLE_COMPLEMENT = 55,
...
{
public:
  static const int64_t DDL_FTS_DAG_DATA_FORMAT_VERSION = 0;
