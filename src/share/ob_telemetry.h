...
// base directory must be an absolute, canonical path. An optional container
// scope ID accepts the same text forms and distinguishes containers that share
// the host machine ID and base-directory path. Pass nullptr and zero when no
// container scope exists. The derivation is
