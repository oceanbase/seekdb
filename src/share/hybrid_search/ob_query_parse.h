...
enum ObFusionMethod
{
  WEIGHT_SUM = 0,
  RRF
  // NOTE: Fusion strategies are now centralized in ObHybridSearchFusionEngine
  // This enum is retained for backward compatibility during migration
  // Future versions will deprecate SQL-layer fusion calculations
};
