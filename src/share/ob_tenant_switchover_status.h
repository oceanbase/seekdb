...
IS_TENANT_STATUS(PREPARE_SWITCHING_TO_PRIMARY_STATUS, prepare_switching_to_primary)
...
static const ObTenantSwitchoverStatus PREP_SWITCHING_TO_PRIMARY_SWITCHOVER_STATUS(ObTenantSwitchoverStatus::PREPARE_SWITCHING_TO_PRIMARY_STATUS);
