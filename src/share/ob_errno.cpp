...
static const _error _error_OB_ERR_SIGNAL_EXCEPTION = {
      .error_name            = "OB_ERR_SIGNAL_EXCEPTION",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = ER_SIGNAL_EXCEPTION,
      .sqlstate              = "HY000",
      .str_error             = "Unhandled user-defined exception condition",
      .str_user_error        = "%.*s"
};
...
static const _error _error_OB_ERR_SP_EMPTY_BLOCK = {
      ...
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "Empty block prohibited",
      .str_user_error        = "Empty block prohibited"
};
...
static const _error _error_OB_ERR_OPERATOR_NOT_EXIST = {
      .error_name            = "OB_ERR_OPERATOR_NOT_EXIST",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "operator binding does not exist",
      .str_user_error        = "operator binding does not exist"
};
static const _error _error_OB_INVALID_MASK = {
      .error_name            = "OB_INVALID_MASK",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
...
static const _error _error_OB_GEO_IN_DIFFERENT_COORDINATE = {
      .error_name            = "OB_GEO_IN_DIFFERENT_COORDINATE",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "geometry objects are in different coordinate systems",
      .str_user_error        = "geometry objects are in different coordinate systems"
};
static const _error _error_OB_ERR_DOMAIN_COLUMN_DUPLICATE = {
      .error_name            = "OB_ERR_DOMAIN_COLUMN_DUPLICATE",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "cannot create multiple domain indexes on a column list using same",
      .str_user_error        = "cannot create multiple domain indexes on a column list using same"
};
static const _error _error_OB_ERR_PARSING_SPATIAL_PARAM = {
      .error_name            = "OB_ERR_PARSING_SPATIAL_PARAM",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "internal error while parsing spatial parameters",
      .str_user_error        = "internal error while parsing spatial parameters"
};
...
static const _error _error_OB_ERR_CONVERSION_OF_UNIT = {
      .error_name            = "OB_ERR_CONVERSION_OF_UNIT",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "conversion error between the specified unit and standard unit",
      .str_user_error        = "conversion error between the specified unit and standard unit"
};
static const _error _error_OB_ERR_PARAM_OUT_OF_RANGE = {
      .error_name            = "OB_ERR_PARAM_OUT_OF_RANGE",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "42000",
      .str_error             = "value is out of range",
      .str_user_error        = "value is out of range"
};
static const _error _error_OB_ERR_INVALID_VECTOR_DIM = {
      .error_name            = "OB_ERR_INVALID_VECTOR_DIM",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "22000",
      .str_error             = "Invalid dimension for vector.",
      .str_user_error        = "inconsistent dimension: expected %u got %u"
};
...
static const _error _error_OB_ERR_ARRAY_TYPE_MISMATCH = {
      .error_name            = "OB_ERR_ARRAY_TYPE_MISMATCH",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "22000",
      .str_error             = "array type mismatch found between definition and data",
      .str_user_error        = "array type mismatch found between definition(%.*s) and data(%.*s)"
};
...
static const _error _error_OB_ERR_CURSOR_ATTR_APPLY = {
      .error_name            = "OB_ERR_CURSOR_ATTR_APPLY",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "HY000",
...
static const _error _error_OB_ELEMENT_AT_GIVEN_INDEX_NOT_EXIST = {
      .error_name            = "OB_ELEMENT_AT_GIVEN_INDEX_NOT_EXIST",
      .error_cause           = "Internal Error",
      .error_solution        = "Contact OceanBase Support",
      .mysql_errno           = -1,
      .sqlstate              = "HY000",
...
struct ObStrErrorInit
{
  ObStrErrorInit()
  {
    ...
    _errors[-OB_ERR_COLUMNS_NUMBER_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION] = &_error_OB_ERR_COLUMNS_NUMBER_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION;
    _errors[-OB_ERR_COLUMN_TYPE_OR_SIZE_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION] = &_error_OB_ERR_COLUMN_TYPE_OR_SIZE_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION;
    _errors[-OB_ERR_INDEX_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION] = &_error_OB_ERR_INDEX_MISMATCH_ALTER_TABLE_EXCHANGE_PARTITION;
    ...
    _errors[-OB_ERR_SIGNAL_EXCEPTION] = &_error_OB_ERR_SIGNAL_EXCEPTION;
    ...
    _errors[-OB_ERR_OPERATOR_NOT_EXIST] = &_error_OB_ERR_OPERATOR_NOT_EXIST;
    _errors[-OB_INVALID_MASK] = &_error_OB_INVALID_MASK;
    _errors[-OB_GEO_IN_DIFFERENT_COORDINATE] = &_error_OB_GEO_IN_DIFFERENT_COORDINATE;
    _errors[-OB_ERR_DOMAIN_COLUMN_DUPLICATE] = &_error_OB_ERR_DOMAIN_COLUMN_DUPLICATE;
    _errors[-OB_ERR_PARSING_SPATIAL_PARAM] = &_error_OB_ERR_PARSING_SPATIAL_PARAM;
    ...
    _errors[-OB_ERR_INVALID_VECTOR_DIM] = &_error_OB_ERR_INVALID_VECTOR_DIM;
    _errors[-OB_ERR_BAD_VEC_INDEX_COLUMN] = &_error_OB_ERR_BAD_VEC_INDEX_COLUMN;
    _errors[-OB_ERR_ARRAY_TYPE_MISMATCH] = &_error_OB_ERR_ARRAY_TYPE_MISMATCH;
