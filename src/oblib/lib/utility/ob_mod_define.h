...
LABEL_ITEM_DEF(OB_CTX_ALLOCATOR, CtxAllocator)
LABEL_ITEM_DEF(OB_LOG_ALLOCATOR, LogAllocator)
...
LABEL_ITEM_DEF(OB_INNER_SQL_CONN, InnerSqlConn)
...
LABEL_ITEM_DEF(OB_MANAGEMENT_EVENT_QUEUE, ManagementEventQueue)
...
LABEL_ITEM_DEF(OB_SQL_MONITOR, SqlMonitor)
...
//schema
LABEL_ITEM_DEF(OB_RUNTIME_SCHEMA_MEM_MGR, RuntScheMemMgr)
LABEL_ITEM_DEF(OB_RUNTIME_SCHEMA_MGR, RuntimeSchemMgr)
...
LABEL_ITEM_DEF(OB_RUNTIME_SPACE_TABLE_ID_SET, TenaSpaTabIdSet)
