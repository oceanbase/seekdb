...
LATCH_DEF(SCHEMA_SERVICE_LOCK, 37, "schema service lock", LATCH_READ_PREFER, 2000, 0, true)
LATCH_DEF(SERVER_RUNTIME_LOCK, 39, "server runtime lock", LATCH_READ_PREFER, 2000, 0, true)
...
LATCH_DEF(MANAGEMENT_EVENT_TS_LOCK, 70, "management event timestamp lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(STORAGE_META_MEM_MGR_LOCK, 125, "storage meta memory manager lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(RESOURCE_MGR_LIST_LOCK, 163, "resource manager state lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(SERVER_RUNTIME_WORKER_LOCK, 180, "server runtime worker lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(GLOBAL_MERGE_MANAGER_READ_LOCK, 201, "global merge manager read lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(MEMORY_USAGE_LOCK, 285, "memory usage lock" , LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(IO_CONFIG_LOCK, 295, "io config lock", LATCH_FIFO, 2000, 0, true)
...
LATCH_DEF(DIRECT_LOAD_MGR_LOCK, 330, "direct load manager lock", LATCH_FIFO, 2000, 0, true)
