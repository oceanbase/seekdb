...
DEF_NAME(id, "id")
    ...
    DEF_NAME(submit_log_for_freeze, "submit log for freeze")
    ...
    DEF_NAME(create_branch_savepoint, "create branch savepoint")
    ...
    DEF_NAME(register_ddl_trans, "register_ddl_trans")
