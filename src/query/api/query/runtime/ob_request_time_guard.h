...
#ifndef OCEANBASE_QUERY_RUNTIME_OB_REQUEST_TIME_GUARD_H_
#define OCEANBASE_QUERY_RUNTIME_OB_REQUEST_TIME_GUARD_H_
...
#endif // OCEANBASE_QUERY_RUNTIME_OB_REQUEST_TIME_GUARD_H_
