...
namespace sql
{
using DatumCmpFunc = common::ObDatumCmpFuncType;
class ObExprCmpFuncsHelper
{
public:
  // The expression already carries the comparison operation at runtime, so it
  // must not become another template axis for every type-specific evaluator.
