...
#ifndef OB_DAS_LEGACY_TR_MERGE_ITER_H_
#define OB_DAS_LEGACY_TR_MERGE_ITER_H_
...
{
public:
  ObDASLegacyTRMergeIter();
  virtual ~ObDASLegacyTRMergeIter() {}
...
private:
  ...
  bool is_inited_;
  DISALLOW_COPY_AND_ASSIGN(ObDASLegacyTRMergeIter);
};

} // namespace sql
} // namespace oceanbase

#endif // OB_DAS_LEGACY_TR_MERGE_ITER_H_
