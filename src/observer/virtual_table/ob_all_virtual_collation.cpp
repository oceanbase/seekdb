...
#include "observer/virtual_table/ob_all_virtual_collation.h"
...
int ObAllVirtualCollation::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
  if (!start_to_read_) {
...
int ObAllVirtualCollation::fill_scanner()
{
  int ret = OB_SUCCESS;
  ObObj *cells = NULL;
