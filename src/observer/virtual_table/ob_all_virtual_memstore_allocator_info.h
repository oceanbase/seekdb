...
#ifndef OB_ALL_VIRTUAL_MEMSTORE_ALLOCATOR_INFO_H_
#define OB_ALL_VIRTUAL_MEMSTORE_ALLOCATOR_INFO_H_
...
class ObAllVirtualMemstoreAllocatorInfo : public common::ObVirtualTableIterator
{
public:
  typedef ObMemstoreAllocatorInfo MemstoreInfo;
  ObAllVirtualMemstoreAllocatorInfo();
  virtual ~ObAllVirtualMemstoreAllocatorInfo();
...
private:
  ...
  char mt_addr_[32];
  DISALLOW_COPY_AND_ASSIGN(ObAllVirtualMemstoreAllocatorInfo);
};

}
}

#endif // OB_ALL_VIRTUAL_MEMSTORE_ALLOCATOR_INFO_H_
