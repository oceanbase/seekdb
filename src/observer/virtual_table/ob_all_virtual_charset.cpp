...
#include "observer/virtual_table/ob_all_virtual_charset.h"
...
int ObAllVirtualCharset::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
  if (!start_to_read_) {
...
int ObAllVirtualCharset::fill_scanner()
{
  int ret = OB_SUCCESS;
  ObObj *cells = NULL;
