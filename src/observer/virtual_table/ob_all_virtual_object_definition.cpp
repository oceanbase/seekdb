...
ObAllVirtualObjectDefinition::ObAllVirtualObjectDefinition()
...
const char *ObAllVirtualObjectDefinition::ObjectTypeName[T_GET_DDL_MAX] =
{
  "TABLE",
  "PROCEDURE",
  "PACKAGE",
...
void ObAllVirtualObjectDefinition::reset()
{
  ObVirtualTableScannerIterator::reset();
}

int ObAllVirtualObjectDefinition::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualObjectDefinition::get_object_type_and_name(GetDDLObjectType &object_type,
                                                  ObString &object_name,
                                                  ObString &ob_schema,
                                                  ObString &version,
                                                  ObString &model,
...
int ObAllVirtualObjectDefinition::get_ddl_creation_str(ObString &ddl_str,
                                          ...
                                          const ObString &db_name)
{
  ...
  switch(object_type) {
    case T_GET_DDL_TABLE:
      // Tables still use the original implementation instead of this object-definition virtual table.
...
int ObAllVirtualObjectDefinition::print_error_log(GetDDLObjectType object_type,
...
/*
int ObAllVirtualObjectDefinition::get_table_definition(ObString &ddl_str, const uint64_t table_id)
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualObjectDefinition::get_constraint_definition(ObString &ddl_str,
...
int ObAllVirtualObjectDefinition::get_foreign_key_definition(ObString &ddl_str,
...
int ObAllVirtualObjectDefinition::get_trigger_definition(ObString &ddl_str,
...
int ObAllVirtualObjectDefinition::get_routine_definition(ObString &ddl_str,
...
int ObAllVirtualObjectDefinition::get_user_definition(ObString &ddl_str,
...
int ObAllVirtualObjectDefinition::get_database_id(const ObString db_name,
...
int ObAllVirtualObjectDefinition::fill_row_cells(ObString &ddl_str,
                                          int64_t object_type,
                                          ObString &object_name,
                                          ObString &ob_schema,
                                          ObString &version,
...
int ObAllVirtualObjectDefinition::get_package_definition(ObString &ddl_str,
  ...
  if (OB_ISNULL(schema_guard_)) {
    ...
    LOG_WARN("get package info failed", K(ret), K(database_id), K(package_name));
             ...
             OB_FAIL(schema_guard_->get_package_info(
                                                     ...
                                                     package_type,
                                                     package_info))) {
    LOG_WARN("get package info failed in system database", K(ret), K(database_id), K(package_name));
