...
ObAllVirtualMemstoreAllocatorInfo::ObAllVirtualMemstoreAllocatorInfo()
...
int ObAllVirtualMemstoreAllocatorInfo::inner_open()
{
  int ret = OB_SUCCESS;
  reset();
...
void ObAllVirtualMemstoreAllocatorInfo::reset()
...
int ObAllVirtualMemstoreAllocatorInfo::fill_memstore_infos()
{
  int ret = OB_SUCCESS;
  memstore_infos_.reset();
  SERVER_MODULE_SCOPE
...
int ObAllVirtualMemstoreAllocatorInfo::inner_get_next_row(ObNewRow *&row)
{
  int ret = OB_SUCCESS;
