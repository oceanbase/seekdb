...
#ifndef OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLES_
#define OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLES_
...
namespace observer
{
class ObShowTables : public common::ObVirtualTableIterator
{
...
private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ObShowTables);
};

}// observer
}// oceanbase
#endif /* OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLES_ */
