...
int ObShowTables::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
...
int ObShowTables::inner_get_next_row()
{
  int ret = OB_SUCCESS;
