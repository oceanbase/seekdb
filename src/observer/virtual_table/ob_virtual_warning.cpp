...
namespace observer
{
const char *const ObVirtualWarning::SHOW_WARNING_STR = "Warning";
const char *const ObVirtualWarning::SHOW_NOTE_STR = "Note";
const char *const ObVirtualWarning::SHOW_ERROR_STR = "Error";

ObVirtualWarning::ObVirtualWarning()
...
void ObVirtualWarning::reset()
{
  ObVirtualTableScannerIterator::reset();
}

int ObVirtualWarning::inner_get_next_row(ObNewRow *&row)
{
  int ret = OB_SUCCESS;
  if (!start_to_read_) {
...
int ObVirtualWarning::fill_scanner()
{
  int ret = OB_SUCCESS;
  ObObj *cells = NULL;
