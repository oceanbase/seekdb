...
#include "observer/virtual_table/ob_all_virtual_warning.h"
...
namespace observer
{
const char *const ObAllVirtualWarning::SHOW_WARNING_STR = "Warning";
const char *const ObAllVirtualWarning::SHOW_NOTE_STR = "Note";
const char *const ObAllVirtualWarning::SHOW_ERROR_STR = "Error";

ObAllVirtualWarning::ObAllVirtualWarning()
...
void ObAllVirtualWarning::reset()
{
  ObVirtualTableScannerIterator::reset();
}

int ObAllVirtualWarning::inner_get_next_row(ObNewRow *&row)
{
  int ret = OB_SUCCESS;
  if (!start_to_read_) {
...
int ObAllVirtualWarning::fill_scanner()
{
  int ret = OB_SUCCESS;
  ObObj *cells = NULL;
