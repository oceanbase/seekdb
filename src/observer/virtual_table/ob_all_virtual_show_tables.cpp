...
#include "observer/virtual_table/ob_all_virtual_show_tables.h"
...
ObAllVirtualShowTables::ObAllVirtualShowTables()
...
int ObAllVirtualShowTables::inner_open()
{
  int ret = OB_SUCCESS;
...
void ObAllVirtualShowTables::reset()
{
  session_ = NULL;
  database_id_ = OB_INVALID_ID;
...
int ObAllVirtualShowTables::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualShowTables::inner_get_next_row()
{
  int ret = OB_SUCCESS;
