...
void ObAllVirtualOutlineBase::reset()
{
...
int ObAllVirtualOutlineBase::inner_open()
{
  int ret = OB_SUCCESS;
...
int ObAllVirtualOutlineBase::set_database_infos_and_get_value(uint64_t database_id, bool &is_recycle)
{
  int ret = OB_SUCCESS;
  is_recycle = false;
  DBInfo db_info;
...
int ObAllVirtualOutlineBase::is_database_recycle(uint64_t database_id, bool &is_recycle)
{
  int ret = OB_SUCCESS;
  DBInfo db_info;
  is_recycle = false;
...
void ObAllVirtualOutline::reset()
{
  ObAllVirtualOutlineBase::reset();
}

int ObAllVirtualOutline::fill_cells(const ObOutlineInfo *outline_info)
{
  int ret = OB_SUCCESS;
  ObObj *cells = NULL;
...
int ObAllVirtualOutline::is_output_outline(const ObOutlineInfo *outline_info, bool &is_output)
{
  int ret = OB_SUCCESS;
  is_output = false;
...
int ObAllVirtualOutline::inner_get_next_row(common::ObNewRow *&row)
{
  int ret = OB_SUCCESS;
