...
#ifndef OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_ALL_VIRTUAL_OBJECT_DEFINITION_
#define OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_ALL_VIRTUAL_OBJECT_DEFINITION_
...
namespace observer
{
class ObAllVirtualObjectDefinition : public common::ObVirtualTableScannerIterator
{
...
public:
  ObAllVirtualObjectDefinition();
  virtual ~ObAllVirtualObjectDefinition();
...
private:
  ...
  int get_package_definition(ObString &ddl_str,
                                ...
                                GetDDLObjectType object_type);
private:
  DISALLOW_COPY_AND_ASSIGN(ObAllVirtualObjectDefinition);
};
}// observer
}// oceanbase
#endif /* OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_ALL_VIRTUAL_OBJECT_DEFINITION_ */
