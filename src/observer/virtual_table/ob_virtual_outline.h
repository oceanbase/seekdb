...
#ifndef OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_VIRTUAL_OUTLINE_
#define OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_VIRTUAL_OUTLINE_
...
class ObVirtualOutlineBase: public common::ObVirtualTableIterator
{
protected:
  struct DBInfo
  {
...
private:
   DISALLOW_COPY_AND_ASSIGN(ObVirtualOutlineBase);
};

class ObVirtualOutline : public ObVirtualOutlineBase
{
  enum VIRTUAL_OUTLINE_COLUMN
  {
    ...
    // The first column is `database_id`.
...
public:
  ObVirtualOutline() : ObVirtualOutlineBase() {}
  ~ObVirtualOutline() {}
  void reset();
...
private:
  DISALLOW_COPY_AND_ASSIGN(ObVirtualOutline);
};
}
}
#endif /* OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_VIRTUAL_OUTLINE_ */
