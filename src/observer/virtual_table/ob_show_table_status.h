...
#ifndef OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLE_STATUS_
#define OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLE_STATUS_
...
#define NEW_TABLE_STATUS_SQL  "select /*+ leading(a) no_use_nl(ts)*/" \
                    ...
                    "comment," \
                    "autoinc_column_id " \
                    "from oceanbase.__all_table where table_type in (0, 1, 2, 3, 4)) a " \
...
class ObShowTableStatus : public common::ObVirtualTableIterator
{
  enum TABLE_STATUS_COLUMN
  {
...
private:
  ...
  char *option_buf_;
  DISALLOW_COPY_AND_ASSIGN(ObShowTableStatus);
};

}// observer
}// oceanbase
#endif /* OCEANBASE_OBSERVER_VIRTUAL_TABLE_OB_SHOW_TABLE_STATUS_ */
