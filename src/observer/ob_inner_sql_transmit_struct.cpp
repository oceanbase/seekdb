...
OB_DEF_SERIALIZE(obcall::ObInnerSQLTransmitArg)
{
  int ret = OB_SUCCESS;
...
OB_DEF_DESERIALIZE(obcall::ObInnerSQLTransmitArg)
{
  int ret = OB_SUCCESS;
...
OB_DEF_SERIALIZE_SIZE(obcall::ObInnerSQLTransmitArg)
{
  int64_t len = 0;
...
// 
// OB_SERIALIZE_MEMBER(obcall::ObInnerSQLTransmitResult, res_code_, conn_id_, affected_rows_, stmt_type_, scanner_, field_columns_);
OB_DEF_SERIALIZE(obcall::ObInnerSQLTransmitResult)
{
  int ret = OB_SUCCESS;
...
OB_DEF_DESERIALIZE(obcall::ObInnerSQLTransmitResult)
{
  int ret = OB_SUCCESS;
...
OB_DEF_SERIALIZE_SIZE(obcall::ObInnerSQLTransmitResult)
{
  int64_t len = 0;
