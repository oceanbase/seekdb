    ...
    rpc::ObRequest *&req)
{
  ...
  if (w.is_group_worker()) {
    ...
    } else if (wk_level > 0 && wk_level >= MAX_REQUEST_LEVEL - 1) {
...
int ObTenant::recv_request(ObRequest &req)
{
  ...
  } else if (0 != req.get_group_id() && share::ObCgSet::instance().is_in_used(req.get_group_id())) {
