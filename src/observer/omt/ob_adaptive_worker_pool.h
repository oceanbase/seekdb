...
#ifndef _OCEABASE_OBSERVER_OMT_OB_ADAPTIVE_WORKER_POOL_H_
#define _OCEABASE_OBSERVER_OMT_OB_ADAPTIVE_WORKER_POOL_H_
...
#endif /* _OCEABASE_OBSERVER_OMT_OB_ADAPTIVE_WORKER_POOL_H_ */
