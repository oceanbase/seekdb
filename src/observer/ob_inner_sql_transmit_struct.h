...
#ifndef OBDEV_SRC_OBSERVER_OB_INNER_SQL_TRANSMIT_STRUCT_H_
...
public:
  ...
  const rpc::frame::ObResultCode &get_res_code() const { return res_code_; }
...
private:
  rpc::frame::ObResultCode res_code_;
  int64_t conn_id_;
...
#endif /* OBDEV_SRC_OBSERVER_OB_INNER_SQL_TRANSMIT_STRUCT_H_ */
