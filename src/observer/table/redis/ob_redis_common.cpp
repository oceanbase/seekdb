...
#include "observer/table/redis/ob_redis_common.h"
#include "observer/table/redis/ob_redis_parser.h"
#include "lib/utility/ob_fast_convert.h"
#include "share/table/ob_table.h"  // relocated-definition owner
...
// ===== definition moved from share/table/ob_table.cpp(ObRedisUtil constant user) =====
namespace oceanbase
{
namespace table
{
