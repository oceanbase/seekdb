...
DAG_SCHEDULER_DAG_NET_TYPE_DEF(DAG_NET_TYPE_RESERVED_3, "DAG_NET_RESERVED_3")
...
DAG_SCHEDULER_DAG_NET_TYPE_DEF(DAG_NET_TYPE_RESERVED_8, "DAG_NET_RESERVED_8")
...
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_RESERVED_0, ObDagPrio::DAG_PRIO_MAX, ObSysTaskType::MAX_SYS_TASK_TYPE, "RESERVED_0", "INVALID",
    false, 0, {})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_RESERVED_1, ObDagPrio::DAG_PRIO_MAX, ObSysTaskType::MAX_SYS_TASK_TYPE, "RESERVED_1", "INVALID",
    false, 0, {})
DAG_SCHEDULER_DAG_TYPE_DEF(DAG_TYPE_RESERVED_2, ObDagPrio::DAG_PRIO_MAX, ObSysTaskType::MAX_SYS_TASK_TYPE, "RESERVED_2", "INVALID",
    false, 0, {})
