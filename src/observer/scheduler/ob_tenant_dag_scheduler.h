...
public:
  enum ObITaskType
  {
    ...
    TASK_TYPE_DIRECT_LOAD_WRITE_CHUNK_PIPELINE = 108, // unused
    TASK_TYPE_DIRECT_LOAD_WRITE_CHANNEL_FLUSH = 109,
    TASK_TYPE_DIRECT_LOAD_WRITE_CHANNEL_FINISH = 110,
    TASK_TYPE_DIRECT_LOAD_WRITE_CLOSE = 111, // unused
    ...
    TASK_TYPE_DIRECT_LOAD_START_MERGE = 116,
    ...
    TASK_TYPE_DIRECT_LOAD_WRITE_MACRO_BLOCK_PIPELINE = 121,
    TASK_TYPE_DIRECT_LOAD_FINISH_OP = 124,
    TASK_TYPE_DIRECT_LOAD_TABLE_OP_OPEN_OP = 125,
    TASK_TYPE_DIRECT_LOAD_TABLE_OP_CLOSE_OP = 126,
    TASK_TYPE_DIRECT_LOAD_TABLE_OP_CLOSE_OP_FINISH = 127, // unused
    TASK_TYPE_DIRECT_LOAD_DIRECT_WRITE_OP = 128,
    TASK_TYPE_DIRECT_LOAD_DIRECT_WRITE_OP_FINISH = 129,
    TASK_TYPE_DIRECT_LOAD_STORE_WRITE_OP = 130,
    TASK_TYPE_DIRECT_LOAD_STORE_WRITE_OP_FINISH = 131,
    TASK_TYPE_DIRECT_LOAD_PRE_SORT_WRITE_OP = 132,
    TASK_TYPE_DIRECT_LOAD_PRE_SORT_WRITE_OP_FINISH = 133,
    TASK_TYPE_DIRECT_LOAD_MEM_SORT_OP = 134,
    TASK_TYPE_DIRECT_LOAD_MEM_SORT_OP_FINISH = 135,
    TASK_TYPE_DIRECT_LOAD_COMPACT_TABLE_OP = 136,
    TASK_TYPE_DIRECT_LOAD_COMPACT_TABLE_OP_FINISH = 137,
    TASK_TYPE_DIRECT_LOAD_INSERT_SSTABLE_OP = 138,
    TASK_TYPE_DIRECT_LOAD_INSERT_SSTABLE_OP_FINISH = 139,
    TASK_TYPE_DIRECT_LOAD_INSERT_SSTABLE = 140,
    TASK_TYPE_DIRECT_LOAD_INSERT_SSTABLE_FINISH = 141,
    TASK_TYPE_DIRECT_LOAD_PRE_SORT_WRITE = 142,
    TASK_TYPE_DIRECT_LOAD_PRE_SORT_WRITE_SORT = 143,
    TASK_TYPE_DIRECT_LOAD_PRE_SORT_WRITE_FLUSH = 144, // unused
    TASK_TYPE_DIRECT_LOAD_MEM_COMPACT_SAMPLE = 145,
    TASK_TYPE_DIRECT_LOAD_MEM_COMPACT_DUMP = 146,
    TASK_TYPE_DIRECT_LOAD_MEM_COMPACT_COMPACT = 147,
    TASK_TYPE_DIRECT_LOAD_PK_MEM_SORT = 148,
    TASK_TYPE_DIRECT_LOAD_PK_MEM_SORT_LOAD = 149,
    TASK_TYPE_DIRECT_LOAD_HEAP_MEM_SORT = 150,
    TASK_TYPE_DIRECT_LOAD_COMPACT_SSTABLE = 151,
    TASK_TYPE_DIRECT_LOAD_COMPACT_SSTABLE_SPLIT_RANGE = 152,
    TASK_TYPE_DIRECT_LOAD_COMPACT_SSTABLE_MERGE_RANGE = 153,
    TASK_TYPE_DIRECT_LOAD_COMPACT_SSTABLE_COMPACT = 154,
    TASK_TYPE_DIRECT_LOAD_COMPACT_HEAP_TABLE = 155,
    TASK_TYPE_DIRECT_LOAD_COMPACT_HEAP_TABLE_COMPACT = 156,
    TASK_TABLE_LOAD_MACRO_BLOCK_WRITE_TASK = 157,
    TASK_TYPE_DDL_SCHEDULE_ANOTHER_MERGE = 158,
    TASK_TYPE_DIRECT_LOAD_INSERT_SSTABLE_CLEAR = 159,
    TASK_TYPE_DIRECT_LOAD_COMPACT_SSTABLE_CLEAR = 160,
    TASK_TYPE_DIRECT_LOAD_UPDATE_SS_INC_MAJOR = 161,
...
int ObTenantDagScheduler::alloc_dag(T *&dag)
{
  ...
  if (IS_NOT_INIT) {
    ...
    T tmp_dag; // TODO:(chengkong) ignore when resolve conflict, but here is an issue about large dag stack overflow
