...
#ifndef SRC_STORAGE_SCHEDULER_OB_DAG_WARNING_HISTORY_MGR_H_
#define SRC_STORAGE_SCHEDULER_OB_DAG_WARNING_HISTORY_MGR_H_
...
DEFINE_DAG_WARN_INFO_PARAM_ADD_EXTRA(2,5)

DEFINE_DAG_WARN_INFO_PARAM_ADD_EXTRA(3,1)
DEFINE_DAG_WARN_INFO_PARAM_ADD_EXTRA(3,3)
DEFINE_DAG_WARN_INFO_PARAM_ADD_EXTRA(3,4)
}//storage
}//oceanbase

#endif /* SRC_STORAGE_SCHEDULER_OB_DAG_WARNING_HISTORY_MGR_H_ */
