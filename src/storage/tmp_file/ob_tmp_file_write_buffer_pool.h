...
{
public:
  // Keep 253 complete tmp-file pages in one normal FIFO allocation page.
  static const int64_t BLOCK_PAGE_NUMS = 253;
  static const int64_t WBP_BLOCK_SIZE = BLOCK_PAGE_NUMS * ObTmpFileGlobal::ALLOC_PAGE_SIZE;
