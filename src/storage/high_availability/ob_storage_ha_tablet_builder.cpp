    ...
    ObICopyTabletInfoReader *&reader)
{
  ...
  if (!is_inited_) {
    ...
    ret = OB_ERR_UNEXPECTED;
    LOG_WARN("get invalid reader", K(ret), K(param_));
  }
  return ret;
}
    ...
    ObLS *ls)
{
  ...
  if (!is_inited_) {
    ...
    if (OB_FAIL(create_tablet_with_major_sstables_(ls, tablet_info, major_tables, major_sstables_param, is_only_replace_major))) {
    ...
    ObICopySSTableInfoReader *&reader)
{
  ...
  if (!is_inited_) {
    ...
    ret = OB_ERR_UNEXPECTED;
    LOG_WARN("invalid reader", K(ret), K(param_));
  }
  return ret;
}
    ...
    const bool is_only_replace_major)
{
  ...
  if (!is_inited_) {
    ...
    //do nothing
      ...
      tablet_info.tablet_id_, major_tables, major_sstables_param, is_only_replace_major))) {
