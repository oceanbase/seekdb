...
public:
  ...
  int init_range_part_split_src(const ObIArray<ObTabletID> &dst_tablet_ids, const ObIArray<uint64_t> &partkey_projector, const share::schema::ObTableSchema &table_schema);
