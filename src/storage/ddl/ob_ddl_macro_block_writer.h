...
#ifndef OCEANBASE_STORAGE_OB_DDL_MACRO_BLOCK_WRITER_H_
#define OCEANBASE_STORAGE_OB_DDL_MACRO_BLOCK_WRITER_H_
...
private:
  DISABLE_COPY_ASSIGN(ObDDLMacroBlockWriter);
...
#endif //OCEANBASE_STORAGE_OB_DDL_MACRO_BLOCK_WRITER_H_
