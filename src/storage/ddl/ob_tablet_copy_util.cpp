...
int ObTabletCopyUtil::get_clipped_storage_schema_on_demand(
...
int ObTabletCopyUtil::check_need_fill_empty_sstable(
    ObLS *ls,
...
int ObTabletCopyUtil::build_create_empty_sstable_param(
