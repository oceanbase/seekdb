...
#ifndef OB_OCEANBASE_STORAGE_DDL_VECTOR_INDEX_DDL_PIPELINE_H
#define OB_OCEANBASE_STORAGE_DDL_VECTOR_INDEX_DDL_PIPELINE_H
...
public:
  explicit ObHNSWEmbeddingOperator(ObPipeline *pipeline)
    : ObVectorIndexBaseOperator(pipeline), embedmgr_(nullptr), vec_dim_(-1), rowkey_cnt_(-1),
      ...
      batch_size_(0), current_batch_(nullptr), lob_read_service_(nullptr)
  {}
...
#endif // OB_OCEANBASE_STORAGE_DDL_VECTOR_INDEX_DDL_PIPELINE_H
