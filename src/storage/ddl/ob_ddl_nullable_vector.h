...
#include "query/engine/vector/ob_bitmap_null_vector_base.h"
...
class ObDDLNullableVector final : public ObDDLVector
{
public:
  ObDDLNullableVector(V *vector)
    : data_vector_(vector),
  ...
  ~ObDDLNullableVector() override = default;
  ...
  {
    const ObDDLNullableVector &nullable_vector =
      static_cast<const ObDDLNullableVector &>(src);
