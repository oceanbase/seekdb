...
#ifndef SRC_STORAGE_COMPACTION_OB_TABLET_CHECK_INFO_H_
#define SRC_STORAGE_COMPACTION_OB_TABLET_CHECK_INFO_H_
...
#endif /* SRC_STORAGE_COMPACTION_OB_TABLET_CHECK_INFO_H_ */
