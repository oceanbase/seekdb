...
#include "ob_local_storage_checkpoint_reader.h"
...
ObLocalStorageCheckpointReader::ObLocalStorageCheckpointReader() {}

int ObLocalStorageCheckpointReader::iter_read_meta_item(
...
int ObLocalStorageCheckpointReader::read_single_meta_item(
    const MacroBlockId &entry_block,
    const ObStorageMetaOp &op,
    ObIArray<MacroBlockId> &block_list)
{
...
int ObLocalStorageCheckpointReader::read_tablet_checkpoint_by_addr(
