...
#include "ob_meta_obj_pool.h"
#include "storage/meta_mem/ob_tablet_meta_mem_mgr.h"
...
ObTabletTryWashFunc::ObTabletTryWashFunc(ObTabletMetaMemMgr &t3m)
  : t3m_(t3m)
{
}

ObTabletTryWashFunc::~ObTabletTryWashFunc()
{
}

int ObTabletTryWashFunc::operator()(const std::type_info &type_info, void *&free_obj)
{
  free_obj = nullptr;
