...
public:
  ...
  int post_msg_(const share::ObLSID &receiver, ObTxMsg &msg);
  int post_msg_(const ObAddr &server, ObTxMsg &msg);
...
private:
  ...
  void set_upstream_state(ObTxState state) { upstream_state_ = state; }
...
public:
  ...
  ObTxState get_upstream_state() const { return upstream_state_; }
