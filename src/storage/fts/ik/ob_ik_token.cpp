...
template int ObFTSortList<ObList<ObIKToken, ObIAllocator>>::add_token(
    const ObIKToken &token);
...
template class ObFTSortList<ObFastList<ObIKToken, IK_TOKEN_BLOCK_CAPACITY>>;
} //  namespace storage
} //  namespace oceanbase
