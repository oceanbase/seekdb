...
// A list whose POD-like nodes come from reusable segmented storage. Individual
// element destructors are intentionally not invoked; the pool is reclaimed in
// bulk when the parser is reset.
...
public:
  ...
  public:
    ...
    iterator &operator++()
    {
      node_ = nullptr == node_ ? nullptr : node_->next;
      return *this;
    }
    ...
    iterator &operator--()
    {
      node_ = nullptr == node_ ? nullptr : node_->prev;
      return *this;
    }
    iterator operator--(int)
    {
