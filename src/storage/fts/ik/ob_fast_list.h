...
// Task4 Op1：链表节点由分块数组批量提供，保留有序插入语义并消除逐节点分配。
...
public:
  ...
  public:
    ...
    T *operator->() const { return &node_->value; }
    iterator &operator++() { node_ = node_ ? node_->next : nullptr; return *this; }
    iterator operator++(int) { iterator tmp(*this); ++(*this); return tmp; }
    iterator &operator--() { node_ = node_ ? node_->prev : nullptr; return *this; }
    iterator operator--(int) { iterator tmp(*this); --(*this); return tmp; }
  ...
  public:
    ...
    const T *operator->() const { return &node_->value; }
    const_iterator &operator++() { node_ = node_ ? node_->next : nullptr; return *this; }
    const_iterator operator++(int) { const_iterator tmp(*this); ++(*this); return tmp; }
    const_iterator &operator--() { node_ = node_ ? node_->prev : nullptr; return *this; }
    const_iterator operator--(int) { const_iterator tmp(*this); --(*this); return tmp; }
