 ...
 */
#ifndef OB_STORAGE_TRUNCATE_INFO_TRUNCATE_TABLET_ARG_H_
#define OB_STORAGE_TRUNCATE_INFO_TRUNCATE_TABLET_ARG_H_
...
#endif // OB_STORAGE_TRUNCATE_INFO_TRUNCATE_TABLET_ARG_H_
