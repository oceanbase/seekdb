...
public:
  ...
  OB_INLINE int deep_copy(const ObDatumRange &src, ObIAllocator &allocator);
...
OB_INLINE int ObDatumRange::deep_copy(const ObDatumRange &src, ObIAllocator &allocator)
{
  int ret = OB_SUCCESS;
