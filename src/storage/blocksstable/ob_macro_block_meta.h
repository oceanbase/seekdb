...
{
public:
  static const int32_t DATA_BLOCK_META_VAL_VERSION = 2;
...
public:
  ...
  TO_STRING_KV(K_(version), K_(length), K_(data_checksum), K_(rowkey_count),
        ...
        K_(row_count_delta), K_(max_merged_trans_version),
...
public:
  ...
  int64_t data_zsize_;    // sum of size of compressed micro blocks
