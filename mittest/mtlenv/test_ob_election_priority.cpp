...
#define CLUSTER_VERSION_0200 (oceanbase::common::cal_version(0, 2, 0, 0))
#define CLUSTER_VERSION_0210 (oceanbase::common::cal_version(0, 2, 1, 0))
...
public:
  ...
  static void test_normal()
  {
    ...
    ASSERT_EQ(CLUSTER_VERSION_0210 > CLUSTER_VERSION_0200, true);
    ...
    oceanbase::common::ObClusterVersion::get_instance().cluster_version_ = CLUSTER_VERSION_0210;
    ...
    oceanbase::common::ObClusterVersion::get_instance().cluster_version_ = CLUSTER_VERSION_1_0_0_0;
    ASSERT_EQ(OB_SUCCESS, impl1.compare_with(impl2, result, reason));
    ASSERT_EQ(result, 1);
  ...
  {
    OB_LOG(DEBUG, "print version", K(CLUSTER_VERSION_0200), K(CLUSTER_VERSION_1_0_0_0));
    ElectionPriorityImpl impl1, impl2;
